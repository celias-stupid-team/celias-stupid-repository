...
#define MENU_INFO_ICON_OBTAINABLE    (NUMBER_OF_MON_TYPES + 6)
#define MENU_INFO_ICON_BONUS    (NUMBER_OF_MON_TYPES + 7)
#define MENU_INFO_ICON_PREMIER    (NUMBER_OF_MON_TYPES + 8)
#define MENU_INFO_ICON_THREE_STAR    (NUMBER_OF_MON_TYPES + 9)
