...
// Mime Jr.
extern const u32 gMonFrontPic_Mime_Jr_[];
extern const u32 gMonPalette_Mime_Jr_[];
extern const u32 gMonBackPic_Mime_Jr_[];
extern const u32 gMonShinyPalette_Mime_Jr_[];
extern const u8 gMonIcon_Mime_Jr_[];
extern const u8 gMonFootprint_Mime_Jr_[];
...
extern const u32 gTrainerFrontPic_Cop[];
...
extern const u32 gTrainerPalette_Cop[];
...
extern const u32 gItemIcon_JellyDonut[];
extern const u32 gItemIconPalette_JellyDonut[];
...
extern const u32 gBattleAnimSpriteGfx_Bulldozer[];
extern const u32 gBattleAnimSpriteGfx_RotomDescend[];
extern const u32 gBattleAnimSpriteGfx_Exodia[];
extern const u32 gBattleAnimSpriteGfx_ThrownKrabby[];
...
extern const u32 gBattleAnimSpriteGfx_LetterR[];
extern const u32 gBattleAnimSpriteGfx_LetterE[];
extern const u32 gBattleAnimSpriteGfx_LetterGMB[];
extern const u32 gBattleAnimSpriteGfx_MrBonding[];
extern const u32 gBattleAnimSpriteGfx_LetterT[];
extern const u32 gBattleAnimSpriteGfx_DadOfLight[];
extern const u32 gBattleAnimSpriteGfx_Lass[];
...
extern const u32 gBattleAnimSpriteGfx_Chocolate[];
extern const u32 gBattleAnimSpriteGfx_CStinger[];
extern const u32 gBattleAnimSpriteGfx_Hotdog[];
extern const u32 gBattleAnimSpriteGfx_AcidRainDrops[];
extern const u32 gBattleAnimSpriteGfx_PSIRockinOne[];
extern const u32 gBattleAnimSpriteGfx_PSIRockinTwo[];
extern const u32 gBattleAnimSpriteGfx_HongKongRun[];
extern const u32 gBattleAnimSpriteGfx_HongKongExplosion[];
...
extern const u32 gBattleAnimSpriteGfx_Clock[];
extern const u32 gBattleAnimSpriteGfx_Cloth[];
extern const u32 gBattleAnimSpriteGfx_DireHit[];
extern const u32 gBattleAnimSpriteGfx_Nobble[];
extern const u32 gBattleAnimSpriteGfx_Feraligatr[];
extern const u32 gBattleAnimSpriteGfx_Store[];
extern const u32 gBattleAnimSpriteGfx_Gym[];
extern const u32 gBattleAnimSpriteGfx_Nobstruct[];
extern const u32 gBattleAnimSpriteGfx_Daisy[];
extern const u32 gBattleAnimSpriteGfx_Nightsy[];
extern const u32 gBattleAnimSpriteGfx_Claw[];
extern const u32 gBattleAnimSpriteGfx_Latias[];
extern const u32 gBattleAnimSpriteGfx_SoulDew[];
extern const u32 gBattleAnimSpriteGfx_EonTicket[];
extern const u32 gBattleAnimSpriteGfx_TheLedge[];
extern const u32 gBattleAnimSpriteGfx_Loss[];
...
extern const u32 gBattleAnimSpriteGfx_Bike[];
extern const u32 gBattleAnimSpriteGfx_WagonAscent[];
extern const u32 gBattleAnimSpriteGfx_Balloon[];
extern const u32 gBattleAnimSpriteGfx_Doduo[];
extern const u32 gBattleAnimSpriteGfx_KoopaShell[];
extern const u32 gBattleAnimSpriteGfx_HeracrossHorn[];
extern const u32 gBattleAnimSpriteGfx_Charizard[];
extern const u32 gBattleAnimSpriteGfx_RaichuTape[];
extern const u32 gBattleAnimSpriteGfx_RaichuRat[];
extern const u32 gBattleAnimSpriteGfx_RaichuBootleg[];
extern const u32 gBattleAnimSpriteGfx_LetsGo[];
extern const u32 gBattleAnimSpriteGfx_Sparrow[];
extern const u32 gBattleAnimSpriteGfx_Umbrella[];
extern const u32 gBattleAnimSpriteGfx_Parasol[];
extern const u32 gBattleAnimSpriteGfx_Boots[];
extern const u32 gBattleAnimSpriteGfx_Oak[];
extern const u32 gBattleAnimSpriteGfx_CameraReticle[];
extern const u32 gBattleAnimSpriteGfx_Stylus[];
extern const u32 gBattleAnimSpriteGfx_TrozeiHbox[];
extern const u32 gBattleAnimSpriteGfx_TrozeiRaichu[];
extern const u32 gBattleAnimSpriteGfx_TrozeiDad[];
extern const u32 gBattleAnimSpriteGfx_TrozeiDigletts[];
extern const u32 gBattleAnimSpriteGfx_TrozeiTime[];
extern const u32 gBattleAnimSpriteGfx_StylerDisc[];
extern const u32 gBattleAnimSpriteGfx_StylerWand[];
extern const u32 gBattleAnimSpriteGfx_Trumpet[];
extern const u32 gBattleAnimSpriteGfx_Microphone[];
extern const u32 gBattleAnimSpriteGfx_Channeler[];
extern const u32 gBattleAnimSpriteGfx_RaichuConquest[];
extern const u32 gBattleAnimSpriteGfx_ConquestEnergy[];
extern const u32 gBattleAnimSpriteGfx_Branch[];
extern const u32 gBattleAnimSpriteGfx_PhaseShift[];
extern const u32 gBattleAnimSpriteGfx_HitCount[];
extern const u32 gBattleAnimSpriteGfx_Letters[];
extern const u32 gBattleAnimSpriteGfx_Box[];
extern const u32 gBattleAnimSpriteGfx_SuddenDeath[];
extern const u32 gBattleAnimSpriteGfx_OhNo[];
extern const u32 gBattleAnimSpriteGfx_Grandpa[];
extern const u32 gBattleAnimSpriteGfx_Rapidash[];
extern const u32 gBattleAnimSpriteGfx_Bobomb[];
extern const u32 gBattleAnimSpriteGfx_TcgDrain[];
extern const u32 gBattleAnimSpriteGfx_TcgHeal[];
extern const u32 gBattleAnimSpriteGfx_BarveBoyWalk[];
extern const u32 gBattleAnimSpriteGfx_BarveBoyKick[];
extern const u32 gBattleAnimSpriteGfx_Mombat[];
extern const u32 gBattleAnimSpriteGfx_TcgPc[];
extern const u32 gBattleAnimSpriteGfx_Heel[];
extern const u32 gBattleAnimSpriteGfx_Arrow[];
extern const u32 gBattleAnimSpriteGfx_Fisher[];
extern const u32 gBattleAnimSpriteGfx_Poncho[];
extern const u32 gBattleAnimSpriteGfx_Raincoat[];
extern const u32 gBattleAnimSpriteGfx_MeowthReporter[];
extern const u32 gBattleAnimSpriteGfx_Azumarill[];
extern const u32 gBattleAnimSpriteGfx_ReportText[];
extern const u32 gBattleAnimSpriteGfx_UniteRightStick[];
extern const u32 gBattleAnimSpriteGfx_UniteHud[];
extern const u32 gBattleAnimSpriteGfx_DetectiveHat[];
extern const u32 gBattleAnimSpriteGfx_DetectivePipe[];
extern const u32 gBattleAnimSpriteGfx_Bottle[];
extern const u32 gBattleAnimSpriteGfx_PokeparkHud[];
extern const u32 gBattleAnimSpriteGfx_RaichuSurf[];
extern const u32 gBattleAnimSpriteGfx_NiceRat[];
extern const u32 gBattleAnimSpriteGfx_TcgTen[];
extern const u32 gBattleAnimSpriteGfx_RaichuSteelRat[];
extern const u32 gBattleAnimSpriteGfx_SheerGold[];
extern const u32 gBattleAnimSpriteGfx_Sraiche[];
extern const u32 gBattleAnimSpriteGfx_Pond[];
extern const u32 gBattleAnimSpriteGfx_Gillotine[];
extern const u32 gBattleAnimSpriteGfx_RaichuHat[];
extern const u32 gBattleAnimSpriteGfx_AngryEmoji[];
extern const u32 gBattleAnimSpriteGfx_RaichuSitting[];
extern const u32 gBattleAnimSpriteGfx_RaichuMini[];
extern const u32 gBattleAnimSpriteGfx_RaichuCafe[];
extern const u32 gBattleAnimSpriteGfx_BrickWall[];
extern const u32 gBattleAnimSpriteGfx_SparkleOn[];
extern const u32 gBattleAnimSpriteGfx_Toothbrush[];
extern const u32 gBattleAnimSpriteGfx_Tooth[];
extern const u32 gBattleAnimSpriteGfx_iPhone[];
extern const u32 gBattleAnimSpriteGfx_Cup[];
extern const u32 gBattleAnimSpriteGfx_Medium[];
extern const u32 gBattleAnimSpriteGfx_Cynthia[];
...
extern const u32 gBattleAnimSpritePal_Bulldozer[];
extern const u32 gBattleAnimSpritePal_RotomDescend[];
extern const u32 gBattleAnimSpritePal_Exodia[];
extern const u32 gBattleAnimSpritePal_ThrownKrabby[];
...
extern const u32 gBattleAnimSpritePal_LetterR[];
extern const u32 gBattleAnimSpritePal_LetterE[];
extern const u32 gBattleAnimSpritePal_LetterGMB[];
extern const u32 gBattleAnimSpritePal_MrBonding[];
extern const u32 gBattleAnimSpritePal_LetterT[];
extern const u32 gBattleAnimSpritePal_DadOfLight[];
extern const u32 gBattleAnimSpritePal_Lass[];
...
extern const u32 gBattleAnimSpritePal_Chocolate[];
extern const u32 gBattleAnimSpritePal_CStinger[];
extern const u32 gBattleAnimSpritePal_Hotdog[];
extern const u32 gBattleAnimSpritePal_AcidRainDrops[];
extern const u32 gBattleAnimSpritePal_PSIRockinOne[];
extern const u32 gBattleAnimSpritePal_PSIRockinTwo[];
extern const u32 gBattleAnimSpritePal_HongKongRun[];
extern const u32 gBattleAnimSpritePal_HongKongExplosion[];
...
extern const u32 gBattleAnimSpritePal_Clock[];
extern const u32 gBattleAnimSpritePal_Cloth[];
extern const u32 gBattleAnimSpritePal_DireHit[];
extern const u32 gBattleAnimSpritePal_Nobble[];
extern const u32 gBattleAnimSpritePal_Feraligatr[];
extern const u32 gBattleAnimSpritePal_Store[];
extern const u32 gBattleAnimSpritePal_Gym[];
extern const u32 gBattleAnimSpritePal_Nobstruct[];
extern const u32 gBattleAnimSpritePal_Daisy[];
extern const u32 gBattleAnimSpritePal_Nightsy[];
extern const u32 gBattleAnimSpritePal_Claw[];
extern const u32 gBattleAnimSpritePal_Latias[];
extern const u32 gBattleAnimSpritePal_SoulDew[];
extern const u32 gBattleAnimSpritePal_EonTicket[];
extern const u32 gBattleAnimSpritePal_TheLedge[];
extern const u32 gBattleAnimSpritePal_Loss[];
...
extern const u32 gBattleAnimSpritePal_Bike[];
extern const u32 gBattleAnimSpritePal_WagonAscent[];
extern const u32 gBattleAnimSpritePal_Balloon[];
extern const u32 gBattleAnimSpritePal_Doduo[];
extern const u32 gBattleAnimSpritePal_KoopaShell[];

extern const u32 gBattleAnimSpritePal_HeracrossHorn[];
extern const u32 gBattleAnimSpritePal_Charizard[];
extern const u32 gBattleAnimSpritePal_RaichuTape[];
extern const u32 gBattleAnimSpritePal_RaichuRat[];
extern const u32 gBattleAnimSpritePal_RaichuBootleg[];
extern const u32 gBattleAnimSpritePal_LetsGo[];
extern const u32 gBattleAnimSpritePal_Sparrow[];
extern const u32 gBattleAnimSpritePal_Umbrella[];
extern const u32 gBattleAnimSpritePal_Parasol[];
extern const u32 gBattleAnimSpritePal_Boots[];
extern const u32 gBattleAnimSpritePal_Oak[];
extern const u32 gBattleAnimSpritePal_CameraReticle[];
extern const u32 gBattleAnimSpritePal_Stylus[];
extern const u32 gBattleAnimSpritePal_TrozeiHbox[];
extern const u32 gBattleAnimSpritePal_TrozeiRaichu[];
extern const u32 gBattleAnimSpritePal_TrozeiDad[];
extern const u32 gBattleAnimSpritePal_TrozeiDigletts[];
extern const u32 gBattleAnimSpritePal_TrozeiTime[];
extern const u32 gBattleAnimSpritePal_StylerDisc[];
extern const u32 gBattleAnimSpritePal_StylerWand[];
extern const u32 gBattleAnimSpritePal_Trumpet[];
extern const u32 gBattleAnimSpritePal_Microphone[];
extern const u32 gBattleAnimSpritePal_Channeler[];
extern const u32 gBattleAnimSpritePal_RaichuConquest[];
extern const u32 gBattleAnimSpritePal_ConquestEnergy[];
extern const u32 gBattleAnimSpritePal_Branch[];
extern const u32 gBattleAnimSpritePal_PhaseShift[];
extern const u32 gBattleAnimSpritePal_HitCount[];
extern const u32 gBattleAnimSpritePal_Letters[];
extern const u32 gBattleAnimSpritePal_Box[];
extern const u32 gBattleAnimSpritePal_SuddenDeath[];
extern const u32 gBattleAnimSpritePal_OhNo[];
extern const u32 gBattleAnimSpritePal_Grandpa[];
extern const u32 gBattleAnimSpritePal_Rapidash[];
extern const u32 gBattleAnimSpritePal_Bobomb[];
extern const u32 gBattleAnimSpritePal_TcgDrain[];
extern const u32 gBattleAnimSpritePal_TcgHeal[];
extern const u32 gBattleAnimSpritePal_BarveBoyWalk[];
extern const u32 gBattleAnimSpritePal_BarveBoyKick[];
extern const u32 gBattleAnimSpritePal_Mombat[];
extern const u32 gBattleAnimSpritePal_TcgPc[];
extern const u32 gBattleAnimSpritePal_Heel[];
extern const u32 gBattleAnimSpritePal_Arrow[];
extern const u32 gBattleAnimSpritePal_Fisher[];
extern const u32 gBattleAnimSpritePal_Poncho[];
extern const u32 gBattleAnimSpritePal_Raincoat[];
extern const u32 gBattleAnimSpritePal_MeowthReporter[];
extern const u32 gBattleAnimSpritePal_Azumarill[];
extern const u32 gBattleAnimSpritePal_ReportText[];
extern const u32 gBattleAnimSpritePal_UniteRightStick[];
extern const u32 gBattleAnimSpritePal_UniteHud[];
extern const u32 gBattleAnimSpritePal_DetectiveHat[];
extern const u32 gBattleAnimSpritePal_DetectivePipe[];
extern const u32 gBattleAnimSpritePal_Bottle[];
extern const u32 gBattleAnimSpritePal_PokeparkHud[];
extern const u32 gBattleAnimSpritePal_RaichuSurf[];
extern const u32 gBattleAnimSpritePal_NiceRat[];
extern const u32 gBattleAnimSpritePal_TcgTen[];
extern const u32 gBattleAnimSpritePal_RaichuSteelRat[];
extern const u32 gBattleAnimSpritePal_SheerGold[];
extern const u32 gBattleAnimSpritePal_Sraiche[];
extern const u32 gBattleAnimSpritePal_Pond[];
extern const u32 gBattleAnimSpritePal_Gillotine[];
extern const u32 gBattleAnimSpritePal_RaichuHat[];
extern const u32 gBattleAnimSpritePal_AngryEmoji[];
extern const u32 gBattleAnimSpritePal_RaichuSitting[];
extern const u32 gBattleAnimSpritePal_RaichuMini[];
extern const u32 gBattleAnimSpritePal_RaichuCafe[];
extern const u32 gBattleAnimSpritePal_BrickWall[];
extern const u32 gBattleAnimSpritePal_SparkleOn[];
extern const u32 gBattleAnimSpritePal_Toothbrush[];
extern const u32 gBattleAnimSpritePal_Tooth[];
extern const u32 gBattleAnimSpritePal_iPhone[];
extern const u32 gBattleAnimSpritePal_Cup[];
extern const u32 gBattleAnimSpritePal_Medium[];
extern const u32 gBattleAnimSpritePal_Cynthia[];
//CSR Moves
...
extern const u32 gBattleAnimBgImage_Manga[];
extern const u32 gBattleAnimBgImage_Luin[];
extern const u32 gBattleAnimBgImage_SkyTower[];
extern const u32 gBattleAnimBgImage_UniteHud[];
extern const u32 gBattleAnimBgImage_Catastrophe[];
extern const u32 gBattleAnimBgImage_Gold[];
...
extern const u32 gBattleAnimBgPalette_Manga[];
extern const u32 gBattleAnimBgPalette_Luin[];
extern const u32 gBattleAnimBgPalette_SkyTower[];
extern const u32 gBattleAnimBgPalette_UniteHud[];
extern const u32 gBattleAnimBgPalette_Catastrophe[];
extern const u32 gBattleAnimBgPalette_Gold[];
...
extern const u32 gBattleAnimBgTilemap_Manga[];
extern const u32 gBattleAnimBgTilemap_Luin[];
extern const u32 gBattleAnimBgTilemap_SkyTower[];
extern const u32 gBattleAnimBgTilemap_UniteHud[];
extern const u32 gBattleAnimBgTilemap_Catastrophe[];
extern const u32 gBattleAnimBgTilemap_Gold[];
...
extern const u8 gMonIcon_QuestionMark[];
extern const u8 gMonIcon_Jigglypuff_Above[];
extern const u8 gMonIcon_Tentaquil[];
extern const u8 gMonIcon_Missingno[];
extern const u8 gMonIcon_Kenya[];
extern const u8 gMonIcon_Hitmonchan_Shit[];
extern const u8 gMonIcon_Hitmonchin[];
extern const u8 gMonIcon_Trubbish_Haircut[];
extern const u8 gMonIcon_Ampharos_Mega[];
extern const u8 gMonIcon_Yoshi[];
extern const u8 gMonIcon_Ditto_Mew[];
extern const u8 gMonIcon_Unown_Loss[];
extern const u8 gMonIcon_Magnalone[];
extern const u8 gMonIcon_Tyranastar[];
extern const u8 gMonIcon_Pokemon_Gun[];
...
extern const u32 gMonPalette_Jigglypuff_Above[];
extern const u32 gMonBackPic_Jigglypuff_Above[];
extern const u32 gMonShinyPalette_Jigglypuff_Above[];
extern const u8 gMonIcon_Jigglypuff_Above[];
extern const u8 gMonFootprint_Jigglypuff_Above[];

// Tentaquil
extern const u32 gMonFrontPic_Tentaquil[];
extern const u32 gMonPalette_Tentaquil[];
extern const u32 gMonBackPic_Tentaquil[];
extern const u32 gMonShinyPalette_Tentaquil[];
extern const u8 gMonIcon_Tentaquil[];
extern const u8 gMonFootprint_Tentaquil[];
...
// Kenya
extern const u32 gMonFrontPic_Kenya[];
extern const u32 gMonPalette_Kenya[];
extern const u32 gMonBackPic_Kenya[];
extern const u32 gMonShinyPalette_Kenya[];
extern const u8 gMonIcon_Kenya[];
extern const u8 gMonFootprint_Kenya[];

// Hitmonchan Shit
extern const u32 gMonFrontPic_Hitmonchan_Shit[];
extern const u32 gMonPalette_Hitmonchan_Shit[];
extern const u32 gMonBackPic_Hitmonchan_Shit[];
extern const u32 gMonShinyPalette_Hitmonchan_Shit[];
extern const u8 gMonIcon_Hitmonchan_Shit[];
extern const u8 gMonFootprint_Hitmonchan_Shit[];

// Hitmonchin
extern const u32 gMonFrontPic_Hitmonchin[];
extern const u32 gMonPalette_Hitmonchin[];
extern const u32 gMonBackPic_Hitmonchin[];
extern const u32 gMonShinyPalette_Hitmonchin[];
extern const u8 gMonIcon_Hitmonchin[];
extern const u8 gMonFootprint_Hitmonchin[];

// Trubbish Haircut
extern const u32 gMonFrontPic_Trubbish_Haircut[];
extern const u32 gMonPalette_Trubbish_Haircut[];
extern const u32 gMonBackPic_Trubbish_Haircut[];
extern const u32 gMonShinyPalette_Trubbish_Haircut[];
extern const u8 gMonIcon_Trubbish_Haircut[];
extern const u8 gMonFootprint_Trubbish_Haircut[];

// Ampharos Mega
extern const u32 gMonFrontPic_Ampharos_Mega[];
extern const u32 gMonPalette_Ampharos_Mega[];
extern const u32 gMonBackPic_Ampharos_Mega[];
extern const u32 gMonShinyPalette_Ampharos_Mega[];
extern const u8 gMonIcon_Ampharos_Mega[];
extern const u8 gMonFootprint_Ampharos_Mega[];

// Yoshi
extern const u32 gMonFrontPic_Yoshi[];
extern const u32 gMonPalette_Yoshi[];
extern const u32 gMonBackPic_Yoshi[];
extern const u32 gMonShinyPalette_Yoshi[];
extern const u8 gMonIcon_Yoshi[];
extern const u8 gMonFootprint_Yoshi[];

// Ditto Mew
extern const u32 gMonFrontPic_Ditto_Mew[];
extern const u32 gMonPalette_Ditto_Mew[];
extern const u32 gMonBackPic_Ditto_Mew[];
extern const u32 gMonShinyPalette_Ditto_Mew[];
extern const u8 gMonIcon_Ditto_Mew[];
extern const u8 gMonFootprint_Ditto_Mew[];

// Unown Loss
extern const u32 gMonFrontPic_Unown_Loss[];
extern const u32 gMonPalette_Unown_Loss[];
extern const u32 gMonBackPic_Unown_Loss[];
extern const u32 gMonShinyPalette_Unown_Loss[];
extern const u8 gMonIcon_Unown_Loss[];
extern const u8 gMonFootprint_Unown_Loss[];

// Magnalone
extern const u32 gMonFrontPic_Magnalone[];
extern const u32 gMonPalette_Magnalone[];
extern const u32 gMonBackPic_Magnalone[];
extern const u32 gMonShinyPalette_Magnalone[];
extern const u8 gMonIcon_Magnalone[];
extern const u8 gMonFootprint_Magnalone[];

// Tyranastar
extern const u32 gMonFrontPic_Tyranastar[];
extern const u32 gMonPalette_Tyranastar[];
extern const u32 gMonBackPic_Tyranastar[];
extern const u32 gMonShinyPalette_Tyranastar[];
extern const u8 gMonIcon_Tyranastar[];
extern const u8 gMonFootprint_Tyranastar[];

// Pokemon Gun
extern const u32 gMonFrontPic_Pokemon_Gun[];
extern const u32 gMonPalette_Pokemon_Gun[];
extern const u32 gMonBackPic_Pokemon_Gun[];
extern const u32 gMonShinyPalette_Pokemon_Gun[];
extern const u8 gMonIcon_Pokemon_Gun[];
extern const u8 gMonFootprint_Pokemon_Gun[];

// Plug Oink
extern const u32 gMonFrontPic_Plug_Oink[];
extern const u32 gMonPalette_Plug_Oink[];
extern const u32 gMonBackPic_Plug_Oink[];
extern const u32 gMonShinyPalette_Plug_Oink[];
extern const u8 gMonIcon_Plug_Oink[];
extern const u8 gMonFootprint_Plug_Oink[];

// Pikablu
extern const u32 gMonFrontPic_Pikablu[];
extern const u32 gMonPalette_Pikablu[];
extern const u32 gMonBackPic_Pikablu[];
extern const u32 gMonShinyPalette_Pikablu[];
extern const u8 gMonIcon_Pikablu[];
...
extern const u8 gMonFootprint_UNOWNS[];
extern const u8 gMonIcon_UNOWNS[];
...
extern const u8 gMonFootprint_UNOWNE[];
extern const u8 gMonIcon_UNOWNE[];
...
extern const u8 gMonFootprint_UNOWNN[];
extern const u8 gMonIcon_UNOWNN[];
...
extern const u8 gMonFootprint_UNOWND[];
extern const u8 gMonIcon_UNOWND[];

// RELICANTH_PAST
extern const u32 gMonFrontPic_RELICANTHPAST[];
extern const u32 gMonPalette_RELICANTHPAST[];
extern const u32 gMonBackPic_RELICANTHPAST[];
extern const u32 gMonShinyPalette_RELICANTHPAST[];
extern const u8 gMonFootprint_RELICANTHPAST[];
extern const u8 gMonIcon_RELICANTHPAST[];

// RELICANTH_FUTURE
extern const u32 gMonFrontPic_RELICANTHFUTURE[];
extern const u32 gMonPalette_RELICANTHFUTURE[];
extern const u32 gMonBackPic_RELICANTHFUTURE[];
extern const u32 gMonShinyPalette_RELICANTHFUTURE[];
extern const u8 gMonFootprint_RELICANTHFUTURE[];
extern const u8 gMonIcon_RELICANTHFUTURE[];

// POKEMON_RAP
extern const u32 gMonFrontPic_POKEMONRAP[];
extern const u32 gMonPalette_POKEMONRAP[];
extern const u32 gMonBackPic_POKEMONRAP[];
extern const u32 gMonShinyPalette_POKEMONRAP[];
extern const u8 gMonFootprint_POKEMONRAP[];
extern const u8 gMonIcon_POKEMONRAP[];

// NIDORAN_M_POKERAP
extern const u32 gMonFrontPic_NIDORANMPOKERAP[];
extern const u32 gMonPalette_NIDORANMPOKERAP[];
extern const u32 gMonBackPic_NIDORANMPOKERAP[];
extern const u32 gMonShinyPalette_NIDORANMPOKERAP[];
extern const u8 gMonFootprint_NIDORANMPOKERAP[];
extern const u8 gMonIcon_NIDORANMPOKERAP[];

// NIDORAN_F_POKERAP
extern const u32 gMonFrontPic_NIDORANFPOKERAP[];
extern const u32 gMonPalette_NIDORANFPOKERAP[];
extern const u32 gMonBackPic_NIDORANFPOKERAP[];
extern const u32 gMonShinyPalette_NIDORANFPOKERAP[];
extern const u8 gMonFootprint_NIDORANFPOKERAP[];
extern const u8 gMonIcon_NIDORANFPOKERAP[];
...
// KANGASKHAN_TEACHER
extern const u32 gMonFrontPic_KANGASKHANTEACHER[];
extern const u32 gMonPalette_KANGASKHANTEACHER[];
extern const u32 gMonBackPic_KANGASKHANTEACHER[];
extern const u32 gMonShinyPalette_KANGASKHANTEACHER[];
extern const u8 gMonFootprint_KANGASKHANTEACHER[];
extern const u8 gMonIcon_KANGASKHANTEACHER[];

// TANGELA_CREEPY
extern const u32 gMonFrontPic_TANGELACREEPY[];
extern const u32 gMonPalette_TANGELACREEPY[];
extern const u32 gMonBackPic_TANGELACREEPY[];
extern const u32 gMonShinyPalette_TANGELACREEPY[];
extern const u8 gMonFootprint_TANGELACREEPY[];
extern const u8 gMonIcon_TANGELACREEPY[];

// CHANSEY_BLANK
extern const u32 gMonFrontPic_CHANSEYBLANK[];
extern const u32 gMonPalette_CHANSEYBLANK[];
extern const u32 gMonBackPic_CHANSEYBLANK[];
extern const u32 gMonShinyPalette_CHANSEYBLANK[];
extern const u8 gMonFootprint_CHANSEYBLANK[];
extern const u8 gMonIcon_CHANSEYBLANK[];

// IRON_CLEFT_GREEN
extern const u32 gMonFrontPic_IRONCLEFTGREEN[];
extern const u32 gMonPalette_IRONCLEFTGREEN[];
extern const u32 gMonBackPic_IRONCLEFTGREEN[];
extern const u32 gMonShinyPalette_IRONCLEFTGREEN[];
extern const u8 gMonFootprint_IRONCLEFTGREEN[];
extern const u8 gMonIcon_IRONCLEFTGREEN[];

// LATIAS_BLAZIKEN
extern const u32 gMonFrontPic_LATIASBLAZIKEN[];
extern const u32 gMonPalette_LATIASBLAZIKEN[];
extern const u32 gMonBackPic_LATIASBLAZIKEN[];
extern const u32 gMonShinyPalette_LATIASBLAZIKEN[];
