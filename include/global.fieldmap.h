...
enum {
    ...
    PLAYER_AVATAR_STATE_SHINY_BIKE,
};
...
#define PLAYER_AVATAR_FLAG_SHINY_BIKE    (1 << PLAYER_AVATAR_STATE_SHINY_BIKE)
...
enum {
    ...
    PLAYER_AVATAR_GFX_BOX_CLOSED,
    PLAYER_AVATAR_GFX_BOX_OPEN,
    PLAYER_AVATAR_GFX_BIKE_SHINY,
};
