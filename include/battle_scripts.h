...
extern const u8 BattleScript_SingleMonDoubleBattleLost[];
...
extern const u8 BattleScript_DmgHazardsOngBank1[];
extern const u8 BattleScript_PerishSongTakesLife[];
extern const u8 BattleScript_PerishSongCountGoesDown[];
extern const u8 BattleScript_AllStatsUp[];
extern const u8 BattleScript_MaxAllStatsUp[];
...
extern const u8 BattleScript_ReflectBounce[];
...
extern const u8 BattleScript_SuccessBallThrowCastform[];
...
extern const u8 BattleScript_BallBouncedOff[];
extern const u8 BattleScript_CantCatchNoSnagMachine[];
