...
#define MB_UP_RIGHT_STAIR_WARP_BIKE 0x70
#define MB_UP_LEFT_STAIR_WARP_BIKE 0x71
#define MB_DOWN_RIGHT_STAIR_WARP_BIKE 0x70
#define MB_DOWN_LEFT_STAIR_WARP_BIKE 0x71

//
#define MB_UNION_ROOM_WARP 0x74
//
...
// sideways stairs
#define MB_SIDEWAYS_STAIRS_RIGHT_SIDE 0xA7
#define MB_SIDEWAYS_STAIRS_LEFT_SIDE 0xA8
#define MB_SIDEWAYS_STAIRS_RIGHT_SIDE_TOP 0xA9
#define MB_SIDEWAYS_STAIRS_LEFT_SIDE_TOP 0xAA
#define MB_SIDEWAYS_STAIRS_RIGHT_SIDE_BOTTOM 0xAB
#define MB_SIDEWAYS_STAIRS_LEFT_SIDE_BOTTOM 0xAC
//
#define MB_CYCLING_ROAD_PULL_DOWN 0xD0
#define MB_CYCLING_ROAD_PULL_DOWN_GRASS 0xD1
//
// CSR
#define MB_REFLECTIVE_FLOOR 0xD2
#define MB_POWER_PLANT_LIGHTS 0xD3
#define MB_MINNESOTA_MART 0xD4
#define MB_FALLING_OBJECT 0xD5
#define MB_GIRL_HOLE 0xD6
#define MB_FISHABLE_STATUE 0xD7
#define MB_PENCIL_STATUE 0xD8
#define MB_LUVDISC_TILE 0xD9
#define MB_LUVDISC_TILE_NORMAL 0xDA
#define MB_BLAINE_GYM 0xDB
#define MB_BROCK_ROCKS 0xDC
#define MB_POKEMONCENTER_TREE 0xDD
