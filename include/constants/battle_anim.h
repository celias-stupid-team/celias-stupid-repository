...
#define ANIM_TAG_STEALTH_ROCK               (ANIM_SPRITES_START + 289)
#define ANIM_TAG_CSR_CRAB                   (ANIM_SPRITES_START + 290)
#define ANIM_TAG_BEE                        (ANIM_SPRITES_START + 291)
#define ANIM_TAG_WATER_SHURIKEN             (ANIM_SPRITES_START + 292)
