...
#define ANIM_TAG_HERACROSS_HORN             (ANIM_SPRITES_START + 602)
#define ANIM_TAG_CHARIZARD                  (ANIM_SPRITES_START + 603)
#define ANIM_TAG_RAICHU_TAPE                (ANIM_SPRITES_START + 604)
#define ANIM_TAG_RAICHU_RAT                 (ANIM_SPRITES_START + 605)
#define ANIM_TAG_RAICHU_BOOTLEG             (ANIM_SPRITES_START + 606)
#define ANIM_TAG_LETS_GO                    (ANIM_SPRITES_START + 607)
#define ANIM_TAG_SPARROW                    (ANIM_SPRITES_START + 608)
#define ANIM_TAG_UMBRELLA                   (ANIM_SPRITES_START + 609)
#define ANIM_TAG_PARASOL                    (ANIM_SPRITES_START + 610)
#define ANIM_TAG_BOOTS                      (ANIM_SPRITES_START + 611)
#define ANIM_TAG_OAK                        (ANIM_SPRITES_START + 612)
#define ANIM_TAG_CAMERA_RETICLE             (ANIM_SPRITES_START + 613)
#define ANIM_TAG_STYLUS                     (ANIM_SPRITES_START + 614)
#define ANIM_TAG_TROZEI_HBOX                (ANIM_SPRITES_START + 615)
#define ANIM_TAG_TROZEI_RAICHU              (ANIM_SPRITES_START + 616)
#define ANIM_TAG_TROZEI_DAD                 (ANIM_SPRITES_START + 617)
#define ANIM_TAG_TROZEI_DIGLETTS            (ANIM_SPRITES_START + 618)
#define ANIM_TAG_TROZEI_TIME                (ANIM_SPRITES_START + 619)
#define ANIM_TAG_STYLER_DISC                (ANIM_SPRITES_START + 620)
#define ANIM_TAG_STYLER_WAND                (ANIM_SPRITES_START + 621)
#define ANIM_TAG_TRUMPET                    (ANIM_SPRITES_START + 622)
#define ANIM_TAG_MICROPHONE                 (ANIM_SPRITES_START + 623)
#define ANIM_TAG_CHANNELER                  (ANIM_SPRITES_START + 624)
#define ANIM_TAG_RAICHU_CONQUEST            (ANIM_SPRITES_START + 625)
#define ANIM_TAG_CONQUEST_ENERGY            (ANIM_SPRITES_START + 626)
#define ANIM_TAG_BRANCH                     (ANIM_SPRITES_START + 627)
#define ANIM_TAG_PHASE_SHIFT                (ANIM_SPRITES_START + 628)
#define ANIM_TAG_HIT_COUNT                  (ANIM_SPRITES_START + 629)
#define ANIM_TAG_LETTERS                    (ANIM_SPRITES_START + 630)
#define ANIM_TAG_BOX                        (ANIM_SPRITES_START + 631)
#define ANIM_TAG_SUDDEN_DEATH               (ANIM_SPRITES_START + 632)
#define ANIM_TAG_OH_NO                      (ANIM_SPRITES_START + 633)
#define ANIM_TAG_GRANDPA                    (ANIM_SPRITES_START + 634)
#define ANIM_TAG_RAPIDASH                   (ANIM_SPRITES_START + 635)
#define ANIM_TAG_BOBOMB                     (ANIM_SPRITES_START + 636)
#define ANIM_TAG_TCG_DRAIN                  (ANIM_SPRITES_START + 637)
#define ANIM_TAG_TCG_HEAL                   (ANIM_SPRITES_START + 638)
#define ANIM_TAG_BARVE_BOY_WALK             (ANIM_SPRITES_START + 639)
#define ANIM_TAG_BARVE_BOY_KICK             (ANIM_SPRITES_START + 640)
#define ANIM_TAG_MOMBAT                     (ANIM_SPRITES_START + 641)
#define ANIM_TAG_TCG_PC                     (ANIM_SPRITES_START + 642)
#define ANIM_TAG_HEEL                       (ANIM_SPRITES_START + 643)
#define ANIM_TAG_ARROW                      (ANIM_SPRITES_START + 644)
#define ANIM_TAG_FISHER                     (ANIM_SPRITES_START + 645)
#define ANIM_TAG_PONCHO                     (ANIM_SPRITES_START + 646)
#define ANIM_TAG_RAINCOAT                   (ANIM_SPRITES_START + 647)
#define ANIM_TAG_MEOWTH_REPORTER            (ANIM_SPRITES_START + 648)
#define ANIM_TAG_AZUMARILL                  (ANIM_SPRITES_START + 649)
#define ANIM_TAG_REPORT_TEXT                (ANIM_SPRITES_START + 650)
#define ANIM_TAG_UNITE_RIGHT_STICK          (ANIM_SPRITES_START + 651)
#define ANIM_TAG_UNITE_HUD                  (ANIM_SPRITES_START + 652)
#define ANIM_TAG_DETECTIVE_HAT              (ANIM_SPRITES_START + 653)
#define ANIM_TAG_DETECTIVE_PIPE             (ANIM_SPRITES_START + 654)
#define ANIM_TAG_BOTTLE                     (ANIM_SPRITES_START + 655)
#define ANIM_TAG_POKEPARK_HUD               (ANIM_SPRITES_START + 656)
#define ANIM_TAG_RAICHU_SURF                (ANIM_SPRITES_START + 657)
#define ANIM_TAG_NICE_RAT                   (ANIM_SPRITES_START + 658)
#define ANIM_TAG_TCG_TEN                    (ANIM_SPRITES_START + 659)
#define ANIM_TAG_RAICHU_STEEL_RAT           (ANIM_SPRITES_START + 660)
#define ANIM_TAG_SHEER_GOLD                 (ANIM_SPRITES_START + 661)
#define ANIM_TAG_SRAICHE                    (ANIM_SPRITES_START + 662)
#define ANIM_TAG_POND                       (ANIM_SPRITES_START + 663)
#define ANIM_TAG_GILLOTINE                  (ANIM_SPRITES_START + 664)
#define ANIM_TAG_RAICHU_HAT                 (ANIM_SPRITES_START + 665)
#define ANIM_TAG_ANGRY_EMOJI                (ANIM_SPRITES_START + 666)
#define ANIM_TAG_RAICHU_SITTING             (ANIM_SPRITES_START + 667)
#define ANIM_TAG_RAICHU_MINI                (ANIM_SPRITES_START + 668)
#define ANIM_TAG_RAICHU_CAFE                (ANIM_SPRITES_START + 669)
#define ANIM_TAG_BRICK_WALL                 (ANIM_SPRITES_START + 670)
#define ANIM_TAG_SPARKLE_ON                 (ANIM_SPRITES_START + 671)
#define ANIM_TAG_TOOTHBRUSH                 (ANIM_SPRITES_START + 672)
#define ANIM_TAG_TOOTH                      (ANIM_SPRITES_START + 673)
#define ANIM_TAG_IPHONE                     (ANIM_SPRITES_START + 674)
#define ANIM_TAG_CUP                        (ANIM_SPRITES_START + 675)
#define ANIM_TAG_MEDIUM                     (ANIM_SPRITES_START + 676)
#define ANIM_TAG_CYNTHIA                    (ANIM_SPRITES_START + 677)
...
#define BG_MANGA 43
#define BG_LUIN 44
#define BG_SKY_TOWER 45
#define BG_UNITE_HUD 46
#define BG_CATASTROPHE 47
#define BG_GOLD 48
