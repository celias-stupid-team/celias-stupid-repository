...
extern const u8 gText_OdorSleuthFieldMove[];
...
extern const u8 gText_GoCheckOutTheShore[];
...
extern const u8 gText_DexCategory_FirstBadgePkmn[];
extern const u8 gText_DexCategory_SecondBadgePkmn[];
extern const u8 gText_DexCategory_ThirdBadgePkmn[];
extern const u8 gText_DexCategory_FourthBadgePkmn[];
extern const u8 gText_DexCategory_FifthBadgePkmn[];
extern const u8 gText_DexCategory_SixthBadgePkmn[];
extern const u8 gText_DexCategory_SeventhBadgePkmn[];
extern const u8 gText_DexCategory_FinalBadgePkmn[];
...
extern const u8 gText_PokeSum_ApparentlyFatefulEncounterHatched_FreeShiny[];
extern const u8 gText_PokeSum_ApparentlyMet[];
extern const u8 gText_PokeSum_ApparentlyMet_FreeShiny[];
