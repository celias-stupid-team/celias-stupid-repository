...
static const u8 sDoorAnimTiles_Fushcia[] = INCBIN_U8("graphics/door_anims/fushcia.4bpp");
...
static const u8 sDoorAnimTiles_Lighthouse[] = INCBIN_U8("graphics/door_anims/lighthouse_door.4bpp");
...
static const u8 sDoorAnimPalettes_Fushcia[] = {8, 8, 8, 8, 8, 8, 8, 8};
...
/*  Below was presumably intended for the door to the Pokemon Fan Club. The metatile is surrounded by metatiles for the fan club building.
    ...
    {METATILE_FushciaCity_Door,                            DOOR_SOUND_NORMAL,  DOOR_SIZE_1x1, sDoorAnimTiles_Fushcia, sDoorAnimPalettes_Fushcia},
    {METATILE_FushciaCity_SafariZoneDoor,                  DOOR_SOUND_SLIDING, DOOR_SIZE_1x1, sDoorAnimTiles_SafariZone, sDoorAnimPalettes_SafariZone},
