...
const u8 *const gMonIconTable[] = {
	...
	[SPECIES_MIME_JR_]   = gMonIcon_Mime_Jr_,
	...
	[SPECIES_JIGGLYPUFF_ABOVE]   = gMonIcon_Jigglypuff_Above,
	[SPECIES_TENTAQUIL]   = gMonIcon_Tentaquil,
	[SPECIES_MISSINGNO]   = gMonIcon_Missingno,
	[SPECIES_KENYA]   = gMonIcon_Kenya,
	[SPECIES_HITMONCHAN_SHIT]   = gMonIcon_Hitmonchan_Shit,
	[SPECIES_HITMONCHIN]   = gMonIcon_Hitmonchin,
	[SPECIES_TRUBBISH_HAIRCUT]   = gMonIcon_Trubbish_Haircut,
	[SPECIES_AMPHAROS_MEGA]   = gMonIcon_Ampharos_Mega,
	[SPECIES_YOSHI]   = gMonIcon_Yoshi,
	[SPECIES_DITTO_MEW]   = gMonIcon_Ditto_Mew,
	[SPECIES_UNOWN_LOSS]   = gMonIcon_Unown_Loss,
	[SPECIES_MAGNALONE]   = gMonIcon_Magnalone,
	[SPECIES_TYRANASTAR]   = gMonIcon_Tyranastar,
	[SPECIES_POKEMON_GUN]   = gMonIcon_Pokemon_Gun,
	[SPECIES_PLUG_OINK]   = gMonIcon_Plug_Oink,
	[SPECIES_PIKABLU]   = gMonIcon_Pikablu,
	[SPECIES_RATTATA_SHINY]   = gMonIcon_Rattata_Shiny,
	[SPECIES_PIKACHU_BIRTHDAY]   = gMonIcon_Pikachu_Birthday,
	[SPECIES_MEW_ANCIENT]   = gMonIcon_Mew_Ancient,
	[SPECIES_PIKACHU_OLD]   = gMonIcon_Pikachu_Old,
	[SPECIES_GENESECT_SHINY]   = gMonIcon_Genesect_Shiny,
	[SPECIES_IRON_CLEFT]   = gMonIcon_Iron_Cleft,
	[SPECIES_VULPIX_ALOLA]   = gMonIcon_Vulpix_Alola,
	[SPECIES_WEEZING_ALOLA]   = gMonIcon_Weezing_Alola,
	[SPECIES_THIS_GUY]   = gMonIcon_This_Guy,
	[SPECIES_STEAMBOAT_WILLIE]   = gMonIcon_Steamboat_Willie,
	[SPECIES_PIDGEOT_OLD]   = gMonIcon_Pidgeot_Old,
	[SPECIES_STRYKE]   = gMonIcon_Stryke,
	[SPECIES_BUTTERFREE_FEMALE]   = gMonIcon_Butterfree_Female,
	[SPECIES_PIKACHU_FAT_GAY]   = gMonIcon_Pikachu_Fat_Gay,
	[SPECIES_TRAPINCH_PIKACHU]   = gMonIcon_Trapinch_Pikachu,
	[SPECIES_KECLEON_SANS]   = gMonIcon_Kecleon_Sans,
	//[SPECIES_RATTATA_SHINY]   = gMonIcon_Rattata_Shiny,
	[SPECIES_PORYGON_16]   = gMonIcon_Porygon_16,
	[SPECIES_PORYGON_8]   = gMonIcon_Porygon_8,
	[SPECIES_PORYGON_4]   = gMonIcon_Porygon_4,
	[SPECIES_PORIST_GAMES]   = gMonIcon_Porist_Games,
	[SPECIES_MISCARRIAGE_KANGA]   = gMonIcon_Miscarriage_Kanga,
	[SPECIES_GHOST]   = gMonIcon_Ghost,
	[SPECIES_VENOMOTH_ATV]   = gMonIcon_Venomoth_ATV,
	[SPECIES_RATICATE_ALOLA]   = gMonIcon_Raticate_Alola,
	[SPECIES_MULTIPAL]   = gMonIcon_Multipal,
	[SPECIES_DIVIDUM]   = gMonIcon_Dividum,
	[SPECIES_EXPONELLE]   = gMonIcon_Exponelle,
	[SPECIES_PIKACHU_SNAP_SURF]   = gMonIcon_Pikachu_Snap_Surf,
	[SPECIES_PIKACHU_SNAP_BALL]   = gMonIcon_Pikachu_Snap_Ball,
	[SPECIES_PIKACHU_SNAP_FLYING]   = gMonIcon_Pikachu_Snap_Flying,
	[SPECIES_PIKACHU_SNAP_CLOSE]   = gMonIcon_Pikachu_Snap_Close,
	[SPECIES_RATICATE_DEAD]   = gMonIcon_Raticate_Dead,
	[SPECIES_SHEDINJA_ELECTRIC]   = gMonIcon_Shedinja_Electric,
	[SPECIES_VENUSAUR_MEGA]   = gMonIcon_Digimon,
	[SPECIES_UNOWN_NUDES]   = gMonIcon_Unown_Nudes,
	[SPECIES_PORYGON22]   = gMonIcon_Porygon22,
	[SPECIES_HO_OWO]   = gMonIcon_Ho_OwO,
	[SPECIES_RATATATTA]   = gMonIcon_Ratatatta,
	[SPECIES_BULBASAUR_POKERAP]   = gMonIcon_Bulbasaur_POKERAP,
	[SPECIES_IVYSAUR_POKERAP]   = gMonIcon_Ivysaur_POKERAP,
	[SPECIES_VENUSAUR_POKERAP]   = gMonIcon_Venusaur_POKERAP,
	[SPECIES_CHARMANDER_POKERAP]   = gMonIcon_Charmander_POKERAP,
	[SPECIES_CHARMELEON_POKERAP]   = gMonIcon_Charmeleon_POKERAP,
	[SPECIES_CHARIZARD_POKERAP]   = gMonIcon_Charizard_POKERAP,
	[SPECIES_SQUIRTLE_POKERAP]   = gMonIcon_Squirtle_POKERAP,
	[SPECIES_WARTORTLE_POKERAP]   = gMonIcon_Wartortle_POKERAP,
	[SPECIES_BLASTOISE_POKERAP]   = gMonIcon_Blastoise_POKERAP,
	[SPECIES_CATERPIE_POKERAP]   = gMonIcon_Caterpie_POKERAP,
	[SPECIES_METAPOD_POKERAP]   = gMonIcon_Metapod_POKERAP,
	[SPECIES_BUTTERFREE_POKERAP]   = gMonIcon_Butterfree_POKERAP,
	[SPECIES_WEEDLE_POKERAP]   = gMonIcon_Weedle_POKERAP,
	[SPECIES_KAKUNA_POKERAP]   = gMonIcon_Kakuna_POKERAP,
	[SPECIES_BEEDRILL_POKERAP]   = gMonIcon_Beedrill_POKERAP,
	[SPECIES_PIDGEY_POKERAP]   = gMonIcon_Pidgey_POKERAP,
	[SPECIES_PIDGEOTTO_POKERAP]   = gMonIcon_Pidgeotto_POKERAP,
	[SPECIES_PIDGEOT_POKERAP]   = gMonIcon_Pidgeot_POKERAP,
	[SPECIES_RATTATA_POKERAP]   = gMonIcon_Rattata_POKERAP,
	[SPECIES_RATICATE_POKERAP]   = gMonIcon_Raticate_POKERAP,
	[SPECIES_SPEAROW_POKERAP]   = gMonIcon_Spearow_POKERAP,
	[SPECIES_FEAROW_POKERAP]   = gMonIcon_Fearow_POKERAP,
	[SPECIES_EKANS_POKERAP]   = gMonIcon_Ekans_POKERAP,
	[SPECIES_ARBOK_POKERAP]   = gMonIcon_Arbok_POKERAP,
	[SPECIES_PIKACHU_POKERAP]   = gMonIcon_Pikachu_POKERAP,
	[SPECIES_RAICHU_POKERAP]   = gMonIcon_Raichu_POKERAP,
	[SPECIES_SANDSHREW_POKERAP]   = gMonIcon_Sandshrew_POKERAP,
	[SPECIES_SANDSLASH_POKERAP]   = gMonIcon_Sandslash_POKERAP,
	[SPECIES_NIDORINA_POKERAP]   = gMonIcon_Nidorina_POKERAP,
	[SPECIES_NIDOQUEEN_POKERAP]   = gMonIcon_Nidoqueen_POKERAP,
	[SPECIES_NIDORINO_POKERAP]   = gMonIcon_Nidorino_POKERAP,
	[SPECIES_NIDOKING_POKERAP]   = gMonIcon_Nidoking_POKERAP,
	[SPECIES_CLEFAIRY_POKERAP]   = gMonIcon_Clefairy_POKERAP,
	[SPECIES_CLEFABLE_POKERAP]   = gMonIcon_Clefable_POKERAP,
	[SPECIES_VULPIX_POKERAP]   = gMonIcon_Vulpix_POKERAP,
	[SPECIES_NINETALES_POKERAP]   = gMonIcon_Ninetales_POKERAP,
	[SPECIES_JIGGLYPUFF_POKERAP]   = gMonIcon_Jigglypuff_POKERAP,
	[SPECIES_WIGGLYTUFF_POKERAP]   = gMonIcon_Wigglytuff_POKERAP,
	[SPECIES_ZUBAT_POKERAP]   = gMonIcon_Zubat_POKERAP,
	[SPECIES_GOLBAT_POKERAP]   = gMonIcon_Golbat_POKERAP,
	[SPECIES_ODDISH_POKERAP]   = gMonIcon_Oddish_POKERAP,
	[SPECIES_GLOOM_POKERAP]   = gMonIcon_Gloom_POKERAP,
	[SPECIES_VILEPLUME_POKERAP]   = gMonIcon_Vileplume_POKERAP,
	[SPECIES_PARAS_POKERAP]   = gMonIcon_Paras_POKERAP,
	[SPECIES_PARASECT_POKERAP]   = gMonIcon_Parasect_POKERAP,
	[SPECIES_VENONAT_POKERAP]   = gMonIcon_Venonat_POKERAP,
	[SPECIES_VENOMOTH_POKERAP]   = gMonIcon_Venomoth_POKERAP,
	[SPECIES_DIGLETT_POKERAP]   = gMonIcon_Diglett_POKERAP,
	[SPECIES_DUGTRIO_POKERAP]   = gMonIcon_Dugtrio_POKERAP,
	[SPECIES_MEOWTH_POKERAP]   = gMonIcon_Meowth_POKERAP,
	[SPECIES_PERSIAN_POKERAP]   = gMonIcon_Persian_POKERAP,
	[SPECIES_PSYDUCK_POKERAP]   = gMonIcon_Psyduck_POKERAP,
	[SPECIES_GOLDUCK_POKERAP]   = gMonIcon_Golduck_POKERAP,
	[SPECIES_MANKEY_POKERAP]   = gMonIcon_Mankey_POKERAP,
	[SPECIES_PRIMEAPE_POKERAP]   = gMonIcon_Primeape_POKERAP,
	[SPECIES_GROWLITHE_POKERAP]   = gMonIcon_Growlithe_POKERAP,
	[SPECIES_ARCANINE_POKERAP]   = gMonIcon_Arcanine_POKERAP,
	[SPECIES_POLIWAG_POKERAP]   = gMonIcon_Poliwag_POKERAP,
	[SPECIES_POLIWHIRL_POKERAP]   = gMonIcon_Poliwhirl_POKERAP,
	[SPECIES_POLIWRATH_POKERAP]   = gMonIcon_Poliwrath_POKERAP,
	[SPECIES_ABRA_POKERAP]   = gMonIcon_Abra_POKERAP,
	[SPECIES_KADABRA_POKERAP]   = gMonIcon_Kadabra_POKERAP,
	[SPECIES_ALAKAZAM_POKERAP]   = gMonIcon_Alakazam_POKERAP,
	[SPECIES_MACHOP_POKERAP]   = gMonIcon_Machop_POKERAP,
	[SPECIES_MACHOKE_POKERAP]   = gMonIcon_Machoke_POKERAP,
	[SPECIES_MACHAMP_POKERAP]   = gMonIcon_Machamp_POKERAP,
	[SPECIES_BELLSPROUT_POKERAP]   = gMonIcon_Bellsprout_POKERAP,
	[SPECIES_WEEPINBELL_POKERAP]   = gMonIcon_Weepinbell_POKERAP,
	[SPECIES_VICTREEBEL_POKERAP]   = gMonIcon_Victreebel_POKERAP,
	[SPECIES_TENTACOOL_POKERAP]   = gMonIcon_Tentacool_POKERAP,
	[SPECIES_TENTACRUEL_POKERAP]   = gMonIcon_Tentacruel_POKERAP,
	[SPECIES_GEODUDE_POKERAP]   = gMonIcon_Geodude_POKERAP,
	[SPECIES_GRAVELER_POKERAP]   = gMonIcon_Graveler_POKERAP,
	[SPECIES_GOLEM_POKERAP]   = gMonIcon_Golem_POKERAP,
	[SPECIES_PONYTA_POKERAP]   = gMonIcon_Ponyta_POKERAP,
	[SPECIES_RAPIDASH_POKERAP]   = gMonIcon_Rapidash_POKERAP,
	[SPECIES_SLOWPOKE_POKERAP]   = gMonIcon_Slowpoke_POKERAP,
	[SPECIES_SLOWBRO_POKERAP]   = gMonIcon_Slowbro_POKERAP,
	[SPECIES_MAGNEMITE_POKERAP]   = gMonIcon_Magnemite_POKERAP,
	[SPECIES_MAGNETON_POKERAP]   = gMonIcon_Magneton_POKERAP,
	[SPECIES_FARFETCHD_POKERAP]   = gMonIcon_Farfetchd_POKERAP,
	[SPECIES_DODUO_POKERAP]   = gMonIcon_Doduo_POKERAP,
	[SPECIES_DODRIO_POKERAP]   = gMonIcon_Dodrio_POKERAP,
	[SPECIES_SEEL_POKERAP]   = gMonIcon_Seel_POKERAP,
	[SPECIES_DEWGONG_POKERAP]   = gMonIcon_Dewgong_POKERAP,
	[SPECIES_GRIMER_POKERAP]   = gMonIcon_Grimer_POKERAP,
	[SPECIES_MUK_POKERAP]   = gMonIcon_Muk_POKERAP,
	[SPECIES_SHELLDER_POKERAP]   = gMonIcon_Shellder_POKERAP,
	[SPECIES_CLOYSTER_POKERAP]   = gMonIcon_Cloyster_POKERAP,
	[SPECIES_GASTLY_POKERAP]   = gMonIcon_Gastly_POKERAP,
	[SPECIES_HAUNTER_POKERAP]   = gMonIcon_Haunter_POKERAP,
	[SPECIES_GENGAR_POKERAP]   = gMonIcon_Gengar_POKERAP,
	[SPECIES_ONIX_POKERAP]   = gMonIcon_Onix_POKERAP,
	[SPECIES_DROWZEE_POKERAP]   = gMonIcon_Drowzee_POKERAP,
	[SPECIES_HYPNO_POKERAP]   = gMonIcon_Hypno_POKERAP,
	[SPECIES_KRABBY_POKERAP]   = gMonIcon_Krabby_POKERAP,
	[SPECIES_KINGLER_POKERAP]   = gMonIcon_Kingler_POKERAP,
	[SPECIES_VOLTORB_POKERAP]   = gMonIcon_Voltorb_POKERAP,
	[SPECIES_ELECTRODE_POKERAP]   = gMonIcon_Electrode_POKERAP,
	[SPECIES_EXEGGCUTE_POKERAP]   = gMonIcon_Exeggcute_POKERAP,
	[SPECIES_EXEGGUTOR_POKERAP]   = gMonIcon_Exeggutor_POKERAP,
	[SPECIES_CUBONE_POKERAP]   = gMonIcon_Cubone_POKERAP,
	[SPECIES_MAROWAK_POKERAP]   = gMonIcon_Marowak_POKERAP,
	[SPECIES_HITMONLEE_POKERAP]   = gMonIcon_Hitmonlee_POKERAP,
	[SPECIES_HITMONCHAN_POKERAP]   = gMonIcon_Hitmonchan_POKERAP,
	[SPECIES_LICKITUNG_POKERAP]   = gMonIcon_Lickitung_POKERAP,
	[SPECIES_KOFFING_POKERAP]   = gMonIcon_Koffing_POKERAP,
	[SPECIES_WEEZING_POKERAP]   = gMonIcon_Weezing_POKERAP,
	[SPECIES_RHYHORN_POKERAP]   = gMonIcon_Rhyhorn_POKERAP,
	[SPECIES_RHYDON_POKERAP]   = gMonIcon_Rhydon_POKERAP,
	[SPECIES_CHANSEY_POKERAP]   = gMonIcon_Chansey_POKERAP,
	[SPECIES_TANGELA_POKERAP]   = gMonIcon_Tangela_POKERAP,
	[SPECIES_KANGASKHAN_POKERAP]   = gMonIcon_Kangaskhan_POKERAP,
	[SPECIES_HORSEA_POKERAP]   = gMonIcon_Horsea_POKERAP,
	[SPECIES_SEADRA_POKERAP]   = gMonIcon_Seadra_POKERAP,
	[SPECIES_GOLDEEN_POKERAP]   = gMonIcon_Goldeen_POKERAP,
	[SPECIES_SEAKING_POKERAP]   = gMonIcon_Seaking_POKERAP,
	[SPECIES_STARYU_POKERAP]   = gMonIcon_Staryu_POKERAP,
	[SPECIES_STARMIE_POKERAP]   = gMonIcon_Starmie_POKERAP,
	[SPECIES_MRMIME_POKERAP]   = gMonIcon_MrMime_POKERAP,
	[SPECIES_SCYTHER_POKERAP]   = gMonIcon_Scyther_POKERAP,
	[SPECIES_JYNX_POKERAP]   = gMonIcon_Jynx_POKERAP,
	[SPECIES_ELECTABUZZ_POKERAP]   = gMonIcon_Electabuzz_POKERAP,
	[SPECIES_MAGMAR_POKERAP]   = gMonIcon_Magmar_POKERAP,
	[SPECIES_PINSIR_POKERAP]   = gMonIcon_Pinsir_POKERAP,
	[SPECIES_TAUROS_POKERAP]   = gMonIcon_Tauros_POKERAP,
	[SPECIES_MAGIKARP_POKERAP]   = gMonIcon_Magikarp_POKERAP,
	[SPECIES_GYARADOS_POKERAP]   = gMonIcon_Gyarados_POKERAP,
	[SPECIES_LAPRAS_POKERAP]   = gMonIcon_Lapras_POKERAP,
	[SPECIES_DITTO_POKERAP]   = gMonIcon_Ditto_POKERAP,
	[SPECIES_EEVEE_POKERAP]   = gMonIcon_Eevee_POKERAP,
	[SPECIES_VAPOREON_POKERAP]   = gMonIcon_Vaporeon_POKERAP,
	[SPECIES_JOLTEON_POKERAP]   = gMonIcon_Jolteon_POKERAP,
	[SPECIES_FLAREON_POKERAP]   = gMonIcon_Flareon_POKERAP,
	[SPECIES_PORYGON_POKERAP]   = gMonIcon_Porygon_POKERAP,
	[SPECIES_OMANYTE_POKERAP]   = gMonIcon_Omanyte_POKERAP,
	[SPECIES_OMASTAR_POKERAP]   = gMonIcon_Omastar_POKERAP,
	[SPECIES_KABUTO_POKERAP]   = gMonIcon_Kabuto_POKERAP,
	[SPECIES_KABUTOPS_POKERAP]   = gMonIcon_Kabutops_POKERAP,
	[SPECIES_AERODACTYL_POKERAP]   = gMonIcon_Aerodactyl_POKERAP,
	[SPECIES_SNORLAX_POKERAP]   = gMonIcon_Snorlax_POKERAP,
	[SPECIES_ARTICUNO_POKERAP]   = gMonIcon_Articuno_POKERAP,
	[SPECIES_ZAPDOS_POKERAP]   = gMonIcon_Zapdos_POKERAP,
	[SPECIES_MOLTRES_POKERAP]   = gMonIcon_Moltres_POKERAP,
	[SPECIES_DRATINI_POKERAP]   = gMonIcon_Dratini_POKERAP,
...
const u8 gMonIconPaletteIndices[] = {
    ...
    [SPECIES_TRUBBISH_HAIRCUT] = 2,
    [SPECIES_HITMONCHIN] = 0,
    [SPECIES_DACHSBUN] = 0,
    [SPECIES_ORTHWORM] = 0,
    [SPECIES_TYRANASTAR] = 1,
    [SPECIES_YANMEGA] = 1,
    [SPECIES_GENESECT] = 2,
    [SPECIES_PHIONE] = 0,
    [SPECIES_ETERNATUS] = 0,
