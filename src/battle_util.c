...
{//                   Defender -->                                                                                                                                                                                                                                                                                                                                                                                          GrassTCG's resists are 0.2x
	...
	[TYPE_GRASS_TCG]   = {	______, 	X(2.0), 	______, 	______, 	X(0.5), 	______, 	______, 	X(0.5), 	______, 	______, 	______, 	______, 	______, 	______, 	______, 	X(2.0), 	______, 	______, 	X(0.5), 	______, 	X(0.5), 	X(2.0), 	______, 	X(0.0), 	______, 	______, 	______, 	______, 	______, 	______, 	______, 	______, 	______, 	X(2.0) 	},
