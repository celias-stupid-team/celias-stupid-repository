...
bool8 DoesHealLocationSkipCutscene(void) {
    ...
    static const u32 HealLocationsWithoutCutscene[] = 
    {
        ...
        HEAL_LOCATION_MINNESOTA,
        HEAL_LOCATION_AETHER_PARADISE_ENTRANCE,
        HEAL_LOCATION_GREAT_SEA_PIRATE_BAY,
        HEAL_LOCATION_ONE_ISLAND_KINDLE_ROAD,
        HEAL_LOCATION_SILPH_CO_11F,
        HEAL_LOCATION_SSANNE_KITCHEN,
        HEAL_LOCATION_VIRIDIAN_GYM_BLAINE,
        HEAL_LOCATION_VIRIDIAN_GYM_DMCA_BROCK,
        HEAL_LOCATION_VIRIDIAN_GYM_ERIKA,
        HEAL_LOCATION_VIRIDIAN_GYM_FALKNER,
        HEAL_LOCATION_VIRIDIAN_GYM_KOGA,
        HEAL_LOCATION_VIRIDIAN_GYM_MISTY,
        HEAL_LOCATION_VIRIDIAN_GYM_SABRINA,
