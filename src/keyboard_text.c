...
const u8 gText_EasyChatKeyboard_TUVWX_Z[] = _("{CLEAR 11}T{CLEAR 6}U{CLEAR 6}V{CLEAR 26}W{CLEAR 6}X{CLEAR 6} {CLEAR 6}Z{CLEAR 26} ");
...
const u8 gText_NamingScreenKeyboard_tuvwxz[] = _("{CLEAR 12}t{CLEAR 6}u{CLEAR 6}v{CLEAR 26}w{CLEAR 6}x{CLEAR 6} {CLEAR 6}z{CLEAR 26} ");
const u8 gText_NamingScreenKeyboard_ABCDEF[] = _("{CLEAR 11}A{CLEAR 6}B{CLEAR 6}C{CLEAR 26}D{CLEAR 6}E{CLEAR 6}F{CLEAR 6} {CLEAR 26}.");
...
const u8 gText_NamingScreenKeyboard_TUVWXZ[] = _("{CLEAR 11}T{CLEAR 6}U{CLEAR 6}V{CLEAR 26}W{CLEAR 6}X{CLEAR 6} {CLEAR 6}Z{CLEAR 26} ");
