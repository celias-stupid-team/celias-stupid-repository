...
#define OBJ_EVENT_PAL_TAG_LOOKER                0x1130
#define OBJ_EVENT_PAL_TAG_AMPHAROS                0x1131
#define OBJ_EVENT_PAL_TAG_BRANDON                0x1132
#define OBJ_EVENT_PAL_TAG_GRETA                0x1133
#define OBJ_EVENT_PAL_TAG_ANABEL                0x1134
#define OBJ_EVENT_PAL_TAG_CURTAIN                0x1135
#define OBJ_EVENT_PAL_TAG_BUFF_OAK                0x1136
...
#define OBJ_EVENT_PAL_TAG_SHELGON  0x113B
#define OBJ_EVENT_PAL_TAG_VICTINI_NEW  0x113C
#define OBJ_EVENT_PAL_TAG_ORTHWORM_RISES  0x113D
#define OBJ_EVENT_PAL_TAG_RATICATE  0x113E
#define OBJ_EVENT_PAL_TAG_SHRINE  0x113F
#define OBJ_EVENT_PAL_TAG_GEN4_STATUE  0x1140
#define OBJ_EVENT_PAL_TAG_MESPRIT  0x1141
#define OBJ_EVENT_PAL_TAG_MESPRIT_2  0x1142
#define OBJ_EVENT_PAL_TAG_DUNG_BEETLE  0x1143
#define OBJ_EVENT_PAL_TAG_ABSOL_2  0x1144
#define OBJ_EVENT_PAL_TAG_PETREL_2  0x1145
#define OBJ_EVENT_PAL_TAG_BRICKWALL  0x1146
...
#define OBJ_EVENT_PAL_TAG_COPPERAJAH  0x1150
#define OBJ_EVENT_PAL_TAG_STARLIGHT  0x1151
#define OBJ_EVENT_PAL_TAG_LICHEN  0x1152
#define OBJ_EVENT_PAL_TAG_GALAR_OAK  0x1153
#define OBJ_EVENT_PAL_TAG_MOLTRES_STATUE  0x1154
...
#define OBJ_EVENT_PAL_TAG_GTS_AIDE  0x11C6
...
#define OBJ_EVENT_PAL_TAG_DRACULA  0x11DA
#define OBJ_EVENT_PAL_TAG_WEREWOLF  0x11DB
#define OBJ_EVENT_PAL_TAG_GAY_1  0x11DC
#define OBJ_EVENT_PAL_TAG_GOLDEEN  0x11DD
...
#define OBJ_EVENT_PAL_TAG_GUNLESSTHER  0x11E8
#define OBJ_EVENT_PAL_TAG_GUNTHER_BODY  0x11E9
#define OBJ_EVENT_PAL_TAG_CIRCUMCISION  0x11EA
...
static const struct SpritePalette sObjectEventSpritePalettes[] = {
    ...
    {gObjectEventPal_RSGentleman,             OBJ_EVENT_PAL_TAG_RS_GENTLEMAN},
    ...
    {gObjectEventPal_Curtain,             OBJ_EVENT_PAL_TAG_CURTAIN},
    ...
    {gObjectEventPal_victini_new,             OBJ_EVENT_PAL_TAG_VICTINI_NEW},
    {gObjectEventPal_orthworm_rises,             OBJ_EVENT_PAL_TAG_ORTHWORM_RISES},
    {gObjectEventPal_raticate,             OBJ_EVENT_PAL_TAG_RATICATE},
    {gObjectEventPal_shrine,             OBJ_EVENT_PAL_TAG_SHRINE},
    {gObjectEventPal_gen4_statue,             OBJ_EVENT_PAL_TAG_GEN4_STATUE},
    {gObjectEventPal_mesprit,             OBJ_EVENT_PAL_TAG_MESPRIT},
    {gObjectEventPal_mesprit_2,             OBJ_EVENT_PAL_TAG_MESPRIT_2},
    {gObjectEventPal_dung_beetle,             OBJ_EVENT_PAL_TAG_DUNG_BEETLE},
    {gObjectEventPal_absol_2,             OBJ_EVENT_PAL_TAG_ABSOL_2},
    {gObjectEventPal_petrel_2,             OBJ_EVENT_PAL_TAG_PETREL_2},
    {gObjectEventPal_Brick_Wall,             OBJ_EVENT_PAL_TAG_BRICKWALL},
    ...
    {gObjectEventPal_copperajah,             OBJ_EVENT_PAL_TAG_COPPERAJAH},
    {gObjectEventPal_starlight,             OBJ_EVENT_PAL_TAG_STARLIGHT},
    {gObjectEventPal_lichen,             OBJ_EVENT_PAL_TAG_LICHEN},
    {gObjectEventPal_galar_oak,             OBJ_EVENT_PAL_TAG_GALAR_OAK},
    {gObjectEventPal_moltres_statue,             OBJ_EVENT_PAL_TAG_MOLTRES_STATUE},
    ...
    {gObjectEventPal_GTS_AIDE,             OBJ_EVENT_PAL_TAG_GTS_AIDE},
    ...
    {gObjectEventPal_DRACULA,             OBJ_EVENT_PAL_TAG_DRACULA},
    {gObjectEventPal_WEREWOLF,             OBJ_EVENT_PAL_TAG_WEREWOLF},
    {gObjectEventPal_GAY_1,             OBJ_EVENT_PAL_TAG_GAY_1},
    ...
    {gObjectEventPal_GUNLESSTHER,             OBJ_EVENT_PAL_TAG_GUNLESSTHER},
    {gObjectEventPal_GUNTHER_BODY,             OBJ_EVENT_PAL_TAG_GUNTHER_BODY},
    {gObjectEventPal_CIRCUMCISION,             OBJ_EVENT_PAL_TAG_CIRCUMCISION},
...
u8 GetSidewaysStairsCollision(struct ObjectEvent *objectEvent, u8 dir, u8 currentBehavior, u8 nextBehavior, u8 collision)
{
    ...
    if (MetatileBehavior_IsWater(nextBehavior))
        return collision;
...
u8 GetVanillaCollision(struct ObjectEvent *objectEvent, s16 x, s16 y, u32 dir)
{
    u8 direction = dir;
...
static u8 TryUpdateMovementActionOnStairs(struct ObjectEvent *objectEvent, u8 movementActionId)
{
    ...
    if (!PlayerIsMovingOnRockStairs(objectEvent, objectEvent->movementDirection))
...
{                                                   \
    ...
    if (direction > sizeof(table)) direction = DIR_NONE; \
...
{
    // may need something here for sideways stairs?
