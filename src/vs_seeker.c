...
static const struct RematchData sRematches[] = {
   { {TRAINER_YOUNGSTER_LEE, TRAINER_YOUNGSTER_LEE, SKIP, TRAINER_YOUNGSTER_LEE, TRAINER_YOUNGSTER_LEE}, MAP(MAP_ROUTE3) },
   { {TRAINER_YOUNGSTER_CALVIN, TRAINER_YOUNGSTER_CALVIN}, MAP(MAP_ROUTE3) },
   { {TRAINER_BUG_CATCHER_COLTON, TRAINER_BUG_CATCHER_COLTON, SKIP, TRAINER_BUG_CATCHER_COLTON, SKIP, TRAINER_BUG_CATCHER_COLTON},
      MAP(MAP_ROUTE3) },
   { {TRAINER_BUG_CATCHER_GREG, TRAINER_BUG_CATCHER_GREG},
      MAP(MAP_ROUTE3) },
   { {TRAINER_BUG_CATCHER_JAMES, TRAINER_BUG_CATCHER_JAMES},
      MAP(MAP_ROUTE3) },
   { {TRAINER_LASS_JANICE, TRAINER_LASS_JANICE, SKIP, TRAINER_LASS_JANICE},
      MAP(MAP_ROUTE3) },
   { {TRAINER_LASS_SALLY, TRAINER_LASS_SALLY},
      MAP(MAP_ROUTE3) },
   { {TRAINER_GENTLEMAN_FALKNERSR, TRAINER_GENTLEMAN_FALKNERSR},
      MAP(MAP_ROUTE3) },
   { {TRAINER_PICKNICKER_MEWTWO, TRAINER_PICKNICKER_MEWTWO},
      MAP(MAP_ROUTE4) },
   { {TRAINER_YOUNGSTER_TIMMY, TRAINER_YOUNGSTER_TIMMY, SKIP, TRAINER_YOUNGSTER_TIMMY, SKIP, TRAINER_YOUNGSTER_TIMMY},
      MAP(MAP_ROUTE24) },
   { {TRAINER_BUG_CATCHER_CALE, TRAINER_BUG_CATCHER_CALE},
      MAP(MAP_ROUTE24) },
   { {TRAINER_CHAMPION_KOTONE, TRAINER_CHAMPION_KOTONE, SKIP, TRAINER_CHAMPION_KOTONE},
      MAP(MAP_ROUTE24) },
   { {TRAINER_CHAMPION_RAY_RIZZO, TRAINER_CHAMPION_RAY_RIZZO},
      MAP(MAP_ROUTE24) },
   { {TRAINER_OFFICER_VERLISIFY, TRAINER_OFFICER_VERLISIFY},
      MAP(MAP_ROUTE24) },
   { {TRAINER_CAMPER_ETHAN, TRAINER_CAMPER_ETHAN},
      MAP(MAP_ROUTE24) },
   { {TRAINER_YOUNGSTER_JOEY, TRAINER_YOUNGSTER_JOEY},
      MAP(MAP_ROUTE25) },
   { {TRAINER_YOUNGSTER_CHINO, TRAINER_YOUNGSTER_CHINO},
      MAP(MAP_ROUTE25) },
   { {TRAINER_ANGRY_NERD_LAVOS, TRAINER_ANGRY_NERD_LAVOS, SKIP, TRAINER_ANGRY_NERD_LAVOS, TRAINER_ANGRY_NERD_LAVOS},
      MAP(MAP_ROUTE25) },
   { {TRAINER_COOLTRAINER_BKC, TRAINER_COOLTRAINER_BKC, SKIP, TRAINER_COOLTRAINER_BKC, TRAINER_COOLTRAINER_BKC},
      MAP(MAP_ROUTE25) },
   { {TRAINER_ELITE_FOUR_KAREN, TRAINER_ELITE_FOUR_KAREN},
      MAP(MAP_ROUTE25) },
   { {TRAINER_HIKER_FRANKLIN, SKIP, TRAINER_HIKER_FRANKLIN},
      MAP(MAP_ROUTE25) },
   ...
   { {TRAINER_BUG_CATCHER_ELIJAH, TRAINER_BUG_CATCHER_ELIJAH},
      MAP(MAP_ROUTE6) },
   { {TRAINER_CAMPER_RICKY, TRAINER_CAMPER_RICKY, SKIP, TRAINER_CAMPER_RICKY, SKIP, TRAINER_CAMPER_RICKY},
      MAP(MAP_ROUTE6) },
   { {TRAINER_CAMPER_JEFF, TRAINER_CAMPER_JEFF, SKIP, TRAINER_CAMPER_JEFF, SKIP, TRAINER_CAMPER_JEFF},
      MAP(MAP_ROUTE6) },
   { {TRAINER_PICNICKER_NANCY, TRAINER_PICNICKER_NANCY},
      MAP(MAP_ROUTE6) },
   { {TRAINER_PICNICKER_ISABELLE, TRAINER_PICNICKER_ISABELLE, SKIP, TRAINER_PICNICKER_ISABELLE, TRAINER_PICNICKER_ISABELLE},
      MAP(MAP_ROUTE6) },
   { {TRAINER_LOSS_MAN_1, TRAINER_LOSS_MAN_1},
      MAP(MAP_ROUTE11) },
   { {TRAINER_DOCTOR_COOKIE, TRAINER_DOCTOR_COOKIE},
      MAP(MAP_ROUTE11) },
   { {TRAINER_LOSS_RECEPTIONIST, SKIP, TRAINER_LOSS_RECEPTIONIST, SKIP, TRAINER_LOSS_RECEPTIONIST},
      MAP(MAP_ROUTE11) },
   { {TRAINER_LOSS_MAN_3, TRAINER_LOSS_MAN_3},
      MAP(MAP_ROUTE11) },
   { {TRAINER_ENGINEER_BRAXTON, TRAINER_ENGINEER_BRAXTON},
      MAP(MAP_ROUTE11) },
   { {TRAINER_ENGINEER_BERNIE, SKIP, SKIP, TRAINER_ENGINEER_BERNIE},
      MAP(MAP_ROUTE11) },
   { {TRAINER_GAMER_HUGO, TRAINER_GAMER_HUGO},
      MAP(MAP_ROUTE11) },
   { {TRAINER_LOSS_MAN_4, TRAINER_LOSS_MAN_4},
      MAP(MAP_ROUTE11) },
   { {TRAINER_LOSS_MISCARRIAGE, TRAINER_LOSS_MISCARRIAGE},
      MAP(MAP_ROUTE11) },
   { {TRAINER_LOSS_MAN_2, SKIP, SKIP, TRAINER_LOSS_MAN_2},
      MAP(MAP_ROUTE11) },
   { {TRAINER_BUG_CATCHER_BRENT, TRAINER_BUG_CATCHER_BRENT},
      MAP(MAP_ROUTE9) },
   { {TRAINER_BUG_CATCHER_CONNER, TRAINER_BUG_CATCHER_CONNER},
      MAP(MAP_ROUTE9) },
   { {TRAINER_CAMPER_CHRIS, SKIP, TRAINER_CAMPER_CHRIS, TRAINER_CAMPER_CHRIS, SKIP, TRAINER_CAMPER_CHRIS},
      MAP(MAP_ROUTE9) },
   { {TRAINER_CAMPER_DREW, TRAINER_CAMPER_DREW},
      MAP(MAP_ROUTE9) },
   { {TRAINER_PICNICKER_ALICIA, SKIP, TRAINER_PICNICKER_ALICIA, TRAINER_PICNICKER_ALICIA, SKIP, TRAINER_PICNICKER_ALICIA},
      MAP(MAP_ROUTE9) },
   ...
   { {TRAINER_HIKER_BRICE, TRAINER_HIKER_BRICE},
      MAP(MAP_ROUTE9) },
   { {TRAINER_HIKER_JEREMY, SKIP, SKIP, TRAINER_HIKER_JEREMY},
      MAP(MAP_ROUTE9) },
   { {TRAINER_PICNICKER_HEIDI, TRAINER_PICNICKER_HEIDI},
      MAP(MAP_ROUTE10) },
   { {TRAINER_PICNICKER_CAROL, TRAINER_PICNICKER_CAROL},
      MAP(MAP_ROUTE10) },
   { {TRAINER_POKEMANIAC_MARK, SKIP, SKIP, TRAINER_POKEMANIAC_MARK, SKIP, TRAINER_POKEMANIAC_MARK},
      MAP(MAP_ROUTE10) },
   { {TRAINER_POKEMANIAC_HERMAN, SKIP, SKIP, TRAINER_POKEMANIAC_HERMAN, SKIP, TRAINER_POKEMANIAC_HERMAN},
      MAP(MAP_ROUTE10) },
   { {TRAINER_HIKER_CLARK, TRAINER_HIKER_CLARK},
      MAP(MAP_ROUTE10) },
   { {TRAINER_HIKER_TRENT, SKIP, SKIP, TRAINER_HIKER_TRENT},
      MAP(MAP_ROUTE10) },
   { {TRAINER_LASS_ROUTE8, TRAINER_LASS_ROUTE8},
      MAP(MAP_ROUTE8) },
   { {TRAINER_LASS_FENCES, TRAINER_LASS_FENCES},
      MAP(MAP_ROUTE8) },
   { {TRAINER_LASS_WEATHER, SKIP, TRAINER_LASS_WEATHER, SKIP, TRAINER_LASS_WEATHER},
      MAP(MAP_ROUTE8) },
   { {TRAINER_PICNICKER_NIGHT, TRAINER_PICNICKER_NIGHT},
      MAP(MAP_ROUTE8) },
   { {TRAINER_SUPER_NERD_AIDAN, TRAINER_SUPER_NERD_AIDAN},
      MAP(MAP_ROUTE8) },
   { {TRAINER_SUPER_NERD_GLENN, SKIP, SKIP, TRAINER_SUPER_NERD_GLENN},
      MAP(MAP_ROUTE8) },
   { {TRAINER_SUPER_NERD_LESLIE, TRAINER_SUPER_NERD_LESLIE},
      MAP(MAP_ROUTE8) },
   { {TRAINER_GAMER_STAN, TRAINER_GAMER_STAN},
      MAP(MAP_ROUTE8) },
   { {TRAINER_GAMER_RICH, SKIP, SKIP, TRAINER_GAMER_RICH},
      MAP(MAP_ROUTE8) },
   { {TRAINER_TWINS_ELI_ANNE, SKIP, SKIP, TRAINER_TWINS_ELI_ANNE},
      MAP(MAP_ROUTE8) },
   { {TRAINER_BIKER_RICARDO, TRAINER_BIKER_RICARDO},
      MAP(MAP_ROUTE8) },
   { {TRAINER_BIKER_JAREN, SKIP, SKIP, TRAINER_BIKER_JAREN},
      MAP(MAP_ROUTE8) },
   ...
   { {TRAINER_FISHERMAN_HANK, TRAINER_FISHERMAN_HANK},
      MAP(MAP_ROUTE12) },
   { {TRAINER_FISHERMAN_ELLIOT, SKIP, SKIP, TRAINER_FISHERMAN_ELLIOT},
      MAP(MAP_ROUTE12) },
   { {TRAINER_FISHERMAN_ANDREW, TRAINER_FISHERMAN_ANDREW},
      MAP(MAP_ROUTE12) },
   { {TRAINER_ROCKER_LUCA, SKIP, SKIP, TRAINER_ROCKER_LUCA},
      MAP(MAP_ROUTE12) },
   { {TRAINER_CAMPER_JUSTIN, TRAINER_CAMPER_JUSTIN},
      MAP(MAP_ROUTE12) },
   { {TRAINER_YOUNG_COUPLE_GIA_JES, SKIP, SKIP, TRAINER_YOUNG_COUPLE_GIA_JES, SKIP, TRAINER_YOUNG_COUPLE_GIA_JES},
      MAP(MAP_ROUTE12) },
   { {TRAINER_BIKER_JARED, TRAINER_BIKER_JARED},
      MAP(MAP_ROUTE13) },
   { {TRAINER_BEAUTY_LOLA, TRAINER_BEAUTY_LOLA},
      MAP(MAP_ROUTE13) },
   { {TRAINER_BEAUTY_SHEILA, SKIP, SKIP, SKIP, TRAINER_BEAUTY_SHEILA},
      MAP(MAP_ROUTE13) },
   { {TRAINER_BIRD_CULTIST_SEBASTIAN, TRAINER_BIRD_CULTIST_SEBASTIAN},
      MAP(MAP_ROUTE13) },
   { {TRAINER_BIRD_CULTIST_PERRY, TRAINER_BIRD_CULTIST_PERRY},
      MAP(MAP_ROUTE13) },
   { {TRAINER_BIRD_CULTIST_EDWARDO, SKIP, SKIP, TRAINER_BIRD_CULTIST_EDWARDO, TRAINER_BIRD_CULTIST_EDWARDO},
      MAP(MAP_ROUTE13) },
   { {TRAINER_LASS_PIT, TRAINER_LASS_PIT},
      MAP(MAP_ROUTE13) },
   { {TRAINER_LASS_INVISIBLE, SKIP, SKIP, TRAINER_LASS_INVISIBLE, TRAINER_LASS_INVISIBLE, TRAINER_LASS_INVISIBLE},
      MAP(MAP_ROUTE13) },
   ...
   { {TRAINER_BIKER_MALIK, TRAINER_BIKER_MALIK},
      MAP(MAP_ROUTE14) },
   { {TRAINER_BIKER_LUKAS, SKIP, SKIP, SKIP, TRAINER_BIKER_LUKAS},
      MAP(MAP_ROUTE14) },
   ...
   { {TRAINER_BIRD_KEEPER_DONALD, TRAINER_BIRD_KEEPER_DONALD},
      MAP(MAP_ROUTE14) },
   { {TRAINER_BIRD_KEEPER_BENNY, SKIP, SKIP, TRAINER_BIRD_KEEPER_BENNY, TRAINER_BIRD_KEEPER_BENNY},
      MAP(MAP_ROUTE14) },
   ...
   { {TRAINER_BIRD_KEEPER_BECK, TRAINER_BIRD_KEEPER_BECK},
      MAP(MAP_ROUTE14) },
   { {TRAINER_BIRD_KEEPER_MARLON, SKIP, SKIP, TRAINER_BIRD_KEEPER_MARLON, TRAINER_BIRD_KEEPER_MARLON},
      MAP(MAP_ROUTE14) },
   ...
   { {TRAINER_BIKER_ALEX, TRAINER_BIKER_ALEX},
      MAP(MAP_ROUTE15) },
   { {TRAINER_BEAUTY_GRACE, SKIP, SKIP, SKIP, TRAINER_BEAUTY_GRACE},
      MAP(MAP_ROUTE15) },
   { {TRAINER_BEAUTY_OLIVIA, TRAINER_BEAUTY_OLIVIA},
      MAP(MAP_ROUTE15) },
   { {TRAINER_BIRD_KEEPER_EDWIN, TRAINER_BIRD_KEEPER_EDWIN},
      MAP(MAP_ROUTE15) },
   { {TRAINER_BIRD_KEEPER_CHESTER, SKIP, SKIP, TRAINER_BIRD_KEEPER_CHESTER, TRAINER_BIRD_KEEPER_CHESTER},
      MAP(MAP_ROUTE15) },
   { {TRAINER_PICNICKER_YAZMIN, TRAINER_PICNICKER_YAZMIN},
      MAP(MAP_ROUTE15) },
   { {TRAINER_PICNICKER_KINDRA, TRAINER_PICNICKER_KINDRA},
      MAP(MAP_ROUTE15) },
   { {TRAINER_PICNICKER_BECKY, SKIP, SKIP, TRAINER_PICNICKER_BECKY, TRAINER_PICNICKER_BECKY, TRAINER_PICNICKER_BECKY},
      MAP(MAP_ROUTE15) },
   { {TRAINER_PICNICKER_CELIA, TRAINER_PICNICKER_CELIA},
      MAP(MAP_ROUTE15) },
   { {TRAINER_CRUSH_KIN_RON_MYA, SKIP, SKIP, TRAINER_CRUSH_KIN_RON_MYA, TRAINER_CRUSH_KIN_RON_MYA, TRAINER_CRUSH_KIN_RON_MYA},
      MAP(MAP_ROUTE15) },
   { {TRAINER_BIKER_LAO, TRAINER_BIKER_LAO},
      MAP(MAP_ROUTE16) },
   { {TRAINER_BIKER_HIDEO, TRAINER_BIKER_HIDEO},
      MAP(MAP_ROUTE16) },
   { {TRAINER_BIKER_RUBEN, SKIP, SKIP, SKIP, TRAINER_BIKER_RUBEN},
      MAP(MAP_ROUTE16) },
   { {TRAINER_COP_1, TRAINER_COP_1},
      MAP(MAP_ROUTE16) },
   { {TRAINER_COP_2, TRAINER_COP_2},
      MAP(MAP_ROUTE16) },
   { {TRAINER_COP_3, SKIP, SKIP, SKIP, TRAINER_COP_3},
      MAP(MAP_ROUTE16) },
   ...
   { {TRAINER_BIKER_NIKOLAS, TRAINER_BIKER_NIKOLAS},
      MAP(MAP_ROUTE17) },
   { {TRAINER_BIKER_JAXON, SKIP, SKIP, SKIP, TRAINER_BIKER_JAXON},
      MAP(MAP_ROUTE17) },
   { {TRAINER_BIKER_WILLIAM, TRAINER_BIKER_WILLIAM},
      MAP(MAP_ROUTE17) },
   { {TRAINER_COP_4, TRAINER_COP_4},
      MAP(MAP_ROUTE17) },
   { {TRAINER_COP_5, SKIP, SKIP, SKIP, TRAINER_COP_5},
      MAP(MAP_ROUTE17) },
   { {TRAINER_CUE_BALL_ZEEK, TRAINER_CUE_BALL_ZEEK},
      MAP(MAP_ROUTE17) },
   { {TRAINER_CUE_BALL_JAMAL, TRAINER_CUE_BALL_JAMAL},
      MAP(MAP_ROUTE17) },
   { {TRAINER_CUE_BALL_COREY, SKIP, SKIP, SKIP, TRAINER_CUE_BALL_COREY},
      MAP(MAP_ROUTE17) },
   ...
   { {TRAINER_SWIMMER_MALE_DEAN, TRAINER_SWIMMER_MALE_DEAN},
      MAP(MAP_ROUTE20) },
   { {TRAINER_SWIMMER_MALE_DARRIN, SKIP, SKIP, SKIP, SKIP, TRAINER_SWIMMER_MALE_DARRIN},
      MAP(MAP_ROUTE20) },
   { {TRAINER_SWIMMER_FEMALE_TIFFANY, TRAINER_SWIMMER_FEMALE_TIFFANY},
      MAP(MAP_ROUTE20) },
   { {TRAINER_SWIMMER_FEMALE_NORA, TRAINER_SWIMMER_FEMALE_NORA},
      MAP(MAP_ROUTE20) },
   { {TRAINER_SWIMMER_FEMALE_MELISSA, SKIP, SKIP, SKIP, TRAINER_SWIMMER_FEMALE_MELISSA},
      MAP(MAP_ROUTE20) },
   { {TRAINER_SWIMMER_FEMALE_SHIRLEY, TRAINER_SWIMMER_FEMALE_SHIRLEY},
      MAP(MAP_ROUTE20) },
   { {TRAINER_BIRD_KEEPER_ROGER, TRAINER_BIRD_KEEPER_ROGER},
      MAP(MAP_ROUTE20) },
   { {TRAINER_PICNICKER_MISSY, SKIP, SKIP, SKIP, TRAINER_PICNICKER_MISSY, TRAINER_PICNICKER_MISSY},
      MAP(MAP_ROUTE20) },
   ...
   { {TRAINER_FISHERMAN_CLAUDE, TRAINER_FISHERMAN_CLAUDE},
      MAP(MAP_ROUTE21_NORTH) },
   { {TRAINER_FISHERMAN_WADE, SKIP, SKIP, SKIP, TRAINER_FISHERMAN_WADE},
      MAP(MAP_ROUTE21_NORTH) },
   { {TRAINER_FISHERMAN_NOLAN, TRAINER_FISHERMAN_NOLAN},
      MAP(MAP_ROUTE21_NORTH) },
   { {TRAINER_SWIMMER_MALE_SPENCER, TRAINER_SWIMMER_MALE_SPENCER},
      MAP(MAP_ROUTE21_NORTH) },
   { {TRAINER_SWIMMER_MALE_JACK, SKIP, SKIP, SKIP, TRAINER_SWIMMER_MALE_JACK},
      MAP(MAP_ROUTE21_NORTH) },
   { {TRAINER_SWIMMER_MALE_JEROME, TRAINER_SWIMMER_MALE_JEROME},
      MAP(MAP_ROUTE21_NORTH) },
   { {TRAINER_SWIMMER_MALE_ROLAND, TRAINER_SWIMMER_MALE_ROLAND},
      MAP(MAP_ROUTE21_NORTH) },
   { {TRAINER_SIS_AND_BRO_LIL_IAN, SKIP, SKIP, SKIP, TRAINER_SIS_AND_BRO_LIL_IAN, TRAINER_SIS_AND_BRO_LIL_IAN},
      MAP(MAP_ROUTE21_NORTH) },
   ...
   { {TRAINER_SWIMMER_FEMALE_ABIGAIL, TRAINER_SWIMMER_FEMALE_ABIGAIL},
      MAP(MAP_ONE_ISLAND_KINDLE_ROAD) },
   { {TRAINER_SWIMMER_MALE_FINN, SKIP, SKIP, SKIP, TRAINER_SWIMMER_MALE_FINN},
      MAP(MAP_ONE_ISLAND_KINDLE_ROAD) },
   { {TRAINER_SWIMMER_MALE_GARRETT, TRAINER_SWIMMER_MALE_GARRETT},
      MAP(MAP_ONE_ISLAND_KINDLE_ROAD) },
   { {TRAINER_FISHERMAN_TOMMY, TRAINER_FISHERMAN_TOMMY},
      MAP(MAP_ONE_ISLAND_KINDLE_ROAD) },
   { {TRAINER_CRUSH_GIRL_SHARON, SKIP, SKIP, SKIP, TRAINER_CRUSH_GIRL_SHARON, TRAINER_CRUSH_GIRL_SHARON},
      MAP(MAP_ONE_ISLAND_KINDLE_ROAD) },
   { {TRAINER_CRUSH_GIRL_TANYA, SKIP, SKIP, SKIP, TRAINER_CRUSH_GIRL_TANYA, TRAINER_CRUSH_GIRL_TANYA},
      MAP(MAP_ONE_ISLAND_KINDLE_ROAD) },
   { {TRAINER_BLACK_BELT_SHEA, SKIP, SKIP, SKIP, TRAINER_BLACK_BELT_SHEA, TRAINER_BLACK_BELT_SHEA},
      MAP(MAP_ONE_ISLAND_KINDLE_ROAD) },
   { {TRAINER_BLACK_BELT_HUGH, SKIP, SKIP, SKIP, TRAINER_BLACK_BELT_HUGH, TRAINER_BLACK_BELT_HUGH},
      MAP(MAP_ONE_ISLAND_KINDLE_ROAD) },
   { {TRAINER_CAMPER_BRYCE, TRAINER_CAMPER_BRYCE},
      MAP(MAP_ONE_ISLAND_KINDLE_ROAD) },
   { {TRAINER_PICNICKER_CLAIRE, TRAINER_PICNICKER_CLAIRE},
      MAP(MAP_ONE_ISLAND_KINDLE_ROAD) },
   { {TRAINER_CRUSH_KIN_MIK_KIA, SKIP, SKIP, SKIP, TRAINER_CRUSH_KIN_MIK_KIA, TRAINER_CRUSH_KIN_MIK_KIA},
      MAP(MAP_ONE_ISLAND_KINDLE_ROAD) },
   ...
   { {TRAINER_AROMA_LADY_VIOLET, TRAINER_AROMA_LADY_VIOLET},
      MAP(MAP_THREE_ISLAND_BOND_BRIDGE) },
   { {TRAINER_TUBER_AMIRA, SKIP, SKIP, SKIP, TRAINER_TUBER_AMIRA},
      MAP(MAP_THREE_ISLAND_BOND_BRIDGE) },
   { {TRAINER_TUBER_ALEXIS, TRAINER_TUBER_ALEXIS},
      MAP(MAP_THREE_ISLAND_BOND_BRIDGE) },
   { {TRAINER_SWIMMER_FEMALE_TISHA, TRAINER_SWIMMER_FEMALE_TISHA},
      MAP(MAP_THREE_ISLAND_BOND_BRIDGE) },
   { {TRAINER_TWINS_JOY_MEG, SKIP, SKIP, SKIP, TRAINER_TWINS_JOY_MEG},
      MAP(MAP_THREE_ISLAND_BOND_BRIDGE) },
   ...
   { {TRAINER_PAINTER_CELINA, TRAINER_PAINTER_CELINA},
      MAP(MAP_FIVE_ISLAND_RESORT_GORGEOUS) },
   { {TRAINER_PAINTER_RAYNA, SKIP, SKIP, SKIP, SKIP, TRAINER_PAINTER_RAYNA},
      MAP(MAP_FIVE_ISLAND_RESORT_GORGEOUS) },
   { {TRAINER_LADY_JACKI, TRAINER_LADY_JACKI},
      MAP(MAP_FIVE_ISLAND_RESORT_GORGEOUS) },
   { {TRAINER_LADY_GILLIAN, TRAINER_LADY_GILLIAN},
      MAP(MAP_FIVE_ISLAND_RESORT_GORGEOUS) },
   { {TRAINER_SHORTS_MARRMOT, SKIP, SKIP, SKIP, SKIP, TRAINER_SHORTS_MARRMOT},
      MAP(MAP_FIVE_ISLAND_RESORT_GORGEOUS) },
   { {TRAINER_SWIMMER_MALE_TOBY, TRAINER_SWIMMER_MALE_TOBY},
      MAP(MAP_FIVE_ISLAND_RESORT_GORGEOUS) },
   { {TRAINER_PKMN_BREEDER_ALIZE, SKIP, SKIP, SKIP, SKIP, TRAINER_PKMN_BREEDER_ALIZE},
      MAP(MAP_FIVE_ISLAND_WATER_LABYRINTH) },
   { {TRAINER_BIRD_KEEPER_MILO, SKIP, SKIP, SKIP, SKIP, TRAINER_BIRD_KEEPER_MILO},
      MAP(MAP_FIVE_ISLAND_MEMORIAL_PILLAR) },
   { {TRAINER_BIRD_KEEPER_CHAZ, SKIP, SKIP, SKIP, SKIP, TRAINER_BIRD_KEEPER_CHAZ},
      MAP(MAP_FIVE_ISLAND_MEMORIAL_PILLAR) },
   { {TRAINER_BIRD_KEEPER_HAROLD, SKIP, SKIP, SKIP, SKIP, TRAINER_BIRD_KEEPER_HAROLD},
      MAP(MAP_FIVE_ISLAND_MEMORIAL_PILLAR) },
   ...
   { {TRAINER_SWIMMER_MALE_MYMO, TRAINER_SWIMMER_MALE_MYMO},
      MAP(MAP_SIX_ISLAND_OUTCAST_ISLAND) },
   { {TRAINER_SWIMMER_FEMALE_NICOLE, SKIP, SKIP, SKIP, SKIP, TRAINER_SWIMMER_FEMALE_NICOLE},
      MAP(MAP_SIX_ISLAND_OUTCAST_ISLAND) },
   { {TRAINER_SIS_AND_BRO_AVA_GEB, TRAINER_SIS_AND_BRO_AVA_GEB},
      MAP(MAP_SIX_ISLAND_OUTCAST_ISLAND) },
   { {TRAINER_IMPOSTER_OAK_FUSHCIA, SKIP, SKIP, SKIP, SKIP, TRAINER_IMPOSTER_OAK_FUSHCIA},
   ...
   { {TRAINER_JUGGLER_EDWARD, TRAINER_JUGGLER_EDWARD},
      MAP(MAP_SIX_ISLAND_WATER_PATH) },
   { {TRAINER_SWIMMER_MALE_SAMIR, SKIP, SKIP, SKIP, SKIP, TRAINER_SWIMMER_MALE_SAMIR},
      MAP(MAP_SIX_ISLAND_WATER_PATH) },
   { {TRAINER_SWIMMER_FEMALE_DENISE, TRAINER_SWIMMER_FEMALE_DENISE},
      MAP(MAP_SIX_ISLAND_WATER_PATH) },
   { {TRAINER_TWINS_MIU_MIA, TRAINER_TWINS_MIU_MIA},
      MAP(MAP_SIX_ISLAND_WATER_PATH) },
   { {TRAINER_HIKER_EARL, SKIP, SKIP, SKIP, SKIP, TRAINER_HIKER_EARL},
      MAP(MAP_SIX_ISLAND_WATER_PATH) },
   ...
   { {TRAINER_RUIN_MANIAC_FOSTER, TRAINER_RUIN_MANIAC_FOSTER},
      MAP(MAP_SIX_ISLAND_RUIN_VALLEY) },
   { {TRAINER_RUIN_MANIAC_LARRY, SKIP, SKIP, SKIP, SKIP, TRAINER_RUIN_MANIAC_LARRY},
      MAP(MAP_SIX_ISLAND_RUIN_VALLEY) },
   { {TRAINER_HIKER_DARYL, TRAINER_HIKER_DARYL},
      MAP(MAP_SIX_ISLAND_RUIN_VALLEY) },
   { {TRAINER_POKEMANIAC_HECTOR, SKIP, SKIP, SKIP, SKIP, TRAINER_POKEMANIAC_HECTOR},
      MAP(MAP_SIX_ISLAND_RUIN_VALLEY) },
   { {TRAINER_PSYCHIC_DARIO, SKIP, SKIP, SKIP, SKIP, TRAINER_PSYCHIC_DARIO},
      MAP(MAP_SEVEN_ISLAND_TRAINER_TOWER) },
   { {TRAINER_PSYCHIC_RODETTE, SKIP, SKIP, SKIP, SKIP, TRAINER_PSYCHIC_RODETTE},
      MAP(MAP_SEVEN_ISLAND_TRAINER_TOWER) },
   ...
   { {TRAINER_YOUNG_COUPLE_EVE_JON, TRAINER_YOUNG_COUPLE_EVE_JON},
      MAP(MAP_SEVEN_ISLAND_SEVAULT_CANYON_ENTRANCE) },
   { {TRAINER_JUGGLER_MASON, SKIP, SKIP, SKIP, SKIP, TRAINER_JUGGLER_MASON},
      MAP(MAP_SEVEN_ISLAND_SEVAULT_CANYON_ENTRANCE) },
   { {TRAINER_PKMN_RANGER_NICOLAS, SKIP, SKIP, SKIP, SKIP, TRAINER_PKMN_RANGER_NICOLAS},
      MAP(MAP_SEVEN_ISLAND_SEVAULT_CANYON_ENTRANCE) },
   { {TRAINER_PKMN_RANGER_MADELINE, SKIP, SKIP, SKIP, SKIP, TRAINER_PKMN_RANGER_MADELINE},
      MAP(MAP_SEVEN_ISLAND_SEVAULT_CANYON_ENTRANCE) },
   { {TRAINER_IMPOSTER_OAK_1, SKIP, SKIP, SKIP, SKIP, TRAINER_IMPOSTER_OAK_1},
      MAP(MAP_SEVEN_ISLAND_SEVAULT_CANYON) },
   { {TRAINER_TAMER_EVAN, SKIP, SKIP, SKIP, SKIP, TRAINER_TAMER_EVAN},
      MAP(MAP_SEVEN_ISLAND_SEVAULT_CANYON) },
   { {TRAINER_PKMN_RANGER_JACKSON, SKIP, SKIP, SKIP, SKIP, TRAINER_PKMN_RANGER_JACKSON},
      MAP(MAP_SEVEN_ISLAND_SEVAULT_CANYON) },
   { {TRAINER_PKMN_RANGER_KATELYN, SKIP, SKIP, SKIP, SKIP, TRAINER_PKMN_RANGER_KATELYN},
      MAP(MAP_SEVEN_ISLAND_SEVAULT_CANYON) },
   { {TRAINER_COOLTRAINER_LEROY, SKIP, SKIP, SKIP, SKIP, TRAINER_COOLTRAINER_LEROY},
      MAP(MAP_SEVEN_ISLAND_SEVAULT_CANYON) },
   { {TRAINER_COOLTRAINER_MICHELLE, SKIP, SKIP, SKIP, SKIP, TRAINER_COOLTRAINER_MICHELLE},
      MAP(MAP_SEVEN_ISLAND_SEVAULT_CANYON) },
   { {TRAINER_COOL_COUPLE_LEX_NYA, SKIP, SKIP, SKIP, SKIP, TRAINER_COOL_COUPLE_LEX_NYA},
      MAP(MAP_SEVEN_ISLAND_SEVAULT_CANYON) },
