...
static const struct RematchData sRematches[] = {
   { {TRAINER_YOUNGSTER_BEN, TRAINER_YOUNGSTER_BEN, SKIP, TRAINER_YOUNGSTER_BEN, TRAINER_YOUNGSTER_BEN}, MAP(ROUTE3) },
   ...
   { {TRAINER_YOUNGSTER_DAN, TRAINER_YOUNGSTER_DAN},
      MAP(ROUTE25) },
   { {TRAINER_YOUNGSTER_CHAD, TRAINER_YOUNGSTER_CHAD, SKIP, TRAINER_YOUNGSTER_CHAD, TRAINER_YOUNGSTER_CHAD},
      MAP(ROUTE25) },
   { {TRAINER_PICNICKER_KELSEY, TRAINER_PICNICKER_KELSEY, SKIP, TRAINER_PICNICKER_KELSEY, TRAINER_PICNICKER_KELSEY},
      MAP(ROUTE25) },
