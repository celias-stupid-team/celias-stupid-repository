...
static const struct RematchData sRematches[] = {
   ...
   { {TRAINER_LASS_ANDREA, TRAINER_LASS_ANDREA},
      MAP(ROUTE8) },
   { {TRAINER_LASS_MEGAN, SKIP, TRAINER_LASS_MEGAN, SKIP, TRAINER_LASS_MEGAN},
      MAP(ROUTE8) },
   ...
   { {TRAINER_BIRD_KEEPER_PERRY, TRAINER_BIRD_KEEPER_PERRY},
      MAP(ROUTE13) },
   { {TRAINER_BIRD_KEEPER_ROBERT, SKIP, SKIP, TRAINER_BIRD_KEEPER_ROBERT, TRAINER_BIRD_KEEPER_ROBERT},
      MAP(ROUTE13) },
   { {TRAINER_PICNICKER_ALMA, TRAINER_PICNICKER_ALMA},
      MAP(ROUTE13) },
   { {TRAINER_PICNICKER_SUSIE, SKIP, SKIP, TRAINER_PICNICKER_SUSIE, TRAINER_PICNICKER_SUSIE, TRAINER_PICNICKER_SUSIE},
      MAP(ROUTE13) },
