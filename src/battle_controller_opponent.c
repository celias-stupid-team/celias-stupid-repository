...
static u32 GetOpponentMonData(u8 monId, u8 *dst)
{
    ...
    case REQUEST_ALL_BATTLE:
        ...
        battleMon.lockedAbility = GetMonData(&gEnemyParty[monId], MON_DATA_LOCKED_ABILITY);
...
static void OpponentHandleChooseMove(void)
{
    ...
    if ((gBattleTypeFlags & (BATTLE_TYPE_TRAINER | BATTLE_TYPE_FIRST_BATTLE | BATTLE_TYPE_SAFARI | BATTLE_TYPE_ROAMER | BATTLE_TYPE_WILD_SCRIPTED)) || IsSingleWildRattata())
    {
