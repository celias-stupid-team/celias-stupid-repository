const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
	...
	SPECIES_SHINY_PAL(MIME_JR_, gMonShinyPalette_Mime_Jr_),
	...
	SPECIES_SHINY_PAL(JIGGLYPUFF_ABOVE, gMonShinyPalette_Jigglypuff_Above),
	SPECIES_SHINY_PAL(TENTAQUIL, gMonShinyPalette_Tentaquil),
	SPECIES_SHINY_PAL(MISSINGNO, gMonShinyPalette_Missingno),
	SPECIES_SHINY_PAL(KENYA, gMonShinyPalette_Kenya),
	SPECIES_SHINY_PAL(HITMONCHAN_SHIT, gMonShinyPalette_Hitmonchan_Shit),
	SPECIES_SHINY_PAL(HITMONCHIN, gMonShinyPalette_Hitmonchin),
	SPECIES_SHINY_PAL(TRUBBISH_HAIRCUT, gMonShinyPalette_Trubbish_Haircut),
	SPECIES_SHINY_PAL(AMPHAROS_MEGA, gMonShinyPalette_Ampharos_Mega),
	SPECIES_SHINY_PAL(YOSHI, gMonShinyPalette_Yoshi),
	SPECIES_SHINY_PAL(DITTO_MEW, gMonShinyPalette_Ditto_Mew),
	SPECIES_SHINY_PAL(UNOWN_LOSS, gMonShinyPalette_Unown_Loss),
	SPECIES_SHINY_PAL(MAGNALONE, gMonShinyPalette_Magnalone),
	SPECIES_SHINY_PAL(TYRANASTAR, gMonShinyPalette_Tyranastar),
	SPECIES_SHINY_PAL(POKEMON_GUN, gMonShinyPalette_Pokemon_Gun),
	SPECIES_SHINY_PAL(PLUG_OINK, gMonShinyPalette_Plug_Oink),
	SPECIES_SHINY_PAL(PIKABLU, gMonShinyPalette_Pikablu),
	SPECIES_SHINY_PAL(RATTATA_SHINY, gMonShinyPalette_Rattata_Shiny),
		SPECIES_SHINY_PAL(PIKACHU_BIRTHDAY, gMonShinyPalette_Pikachu_Birthday),
	SPECIES_SHINY_PAL(MEW_ANCIENT, gMonShinyPalette_Mew_Ancient),
	SPECIES_SHINY_PAL(PIKACHU_OLD, gMonShinyPalette_Pikachu_Old),
	SPECIES_SHINY_PAL(GENESECT_SHINY, gMonShinyPalette_Genesect_Shiny),
	SPECIES_SHINY_PAL(IRON_CLEFT, gMonShinyPalette_Iron_Cleft),
	SPECIES_SHINY_PAL(VULPIX_ALOLA, gMonShinyPalette_Vulpix_Alola),
	SPECIES_SHINY_PAL(WEEZING_ALOLA, gMonShinyPalette_Weezing_Alola),
	SPECIES_SHINY_PAL(THIS_GUY, gMonShinyPalette_This_Guy),
	SPECIES_SHINY_PAL(STEAMBOAT_WILLIE, gMonShinyPalette_Steamboat_Willie),
	SPECIES_SHINY_PAL(PIDGEOT_OLD, gMonShinyPalette_Pidgeot_Old),
	SPECIES_SHINY_PAL(STRYKE, gMonShinyPalette_Stryke),
	SPECIES_SHINY_PAL(BUTTERFREE_FEMALE, gMonShinyPalette_Butterfree_Female),
	SPECIES_SHINY_PAL(PIKACHU_FAT_GAY, gMonShinyPalette_Pikachu_Fat_Gay),
	SPECIES_SHINY_PAL(TRAPINCH_PIKACHU, gMonShinyPalette_Trapinch_Pikachu),
	SPECIES_SHINY_PAL(KECLEON_SANS, gMonShinyPalette_Kecleon_Sans),
	//SPECIES_SHINY_PAL(RATTATA_SHINY, gMonShinyPalette_Rattata_Shiny),
	SPECIES_SHINY_PAL(PORYGON_16, gMonShinyPalette_Porygon_16),
	SPECIES_SHINY_PAL(PORYGON_8, gMonShinyPalette_Porygon_8),
	SPECIES_SHINY_PAL(PORYGON_4, gMonShinyPalette_Porygon_4),
	SPECIES_SHINY_PAL(PORIST_GAMES, gMonShinyPalette_Porist_Games),
	SPECIES_SHINY_PAL(MISCARRIAGE_KANGA, gMonShinyPalette_Miscarriage_Kanga),
	SPECIES_SHINY_PAL(GHOST, gMonShinyPalette_Ghost),
	SPECIES_SHINY_PAL(VENOMOTH_ATV, gMonShinyPalette_Venomoth_ATV),
	SPECIES_SHINY_PAL(RATICATE_ALOLA, gMonShinyPalette_Raticate_Alola),
	SPECIES_SHINY_PAL(MULTIPAL, gMonShinyPalette_Multipal),
	SPECIES_SHINY_PAL(DIVIDUM, gMonShinyPalette_Dividum),
	SPECIES_SHINY_PAL(EXPONELLE, gMonShinyPalette_Exponelle),
	SPECIES_SHINY_PAL(PIKACHU_SNAP_SURF, gMonShinyPalette_Pikachu_Snap_Surf),
	SPECIES_SHINY_PAL(PIKACHU_SNAP_BALL, gMonShinyPalette_Pikachu_Snap_Ball),
	SPECIES_SHINY_PAL(PIKACHU_SNAP_FLYING, gMonShinyPalette_Pikachu_Snap_Flying),
	SPECIES_SHINY_PAL(PIKACHU_SNAP_CLOSE, gMonShinyPalette_Pikachu_Snap_Close),
	SPECIES_SHINY_PAL(RATICATE_DEAD, gMonShinyPalette_Raticate_Dead),
	SPECIES_SHINY_PAL(SHEDINJA_ELECTRIC, gMonShinyPalette_Shedinja_Electric),
	SPECIES_SHINY_PAL(VENUSAUR_MEGA, gMonShinyPalette_Digimon),
	SPECIES_SHINY_PAL(UNOWN_NUDES, gMonShinyPalette_Unown_Nudes),
	SPECIES_SHINY_PAL(PORYGON22, gMonShinyPalette_Porygon22),
	SPECIES_SHINY_PAL(HO_OWO, gMonShinyPalette_Ho_OwO),
	SPECIES_SHINY_PAL(RATATATTA, gMonShinyPalette_Ratatatta),
	SPECIES_SHINY_PAL(BULBASAUR_POKERAP, gMonShinyPalette_Bulbasaur_POKERAP),
	SPECIES_SHINY_PAL(IVYSAUR_POKERAP, gMonShinyPalette_Ivysaur_POKERAP),
	SPECIES_SHINY_PAL(VENUSAUR_POKERAP, gMonShinyPalette_Venusaur_POKERAP),
	SPECIES_SHINY_PAL(CHARMANDER_POKERAP, gMonShinyPalette_Charmander_POKERAP),
	SPECIES_SHINY_PAL(CHARMELEON_POKERAP, gMonShinyPalette_Charmeleon_POKERAP),
	SPECIES_SHINY_PAL(CHARIZARD_POKERAP, gMonShinyPalette_Charizard_POKERAP),
	SPECIES_SHINY_PAL(SQUIRTLE_POKERAP, gMonShinyPalette_Squirtle_POKERAP),
	SPECIES_SHINY_PAL(WARTORTLE_POKERAP, gMonShinyPalette_Wartortle_POKERAP),
	SPECIES_SHINY_PAL(BLASTOISE_POKERAP, gMonShinyPalette_Blastoise_POKERAP),
	SPECIES_SHINY_PAL(CATERPIE_POKERAP, gMonShinyPalette_Caterpie_POKERAP),
	SPECIES_SHINY_PAL(METAPOD_POKERAP, gMonShinyPalette_Metapod_POKERAP),
	SPECIES_SHINY_PAL(BUTTERFREE_POKERAP, gMonShinyPalette_Butterfree_POKERAP),
	SPECIES_SHINY_PAL(WEEDLE_POKERAP, gMonShinyPalette_Weedle_POKERAP),
	SPECIES_SHINY_PAL(KAKUNA_POKERAP, gMonShinyPalette_Kakuna_POKERAP),
	SPECIES_SHINY_PAL(BEEDRILL_POKERAP, gMonShinyPalette_Beedrill_POKERAP),
	SPECIES_SHINY_PAL(PIDGEY_POKERAP, gMonShinyPalette_Pidgey_POKERAP),
	SPECIES_SHINY_PAL(PIDGEOTTO_POKERAP, gMonShinyPalette_Pidgeotto_POKERAP),
	SPECIES_SHINY_PAL(PIDGEOT_POKERAP, gMonShinyPalette_Pidgeot_POKERAP),
	SPECIES_SHINY_PAL(RATTATA_POKERAP, gMonShinyPalette_Rattata_POKERAP),
	SPECIES_SHINY_PAL(RATICATE_POKERAP, gMonShinyPalette_Raticate_POKERAP),
	SPECIES_SHINY_PAL(SPEAROW_POKERAP, gMonShinyPalette_Spearow_POKERAP),
	SPECIES_SHINY_PAL(FEAROW_POKERAP, gMonShinyPalette_Fearow_POKERAP),
	SPECIES_SHINY_PAL(EKANS_POKERAP, gMonShinyPalette_Ekans_POKERAP),
	SPECIES_SHINY_PAL(ARBOK_POKERAP, gMonShinyPalette_Arbok_POKERAP),
	SPECIES_SHINY_PAL(PIKACHU_POKERAP, gMonShinyPalette_Pikachu_POKERAP),
	SPECIES_SHINY_PAL(RAICHU_POKERAP, gMonShinyPalette_Raichu_POKERAP),
	SPECIES_SHINY_PAL(SANDSHREW_POKERAP, gMonShinyPalette_Sandshrew_POKERAP),
	SPECIES_SHINY_PAL(SANDSLASH_POKERAP, gMonShinyPalette_Sandslash_POKERAP),
	SPECIES_SHINY_PAL(NIDORINA_POKERAP, gMonShinyPalette_Nidorina_POKERAP),
	SPECIES_SHINY_PAL(NIDOQUEEN_POKERAP, gMonShinyPalette_Nidoqueen_POKERAP),
	SPECIES_SHINY_PAL(NIDORINO_POKERAP, gMonShinyPalette_Nidorino_POKERAP),
	SPECIES_SHINY_PAL(NIDOKING_POKERAP, gMonShinyPalette_Nidoking_POKERAP),
	SPECIES_SHINY_PAL(CLEFAIRY_POKERAP, gMonShinyPalette_Clefairy_POKERAP),
	SPECIES_SHINY_PAL(CLEFABLE_POKERAP, gMonShinyPalette_Clefable_POKERAP),
	SPECIES_SHINY_PAL(VULPIX_POKERAP, gMonShinyPalette_Vulpix_POKERAP),
	SPECIES_SHINY_PAL(NINETALES_POKERAP, gMonShinyPalette_Ninetales_POKERAP),
	SPECIES_SHINY_PAL(JIGGLYPUFF_POKERAP, gMonShinyPalette_Jigglypuff_POKERAP),
	SPECIES_SHINY_PAL(WIGGLYTUFF_POKERAP, gMonShinyPalette_Wigglytuff_POKERAP),
	SPECIES_SHINY_PAL(ZUBAT_POKERAP, gMonShinyPalette_Zubat_POKERAP),
	SPECIES_SHINY_PAL(GOLBAT_POKERAP, gMonShinyPalette_Golbat_POKERAP),
	SPECIES_SHINY_PAL(ODDISH_POKERAP, gMonShinyPalette_Oddish_POKERAP),
	SPECIES_SHINY_PAL(GLOOM_POKERAP, gMonShinyPalette_Gloom_POKERAP),
	SPECIES_SHINY_PAL(VILEPLUME_POKERAP, gMonShinyPalette_Vileplume_POKERAP),
	SPECIES_SHINY_PAL(PARAS_POKERAP, gMonShinyPalette_Paras_POKERAP),
	SPECIES_SHINY_PAL(PARASECT_POKERAP, gMonShinyPalette_Parasect_POKERAP),
	SPECIES_SHINY_PAL(VENONAT_POKERAP, gMonShinyPalette_Venonat_POKERAP),
	SPECIES_SHINY_PAL(VENOMOTH_POKERAP, gMonShinyPalette_Venomoth_POKERAP),
	SPECIES_SHINY_PAL(DIGLETT_POKERAP, gMonShinyPalette_Diglett_POKERAP),
	SPECIES_SHINY_PAL(DUGTRIO_POKERAP, gMonShinyPalette_Dugtrio_POKERAP),
	SPECIES_SHINY_PAL(MEOWTH_POKERAP, gMonShinyPalette_Meowth_POKERAP),
	SPECIES_SHINY_PAL(PERSIAN_POKERAP, gMonShinyPalette_Persian_POKERAP),
	SPECIES_SHINY_PAL(PSYDUCK_POKERAP, gMonShinyPalette_Psyduck_POKERAP),
	SPECIES_SHINY_PAL(GOLDUCK_POKERAP, gMonShinyPalette_Golduck_POKERAP),
	SPECIES_SHINY_PAL(MANKEY_POKERAP, gMonShinyPalette_Mankey_POKERAP),
	SPECIES_SHINY_PAL(PRIMEAPE_POKERAP, gMonShinyPalette_Primeape_POKERAP),
	SPECIES_SHINY_PAL(GROWLITHE_POKERAP, gMonShinyPalette_Growlithe_POKERAP),
	SPECIES_SHINY_PAL(ARCANINE_POKERAP, gMonShinyPalette_Arcanine_POKERAP),
	SPECIES_SHINY_PAL(POLIWAG_POKERAP, gMonShinyPalette_Poliwag_POKERAP),
	SPECIES_SHINY_PAL(POLIWHIRL_POKERAP, gMonShinyPalette_Poliwhirl_POKERAP),
	SPECIES_SHINY_PAL(POLIWRATH_POKERAP, gMonShinyPalette_Poliwrath_POKERAP),
	SPECIES_SHINY_PAL(ABRA_POKERAP, gMonShinyPalette_Abra_POKERAP),
	SPECIES_SHINY_PAL(KADABRA_POKERAP, gMonShinyPalette_Kadabra_POKERAP),
	SPECIES_SHINY_PAL(ALAKAZAM_POKERAP, gMonShinyPalette_Alakazam_POKERAP),
	SPECIES_SHINY_PAL(MACHOP_POKERAP, gMonShinyPalette_Machop_POKERAP),
	SPECIES_SHINY_PAL(MACHOKE_POKERAP, gMonShinyPalette_Machoke_POKERAP),
	SPECIES_SHINY_PAL(MACHAMP_POKERAP, gMonShinyPalette_Machamp_POKERAP),
	SPECIES_SHINY_PAL(BELLSPROUT_POKERAP, gMonShinyPalette_Bellsprout_POKERAP),
	SPECIES_SHINY_PAL(WEEPINBELL_POKERAP, gMonShinyPalette_Weepinbell_POKERAP),
	SPECIES_SHINY_PAL(VICTREEBEL_POKERAP, gMonShinyPalette_Victreebel_POKERAP),
	SPECIES_SHINY_PAL(TENTACOOL_POKERAP, gMonShinyPalette_Tentacool_POKERAP),
	SPECIES_SHINY_PAL(TENTACRUEL_POKERAP, gMonShinyPalette_Tentacruel_POKERAP),
	SPECIES_SHINY_PAL(GEODUDE_POKERAP, gMonShinyPalette_Geodude_POKERAP),
	SPECIES_SHINY_PAL(GRAVELER_POKERAP, gMonShinyPalette_Graveler_POKERAP),
	SPECIES_SHINY_PAL(GOLEM_POKERAP, gMonShinyPalette_Golem_POKERAP),
	SPECIES_SHINY_PAL(PONYTA_POKERAP, gMonShinyPalette_Ponyta_POKERAP),
	SPECIES_SHINY_PAL(RAPIDASH_POKERAP, gMonShinyPalette_Rapidash_POKERAP),
	SPECIES_SHINY_PAL(SLOWPOKE_POKERAP, gMonShinyPalette_Slowpoke_POKERAP),
	SPECIES_SHINY_PAL(SLOWBRO_POKERAP, gMonShinyPalette_Slowbro_POKERAP),
	SPECIES_SHINY_PAL(MAGNEMITE_POKERAP, gMonShinyPalette_Magnemite_POKERAP),
	SPECIES_SHINY_PAL(MAGNETON_POKERAP, gMonShinyPalette_Magneton_POKERAP),
	SPECIES_SHINY_PAL(FARFETCHD_POKERAP, gMonShinyPalette_Farfetchd_POKERAP),
	SPECIES_SHINY_PAL(DODUO_POKERAP, gMonShinyPalette_Doduo_POKERAP),
	SPECIES_SHINY_PAL(DODRIO_POKERAP, gMonShinyPalette_Dodrio_POKERAP),
	SPECIES_SHINY_PAL(SEEL_POKERAP, gMonShinyPalette_Seel_POKERAP),
	SPECIES_SHINY_PAL(DEWGONG_POKERAP, gMonShinyPalette_Dewgong_POKERAP),
	SPECIES_SHINY_PAL(GRIMER_POKERAP, gMonShinyPalette_Grimer_POKERAP),
	SPECIES_SHINY_PAL(MUK_POKERAP, gMonShinyPalette_Muk_POKERAP),
	SPECIES_SHINY_PAL(SHELLDER_POKERAP, gMonShinyPalette_Shellder_POKERAP),
	SPECIES_SHINY_PAL(CLOYSTER_POKERAP, gMonShinyPalette_Cloyster_POKERAP),
	SPECIES_SHINY_PAL(GASTLY_POKERAP, gMonShinyPalette_Gastly_POKERAP),
	SPECIES_SHINY_PAL(HAUNTER_POKERAP, gMonShinyPalette_Haunter_POKERAP),
	SPECIES_SHINY_PAL(GENGAR_POKERAP, gMonShinyPalette_Gengar_POKERAP),
	SPECIES_SHINY_PAL(ONIX_POKERAP, gMonShinyPalette_Onix_POKERAP),
	SPECIES_SHINY_PAL(DROWZEE_POKERAP, gMonShinyPalette_Drowzee_POKERAP),
	SPECIES_SHINY_PAL(HYPNO_POKERAP, gMonShinyPalette_Hypno_POKERAP),
	SPECIES_SHINY_PAL(KRABBY_POKERAP, gMonShinyPalette_Krabby_POKERAP),
	SPECIES_SHINY_PAL(KINGLER_POKERAP, gMonShinyPalette_Kingler_POKERAP),
	SPECIES_SHINY_PAL(VOLTORB_POKERAP, gMonShinyPalette_Voltorb_POKERAP),
	SPECIES_SHINY_PAL(ELECTRODE_POKERAP, gMonShinyPalette_Electrode_POKERAP),
	SPECIES_SHINY_PAL(EXEGGCUTE_POKERAP, gMonShinyPalette_Exeggcute_POKERAP),
	SPECIES_SHINY_PAL(EXEGGUTOR_POKERAP, gMonShinyPalette_Exeggutor_POKERAP),
	SPECIES_SHINY_PAL(CUBONE_POKERAP, gMonShinyPalette_Cubone_POKERAP),
	SPECIES_SHINY_PAL(MAROWAK_POKERAP, gMonShinyPalette_Marowak_POKERAP),
	SPECIES_SHINY_PAL(HITMONLEE_POKERAP, gMonShinyPalette_Hitmonlee_POKERAP),
	SPECIES_SHINY_PAL(HITMONCHAN_POKERAP, gMonShinyPalette_Hitmonchan_POKERAP),
	SPECIES_SHINY_PAL(LICKITUNG_POKERAP, gMonShinyPalette_Lickitung_POKERAP),
	SPECIES_SHINY_PAL(KOFFING_POKERAP, gMonShinyPalette_Koffing_POKERAP),
	SPECIES_SHINY_PAL(WEEZING_POKERAP, gMonShinyPalette_Weezing_POKERAP),
	SPECIES_SHINY_PAL(RHYHORN_POKERAP, gMonShinyPalette_Rhyhorn_POKERAP),
	SPECIES_SHINY_PAL(RHYDON_POKERAP, gMonShinyPalette_Rhydon_POKERAP),
	SPECIES_SHINY_PAL(CHANSEY_POKERAP, gMonShinyPalette_Chansey_POKERAP),
	SPECIES_SHINY_PAL(TANGELA_POKERAP, gMonShinyPalette_Tangela_POKERAP),
	SPECIES_SHINY_PAL(KANGASKHAN_POKERAP, gMonShinyPalette_Kangaskhan_POKERAP),
	SPECIES_SHINY_PAL(HORSEA_POKERAP, gMonShinyPalette_Horsea_POKERAP),
	SPECIES_SHINY_PAL(SEADRA_POKERAP, gMonShinyPalette_Seadra_POKERAP),
	SPECIES_SHINY_PAL(GOLDEEN_POKERAP, gMonShinyPalette_Goldeen_POKERAP),
	SPECIES_SHINY_PAL(SEAKING_POKERAP, gMonShinyPalette_Seaking_POKERAP),
	SPECIES_SHINY_PAL(STARYU_POKERAP, gMonShinyPalette_Staryu_POKERAP),
	SPECIES_SHINY_PAL(STARMIE_POKERAP, gMonShinyPalette_Starmie_POKERAP),
	SPECIES_SHINY_PAL(MRMIME_POKERAP, gMonShinyPalette_MrMime_POKERAP),
	SPECIES_SHINY_PAL(SCYTHER_POKERAP, gMonShinyPalette_Scyther_POKERAP),
	SPECIES_SHINY_PAL(JYNX_POKERAP, gMonShinyPalette_Jynx_POKERAP),
	SPECIES_SHINY_PAL(ELECTABUZZ_POKERAP, gMonShinyPalette_Electabuzz_POKERAP),
	SPECIES_SHINY_PAL(MAGMAR_POKERAP, gMonShinyPalette_Magmar_POKERAP),
	SPECIES_SHINY_PAL(PINSIR_POKERAP, gMonShinyPalette_Pinsir_POKERAP),
	SPECIES_SHINY_PAL(TAUROS_POKERAP, gMonShinyPalette_Tauros_POKERAP),
	SPECIES_SHINY_PAL(MAGIKARP_POKERAP, gMonShinyPalette_Magikarp_POKERAP),
	SPECIES_SHINY_PAL(GYARADOS_POKERAP, gMonShinyPalette_Gyarados_POKERAP),
	SPECIES_SHINY_PAL(LAPRAS_POKERAP, gMonShinyPalette_Lapras_POKERAP),
	SPECIES_SHINY_PAL(DITTO_POKERAP, gMonShinyPalette_Ditto_POKERAP),
	SPECIES_SHINY_PAL(EEVEE_POKERAP, gMonShinyPalette_Eevee_POKERAP),
	SPECIES_SHINY_PAL(VAPOREON_POKERAP, gMonShinyPalette_Vaporeon_POKERAP),
	SPECIES_SHINY_PAL(JOLTEON_POKERAP, gMonShinyPalette_Jolteon_POKERAP),
	SPECIES_SHINY_PAL(FLAREON_POKERAP, gMonShinyPalette_Flareon_POKERAP),
	SPECIES_SHINY_PAL(PORYGON_POKERAP, gMonShinyPalette_Porygon_POKERAP),
	SPECIES_SHINY_PAL(OMANYTE_POKERAP, gMonShinyPalette_Omanyte_POKERAP),
	SPECIES_SHINY_PAL(OMASTAR_POKERAP, gMonShinyPalette_Omastar_POKERAP),
	SPECIES_SHINY_PAL(KABUTO_POKERAP, gMonShinyPalette_Kabuto_POKERAP),
	SPECIES_SHINY_PAL(KABUTOPS_POKERAP, gMonShinyPalette_Kabutops_POKERAP),
	SPECIES_SHINY_PAL(AERODACTYL_POKERAP, gMonShinyPalette_Aerodactyl_POKERAP),
	SPECIES_SHINY_PAL(SNORLAX_POKERAP, gMonShinyPalette_Snorlax_POKERAP),
	SPECIES_SHINY_PAL(ARTICUNO_POKERAP, gMonShinyPalette_Articuno_POKERAP),
	SPECIES_SHINY_PAL(ZAPDOS_POKERAP, gMonShinyPalette_Zapdos_POKERAP),
	SPECIES_SHINY_PAL(MOLTRES_POKERAP, gMonShinyPalette_Moltres_POKERAP),
	SPECIES_SHINY_PAL(DRATINI_POKERAP, gMonShinyPalette_Dratini_POKERAP),
	SPECIES_SHINY_PAL(DRAGONAIR_POKERAP, gMonShinyPalette_Dragonair_POKERAP),
	SPECIES_SHINY_PAL(DRAGONITE_POKERAP, gMonShinyPalette_Dragonite_POKERAP),
	SPECIES_SHINY_PAL(MEWTWO_POKERAP, gMonShinyPalette_Mewtwo_POKERAP),



    	SPECIES_SHINY_PAL(REVENANT, gMonShinyPalette_REVENANT),
	SPECIES_SHINY_PAL(UNOWNS, gMonShinyPalette_UNOWNS),
	SPECIES_SHINY_PAL(UNOWNE, gMonShinyPalette_UNOWNE),
	SPECIES_SHINY_PAL(UNOWNN, gMonShinyPalette_UNOWNN),
	SPECIES_SHINY_PAL(UNOWND, gMonShinyPalette_UNOWND),
	SPECIES_SHINY_PAL(RELICANTHPAST, gMonShinyPalette_RELICANTHPAST),
	SPECIES_SHINY_PAL(RELICANTHFUTURE, gMonShinyPalette_RELICANTHFUTURE),
	SPECIES_SHINY_PAL(POKEMONRAP, gMonShinyPalette_POKEMONRAP),
	SPECIES_SHINY_PAL(NIDORANMPOKERAP, gMonShinyPalette_NIDORANMPOKERAP),
	SPECIES_SHINY_PAL(NIDORANFPOKERAP, gMonShinyPalette_NIDORANFPOKERAP),
	SPECIES_SHINY_PAL(THATSALL, gMonShinyPalette_THATSALL),
	SPECIES_SHINY_PAL(KANGASKHANTEACHER, gMonShinyPalette_KANGASKHANTEACHER),
	SPECIES_SHINY_PAL(TANGELACREEPY, gMonShinyPalette_TANGELACREEPY),
	SPECIES_SHINY_PAL(CHANSEYBLANK, gMonShinyPalette_CHANSEYBLANK),
	SPECIES_SHINY_PAL(IRONCLEFTGREEN, gMonShinyPalette_IRONCLEFTGREEN),
	SPECIES_SHINY_PAL(LATIASBLAZIKEN, gMonShinyPalette_LATIASBLAZIKEN),
	SPECIES_SHINY_PAL(MONICA, gMonShinyPalette_Monica),
	SPECIES_SHINY_PAL(IRONBUTT, gMonShinyPalette_IRONBUTT),
	SPECIES_SHINY_PAL(RELICRABBY, gMonShinyPalette_Relicrabby),
	SPECIES_SHINY_PAL(EGEXCSUTER, gMonShinyPalette_EGEXCSUTER),
	SPECIES_SHINY_PAL(GYARADOS_LANCE, gMonShinyPalette_GyaradosLance),
	SPECIES_SHINY_PAL(ALAKAZAMTCG, gMonShinyPalette_AlakazamTCG),
	SPECIES_SHINY_PAL(REGIEYES, gMonShinyPalette_REGIEYES),
	SPECIES_SHINY_PAL(REGIFILSAMIE, gMonShinyPalette_REGIFILSAMIE),
	SPECIES_SHINY_PAL(SOLACEON, gMonShinyPalette_SOLACEON),
	SPECIES_SHINY_PAL(PORYGON64, gMonShinyPalette_PORYGON64),
	SPECIES_SHINY_PAL(PORYGON32, gMonShinyPalette_PORYGON32),
	SPECIES_SHINY_PAL(STARMIEMEGA, gMonShinyPalette_STARMIEMEGA),
	SPECIES_SHINY_PAL(GIRAFARIGBOTTOM, gMonShinyPalette_GIRAFARIGBOTTOM),
	SPECIES_SHINY_PAL(GIRAFARIGBUTT, gMonShinyPalette_GIRAFARIGBUTT),
	SPECIES_SHINY_PAL(MEWTWOW, gMonShinyPalette_MEWTWOW),
	SPECIES_SHINY_PAL(CHARIZARDQ, gMonShinyPalette_CHARIZARDQ),
	SPECIES_SHINY_PAL(HOOT, gMonShinyPalette_HOOT),
	SPECIES_SHINY_PAL(ZAPMOLCUNO, gMonShinyPalette_ZAPMOLCUNO),
	SPECIES_SHINY_PAL(UNITEDKINGDOM, gMonShinyPalette_UNITEDKINGDOM),
	SPECIES_SHINY_PAL(FIRETYPES, gMonShinyPalette_FIRETYPES),
	SPECIES_SHINY_PAL(RATICATEGHOST, gMonShinyPalette_RATICATEGHOST),
	SPECIES_SHINY_PAL(FINALLUGIA, gMonShinyPalette_FINALLUGIA),
	SPECIES_SHINY_PAL(FINALARTICUNO, gMonShinyPalette_FINALARTICUNO),
	SPECIES_SHINY_PAL(FINALHOOH, gMonShinyPalette_FINALHOOH),
	SPECIES_SHINY_PAL(FINALZAPDOS, gMonShinyPalette_FINALZAPDOS),
	SPECIES_SHINY_PAL(FINALMOLTRES, gMonShinyPalette_FINALMOLTRES),
	SPECIES_SHINY_PAL(FINALWARTORTLE, gMonShinyPalette_FINALWARTORTLE),
	SPECIES_SHINY_PAL(DODODUO, gMonShinyPalette_DODODUO),
	SPECIES_SHINY_PAL(CELEBI2, gMonShinyPalette_CELEBI2),
	SPECIES_SHINY_PAL(PIKACHUSURF, gMonShinyPalette_PIKACHUSURF),
	SPECIES_SHINY_PAL(SHINYABRA, gMonShinyPalette_SHINYABRA),
	SPECIES_SHINY_PAL(EARRAT, gMonShinyPalette_EARRAT),
	SPECIES_SHINY_PAL(FINALCHARMANDER, gMonShinyPalette_Charmander),
	SPECIES_SHINY_PAL(CELIASSTUPIDROMHACK, gMonShinyPalette_CELIASSTUPIDROMHACK),
    SPECIES_SHINY_PAL(KECLEON_WIZ1989, gMonShinyPalette_Kecleon_wiz1989),

		SPECIES_SHINY_PAL(GREGORY, gMonShinyPalette_GREGORY),
	SPECIES_SHINY_PAL(ARCEUSLAST, gMonShinyPalette_ARCEUSLAST),
	SPECIES_SHINY_PAL(NOTHING, gMonShinyPalette_NOTHING),
	SPECIES_SHINY_PAL(DITTOBLIZ, gMonShinyPalette_DITTOBLIZ),
	SPECIES_SHINY_PAL(IRONMASK, gMonShinyPalette_IRONMASK),
	SPECIES_SHINY_PAL(ZOMBON, gMonShinyPalette_ZOMBON),
	SPECIES_SHINY_PAL(TINKANETTE, gMonShinyPalette_TINKANETTE),
	SPECIES_SHINY_PAL(RICKETOT, gMonShinyPalette_RICKETOT),
	SPECIES_SHINY_PAL(IMAKUNIDODUO, gMonShinyPalette_IMAKUNIDODUO),
	SPECIES_SHINY_PAL(ABSOLYNE, gMonShinyPalette_ABSOLYNE),
	SPECIES_SHINY_PAL(LICHENMASQUERAIN, gMonShinyPalette_LICHENMASQUERAIN),
	SPECIES_SHINY_PAL(LICHENMAWILE, gMonShinyPalette_LICHENMAWILE),
	SPECIES_SHINY_PAL(DMCACUTOUT, gMonShinyPalette_DMCACUTOUT),
