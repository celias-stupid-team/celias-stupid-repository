const u8 *const gMonFootprintTable[] =
{
	...
	[SPECIES_MIME_JR_]    = gMonFootprint_Mime_Jr_,
	...
	[SPECIES_JIGGLYPUFF_ABOVE]    = gMonFootprint_Jigglypuff_Above,
	[SPECIES_TENTAQUIL]    = gMonFootprint_Tentaquil,
	[SPECIES_MISSINGNO]    = gMonFootprint_Missingno,
	[SPECIES_KENYA]    = gMonFootprint_Kenya,
	[SPECIES_HITMONCHAN_SHIT]    = gMonFootprint_Hitmonchan_Shit,
	[SPECIES_HITMONCHIN]    = gMonFootprint_Hitmonchin,
	[SPECIES_TRUBBISH_HAIRCUT]    = gMonFootprint_Trubbish_Haircut,
	[SPECIES_AMPHAROS_MEGA]    = gMonFootprint_Ampharos_Mega,
	[SPECIES_YOSHI]    = gMonFootprint_Yoshi,
	[SPECIES_DITTO_MEW]    = gMonFootprint_Ditto_Mew,
	[SPECIES_UNOWN_LOSS]    = gMonFootprint_Unown_Loss,
	[SPECIES_MAGNALONE]    = gMonFootprint_Magnalone,
	[SPECIES_TYRANASTAR]    = gMonFootprint_Tyranastar,
	[SPECIES_POKEMON_GUN]    = gMonFootprint_Pokemon_Gun,
	[SPECIES_PLUG_OINK]    = gMonFootprint_Plug_Oink,
	[SPECIES_PIKABLU]    = gMonFootprint_Pikablu,
	[SPECIES_RATTATA_SHINY]    = gMonFootprint_Rattata_Shiny,
		[SPECIES_PIKACHU_BIRTHDAY]    = gMonFootprint_Pikachu_Birthday,
	[SPECIES_MEW_ANCIENT]    = gMonFootprint_Mew_Ancient,
	[SPECIES_PIKACHU_OLD]    = gMonFootprint_Pikachu_Old,
	[SPECIES_GENESECT_SHINY]    = gMonFootprint_Genesect_Shiny,
	[SPECIES_IRON_CLEFT]    = gMonFootprint_Iron_Cleft,
	[SPECIES_VULPIX_ALOLA]    = gMonFootprint_Vulpix_Alola,
	[SPECIES_WEEZING_ALOLA]    = gMonFootprint_Weezing_Alola,
	[SPECIES_THIS_GUY]    = gMonFootprint_This_Guy,
	[SPECIES_STEAMBOAT_WILLIE]    = gMonFootprint_Steamboat_Willie,
	[SPECIES_PIDGEOT_OLD]    = gMonFootprint_Pidgeot_Old,
	[SPECIES_STRYKE]    = gMonFootprint_Stryke,
	[SPECIES_BUTTERFREE_FEMALE]    = gMonFootprint_Butterfree_Female,
	[SPECIES_PIKACHU_FAT_GAY]    = gMonFootprint_Pikachu_Fat_Gay,
	[SPECIES_TRAPINCH_PIKACHU]    = gMonFootprint_Trapinch_Pikachu,
	[SPECIES_KECLEON_SANS]    = gMonFootprint_Kecleon_Sans,
	//[SPECIES_RATTATA_SHINY]    = gMonFootprint_Rattata_Shiny,
	[SPECIES_PORYGON_16]    = gMonFootprint_Porygon_16,
	[SPECIES_PORYGON_8]    = gMonFootprint_Porygon_8,
	[SPECIES_PORYGON_4]    = gMonFootprint_Porygon_4,
	[SPECIES_PORIST_GAMES]    = gMonFootprint_Porist_Games,
	[SPECIES_MISCARRIAGE_KANGA]    = gMonFootprint_Miscarriage_Kanga,
	[SPECIES_GHOST]    = gMonFootprint_Ghost,
	[SPECIES_VENOMOTH_ATV]    = gMonFootprint_Venomoth_ATV,
	[SPECIES_RATICATE_ALOLA]    = gMonFootprint_Raticate_Alola,
	[SPECIES_MULTIPAL]    = gMonFootprint_Multipal,
	[SPECIES_DIVIDUM]    = gMonFootprint_Dividum,
	[SPECIES_EXPONELLE]    = gMonFootprint_Exponelle,
	[SPECIES_PIKACHU_SNAP_SURF]    = gMonFootprint_Pikachu_Snap_Surf,
	[SPECIES_PIKACHU_SNAP_BALL]    = gMonFootprint_Pikachu_Snap_Ball,
	[SPECIES_PIKACHU_SNAP_FLYING]    = gMonFootprint_Pikachu_Snap_Flying,
	[SPECIES_PIKACHU_SNAP_CLOSE]    = gMonFootprint_Pikachu_Snap_Close,
	[SPECIES_RATICATE_DEAD]    = gMonFootprint_Raticate_Dead,
	[SPECIES_SHEDINJA_ELECTRIC]    = gMonFootprint_Shedinja_Electric,
	[SPECIES_VENUSAUR_MEGA]    = gMonFootprint_Digimon,
	[SPECIES_UNOWN_NUDES]    = gMonFootprint_Unown_Nudes,
	[SPECIES_PORYGON22]    = gMonFootprint_Porygon22,
	[SPECIES_HO_OWO]    = gMonFootprint_Ho_OwO,
	[SPECIES_RATATATTA]    = gMonFootprint_Ratatatta,
	[SPECIES_BULBASAUR_POKERAP]    = gMonFootprint_Bulbasaur_POKERAP,
	[SPECIES_IVYSAUR_POKERAP]    = gMonFootprint_Ivysaur_POKERAP,
	[SPECIES_VENUSAUR_POKERAP]    = gMonFootprint_Venusaur_POKERAP,
	[SPECIES_CHARMANDER_POKERAP]    = gMonFootprint_Charmander_POKERAP,
	[SPECIES_CHARMELEON_POKERAP]    = gMonFootprint_Charmeleon_POKERAP,
	[SPECIES_CHARIZARD_POKERAP]    = gMonFootprint_Charizard_POKERAP,
	[SPECIES_SQUIRTLE_POKERAP]    = gMonFootprint_Squirtle_POKERAP,
	[SPECIES_WARTORTLE_POKERAP]    = gMonFootprint_Wartortle_POKERAP,
	[SPECIES_BLASTOISE_POKERAP]    = gMonFootprint_Blastoise_POKERAP,
	[SPECIES_CATERPIE_POKERAP]    = gMonFootprint_Caterpie_POKERAP,
	[SPECIES_METAPOD_POKERAP]    = gMonFootprint_Metapod_POKERAP,
	[SPECIES_BUTTERFREE_POKERAP]    = gMonFootprint_Butterfree_POKERAP,
	[SPECIES_WEEDLE_POKERAP]    = gMonFootprint_Weedle_POKERAP,
	[SPECIES_KAKUNA_POKERAP]    = gMonFootprint_Kakuna_POKERAP,
	[SPECIES_BEEDRILL_POKERAP]    = gMonFootprint_Beedrill_POKERAP,
	[SPECIES_PIDGEY_POKERAP]    = gMonFootprint_Pidgey_POKERAP,
	[SPECIES_PIDGEOTTO_POKERAP]    = gMonFootprint_Pidgeotto_POKERAP,
	[SPECIES_PIDGEOT_POKERAP]    = gMonFootprint_Pidgeot_POKERAP,
	[SPECIES_RATTATA_POKERAP]    = gMonFootprint_Rattata_POKERAP,
	[SPECIES_RATICATE_POKERAP]    = gMonFootprint_Raticate_POKERAP,
	[SPECIES_SPEAROW_POKERAP]    = gMonFootprint_Spearow_POKERAP,
	[SPECIES_FEAROW_POKERAP]    = gMonFootprint_Fearow_POKERAP,
	[SPECIES_EKANS_POKERAP]    = gMonFootprint_Ekans_POKERAP,
	[SPECIES_ARBOK_POKERAP]    = gMonFootprint_Arbok_POKERAP,
	[SPECIES_PIKACHU_POKERAP]    = gMonFootprint_Pikachu_POKERAP,
	[SPECIES_RAICHU_POKERAP]    = gMonFootprint_Raichu_POKERAP,
	[SPECIES_SANDSHREW_POKERAP]    = gMonFootprint_Sandshrew_POKERAP,
	[SPECIES_SANDSLASH_POKERAP]    = gMonFootprint_Sandslash_POKERAP,
	[SPECIES_NIDORINA_POKERAP]    = gMonFootprint_Nidorina_POKERAP,
	[SPECIES_NIDOQUEEN_POKERAP]    = gMonFootprint_Nidoqueen_POKERAP,
	[SPECIES_NIDORINO_POKERAP]    = gMonFootprint_Nidorino_POKERAP,
	[SPECIES_NIDOKING_POKERAP]    = gMonFootprint_Nidoking_POKERAP,
	[SPECIES_CLEFAIRY_POKERAP]    = gMonFootprint_Clefairy_POKERAP,
	[SPECIES_CLEFABLE_POKERAP]    = gMonFootprint_Clefable_POKERAP,
	[SPECIES_VULPIX_POKERAP]    = gMonFootprint_Vulpix_POKERAP,
	[SPECIES_NINETALES_POKERAP]    = gMonFootprint_Ninetales_POKERAP,
	[SPECIES_JIGGLYPUFF_POKERAP]    = gMonFootprint_Jigglypuff_POKERAP,
	[SPECIES_WIGGLYTUFF_POKERAP]    = gMonFootprint_Wigglytuff_POKERAP,
	[SPECIES_ZUBAT_POKERAP]    = gMonFootprint_Zubat_POKERAP,
	[SPECIES_GOLBAT_POKERAP]    = gMonFootprint_Golbat_POKERAP,
	[SPECIES_ODDISH_POKERAP]    = gMonFootprint_Oddish_POKERAP,
	[SPECIES_GLOOM_POKERAP]    = gMonFootprint_Gloom_POKERAP,
	[SPECIES_VILEPLUME_POKERAP]    = gMonFootprint_Vileplume_POKERAP,
	[SPECIES_PARAS_POKERAP]    = gMonFootprint_Paras_POKERAP,
	[SPECIES_PARASECT_POKERAP]    = gMonFootprint_Parasect_POKERAP,
	[SPECIES_VENONAT_POKERAP]    = gMonFootprint_Venonat_POKERAP,
	[SPECIES_VENOMOTH_POKERAP]    = gMonFootprint_Venomoth_POKERAP,
	[SPECIES_DIGLETT_POKERAP]    = gMonFootprint_Diglett_POKERAP,
	[SPECIES_DUGTRIO_POKERAP]    = gMonFootprint_Dugtrio_POKERAP,
	[SPECIES_MEOWTH_POKERAP]    = gMonFootprint_Meowth_POKERAP,
	[SPECIES_PERSIAN_POKERAP]    = gMonFootprint_Persian_POKERAP,
	[SPECIES_PSYDUCK_POKERAP]    = gMonFootprint_Psyduck_POKERAP,
	[SPECIES_GOLDUCK_POKERAP]    = gMonFootprint_Golduck_POKERAP,
	[SPECIES_MANKEY_POKERAP]    = gMonFootprint_Mankey_POKERAP,
	[SPECIES_PRIMEAPE_POKERAP]    = gMonFootprint_Primeape_POKERAP,
	[SPECIES_GROWLITHE_POKERAP]    = gMonFootprint_Growlithe_POKERAP,
	[SPECIES_ARCANINE_POKERAP]    = gMonFootprint_Arcanine_POKERAP,
	[SPECIES_POLIWAG_POKERAP]    = gMonFootprint_Poliwag_POKERAP,
	[SPECIES_POLIWHIRL_POKERAP]    = gMonFootprint_Poliwhirl_POKERAP,
	[SPECIES_POLIWRATH_POKERAP]    = gMonFootprint_Poliwrath_POKERAP,
	[SPECIES_ABRA_POKERAP]    = gMonFootprint_Abra_POKERAP,
	[SPECIES_KADABRA_POKERAP]    = gMonFootprint_Kadabra_POKERAP,
	[SPECIES_ALAKAZAM_POKERAP]    = gMonFootprint_Alakazam_POKERAP,
	[SPECIES_MACHOP_POKERAP]    = gMonFootprint_Machop_POKERAP,
	[SPECIES_MACHOKE_POKERAP]    = gMonFootprint_Machoke_POKERAP,
	[SPECIES_MACHAMP_POKERAP]    = gMonFootprint_Machamp_POKERAP,
	[SPECIES_BELLSPROUT_POKERAP]    = gMonFootprint_Bellsprout_POKERAP,
	[SPECIES_WEEPINBELL_POKERAP]    = gMonFootprint_Weepinbell_POKERAP,
	[SPECIES_VICTREEBEL_POKERAP]    = gMonFootprint_Victreebel_POKERAP,
	[SPECIES_TENTACOOL_POKERAP]    = gMonFootprint_Tentacool_POKERAP,
	[SPECIES_TENTACRUEL_POKERAP]    = gMonFootprint_Tentacruel_POKERAP,
	[SPECIES_GEODUDE_POKERAP]    = gMonFootprint_Geodude_POKERAP,
	[SPECIES_GRAVELER_POKERAP]    = gMonFootprint_Graveler_POKERAP,
	[SPECIES_GOLEM_POKERAP]    = gMonFootprint_Golem_POKERAP,
	[SPECIES_PONYTA_POKERAP]    = gMonFootprint_Ponyta_POKERAP,
	[SPECIES_RAPIDASH_POKERAP]    = gMonFootprint_Rapidash_POKERAP,
	[SPECIES_SLOWPOKE_POKERAP]    = gMonFootprint_Slowpoke_POKERAP,
	[SPECIES_SLOWBRO_POKERAP]    = gMonFootprint_Slowbro_POKERAP,
	[SPECIES_MAGNEMITE_POKERAP]    = gMonFootprint_Magnemite_POKERAP,
	[SPECIES_MAGNETON_POKERAP]    = gMonFootprint_Magneton_POKERAP,
	[SPECIES_FARFETCHD_POKERAP]    = gMonFootprint_Farfetchd_POKERAP,
	[SPECIES_DODUO_POKERAP]    = gMonFootprint_Doduo_POKERAP,
	[SPECIES_DODRIO_POKERAP]    = gMonFootprint_Dodrio_POKERAP,
	[SPECIES_SEEL_POKERAP]    = gMonFootprint_Seel_POKERAP,
	[SPECIES_DEWGONG_POKERAP]    = gMonFootprint_Dewgong_POKERAP,
	[SPECIES_GRIMER_POKERAP]    = gMonFootprint_Grimer_POKERAP,
	[SPECIES_MUK_POKERAP]    = gMonFootprint_Muk_POKERAP,
	[SPECIES_SHELLDER_POKERAP]    = gMonFootprint_Shellder_POKERAP,
	[SPECIES_CLOYSTER_POKERAP]    = gMonFootprint_Cloyster_POKERAP,
	[SPECIES_GASTLY_POKERAP]    = gMonFootprint_Gastly_POKERAP,
	[SPECIES_HAUNTER_POKERAP]    = gMonFootprint_Haunter_POKERAP,
	[SPECIES_GENGAR_POKERAP]    = gMonFootprint_Gengar_POKERAP,
	[SPECIES_ONIX_POKERAP]    = gMonFootprint_Onix_POKERAP,
	[SPECIES_DROWZEE_POKERAP]    = gMonFootprint_Drowzee_POKERAP,
	[SPECIES_HYPNO_POKERAP]    = gMonFootprint_Hypno_POKERAP,
	[SPECIES_KRABBY_POKERAP]    = gMonFootprint_Krabby_POKERAP,
	[SPECIES_KINGLER_POKERAP]    = gMonFootprint_Kingler_POKERAP,
	[SPECIES_VOLTORB_POKERAP]    = gMonFootprint_Voltorb_POKERAP,
	[SPECIES_ELECTRODE_POKERAP]    = gMonFootprint_Electrode_POKERAP,
	[SPECIES_EXEGGCUTE_POKERAP]    = gMonFootprint_Exeggcute_POKERAP,
	[SPECIES_EXEGGUTOR_POKERAP]    = gMonFootprint_Exeggutor_POKERAP,
	[SPECIES_CUBONE_POKERAP]    = gMonFootprint_Cubone_POKERAP,
	[SPECIES_MAROWAK_POKERAP]    = gMonFootprint_Marowak_POKERAP,
	[SPECIES_HITMONLEE_POKERAP]    = gMonFootprint_Hitmonlee_POKERAP,
	[SPECIES_HITMONCHAN_POKERAP]    = gMonFootprint_Hitmonchan_POKERAP,
	[SPECIES_LICKITUNG_POKERAP]    = gMonFootprint_Lickitung_POKERAP,
	[SPECIES_KOFFING_POKERAP]    = gMonFootprint_Koffing_POKERAP,
	[SPECIES_WEEZING_POKERAP]    = gMonFootprint_Weezing_POKERAP,
	[SPECIES_RHYHORN_POKERAP]    = gMonFootprint_Rhyhorn_POKERAP,
	[SPECIES_RHYDON_POKERAP]    = gMonFootprint_Rhydon_POKERAP,
	[SPECIES_CHANSEY_POKERAP]    = gMonFootprint_Chansey_POKERAP,
	[SPECIES_TANGELA_POKERAP]    = gMonFootprint_Tangela_POKERAP,
	[SPECIES_KANGASKHAN_POKERAP]    = gMonFootprint_Kangaskhan_POKERAP,
	[SPECIES_HORSEA_POKERAP]    = gMonFootprint_Horsea_POKERAP,
	[SPECIES_SEADRA_POKERAP]    = gMonFootprint_Seadra_POKERAP,
	[SPECIES_GOLDEEN_POKERAP]    = gMonFootprint_Goldeen_POKERAP,
	[SPECIES_SEAKING_POKERAP]    = gMonFootprint_Seaking_POKERAP,
	[SPECIES_STARYU_POKERAP]    = gMonFootprint_Staryu_POKERAP,
	[SPECIES_STARMIE_POKERAP]    = gMonFootprint_Starmie_POKERAP,
	[SPECIES_MRMIME_POKERAP]    = gMonFootprint_MrMime_POKERAP,
	[SPECIES_SCYTHER_POKERAP]    = gMonFootprint_Scyther_POKERAP,
	[SPECIES_JYNX_POKERAP]    = gMonFootprint_Jynx_POKERAP,
	[SPECIES_ELECTABUZZ_POKERAP]    = gMonFootprint_Electabuzz_POKERAP,
	[SPECIES_MAGMAR_POKERAP]    = gMonFootprint_Magmar_POKERAP,
	[SPECIES_PINSIR_POKERAP]    = gMonFootprint_Pinsir_POKERAP,
	[SPECIES_TAUROS_POKERAP]    = gMonFootprint_Tauros_POKERAP,
	[SPECIES_MAGIKARP_POKERAP]    = gMonFootprint_Magikarp_POKERAP,
	[SPECIES_GYARADOS_POKERAP]    = gMonFootprint_Gyarados_POKERAP,
	[SPECIES_LAPRAS_POKERAP]    = gMonFootprint_Lapras_POKERAP,
	[SPECIES_DITTO_POKERAP]    = gMonFootprint_Ditto_POKERAP,
	[SPECIES_EEVEE_POKERAP]    = gMonFootprint_Eevee_POKERAP,
	[SPECIES_VAPOREON_POKERAP]    = gMonFootprint_Vaporeon_POKERAP,
	[SPECIES_JOLTEON_POKERAP]    = gMonFootprint_Jolteon_POKERAP,
	[SPECIES_FLAREON_POKERAP]    = gMonFootprint_Flareon_POKERAP,
	[SPECIES_PORYGON_POKERAP]    = gMonFootprint_Porygon_POKERAP,
	[SPECIES_OMANYTE_POKERAP]    = gMonFootprint_Omanyte_POKERAP,
	[SPECIES_OMASTAR_POKERAP]    = gMonFootprint_Omastar_POKERAP,
	[SPECIES_KABUTO_POKERAP]    = gMonFootprint_Kabuto_POKERAP,
	[SPECIES_KABUTOPS_POKERAP]    = gMonFootprint_Kabutops_POKERAP,
	[SPECIES_AERODACTYL_POKERAP]    = gMonFootprint_Aerodactyl_POKERAP,
	[SPECIES_SNORLAX_POKERAP]    = gMonFootprint_Snorlax_POKERAP,
	[SPECIES_ARTICUNO_POKERAP]    = gMonFootprint_Articuno_POKERAP,
	[SPECIES_ZAPDOS_POKERAP]    = gMonFootprint_Zapdos_POKERAP,
	[SPECIES_MOLTRES_POKERAP]    = gMonFootprint_Moltres_POKERAP,
	[SPECIES_DRATINI_POKERAP]    = gMonFootprint_Dratini_POKERAP,
	[SPECIES_DRAGONAIR_POKERAP]    = gMonFootprint_Dragonair_POKERAP,
	[SPECIES_DRAGONITE_POKERAP]    = gMonFootprint_Dragonite_POKERAP,
	[SPECIES_MEWTWO_POKERAP]    = gMonFootprint_Mewtwo_POKERAP,



    [SPECIES_EGG] = gMonFootprint_Bulbasaur,
	[SPECIES_REVENANT]    = gMonFootprint_REVENANT,
	[SPECIES_UNOWNS]    = gMonFootprint_UNOWNS,
	[SPECIES_UNOWNE]    = gMonFootprint_UNOWNE,
	[SPECIES_UNOWNN]    = gMonFootprint_UNOWNN,
	[SPECIES_UNOWND]    = gMonFootprint_UNOWND,
	[SPECIES_RELICANTHPAST]    = gMonFootprint_RELICANTHPAST,
	[SPECIES_RELICANTHFUTURE]    = gMonFootprint_RELICANTHFUTURE,
	[SPECIES_POKEMONRAP]    = gMonFootprint_POKEMONRAP,
	[SPECIES_NIDORANMPOKERAP]    = gMonFootprint_NIDORANMPOKERAP,
	[SPECIES_NIDORANFPOKERAP]    = gMonFootprint_NIDORANFPOKERAP,
	[SPECIES_THATSALL]    = gMonFootprint_THATSALL,
	[SPECIES_KANGASKHANTEACHER]    = gMonFootprint_KANGASKHANTEACHER,
	[SPECIES_TANGELACREEPY]    = gMonFootprint_TANGELACREEPY,
	...
	[SPECIES_STARMIEMEGA]    = gMonFootprint_STARMIEMEGA,
	[SPECIES_GIRAFARIGBOTTOM]    = gMonFootprint_GIRAFARIGBOTTOM,
	...
	[SPECIES_FINALLUGIA]    = gMonFootprint_FINALLUGIA,
	[SPECIES_FINALARTICUNO]    = gMonFootprint_FINALARTICUNO,
	[SPECIES_FINALHOOH]    = gMonFootprint_FINALHOOH,
	[SPECIES_FINALZAPDOS]    = gMonFootprint_FINALZAPDOS,
