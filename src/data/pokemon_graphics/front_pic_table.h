const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
	...
	SPECIES_SPRITE(MIME_JR_, gMonFrontPic_Mime_Jr_),
	...
	SPECIES_SPRITE(JIGGLYPUFF_ABOVE, gMonFrontPic_Jigglypuff_Above),
	SPECIES_SPRITE(TENTAQUIL, gMonFrontPic_Tentaquil),
	SPECIES_SPRITE(MISSINGNO, gMonFrontPic_Missingno),
	SPECIES_SPRITE(KENYA, gMonFrontPic_Kenya),
	SPECIES_SPRITE(HITMONCHAN_SHIT, gMonFrontPic_Hitmonchan_Shit),
	SPECIES_SPRITE(HITMONCHIN, gMonFrontPic_Hitmonchin),
	SPECIES_SPRITE(TRUBBISH_HAIRCUT, gMonFrontPic_Trubbish_Haircut),
	SPECIES_SPRITE(AMPHAROS_MEGA, gMonFrontPic_Ampharos_Mega),
	SPECIES_SPRITE(YOSHI, gMonFrontPic_Yoshi),
	SPECIES_SPRITE(DITTO_MEW, gMonFrontPic_Ditto_Mew),
	SPECIES_SPRITE(UNOWN_LOSS, gMonFrontPic_Unown_Loss),
	SPECIES_SPRITE(MAGNALONE, gMonFrontPic_Magnalone),
	SPECIES_SPRITE(TYRANASTAR, gMonFrontPic_Tyranastar),
	SPECIES_SPRITE(POKEMON_GUN, gMonFrontPic_Pokemon_Gun),
	SPECIES_SPRITE(PLUG_OINK, gMonFrontPic_Plug_Oink),
	SPECIES_SPRITE(PIKABLU, gMonFrontPic_Pikablu),
	SPECIES_SPRITE(RATTATA_SHINY, gMonFrontPic_Rattata_Shiny),
		SPECIES_SPRITE(PIKACHU_BIRTHDAY, gMonFrontPic_Pikachu_Birthday),
	SPECIES_SPRITE(MEW_ANCIENT, gMonFrontPic_Mew_Ancient),
	SPECIES_SPRITE(PIKACHU_OLD, gMonFrontPic_Pikachu_Old),
	SPECIES_SPRITE(GENESECT_SHINY, gMonFrontPic_Genesect_Shiny),
	SPECIES_SPRITE(IRON_CLEFT, gMonFrontPic_Iron_Cleft),
	SPECIES_SPRITE(VULPIX_ALOLA, gMonFrontPic_Vulpix_Alola),
	SPECIES_SPRITE(WEEZING_ALOLA, gMonFrontPic_Weezing_Alola),
	SPECIES_SPRITE(THIS_GUY, gMonFrontPic_This_Guy),
	SPECIES_SPRITE(STEAMBOAT_WILLIE, gMonFrontPic_Steamboat_Willie),
	SPECIES_SPRITE(PIDGEOT_OLD, gMonFrontPic_Pidgeot_Old),
	SPECIES_SPRITE(STRYKE, gMonFrontPic_Stryke),
	SPECIES_SPRITE(BUTTERFREE_FEMALE, gMonFrontPic_Butterfree_Female),
	SPECIES_SPRITE(PIKACHU_FAT_GAY, gMonFrontPic_Pikachu_Fat_Gay),
	SPECIES_SPRITE(TRAPINCH_PIKACHU, gMonFrontPic_Trapinch_Pikachu),
	SPECIES_SPRITE(KECLEON_SANS, gMonFrontPic_Kecleon_Sans),
	//SPECIES_SPRITE(RATTATA_SHINY, gMonFrontPic_Rattata_Shiny),
	SPECIES_SPRITE(PORYGON_16, gMonFrontPic_Porygon_16),
	SPECIES_SPRITE(PORYGON_8, gMonFrontPic_Porygon_8),
	SPECIES_SPRITE(PORYGON_4, gMonFrontPic_Porygon_4),
	SPECIES_SPRITE(PORIST_GAMES, gMonFrontPic_Porist_Games),
	SPECIES_SPRITE(MISCARRIAGE_KANGA, gMonFrontPic_Miscarriage_Kanga),
	SPECIES_SPRITE(GHOST, gMonFrontPic_Ghost),
	SPECIES_SPRITE(VENOMOTH_ATV, gMonFrontPic_Venomoth_ATV),
	SPECIES_SPRITE(RATICATE_ALOLA, gMonFrontPic_Raticate_Alola),
	SPECIES_SPRITE(MULTIPAL, gMonFrontPic_Multipal),
	SPECIES_SPRITE(DIVIDUM, gMonFrontPic_Dividum),
	SPECIES_SPRITE(EXPONELLE, gMonFrontPic_Exponelle),
	SPECIES_SPRITE(PIKACHU_SNAP_SURF, gMonFrontPic_Pikachu_Snap_Surf),
	SPECIES_SPRITE(PIKACHU_SNAP_BALL, gMonFrontPic_Pikachu_Snap_Ball),
	SPECIES_SPRITE(PIKACHU_SNAP_FLYING, gMonFrontPic_Pikachu_Snap_Flying),
	SPECIES_SPRITE(PIKACHU_SNAP_CLOSE, gMonFrontPic_Pikachu_Snap_Close),
	SPECIES_SPRITE(RATICATE_DEAD, gMonFrontPic_Raticate_Dead),
	SPECIES_SPRITE(SHEDINJA_ELECTRIC, gMonFrontPic_Shedinja_Electric),
	SPECIES_SPRITE(VENUSAUR_MEGA, gMonFrontPic_Digimon),
	SPECIES_SPRITE(UNOWN_NUDES, gMonFrontPic_Unown_Nudes),
	SPECIES_SPRITE(PORYGON22, gMonFrontPic_Porygon22),
	SPECIES_SPRITE(HO_OWO, gMonFrontPic_Ho_OwO),
	SPECIES_SPRITE(RATATATTA, gMonFrontPic_Ratatatta),
	SPECIES_SPRITE(BULBASAUR_POKERAP, gMonFrontPic_Bulbasaur_POKERAP),
	SPECIES_SPRITE(IVYSAUR_POKERAP, gMonFrontPic_Ivysaur_POKERAP),
	SPECIES_SPRITE(VENUSAUR_POKERAP, gMonFrontPic_Venusaur_POKERAP),
	SPECIES_SPRITE(CHARMANDER_POKERAP, gMonFrontPic_Charmander_POKERAP),
	SPECIES_SPRITE(CHARMELEON_POKERAP, gMonFrontPic_Charmeleon_POKERAP),
	SPECIES_SPRITE(CHARIZARD_POKERAP, gMonFrontPic_Charizard_POKERAP),
	SPECIES_SPRITE(SQUIRTLE_POKERAP, gMonFrontPic_Squirtle_POKERAP),
	SPECIES_SPRITE(WARTORTLE_POKERAP, gMonFrontPic_Wartortle_POKERAP),
	SPECIES_SPRITE(BLASTOISE_POKERAP, gMonFrontPic_Blastoise_POKERAP),
	SPECIES_SPRITE(CATERPIE_POKERAP, gMonFrontPic_Caterpie_POKERAP),
	SPECIES_SPRITE(METAPOD_POKERAP, gMonFrontPic_Metapod_POKERAP),
	SPECIES_SPRITE(BUTTERFREE_POKERAP, gMonFrontPic_Butterfree_POKERAP),
	SPECIES_SPRITE(WEEDLE_POKERAP, gMonFrontPic_Weedle_POKERAP),
	SPECIES_SPRITE(KAKUNA_POKERAP, gMonFrontPic_Kakuna_POKERAP),
	SPECIES_SPRITE(BEEDRILL_POKERAP, gMonFrontPic_Beedrill_POKERAP),
	SPECIES_SPRITE(PIDGEY_POKERAP, gMonFrontPic_Pidgey_POKERAP),
	SPECIES_SPRITE(PIDGEOTTO_POKERAP, gMonFrontPic_Pidgeotto_POKERAP),
	SPECIES_SPRITE(PIDGEOT_POKERAP, gMonFrontPic_Pidgeot_POKERAP),
	SPECIES_SPRITE(RATTATA_POKERAP, gMonFrontPic_Rattata_POKERAP),
	SPECIES_SPRITE(RATICATE_POKERAP, gMonFrontPic_Raticate_POKERAP),
	SPECIES_SPRITE(SPEAROW_POKERAP, gMonFrontPic_Spearow_POKERAP),
	SPECIES_SPRITE(FEAROW_POKERAP, gMonFrontPic_Fearow_POKERAP),
	SPECIES_SPRITE(EKANS_POKERAP, gMonFrontPic_Ekans_POKERAP),
	SPECIES_SPRITE(ARBOK_POKERAP, gMonFrontPic_Arbok_POKERAP),
	SPECIES_SPRITE(PIKACHU_POKERAP, gMonFrontPic_Pikachu_POKERAP),
	SPECIES_SPRITE(RAICHU_POKERAP, gMonFrontPic_Raichu_POKERAP),
	SPECIES_SPRITE(SANDSHREW_POKERAP, gMonFrontPic_Sandshrew_POKERAP),
	SPECIES_SPRITE(SANDSLASH_POKERAP, gMonFrontPic_Sandslash_POKERAP),
	SPECIES_SPRITE(NIDORINA_POKERAP, gMonFrontPic_Nidorina_POKERAP),
	SPECIES_SPRITE(NIDOQUEEN_POKERAP, gMonFrontPic_Nidoqueen_POKERAP),
	SPECIES_SPRITE(NIDORINO_POKERAP, gMonFrontPic_Nidorino_POKERAP),
	SPECIES_SPRITE(NIDOKING_POKERAP, gMonFrontPic_Nidoking_POKERAP),
	SPECIES_SPRITE(CLEFAIRY_POKERAP, gMonFrontPic_Clefairy_POKERAP),
	SPECIES_SPRITE(CLEFABLE_POKERAP, gMonFrontPic_Clefable_POKERAP),
	SPECIES_SPRITE(VULPIX_POKERAP, gMonFrontPic_Vulpix_POKERAP),
	SPECIES_SPRITE(NINETALES_POKERAP, gMonFrontPic_Ninetales_POKERAP),
	SPECIES_SPRITE(JIGGLYPUFF_POKERAP, gMonFrontPic_Jigglypuff_POKERAP),
	SPECIES_SPRITE(WIGGLYTUFF_POKERAP, gMonFrontPic_Wigglytuff_POKERAP),
	SPECIES_SPRITE(ZUBAT_POKERAP, gMonFrontPic_Zubat_POKERAP),
	SPECIES_SPRITE(GOLBAT_POKERAP, gMonFrontPic_Golbat_POKERAP),
	SPECIES_SPRITE(ODDISH_POKERAP, gMonFrontPic_Oddish_POKERAP),
	SPECIES_SPRITE(GLOOM_POKERAP, gMonFrontPic_Gloom_POKERAP),
	SPECIES_SPRITE(VILEPLUME_POKERAP, gMonFrontPic_Vileplume_POKERAP),
	SPECIES_SPRITE(PARAS_POKERAP, gMonFrontPic_Paras_POKERAP),
	SPECIES_SPRITE(PARASECT_POKERAP, gMonFrontPic_Parasect_POKERAP),
	SPECIES_SPRITE(VENONAT_POKERAP, gMonFrontPic_Venonat_POKERAP),
	SPECIES_SPRITE(VENOMOTH_POKERAP, gMonFrontPic_Venomoth_POKERAP),
	SPECIES_SPRITE(DIGLETT_POKERAP, gMonFrontPic_Diglett_POKERAP),
	SPECIES_SPRITE(DUGTRIO_POKERAP, gMonFrontPic_Dugtrio_POKERAP),
	SPECIES_SPRITE(MEOWTH_POKERAP, gMonFrontPic_Meowth_POKERAP),
	SPECIES_SPRITE(PERSIAN_POKERAP, gMonFrontPic_Persian_POKERAP),
	SPECIES_SPRITE(PSYDUCK_POKERAP, gMonFrontPic_Psyduck_POKERAP),
	SPECIES_SPRITE(GOLDUCK_POKERAP, gMonFrontPic_Golduck_POKERAP),
	SPECIES_SPRITE(MANKEY_POKERAP, gMonFrontPic_Mankey_POKERAP),
	SPECIES_SPRITE(PRIMEAPE_POKERAP, gMonFrontPic_Primeape_POKERAP),
	SPECIES_SPRITE(GROWLITHE_POKERAP, gMonFrontPic_Growlithe_POKERAP),
	SPECIES_SPRITE(ARCANINE_POKERAP, gMonFrontPic_Arcanine_POKERAP),
	SPECIES_SPRITE(POLIWAG_POKERAP, gMonFrontPic_Poliwag_POKERAP),
	SPECIES_SPRITE(POLIWHIRL_POKERAP, gMonFrontPic_Poliwhirl_POKERAP),
	SPECIES_SPRITE(POLIWRATH_POKERAP, gMonFrontPic_Poliwrath_POKERAP),
	SPECIES_SPRITE(ABRA_POKERAP, gMonFrontPic_Abra_POKERAP),
	SPECIES_SPRITE(KADABRA_POKERAP, gMonFrontPic_Kadabra_POKERAP),
	SPECIES_SPRITE(ALAKAZAM_POKERAP, gMonFrontPic_Alakazam_POKERAP),
	SPECIES_SPRITE(MACHOP_POKERAP, gMonFrontPic_Machop_POKERAP),
	SPECIES_SPRITE(MACHOKE_POKERAP, gMonFrontPic_Machoke_POKERAP),
	SPECIES_SPRITE(MACHAMP_POKERAP, gMonFrontPic_Machamp_POKERAP),
	SPECIES_SPRITE(BELLSPROUT_POKERAP, gMonFrontPic_Bellsprout_POKERAP),
	SPECIES_SPRITE(WEEPINBELL_POKERAP, gMonFrontPic_Weepinbell_POKERAP),
	SPECIES_SPRITE(VICTREEBEL_POKERAP, gMonFrontPic_Victreebel_POKERAP),
	SPECIES_SPRITE(TENTACOOL_POKERAP, gMonFrontPic_Tentacool_POKERAP),
	SPECIES_SPRITE(TENTACRUEL_POKERAP, gMonFrontPic_Tentacruel_POKERAP),
	SPECIES_SPRITE(GEODUDE_POKERAP, gMonFrontPic_Geodude_POKERAP),
	SPECIES_SPRITE(GRAVELER_POKERAP, gMonFrontPic_Graveler_POKERAP),
	SPECIES_SPRITE(GOLEM_POKERAP, gMonFrontPic_Golem_POKERAP),
	SPECIES_SPRITE(PONYTA_POKERAP, gMonFrontPic_Ponyta_POKERAP),
	SPECIES_SPRITE(RAPIDASH_POKERAP, gMonFrontPic_Rapidash_POKERAP),
	SPECIES_SPRITE(SLOWPOKE_POKERAP, gMonFrontPic_Slowpoke_POKERAP),
	SPECIES_SPRITE(SLOWBRO_POKERAP, gMonFrontPic_Slowbro_POKERAP),
	SPECIES_SPRITE(MAGNEMITE_POKERAP, gMonFrontPic_Magnemite_POKERAP),
	SPECIES_SPRITE(MAGNETON_POKERAP, gMonFrontPic_Magneton_POKERAP),
	SPECIES_SPRITE(FARFETCHD_POKERAP, gMonFrontPic_Farfetchd_POKERAP),
	SPECIES_SPRITE(DODUO_POKERAP, gMonFrontPic_Doduo_POKERAP),
	SPECIES_SPRITE(DODRIO_POKERAP, gMonFrontPic_Dodrio_POKERAP),
	SPECIES_SPRITE(SEEL_POKERAP, gMonFrontPic_Seel_POKERAP),
	SPECIES_SPRITE(DEWGONG_POKERAP, gMonFrontPic_Dewgong_POKERAP),
	SPECIES_SPRITE(GRIMER_POKERAP, gMonFrontPic_Grimer_POKERAP),
	SPECIES_SPRITE(MUK_POKERAP, gMonFrontPic_Muk_POKERAP),
	SPECIES_SPRITE(SHELLDER_POKERAP, gMonFrontPic_Shellder_POKERAP),
	SPECIES_SPRITE(CLOYSTER_POKERAP, gMonFrontPic_Cloyster_POKERAP),
	SPECIES_SPRITE(GASTLY_POKERAP, gMonFrontPic_Gastly_POKERAP),
	SPECIES_SPRITE(HAUNTER_POKERAP, gMonFrontPic_Haunter_POKERAP),
	SPECIES_SPRITE(GENGAR_POKERAP, gMonFrontPic_Gengar_POKERAP),
	SPECIES_SPRITE(ONIX_POKERAP, gMonFrontPic_Onix_POKERAP),
	SPECIES_SPRITE(DROWZEE_POKERAP, gMonFrontPic_Drowzee_POKERAP),
	SPECIES_SPRITE(HYPNO_POKERAP, gMonFrontPic_Hypno_POKERAP),
	SPECIES_SPRITE(KRABBY_POKERAP, gMonFrontPic_Krabby_POKERAP),
	SPECIES_SPRITE(KINGLER_POKERAP, gMonFrontPic_Kingler_POKERAP),
	SPECIES_SPRITE(VOLTORB_POKERAP, gMonFrontPic_Voltorb_POKERAP),
	SPECIES_SPRITE(ELECTRODE_POKERAP, gMonFrontPic_Electrode_POKERAP),
	SPECIES_SPRITE(EXEGGCUTE_POKERAP, gMonFrontPic_Exeggcute_POKERAP),
	SPECIES_SPRITE(EXEGGUTOR_POKERAP, gMonFrontPic_Exeggutor_POKERAP),
	SPECIES_SPRITE(CUBONE_POKERAP, gMonFrontPic_Cubone_POKERAP),
	SPECIES_SPRITE(MAROWAK_POKERAP, gMonFrontPic_Marowak_POKERAP),
	SPECIES_SPRITE(HITMONLEE_POKERAP, gMonFrontPic_Hitmonlee_POKERAP),
	SPECIES_SPRITE(HITMONCHAN_POKERAP, gMonFrontPic_Hitmonchan_POKERAP),
	SPECIES_SPRITE(LICKITUNG_POKERAP, gMonFrontPic_Lickitung_POKERAP),
	SPECIES_SPRITE(KOFFING_POKERAP, gMonFrontPic_Koffing_POKERAP),
	SPECIES_SPRITE(WEEZING_POKERAP, gMonFrontPic_Weezing_POKERAP),
	SPECIES_SPRITE(RHYHORN_POKERAP, gMonFrontPic_Rhyhorn_POKERAP),
	SPECIES_SPRITE(RHYDON_POKERAP, gMonFrontPic_Rhydon_POKERAP),
	SPECIES_SPRITE(CHANSEY_POKERAP, gMonFrontPic_Chansey_POKERAP),
	SPECIES_SPRITE(TANGELA_POKERAP, gMonFrontPic_Tangela_POKERAP),
	SPECIES_SPRITE(KANGASKHAN_POKERAP, gMonFrontPic_Kangaskhan_POKERAP),
	SPECIES_SPRITE(HORSEA_POKERAP, gMonFrontPic_Horsea_POKERAP),
	SPECIES_SPRITE(SEADRA_POKERAP, gMonFrontPic_Seadra_POKERAP),
	SPECIES_SPRITE(GOLDEEN_POKERAP, gMonFrontPic_Goldeen_POKERAP),
	SPECIES_SPRITE(SEAKING_POKERAP, gMonFrontPic_Seaking_POKERAP),
	SPECIES_SPRITE(STARYU_POKERAP, gMonFrontPic_Staryu_POKERAP),
	SPECIES_SPRITE(STARMIE_POKERAP, gMonFrontPic_Starmie_POKERAP),
	SPECIES_SPRITE(MRMIME_POKERAP, gMonFrontPic_MrMime_POKERAP),
	SPECIES_SPRITE(SCYTHER_POKERAP, gMonFrontPic_Scyther_POKERAP),
	SPECIES_SPRITE(JYNX_POKERAP, gMonFrontPic_Jynx_POKERAP),
	SPECIES_SPRITE(ELECTABUZZ_POKERAP, gMonFrontPic_Electabuzz_POKERAP),
	SPECIES_SPRITE(MAGMAR_POKERAP, gMonFrontPic_Magmar_POKERAP),
	SPECIES_SPRITE(PINSIR_POKERAP, gMonFrontPic_Pinsir_POKERAP),
	SPECIES_SPRITE(TAUROS_POKERAP, gMonFrontPic_Tauros_POKERAP),
	SPECIES_SPRITE(MAGIKARP_POKERAP, gMonFrontPic_Magikarp_POKERAP),
	SPECIES_SPRITE(GYARADOS_POKERAP, gMonFrontPic_Gyarados_POKERAP),
	SPECIES_SPRITE(LAPRAS_POKERAP, gMonFrontPic_Lapras_POKERAP),
	SPECIES_SPRITE(DITTO_POKERAP, gMonFrontPic_Ditto_POKERAP),
	SPECIES_SPRITE(EEVEE_POKERAP, gMonFrontPic_Eevee_POKERAP),
	SPECIES_SPRITE(VAPOREON_POKERAP, gMonFrontPic_Vaporeon_POKERAP),
	SPECIES_SPRITE(JOLTEON_POKERAP, gMonFrontPic_Jolteon_POKERAP),
	SPECIES_SPRITE(FLAREON_POKERAP, gMonFrontPic_Flareon_POKERAP),
	SPECIES_SPRITE(PORYGON_POKERAP, gMonFrontPic_Porygon_POKERAP),
	SPECIES_SPRITE(OMANYTE_POKERAP, gMonFrontPic_Omanyte_POKERAP),
	SPECIES_SPRITE(OMASTAR_POKERAP, gMonFrontPic_Omastar_POKERAP),
	SPECIES_SPRITE(KABUTO_POKERAP, gMonFrontPic_Kabuto_POKERAP),
	SPECIES_SPRITE(KABUTOPS_POKERAP, gMonFrontPic_Kabutops_POKERAP),
	SPECIES_SPRITE(AERODACTYL_POKERAP, gMonFrontPic_Aerodactyl_POKERAP),
	SPECIES_SPRITE(SNORLAX_POKERAP, gMonFrontPic_Snorlax_POKERAP),
	SPECIES_SPRITE(ARTICUNO_POKERAP, gMonFrontPic_Articuno_POKERAP),
	SPECIES_SPRITE(ZAPDOS_POKERAP, gMonFrontPic_Zapdos_POKERAP),
	SPECIES_SPRITE(MOLTRES_POKERAP, gMonFrontPic_Moltres_POKERAP),
	SPECIES_SPRITE(DRATINI_POKERAP, gMonFrontPic_Dratini_POKERAP),
	SPECIES_SPRITE(DRAGONAIR_POKERAP, gMonFrontPic_Dragonair_POKERAP),
	SPECIES_SPRITE(DRAGONITE_POKERAP, gMonFrontPic_Dragonite_POKERAP),
	SPECIES_SPRITE(MEWTWO_POKERAP, gMonFrontPic_Mewtwo_POKERAP),



    	SPECIES_SPRITE(REVENANT, gMonFrontPic_REVENANT),
	SPECIES_SPRITE(UNOWNS, gMonFrontPic_UNOWNS),
	SPECIES_SPRITE(UNOWNE, gMonFrontPic_UNOWNE),
	SPECIES_SPRITE(UNOWNN, gMonFrontPic_UNOWNN),
	SPECIES_SPRITE(UNOWND, gMonFrontPic_UNOWND),
	SPECIES_SPRITE(RELICANTHPAST, gMonFrontPic_RELICANTHPAST),
	SPECIES_SPRITE(RELICANTHFUTURE, gMonFrontPic_RELICANTHFUTURE),
	SPECIES_SPRITE(POKEMONRAP, gMonFrontPic_POKEMONRAP),
	SPECIES_SPRITE(NIDORANMPOKERAP, gMonFrontPic_NIDORANMPOKERAP),
	SPECIES_SPRITE(NIDORANFPOKERAP, gMonFrontPic_NIDORANFPOKERAP),
	SPECIES_SPRITE(THATSALL, gMonFrontPic_THATSALL),
	SPECIES_SPRITE(KANGASKHANTEACHER, gMonFrontPic_KANGASKHANTEACHER),
	SPECIES_SPRITE(TANGELACREEPY, gMonFrontPic_TANGELACREEPY),
	SPECIES_SPRITE(CHANSEYBLANK, gMonFrontPic_CHANSEYBLANK),
	SPECIES_SPRITE(IRONCLEFTGREEN, gMonFrontPic_IRONCLEFTGREEN),
	SPECIES_SPRITE(LATIASBLAZIKEN, gMonFrontPic_LATIASBLAZIKEN),
	SPECIES_SPRITE(MONICA, gMonFrontPic_Monica),
	SPECIES_SPRITE(IRONBUTT, gMonFrontPic_IRONBUTT),
	SPECIES_SPRITE(RELICRABBY, gMonFrontPic_Relicrabby),
	SPECIES_SPRITE(EGEXCSUTER, gMonFrontPic_EGEXCSUTER),
	SPECIES_SPRITE(GYARADOS_LANCE, gMonFrontPic_GyaradosLance),
	SPECIES_SPRITE(ALAKAZAMTCG, gMonFrontPic_AlakazamTCG),
	SPECIES_SPRITE(REGIEYES, gMonFrontPic_REGIEYES),
	SPECIES_SPRITE(REGIFILSAMIE, gMonFrontPic_REGIFILSAMIE),
	SPECIES_SPRITE(SOLACEON, gMonFrontPic_SOLACEON),
	SPECIES_SPRITE(PORYGON64, gMonFrontPic_PORYGON64),
	SPECIES_SPRITE(PORYGON32, gMonFrontPic_PORYGON32),
	SPECIES_SPRITE(STARMIEMEGA, gMonFrontPic_STARMIEMEGA),
	SPECIES_SPRITE(GIRAFARIGBOTTOM, gMonFrontPic_GIRAFARIGBOTTOM),
	SPECIES_SPRITE(GIRAFARIGBUTT, gMonFrontPic_GIRAFARIGBUTT),
	SPECIES_SPRITE(MEWTWOW, gMonFrontPic_MEWTWOW),
	SPECIES_SPRITE(CHARIZARDQ, gMonFrontPic_CHARIZARDQ),
	SPECIES_SPRITE(HOOT, gMonFrontPic_HOOT),
	SPECIES_SPRITE(ZAPMOLCUNO, gMonFrontPic_ZAPMOLCUNO),
	SPECIES_SPRITE(UNITEDKINGDOM, gMonFrontPic_UNITEDKINGDOM),
	SPECIES_SPRITE(FIRETYPES, gMonFrontPic_FIRETYPES),
	SPECIES_SPRITE(RATICATEGHOST, gMonFrontPic_RATICATEGHOST),
	SPECIES_SPRITE(FINALLUGIA, gMonFrontPic_FINALLUGIA),
	SPECIES_SPRITE(FINALARTICUNO, gMonFrontPic_FINALARTICUNO),
	SPECIES_SPRITE(FINALHOOH, gMonFrontPic_FINALHOOH),
	SPECIES_SPRITE(FINALZAPDOS, gMonFrontPic_FINALZAPDOS),
	SPECIES_SPRITE(FINALMOLTRES, gMonFrontPic_FINALMOLTRES),
	SPECIES_SPRITE(FINALWARTORTLE, gMonFrontPic_FINALWARTORTLE),
	SPECIES_SPRITE(DODODUO, gMonFrontPic_DODODUO),
	SPECIES_SPRITE(CELEBI2, gMonFrontPic_CELEBI2),
	SPECIES_SPRITE(PIKACHUSURF, gMonFrontPic_PIKACHUSURF),
	SPECIES_SPRITE(SHINYABRA, gMonFrontPic_SHINYABRA),
	SPECIES_SPRITE(EARRAT, gMonFrontPic_EARRAT),
	SPECIES_SPRITE(FINALCHARMANDER, gMonFrontPic_Charmander),
	SPECIES_SPRITE(CELIASSTUPIDROMHACK, gMonFrontPic_CELIASSTUPIDROMHACK),
    SPECIES_SPRITE(KECLEON_WIZ1989, gMonFrontPic_Kecleon_wiz1989),

		SPECIES_SPRITE(GREGORY, gMonFrontPic_GREGORY),
	SPECIES_SPRITE(ARCEUSLAST, gMonFrontPic_ARCEUSLAST),
	SPECIES_SPRITE(NOTHING, gMonFrontPic_NOTHING),
	SPECIES_SPRITE(DITTOBLIZ, gMonFrontPic_DITTOBLIZ),
	SPECIES_SPRITE(IRONMASK, gMonFrontPic_IRONMASK),
	SPECIES_SPRITE(ZOMBON, gMonFrontPic_ZOMBON),
	SPECIES_SPRITE(TINKANETTE, gMonFrontPic_TINKANETTE),
	SPECIES_SPRITE(RICKETOT, gMonFrontPic_RICKETOT),
	SPECIES_SPRITE(IMAKUNIDODUO, gMonFrontPic_IMAKUNIDODUO),
	SPECIES_SPRITE(ABSOLYNE, gMonFrontPic_ABSOLYNE),
	SPECIES_SPRITE(LICHENMASQUERAIN, gMonFrontPic_LICHENMASQUERAIN),
	SPECIES_SPRITE(LICHENMAWILE, gMonFrontPic_LICHENMAWILE),
	SPECIES_SPRITE(DMCACUTOUT, gMonFrontPic_DMCACUTOUT),
