const struct CompressedSpritePalette gMonPaletteTable[] =
{
	...
	SPECIES_PAL(MIME_JR_, gMonPalette_Mime_Jr_),
	...
	SPECIES_PAL(JIGGLYPUFF_ABOVE, gMonPalette_Jigglypuff_Above),
	SPECIES_PAL(TENTAQUIL, gMonPalette_Tentaquil),
	SPECIES_PAL(MISSINGNO, gMonPalette_Missingno),
	SPECIES_PAL(KENYA, gMonPalette_Kenya),
	SPECIES_PAL(HITMONCHAN_SHIT, gMonPalette_Hitmonchan_Shit),
	SPECIES_PAL(HITMONCHIN, gMonPalette_Hitmonchin),
	SPECIES_PAL(TRUBBISH_HAIRCUT, gMonPalette_Trubbish_Haircut),
	SPECIES_PAL(AMPHAROS_MEGA, gMonPalette_Ampharos_Mega),
	SPECIES_PAL(YOSHI, gMonPalette_Yoshi),
	SPECIES_PAL(DITTO_MEW, gMonPalette_Ditto_Mew),
	SPECIES_PAL(UNOWN_LOSS, gMonPalette_Unown_Loss),
	SPECIES_PAL(MAGNALONE, gMonPalette_Magnalone),
	SPECIES_PAL(TYRANASTAR, gMonPalette_Tyranastar),
	SPECIES_PAL(POKEMON_GUN, gMonPalette_Pokemon_Gun),
	SPECIES_PAL(PLUG_OINK, gMonPalette_Plug_Oink),
	SPECIES_PAL(PIKABLU, gMonPalette_Pikablu),
	SPECIES_PAL(RATTATA_SHINY, gMonPalette_Rattata_Shiny),
		SPECIES_PAL(PIKACHU_BIRTHDAY, gMonPalette_Pikachu_Birthday),
	SPECIES_PAL(MEW_ANCIENT, gMonPalette_Mew_Ancient),
	SPECIES_PAL(PIKACHU_OLD, gMonPalette_Pikachu_Old),
	SPECIES_PAL(GENESECT_SHINY, gMonPalette_Genesect_Shiny),
	SPECIES_PAL(IRON_CLEFT, gMonPalette_Iron_Cleft),
	SPECIES_PAL(VULPIX_ALOLA, gMonPalette_Vulpix_Alola),
	SPECIES_PAL(WEEZING_ALOLA, gMonPalette_Weezing_Alola),
	SPECIES_PAL(THIS_GUY, gMonPalette_This_Guy),
	SPECIES_PAL(STEAMBOAT_WILLIE, gMonPalette_Steamboat_Willie),
	SPECIES_PAL(PIDGEOT_OLD, gMonPalette_Pidgeot_Old),
	SPECIES_PAL(STRYKE, gMonPalette_Stryke),
	SPECIES_PAL(BUTTERFREE_FEMALE, gMonPalette_Butterfree_Female),
	SPECIES_PAL(PIKACHU_FAT_GAY, gMonPalette_Pikachu_Fat_Gay),
	SPECIES_PAL(TRAPINCH_PIKACHU, gMonPalette_Trapinch_Pikachu),
	SPECIES_PAL(KECLEON_SANS, gMonPalette_Kecleon_Sans),
	//SPECIES_PAL(RATTATA_SHINY, gMonPalette_Rattata_Shiny),
	SPECIES_PAL(PORYGON_16, gMonPalette_Porygon_16),
	SPECIES_PAL(PORYGON_8, gMonPalette_Porygon_8),
	SPECIES_PAL(PORYGON_4, gMonPalette_Porygon_4),
	SPECIES_PAL(PORIST_GAMES, gMonPalette_Porist_Games),
	SPECIES_PAL(MISCARRIAGE_KANGA, gMonPalette_Miscarriage_Kanga),
	SPECIES_PAL(GHOST, gMonPalette_Ghost),
	SPECIES_PAL(VENOMOTH_ATV, gMonPalette_Venomoth_ATV),
	SPECIES_PAL(RATICATE_ALOLA, gMonPalette_Raticate_Alola),
	SPECIES_PAL(MULTIPAL, gMonPalette_Multipal),
	SPECIES_PAL(DIVIDUM, gMonPalette_Dividum),
	SPECIES_PAL(EXPONELLE, gMonPalette_Exponelle),
	SPECIES_PAL(PIKACHU_SNAP_SURF, gMonPalette_Pikachu_Snap_Surf),
	SPECIES_PAL(PIKACHU_SNAP_BALL, gMonPalette_Pikachu_Snap_Ball),
	SPECIES_PAL(PIKACHU_SNAP_FLYING, gMonPalette_Pikachu_Snap_Flying),
	SPECIES_PAL(PIKACHU_SNAP_CLOSE, gMonPalette_Pikachu_Snap_Close),
	SPECIES_PAL(RATICATE_DEAD, gMonPalette_Raticate_Dead),
	SPECIES_PAL(SHEDINJA_ELECTRIC, gMonPalette_Shedinja_Electric),
	SPECIES_PAL(VENUSAUR_MEGA, gMonPalette_Digimon),
	SPECIES_PAL(UNOWN_NUDES, gMonPalette_Unown_Nudes),
	SPECIES_PAL(PORYGON22, gMonPalette_Porygon22),
	SPECIES_PAL(HO_OWO, gMonPalette_Ho_OwO),
	SPECIES_PAL(RATATATTA, gMonPalette_Ratatatta),
	SPECIES_PAL(BULBASAUR_POKERAP, gMonPalette_Bulbasaur_POKERAP),
	SPECIES_PAL(IVYSAUR_POKERAP, gMonPalette_Ivysaur_POKERAP),
	SPECIES_PAL(VENUSAUR_POKERAP, gMonPalette_Venusaur_POKERAP),
	SPECIES_PAL(CHARMANDER_POKERAP, gMonPalette_Charmander_POKERAP),
	SPECIES_PAL(CHARMELEON_POKERAP, gMonPalette_Charmeleon_POKERAP),
	SPECIES_PAL(CHARIZARD_POKERAP, gMonPalette_Charizard_POKERAP),
	SPECIES_PAL(SQUIRTLE_POKERAP, gMonPalette_Squirtle_POKERAP),
	SPECIES_PAL(WARTORTLE_POKERAP, gMonPalette_Wartortle_POKERAP),
	SPECIES_PAL(BLASTOISE_POKERAP, gMonPalette_Blastoise_POKERAP),
	SPECIES_PAL(CATERPIE_POKERAP, gMonPalette_Caterpie_POKERAP),
	SPECIES_PAL(METAPOD_POKERAP, gMonPalette_Metapod_POKERAP),
	SPECIES_PAL(BUTTERFREE_POKERAP, gMonPalette_Butterfree_POKERAP),
	SPECIES_PAL(WEEDLE_POKERAP, gMonPalette_Weedle_POKERAP),
	SPECIES_PAL(KAKUNA_POKERAP, gMonPalette_Kakuna_POKERAP),
	SPECIES_PAL(BEEDRILL_POKERAP, gMonPalette_Beedrill_POKERAP),
	SPECIES_PAL(PIDGEY_POKERAP, gMonPalette_Pidgey_POKERAP),
	SPECIES_PAL(PIDGEOTTO_POKERAP, gMonPalette_Pidgeotto_POKERAP),
	SPECIES_PAL(PIDGEOT_POKERAP, gMonPalette_Pidgeot_POKERAP),
	SPECIES_PAL(RATTATA_POKERAP, gMonPalette_Rattata_POKERAP),
	SPECIES_PAL(RATICATE_POKERAP, gMonPalette_Raticate_POKERAP),
	SPECIES_PAL(SPEAROW_POKERAP, gMonPalette_Spearow_POKERAP),
	SPECIES_PAL(FEAROW_POKERAP, gMonPalette_Fearow_POKERAP),
	SPECIES_PAL(EKANS_POKERAP, gMonPalette_Ekans_POKERAP),
	SPECIES_PAL(ARBOK_POKERAP, gMonPalette_Arbok_POKERAP),
	SPECIES_PAL(PIKACHU_POKERAP, gMonPalette_Pikachu_POKERAP),
	SPECIES_PAL(RAICHU_POKERAP, gMonPalette_Raichu_POKERAP),
	SPECIES_PAL(SANDSHREW_POKERAP, gMonPalette_Sandshrew_POKERAP),
	SPECIES_PAL(SANDSLASH_POKERAP, gMonPalette_Sandslash_POKERAP),
	SPECIES_PAL(NIDORINA_POKERAP, gMonPalette_Nidorina_POKERAP),
	SPECIES_PAL(NIDOQUEEN_POKERAP, gMonPalette_Nidoqueen_POKERAP),
	SPECIES_PAL(NIDORINO_POKERAP, gMonPalette_Nidorino_POKERAP),
	SPECIES_PAL(NIDOKING_POKERAP, gMonPalette_Nidoking_POKERAP),
	SPECIES_PAL(CLEFAIRY_POKERAP, gMonPalette_Clefairy_POKERAP),
	SPECIES_PAL(CLEFABLE_POKERAP, gMonPalette_Clefable_POKERAP),
	SPECIES_PAL(VULPIX_POKERAP, gMonPalette_Vulpix_POKERAP),
	SPECIES_PAL(NINETALES_POKERAP, gMonPalette_Ninetales_POKERAP),
	SPECIES_PAL(JIGGLYPUFF_POKERAP, gMonPalette_Jigglypuff_POKERAP),
	SPECIES_PAL(WIGGLYTUFF_POKERAP, gMonPalette_Wigglytuff_POKERAP),
	SPECIES_PAL(ZUBAT_POKERAP, gMonPalette_Zubat_POKERAP),
	SPECIES_PAL(GOLBAT_POKERAP, gMonPalette_Golbat_POKERAP),
	SPECIES_PAL(ODDISH_POKERAP, gMonPalette_Oddish_POKERAP),
	SPECIES_PAL(GLOOM_POKERAP, gMonPalette_Gloom_POKERAP),
	SPECIES_PAL(VILEPLUME_POKERAP, gMonPalette_Vileplume_POKERAP),
	SPECIES_PAL(PARAS_POKERAP, gMonPalette_Paras_POKERAP),
	SPECIES_PAL(PARASECT_POKERAP, gMonPalette_Parasect_POKERAP),
	SPECIES_PAL(VENONAT_POKERAP, gMonPalette_Venonat_POKERAP),
	SPECIES_PAL(VENOMOTH_POKERAP, gMonPalette_Venomoth_POKERAP),
	SPECIES_PAL(DIGLETT_POKERAP, gMonPalette_Diglett_POKERAP),
	SPECIES_PAL(DUGTRIO_POKERAP, gMonPalette_Dugtrio_POKERAP),
	SPECIES_PAL(MEOWTH_POKERAP, gMonPalette_Meowth_POKERAP),
	SPECIES_PAL(PERSIAN_POKERAP, gMonPalette_Persian_POKERAP),
	SPECIES_PAL(PSYDUCK_POKERAP, gMonPalette_Psyduck_POKERAP),
	SPECIES_PAL(GOLDUCK_POKERAP, gMonPalette_Golduck_POKERAP),
	SPECIES_PAL(MANKEY_POKERAP, gMonPalette_Mankey_POKERAP),
	SPECIES_PAL(PRIMEAPE_POKERAP, gMonPalette_Primeape_POKERAP),
	SPECIES_PAL(GROWLITHE_POKERAP, gMonPalette_Growlithe_POKERAP),
	SPECIES_PAL(ARCANINE_POKERAP, gMonPalette_Arcanine_POKERAP),
	SPECIES_PAL(POLIWAG_POKERAP, gMonPalette_Poliwag_POKERAP),
	SPECIES_PAL(POLIWHIRL_POKERAP, gMonPalette_Poliwhirl_POKERAP),
	SPECIES_PAL(POLIWRATH_POKERAP, gMonPalette_Poliwrath_POKERAP),
	SPECIES_PAL(ABRA_POKERAP, gMonPalette_Abra_POKERAP),
	SPECIES_PAL(KADABRA_POKERAP, gMonPalette_Kadabra_POKERAP),
	SPECIES_PAL(ALAKAZAM_POKERAP, gMonPalette_Alakazam_POKERAP),
	SPECIES_PAL(MACHOP_POKERAP, gMonPalette_Machop_POKERAP),
	SPECIES_PAL(MACHOKE_POKERAP, gMonPalette_Machoke_POKERAP),
	SPECIES_PAL(MACHAMP_POKERAP, gMonPalette_Machamp_POKERAP),
	SPECIES_PAL(BELLSPROUT_POKERAP, gMonPalette_Bellsprout_POKERAP),
	SPECIES_PAL(WEEPINBELL_POKERAP, gMonPalette_Weepinbell_POKERAP),
	SPECIES_PAL(VICTREEBEL_POKERAP, gMonPalette_Victreebel_POKERAP),
	SPECIES_PAL(TENTACOOL_POKERAP, gMonPalette_Tentacool_POKERAP),
	SPECIES_PAL(TENTACRUEL_POKERAP, gMonPalette_Tentacruel_POKERAP),
	SPECIES_PAL(GEODUDE_POKERAP, gMonPalette_Geodude_POKERAP),
	SPECIES_PAL(GRAVELER_POKERAP, gMonPalette_Graveler_POKERAP),
	SPECIES_PAL(GOLEM_POKERAP, gMonPalette_Golem_POKERAP),
	SPECIES_PAL(PONYTA_POKERAP, gMonPalette_Ponyta_POKERAP),
	SPECIES_PAL(RAPIDASH_POKERAP, gMonPalette_Rapidash_POKERAP),
	SPECIES_PAL(SLOWPOKE_POKERAP, gMonPalette_Slowpoke_POKERAP),
	SPECIES_PAL(SLOWBRO_POKERAP, gMonPalette_Slowbro_POKERAP),
	SPECIES_PAL(MAGNEMITE_POKERAP, gMonPalette_Magnemite_POKERAP),
	SPECIES_PAL(MAGNETON_POKERAP, gMonPalette_Magneton_POKERAP),
	SPECIES_PAL(FARFETCHD_POKERAP, gMonPalette_Farfetchd_POKERAP),
	SPECIES_PAL(DODUO_POKERAP, gMonPalette_Doduo_POKERAP),
	SPECIES_PAL(DODRIO_POKERAP, gMonPalette_Dodrio_POKERAP),
	SPECIES_PAL(SEEL_POKERAP, gMonPalette_Seel_POKERAP),
	SPECIES_PAL(DEWGONG_POKERAP, gMonPalette_Dewgong_POKERAP),
	SPECIES_PAL(GRIMER_POKERAP, gMonPalette_Grimer_POKERAP),
	SPECIES_PAL(MUK_POKERAP, gMonPalette_Muk_POKERAP),
	SPECIES_PAL(SHELLDER_POKERAP, gMonPalette_Shellder_POKERAP),
	SPECIES_PAL(CLOYSTER_POKERAP, gMonPalette_Cloyster_POKERAP),
	SPECIES_PAL(GASTLY_POKERAP, gMonPalette_Gastly_POKERAP),
	SPECIES_PAL(HAUNTER_POKERAP, gMonPalette_Haunter_POKERAP),
	SPECIES_PAL(GENGAR_POKERAP, gMonPalette_Gengar_POKERAP),
	SPECIES_PAL(ONIX_POKERAP, gMonPalette_Onix_POKERAP),
	SPECIES_PAL(DROWZEE_POKERAP, gMonPalette_Drowzee_POKERAP),
	SPECIES_PAL(HYPNO_POKERAP, gMonPalette_Hypno_POKERAP),
	SPECIES_PAL(KRABBY_POKERAP, gMonPalette_Krabby_POKERAP),
	SPECIES_PAL(KINGLER_POKERAP, gMonPalette_Kingler_POKERAP),
	SPECIES_PAL(VOLTORB_POKERAP, gMonPalette_Voltorb_POKERAP),
	SPECIES_PAL(ELECTRODE_POKERAP, gMonPalette_Electrode_POKERAP),
	SPECIES_PAL(EXEGGCUTE_POKERAP, gMonPalette_Exeggcute_POKERAP),
	SPECIES_PAL(EXEGGUTOR_POKERAP, gMonPalette_Exeggutor_POKERAP),
	SPECIES_PAL(CUBONE_POKERAP, gMonPalette_Cubone_POKERAP),
	SPECIES_PAL(MAROWAK_POKERAP, gMonPalette_Marowak_POKERAP),
	SPECIES_PAL(HITMONLEE_POKERAP, gMonPalette_Hitmonlee_POKERAP),
	SPECIES_PAL(HITMONCHAN_POKERAP, gMonPalette_Hitmonchan_POKERAP),
	SPECIES_PAL(LICKITUNG_POKERAP, gMonPalette_Lickitung_POKERAP),
	SPECIES_PAL(KOFFING_POKERAP, gMonPalette_Koffing_POKERAP),
	SPECIES_PAL(WEEZING_POKERAP, gMonPalette_Weezing_POKERAP),
	SPECIES_PAL(RHYHORN_POKERAP, gMonPalette_Rhyhorn_POKERAP),
	SPECIES_PAL(RHYDON_POKERAP, gMonPalette_Rhydon_POKERAP),
	SPECIES_PAL(CHANSEY_POKERAP, gMonPalette_Chansey_POKERAP),
	SPECIES_PAL(TANGELA_POKERAP, gMonPalette_Tangela_POKERAP),
	SPECIES_PAL(KANGASKHAN_POKERAP, gMonPalette_Kangaskhan_POKERAP),
	SPECIES_PAL(HORSEA_POKERAP, gMonPalette_Horsea_POKERAP),
	SPECIES_PAL(SEADRA_POKERAP, gMonPalette_Seadra_POKERAP),
	SPECIES_PAL(GOLDEEN_POKERAP, gMonPalette_Goldeen_POKERAP),
	SPECIES_PAL(SEAKING_POKERAP, gMonPalette_Seaking_POKERAP),
	SPECIES_PAL(STARYU_POKERAP, gMonPalette_Staryu_POKERAP),
	SPECIES_PAL(STARMIE_POKERAP, gMonPalette_Starmie_POKERAP),
	SPECIES_PAL(MRMIME_POKERAP, gMonPalette_MrMime_POKERAP),
	SPECIES_PAL(SCYTHER_POKERAP, gMonPalette_Scyther_POKERAP),
	SPECIES_PAL(JYNX_POKERAP, gMonPalette_Jynx_POKERAP),
	SPECIES_PAL(ELECTABUZZ_POKERAP, gMonPalette_Electabuzz_POKERAP),
	SPECIES_PAL(MAGMAR_POKERAP, gMonPalette_Magmar_POKERAP),
	SPECIES_PAL(PINSIR_POKERAP, gMonPalette_Pinsir_POKERAP),
	SPECIES_PAL(TAUROS_POKERAP, gMonPalette_Tauros_POKERAP),
	SPECIES_PAL(MAGIKARP_POKERAP, gMonPalette_Magikarp_POKERAP),
	SPECIES_PAL(GYARADOS_POKERAP, gMonPalette_Gyarados_POKERAP),
	SPECIES_PAL(LAPRAS_POKERAP, gMonPalette_Lapras_POKERAP),
	SPECIES_PAL(DITTO_POKERAP, gMonPalette_Ditto_POKERAP),
	SPECIES_PAL(EEVEE_POKERAP, gMonPalette_Eevee_POKERAP),
	SPECIES_PAL(VAPOREON_POKERAP, gMonPalette_Vaporeon_POKERAP),
	SPECIES_PAL(JOLTEON_POKERAP, gMonPalette_Jolteon_POKERAP),
	SPECIES_PAL(FLAREON_POKERAP, gMonPalette_Flareon_POKERAP),
	SPECIES_PAL(PORYGON_POKERAP, gMonPalette_Porygon_POKERAP),
	SPECIES_PAL(OMANYTE_POKERAP, gMonPalette_Omanyte_POKERAP),
	SPECIES_PAL(OMASTAR_POKERAP, gMonPalette_Omastar_POKERAP),
	SPECIES_PAL(KABUTO_POKERAP, gMonPalette_Kabuto_POKERAP),
	SPECIES_PAL(KABUTOPS_POKERAP, gMonPalette_Kabutops_POKERAP),
	SPECIES_PAL(AERODACTYL_POKERAP, gMonPalette_Aerodactyl_POKERAP),
	SPECIES_PAL(SNORLAX_POKERAP, gMonPalette_Snorlax_POKERAP),
	SPECIES_PAL(ARTICUNO_POKERAP, gMonPalette_Articuno_POKERAP),
	SPECIES_PAL(ZAPDOS_POKERAP, gMonPalette_Zapdos_POKERAP),
	SPECIES_PAL(MOLTRES_POKERAP, gMonPalette_Moltres_POKERAP),
	SPECIES_PAL(DRATINI_POKERAP, gMonPalette_Dratini_POKERAP),
	SPECIES_PAL(DRAGONAIR_POKERAP, gMonPalette_Dragonair_POKERAP),
	SPECIES_PAL(DRAGONITE_POKERAP, gMonPalette_Dragonite_POKERAP),
	SPECIES_PAL(MEWTWO_POKERAP, gMonPalette_Mewtwo_POKERAP),



    	SPECIES_PAL(REVENANT, gMonPalette_REVENANT),
	SPECIES_PAL(UNOWNS, gMonPalette_UNOWNS),
	SPECIES_PAL(UNOWNE, gMonPalette_UNOWNE),
	SPECIES_PAL(UNOWNN, gMonPalette_UNOWNN),
	SPECIES_PAL(UNOWND, gMonPalette_UNOWND),
	SPECIES_PAL(RELICANTHPAST, gMonPalette_RELICANTHPAST),
	SPECIES_PAL(RELICANTHFUTURE, gMonPalette_RELICANTHFUTURE),
	SPECIES_PAL(POKEMONRAP, gMonPalette_POKEMONRAP),
	SPECIES_PAL(NIDORANMPOKERAP, gMonPalette_NIDORANMPOKERAP),
	SPECIES_PAL(NIDORANFPOKERAP, gMonPalette_NIDORANFPOKERAP),
	SPECIES_PAL(THATSALL, gMonPalette_THATSALL),
	SPECIES_PAL(KANGASKHANTEACHER, gMonPalette_KANGASKHANTEACHER),
	SPECIES_PAL(TANGELACREEPY, gMonPalette_TANGELACREEPY),
	SPECIES_PAL(CHANSEYBLANK, gMonPalette_CHANSEYBLANK),
	SPECIES_PAL(IRONCLEFTGREEN, gMonPalette_IRONCLEFTGREEN),
	SPECIES_PAL(LATIASBLAZIKEN, gMonPalette_LATIASBLAZIKEN),
	SPECIES_PAL(MONICA, gMonPalette_Monica),
	SPECIES_PAL(IRONBUTT, gMonPalette_IRONBUTT),
	SPECIES_PAL(RELICRABBY, gMonPalette_Relicrabby),
	SPECIES_PAL(EGEXCSUTER, gMonPalette_EGEXCSUTER),
	SPECIES_PAL(GYARADOS_LANCE, gMonPalette_GyaradosLance),
	SPECIES_PAL(ALAKAZAMTCG, gMonPalette_AlakazamTCG),
	SPECIES_PAL(REGIEYES, gMonPalette_REGIEYES),
	SPECIES_PAL(REGIFILSAMIE, gMonPalette_REGIFILSAMIE),
	SPECIES_PAL(SOLACEON, gMonPalette_SOLACEON),
	SPECIES_PAL(PORYGON64, gMonPalette_PORYGON64),
	SPECIES_PAL(PORYGON32, gMonPalette_PORYGON32),
	SPECIES_PAL(STARMIEMEGA, gMonPalette_STARMIEMEGA),
	SPECIES_PAL(GIRAFARIGBOTTOM, gMonPalette_GIRAFARIGBOTTOM),
	SPECIES_PAL(GIRAFARIGBUTT, gMonPalette_GIRAFARIGBUTT),
	SPECIES_PAL(MEWTWOW, gMonPalette_MEWTWOW),
	SPECIES_PAL(CHARIZARDQ, gMonPalette_CHARIZARDQ),
	SPECIES_PAL(HOOT, gMonPalette_HOOT),
	SPECIES_PAL(ZAPMOLCUNO, gMonPalette_ZAPMOLCUNO),
	SPECIES_PAL(UNITEDKINGDOM, gMonPalette_UNITEDKINGDOM),
	SPECIES_PAL(FIRETYPES, gMonPalette_FIRETYPES),
	SPECIES_PAL(RATICATEGHOST, gMonPalette_RATICATEGHOST),
	SPECIES_PAL(FINALLUGIA, gMonPalette_FINALLUGIA),
	SPECIES_PAL(FINALARTICUNO, gMonPalette_FINALARTICUNO),
	SPECIES_PAL(FINALHOOH, gMonPalette_FINALHOOH),
	SPECIES_PAL(FINALZAPDOS, gMonPalette_FINALZAPDOS),
	SPECIES_PAL(FINALMOLTRES, gMonPalette_FINALMOLTRES),
	SPECIES_PAL(FINALWARTORTLE, gMonPalette_FINALWARTORTLE),
	SPECIES_PAL(DODODUO, gMonPalette_DODODUO),
	SPECIES_PAL(CELEBI2, gMonPalette_CELEBI2),
	SPECIES_PAL(PIKACHUSURF, gMonPalette_PIKACHUSURF),
	SPECIES_PAL(SHINYABRA, gMonPalette_SHINYABRA),
	SPECIES_PAL(EARRAT, gMonPalette_EARRAT),
	SPECIES_PAL(FINALCHARMANDER, gMonPalette_Charmander),
	SPECIES_PAL(CELIASSTUPIDROMHACK, gMonPalette_CELIASSTUPIDROMHACK),
    SPECIES_PAL(KECLEON_WIZ1989, gMonPalette_Kecleon_wiz1989),

		SPECIES_PAL(GREGORY, gMonPalette_GREGORY),
	SPECIES_PAL(ARCEUSLAST, gMonPalette_ARCEUSLAST),
	SPECIES_PAL(NOTHING, gMonPalette_NOTHING),
	SPECIES_PAL(DITTOBLIZ, gMonPalette_DITTOBLIZ),
	SPECIES_PAL(IRONMASK, gMonPalette_IRONMASK),
	SPECIES_PAL(ZOMBON, gMonPalette_ZOMBON),
	SPECIES_PAL(TINKANETTE, gMonPalette_TINKANETTE),
	SPECIES_PAL(RICKETOT, gMonPalette_RICKETOT),
	SPECIES_PAL(IMAKUNIDODUO, gMonPalette_IMAKUNIDODUO),
	SPECIES_PAL(ABSOLYNE, gMonPalette_ABSOLYNE),
	SPECIES_PAL(LICHENMASQUERAIN, gMonPalette_LICHENMASQUERAIN),
	SPECIES_PAL(LICHENMAWILE, gMonPalette_LICHENMAWILE),
	SPECIES_PAL(DMCACUTOUT, gMonPalette_DMCACUTOUT),
