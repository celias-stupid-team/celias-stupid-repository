const struct CompressedSpriteSheet gMonBackPicTable[] =
{
	...
	SPECIES_SPRITE(MIME_JR_, gMonBackPic_Mime_Jr_),
	...
	SPECIES_SPRITE(JIGGLYPUFF_ABOVE, gMonBackPic_Jigglypuff_Above),
	SPECIES_SPRITE(TENTAQUIL, gMonBackPic_Tentaquil),
	SPECIES_SPRITE(MISSINGNO, gMonBackPic_Missingno),
	SPECIES_SPRITE(KENYA, gMonBackPic_Kenya),
	SPECIES_SPRITE(HITMONCHAN_SHIT, gMonBackPic_Hitmonchan_Shit),
	SPECIES_SPRITE(HITMONCHIN, gMonBackPic_Hitmonchin),
	SPECIES_SPRITE(TRUBBISH_HAIRCUT, gMonBackPic_Trubbish_Haircut),
	SPECIES_SPRITE(AMPHAROS_MEGA, gMonBackPic_Ampharos_Mega),
	SPECIES_SPRITE(YOSHI, gMonBackPic_Yoshi),
	SPECIES_SPRITE(DITTO_MEW, gMonBackPic_Ditto_Mew),
	SPECIES_SPRITE(UNOWN_LOSS, gMonBackPic_Unown_Loss),
	SPECIES_SPRITE(MAGNALONE, gMonBackPic_Magnalone),
	SPECIES_SPRITE(TYRANASTAR, gMonBackPic_Tyranastar),
	SPECIES_SPRITE(POKEMON_GUN, gMonBackPic_Pokemon_Gun),
	SPECIES_SPRITE(PLUG_OINK, gMonBackPic_Plug_Oink),
	SPECIES_SPRITE(PIKABLU, gMonBackPic_Pikablu),
	SPECIES_SPRITE(RATTATA_SHINY, gMonBackPic_Rattata_Shiny),
		SPECIES_SPRITE(PIKACHU_BIRTHDAY, gMonBackPic_Pikachu_Birthday),
	SPECIES_SPRITE(MEW_ANCIENT, gMonBackPic_Mew_Ancient),
	SPECIES_SPRITE(PIKACHU_OLD, gMonBackPic_Pikachu_Old),
	SPECIES_SPRITE(GENESECT_SHINY, gMonBackPic_Genesect_Shiny),
	SPECIES_SPRITE(IRON_CLEFT, gMonBackPic_Iron_Cleft),
	SPECIES_SPRITE(VULPIX_ALOLA, gMonBackPic_Vulpix_Alola),
	SPECIES_SPRITE(WEEZING_ALOLA, gMonBackPic_Weezing_Alola),
	SPECIES_SPRITE(THIS_GUY, gMonBackPic_This_Guy),
	SPECIES_SPRITE(STEAMBOAT_WILLIE, gMonBackPic_Steamboat_Willie),
	SPECIES_SPRITE(PIDGEOT_OLD, gMonBackPic_Pidgeot_Old),
	SPECIES_SPRITE(STRYKE, gMonBackPic_Stryke),
	SPECIES_SPRITE(BUTTERFREE_FEMALE, gMonBackPic_Butterfree_Female),
	SPECIES_SPRITE(PIKACHU_FAT_GAY, gMonBackPic_Pikachu_Fat_Gay),
	SPECIES_SPRITE(TRAPINCH_PIKACHU, gMonBackPic_Trapinch_Pikachu),
	SPECIES_SPRITE(KECLEON_SANS, gMonBackPic_Kecleon_Sans),
	//SPECIES_SPRITE(RATTATA_SHINY, gMonBackPic_Rattata_Shiny),
	SPECIES_SPRITE(PORYGON_16, gMonBackPic_Porygon_16),
	SPECIES_SPRITE(PORYGON_8, gMonBackPic_Porygon_8),
	SPECIES_SPRITE(PORYGON_4, gMonBackPic_Porygon_4),
	SPECIES_SPRITE(PORIST_GAMES, gMonBackPic_Porist_Games),
	SPECIES_SPRITE(MISCARRIAGE_KANGA, gMonBackPic_Miscarriage_Kanga),
	SPECIES_SPRITE(GHOST, gMonBackPic_Ghost),
	SPECIES_SPRITE(VENOMOTH_ATV, gMonBackPic_Venomoth_ATV),
	SPECIES_SPRITE(RATICATE_ALOLA, gMonBackPic_Raticate_Alola),
	SPECIES_SPRITE(MULTIPAL, gMonBackPic_Multipal),
	SPECIES_SPRITE(DIVIDUM, gMonBackPic_Dividum),
	SPECIES_SPRITE(EXPONELLE, gMonBackPic_Exponelle),
	SPECIES_SPRITE(PIKACHU_SNAP_SURF, gMonBackPic_Pikachu_Snap_Surf),
	SPECIES_SPRITE(PIKACHU_SNAP_BALL, gMonBackPic_Pikachu_Snap_Ball),
	SPECIES_SPRITE(PIKACHU_SNAP_FLYING, gMonBackPic_Pikachu_Snap_Flying),
	SPECIES_SPRITE(PIKACHU_SNAP_CLOSE, gMonBackPic_Pikachu_Snap_Close),
	SPECIES_SPRITE(RATICATE_DEAD, gMonBackPic_Raticate_Dead),
	SPECIES_SPRITE(SHEDINJA_ELECTRIC, gMonBackPic_Shedinja_Electric),
	SPECIES_SPRITE(VENUSAUR_MEGA, gMonBackPic_Digimon),
	SPECIES_SPRITE(UNOWN_NUDES, gMonBackPic_Unown_Nudes),
	SPECIES_SPRITE(PORYGON22, gMonBackPic_Porygon22),
	SPECIES_SPRITE(HO_OWO, gMonBackPic_Ho_OwO),
	SPECIES_SPRITE(RATATATTA, gMonBackPic_Ratatatta),
	SPECIES_SPRITE(BULBASAUR_POKERAP, gMonBackPic_Bulbasaur_POKERAP),
	SPECIES_SPRITE(IVYSAUR_POKERAP, gMonBackPic_Ivysaur_POKERAP),
	SPECIES_SPRITE(VENUSAUR_POKERAP, gMonBackPic_Venusaur_POKERAP),
	SPECIES_SPRITE(CHARMANDER_POKERAP, gMonBackPic_Charmander_POKERAP),
	SPECIES_SPRITE(CHARMELEON_POKERAP, gMonBackPic_Charmeleon_POKERAP),
	SPECIES_SPRITE(CHARIZARD_POKERAP, gMonBackPic_Charizard_POKERAP),
	SPECIES_SPRITE(SQUIRTLE_POKERAP, gMonBackPic_Squirtle_POKERAP),
	SPECIES_SPRITE(WARTORTLE_POKERAP, gMonBackPic_Wartortle_POKERAP),
	SPECIES_SPRITE(BLASTOISE_POKERAP, gMonBackPic_Blastoise_POKERAP),
	SPECIES_SPRITE(CATERPIE_POKERAP, gMonBackPic_Caterpie_POKERAP),
	SPECIES_SPRITE(METAPOD_POKERAP, gMonBackPic_Metapod_POKERAP),
	SPECIES_SPRITE(BUTTERFREE_POKERAP, gMonBackPic_Butterfree_POKERAP),
	SPECIES_SPRITE(WEEDLE_POKERAP, gMonBackPic_Weedle_POKERAP),
	SPECIES_SPRITE(KAKUNA_POKERAP, gMonBackPic_Kakuna_POKERAP),
	SPECIES_SPRITE(BEEDRILL_POKERAP, gMonBackPic_Beedrill_POKERAP),
	SPECIES_SPRITE(PIDGEY_POKERAP, gMonBackPic_Pidgey_POKERAP),
	SPECIES_SPRITE(PIDGEOTTO_POKERAP, gMonBackPic_Pidgeotto_POKERAP),
	SPECIES_SPRITE(PIDGEOT_POKERAP, gMonBackPic_Pidgeot_POKERAP),
	SPECIES_SPRITE(RATTATA_POKERAP, gMonBackPic_Rattata_POKERAP),
	SPECIES_SPRITE(RATICATE_POKERAP, gMonBackPic_Raticate_POKERAP),
	SPECIES_SPRITE(SPEAROW_POKERAP, gMonBackPic_Spearow_POKERAP),
	SPECIES_SPRITE(FEAROW_POKERAP, gMonBackPic_Fearow_POKERAP),
	SPECIES_SPRITE(EKANS_POKERAP, gMonBackPic_Ekans_POKERAP),
	SPECIES_SPRITE(ARBOK_POKERAP, gMonBackPic_Arbok_POKERAP),
	SPECIES_SPRITE(PIKACHU_POKERAP, gMonBackPic_Pikachu_POKERAP),
	SPECIES_SPRITE(RAICHU_POKERAP, gMonBackPic_Raichu_POKERAP),
	SPECIES_SPRITE(SANDSHREW_POKERAP, gMonBackPic_Sandshrew_POKERAP),
	SPECIES_SPRITE(SANDSLASH_POKERAP, gMonBackPic_Sandslash_POKERAP),
	SPECIES_SPRITE(NIDORINA_POKERAP, gMonBackPic_Nidorina_POKERAP),
	SPECIES_SPRITE(NIDOQUEEN_POKERAP, gMonBackPic_Nidoqueen_POKERAP),
	SPECIES_SPRITE(NIDORINO_POKERAP, gMonBackPic_Nidorino_POKERAP),
	SPECIES_SPRITE(NIDOKING_POKERAP, gMonBackPic_Nidoking_POKERAP),
	SPECIES_SPRITE(CLEFAIRY_POKERAP, gMonBackPic_Clefairy_POKERAP),
	SPECIES_SPRITE(CLEFABLE_POKERAP, gMonBackPic_Clefable_POKERAP),
	SPECIES_SPRITE(VULPIX_POKERAP, gMonBackPic_Vulpix_POKERAP),
	SPECIES_SPRITE(NINETALES_POKERAP, gMonBackPic_Ninetales_POKERAP),
	SPECIES_SPRITE(JIGGLYPUFF_POKERAP, gMonBackPic_Jigglypuff_POKERAP),
	SPECIES_SPRITE(WIGGLYTUFF_POKERAP, gMonBackPic_Wigglytuff_POKERAP),
	SPECIES_SPRITE(ZUBAT_POKERAP, gMonBackPic_Zubat_POKERAP),
	SPECIES_SPRITE(GOLBAT_POKERAP, gMonBackPic_Golbat_POKERAP),
	SPECIES_SPRITE(ODDISH_POKERAP, gMonBackPic_Oddish_POKERAP),
	SPECIES_SPRITE(GLOOM_POKERAP, gMonBackPic_Gloom_POKERAP),
	SPECIES_SPRITE(VILEPLUME_POKERAP, gMonBackPic_Vileplume_POKERAP),
	SPECIES_SPRITE(PARAS_POKERAP, gMonBackPic_Paras_POKERAP),
	SPECIES_SPRITE(PARASECT_POKERAP, gMonBackPic_Parasect_POKERAP),
	SPECIES_SPRITE(VENONAT_POKERAP, gMonBackPic_Venonat_POKERAP),
	SPECIES_SPRITE(VENOMOTH_POKERAP, gMonBackPic_Venomoth_POKERAP),
	SPECIES_SPRITE(DIGLETT_POKERAP, gMonBackPic_Diglett_POKERAP),
	SPECIES_SPRITE(DUGTRIO_POKERAP, gMonBackPic_Dugtrio_POKERAP),
	SPECIES_SPRITE(MEOWTH_POKERAP, gMonBackPic_Meowth_POKERAP),
	SPECIES_SPRITE(PERSIAN_POKERAP, gMonBackPic_Persian_POKERAP),
	SPECIES_SPRITE(PSYDUCK_POKERAP, gMonBackPic_Psyduck_POKERAP),
	SPECIES_SPRITE(GOLDUCK_POKERAP, gMonBackPic_Golduck_POKERAP),
	SPECIES_SPRITE(MANKEY_POKERAP, gMonBackPic_Mankey_POKERAP),
	SPECIES_SPRITE(PRIMEAPE_POKERAP, gMonBackPic_Primeape_POKERAP),
	SPECIES_SPRITE(GROWLITHE_POKERAP, gMonBackPic_Growlithe_POKERAP),
	SPECIES_SPRITE(ARCANINE_POKERAP, gMonBackPic_Arcanine_POKERAP),
	SPECIES_SPRITE(POLIWAG_POKERAP, gMonBackPic_Poliwag_POKERAP),
	SPECIES_SPRITE(POLIWHIRL_POKERAP, gMonBackPic_Poliwhirl_POKERAP),
	SPECIES_SPRITE(POLIWRATH_POKERAP, gMonBackPic_Poliwrath_POKERAP),
	SPECIES_SPRITE(ABRA_POKERAP, gMonBackPic_Abra_POKERAP),
	SPECIES_SPRITE(KADABRA_POKERAP, gMonBackPic_Kadabra_POKERAP),
	SPECIES_SPRITE(ALAKAZAM_POKERAP, gMonBackPic_Alakazam_POKERAP),
	SPECIES_SPRITE(MACHOP_POKERAP, gMonBackPic_Machop_POKERAP),
	SPECIES_SPRITE(MACHOKE_POKERAP, gMonBackPic_Machoke_POKERAP),
	SPECIES_SPRITE(MACHAMP_POKERAP, gMonBackPic_Machamp_POKERAP),
	SPECIES_SPRITE(BELLSPROUT_POKERAP, gMonBackPic_Bellsprout_POKERAP),
	SPECIES_SPRITE(WEEPINBELL_POKERAP, gMonBackPic_Weepinbell_POKERAP),
	SPECIES_SPRITE(VICTREEBEL_POKERAP, gMonBackPic_Victreebel_POKERAP),
	SPECIES_SPRITE(TENTACOOL_POKERAP, gMonBackPic_Tentacool_POKERAP),
	SPECIES_SPRITE(TENTACRUEL_POKERAP, gMonBackPic_Tentacruel_POKERAP),
	SPECIES_SPRITE(GEODUDE_POKERAP, gMonBackPic_Geodude_POKERAP),
	SPECIES_SPRITE(GRAVELER_POKERAP, gMonBackPic_Graveler_POKERAP),
	SPECIES_SPRITE(GOLEM_POKERAP, gMonBackPic_Golem_POKERAP),
	SPECIES_SPRITE(PONYTA_POKERAP, gMonBackPic_Ponyta_POKERAP),
	SPECIES_SPRITE(RAPIDASH_POKERAP, gMonBackPic_Rapidash_POKERAP),
	SPECIES_SPRITE(SLOWPOKE_POKERAP, gMonBackPic_Slowpoke_POKERAP),
	SPECIES_SPRITE(SLOWBRO_POKERAP, gMonBackPic_Slowbro_POKERAP),
	SPECIES_SPRITE(MAGNEMITE_POKERAP, gMonBackPic_Magnemite_POKERAP),
	SPECIES_SPRITE(MAGNETON_POKERAP, gMonBackPic_Magneton_POKERAP),
	SPECIES_SPRITE(FARFETCHD_POKERAP, gMonBackPic_Farfetchd_POKERAP),
	SPECIES_SPRITE(DODUO_POKERAP, gMonBackPic_Doduo_POKERAP),
	SPECIES_SPRITE(DODRIO_POKERAP, gMonBackPic_Dodrio_POKERAP),
	SPECIES_SPRITE(SEEL_POKERAP, gMonBackPic_Seel_POKERAP),
	SPECIES_SPRITE(DEWGONG_POKERAP, gMonBackPic_Dewgong_POKERAP),
	SPECIES_SPRITE(GRIMER_POKERAP, gMonBackPic_Grimer_POKERAP),
	SPECIES_SPRITE(MUK_POKERAP, gMonBackPic_Muk_POKERAP),
	SPECIES_SPRITE(SHELLDER_POKERAP, gMonBackPic_Shellder_POKERAP),
	SPECIES_SPRITE(CLOYSTER_POKERAP, gMonBackPic_Cloyster_POKERAP),
	SPECIES_SPRITE(GASTLY_POKERAP, gMonBackPic_Gastly_POKERAP),
	SPECIES_SPRITE(HAUNTER_POKERAP, gMonBackPic_Haunter_POKERAP),
	SPECIES_SPRITE(GENGAR_POKERAP, gMonBackPic_Gengar_POKERAP),
	SPECIES_SPRITE(ONIX_POKERAP, gMonBackPic_Onix_POKERAP),
	SPECIES_SPRITE(DROWZEE_POKERAP, gMonBackPic_Drowzee_POKERAP),
	SPECIES_SPRITE(HYPNO_POKERAP, gMonBackPic_Hypno_POKERAP),
	SPECIES_SPRITE(KRABBY_POKERAP, gMonBackPic_Krabby_POKERAP),
	SPECIES_SPRITE(KINGLER_POKERAP, gMonBackPic_Kingler_POKERAP),
	SPECIES_SPRITE(VOLTORB_POKERAP, gMonBackPic_Voltorb_POKERAP),
	SPECIES_SPRITE(ELECTRODE_POKERAP, gMonBackPic_Electrode_POKERAP),
	SPECIES_SPRITE(EXEGGCUTE_POKERAP, gMonBackPic_Exeggcute_POKERAP),
	SPECIES_SPRITE(EXEGGUTOR_POKERAP, gMonBackPic_Exeggutor_POKERAP),
	SPECIES_SPRITE(CUBONE_POKERAP, gMonBackPic_Cubone_POKERAP),
	SPECIES_SPRITE(MAROWAK_POKERAP, gMonBackPic_Marowak_POKERAP),
	SPECIES_SPRITE(HITMONLEE_POKERAP, gMonBackPic_Hitmonlee_POKERAP),
	SPECIES_SPRITE(HITMONCHAN_POKERAP, gMonBackPic_Hitmonchan_POKERAP),
	SPECIES_SPRITE(LICKITUNG_POKERAP, gMonBackPic_Lickitung_POKERAP),
	SPECIES_SPRITE(KOFFING_POKERAP, gMonBackPic_Koffing_POKERAP),
	SPECIES_SPRITE(WEEZING_POKERAP, gMonBackPic_Weezing_POKERAP),
	SPECIES_SPRITE(RHYHORN_POKERAP, gMonBackPic_Rhyhorn_POKERAP),
	SPECIES_SPRITE(RHYDON_POKERAP, gMonBackPic_Rhydon_POKERAP),
	SPECIES_SPRITE(CHANSEY_POKERAP, gMonBackPic_Chansey_POKERAP),
	SPECIES_SPRITE(TANGELA_POKERAP, gMonBackPic_Tangela_POKERAP),
	SPECIES_SPRITE(KANGASKHAN_POKERAP, gMonBackPic_Kangaskhan_POKERAP),
	SPECIES_SPRITE(HORSEA_POKERAP, gMonBackPic_Horsea_POKERAP),
	SPECIES_SPRITE(SEADRA_POKERAP, gMonBackPic_Seadra_POKERAP),
	SPECIES_SPRITE(GOLDEEN_POKERAP, gMonBackPic_Goldeen_POKERAP),
	SPECIES_SPRITE(SEAKING_POKERAP, gMonBackPic_Seaking_POKERAP),
	SPECIES_SPRITE(STARYU_POKERAP, gMonBackPic_Staryu_POKERAP),
	SPECIES_SPRITE(STARMIE_POKERAP, gMonBackPic_Starmie_POKERAP),
	SPECIES_SPRITE(MRMIME_POKERAP, gMonBackPic_MrMime_POKERAP),
	SPECIES_SPRITE(SCYTHER_POKERAP, gMonBackPic_Scyther_POKERAP),
	SPECIES_SPRITE(JYNX_POKERAP, gMonBackPic_Jynx_POKERAP),
	SPECIES_SPRITE(ELECTABUZZ_POKERAP, gMonBackPic_Electabuzz_POKERAP),
	SPECIES_SPRITE(MAGMAR_POKERAP, gMonBackPic_Magmar_POKERAP),
	SPECIES_SPRITE(PINSIR_POKERAP, gMonBackPic_Pinsir_POKERAP),
	SPECIES_SPRITE(TAUROS_POKERAP, gMonBackPic_Tauros_POKERAP),
	SPECIES_SPRITE(MAGIKARP_POKERAP, gMonBackPic_Magikarp_POKERAP),
	SPECIES_SPRITE(GYARADOS_POKERAP, gMonBackPic_Gyarados_POKERAP),
	SPECIES_SPRITE(LAPRAS_POKERAP, gMonBackPic_Lapras_POKERAP),
	SPECIES_SPRITE(DITTO_POKERAP, gMonBackPic_Ditto_POKERAP),
	SPECIES_SPRITE(EEVEE_POKERAP, gMonBackPic_Eevee_POKERAP),
	SPECIES_SPRITE(VAPOREON_POKERAP, gMonBackPic_Vaporeon_POKERAP),
	SPECIES_SPRITE(JOLTEON_POKERAP, gMonBackPic_Jolteon_POKERAP),
	SPECIES_SPRITE(FLAREON_POKERAP, gMonBackPic_Flareon_POKERAP),
	SPECIES_SPRITE(PORYGON_POKERAP, gMonBackPic_Porygon_POKERAP),
	SPECIES_SPRITE(OMANYTE_POKERAP, gMonBackPic_Omanyte_POKERAP),
	SPECIES_SPRITE(OMASTAR_POKERAP, gMonBackPic_Omastar_POKERAP),
	SPECIES_SPRITE(KABUTO_POKERAP, gMonBackPic_Kabuto_POKERAP),
	SPECIES_SPRITE(KABUTOPS_POKERAP, gMonBackPic_Kabutops_POKERAP),
	SPECIES_SPRITE(AERODACTYL_POKERAP, gMonBackPic_Aerodactyl_POKERAP),
	SPECIES_SPRITE(SNORLAX_POKERAP, gMonBackPic_Snorlax_POKERAP),
	SPECIES_SPRITE(ARTICUNO_POKERAP, gMonBackPic_Articuno_POKERAP),
	SPECIES_SPRITE(ZAPDOS_POKERAP, gMonBackPic_Zapdos_POKERAP),
	SPECIES_SPRITE(MOLTRES_POKERAP, gMonBackPic_Moltres_POKERAP),
	SPECIES_SPRITE(DRATINI_POKERAP, gMonBackPic_Dratini_POKERAP),
	SPECIES_SPRITE(DRAGONAIR_POKERAP, gMonBackPic_Dragonair_POKERAP),
	SPECIES_SPRITE(DRAGONITE_POKERAP, gMonBackPic_Dragonite_POKERAP),
	SPECIES_SPRITE(MEWTWO_POKERAP, gMonBackPic_Mewtwo_POKERAP),



    	SPECIES_SPRITE(REVENANT, gMonBackPic_REVENANT),
	SPECIES_SPRITE(UNOWNS, gMonBackPic_UNOWNS),
	SPECIES_SPRITE(UNOWNE, gMonBackPic_UNOWNE),
	SPECIES_SPRITE(UNOWNN, gMonBackPic_UNOWNN),
	SPECIES_SPRITE(UNOWND, gMonBackPic_UNOWND),
	SPECIES_SPRITE(RELICANTHPAST, gMonBackPic_RELICANTHPAST),
	SPECIES_SPRITE(RELICANTHFUTURE, gMonBackPic_RELICANTHFUTURE),
	SPECIES_SPRITE(POKEMONRAP, gMonBackPic_POKEMONRAP),
	SPECIES_SPRITE(NIDORANMPOKERAP, gMonBackPic_NIDORANMPOKERAP),
	SPECIES_SPRITE(NIDORANFPOKERAP, gMonBackPic_NIDORANFPOKERAP),
	SPECIES_SPRITE(THATSALL, gMonBackPic_THATSALL),
	SPECIES_SPRITE(KANGASKHANTEACHER, gMonBackPic_KANGASKHANTEACHER),
	SPECIES_SPRITE(TANGELACREEPY, gMonBackPic_TANGELACREEPY),
	SPECIES_SPRITE(CHANSEYBLANK, gMonBackPic_CHANSEYBLANK),
	SPECIES_SPRITE(IRONCLEFTGREEN, gMonBackPic_IRONCLEFTGREEN),
	SPECIES_SPRITE(LATIASBLAZIKEN, gMonBackPic_LATIASBLAZIKEN),
	SPECIES_SPRITE(MONICA, gMonBackPic_Monica),
	SPECIES_SPRITE(IRONBUTT, gMonBackPic_IRONBUTT),
	SPECIES_SPRITE(RELICRABBY, gMonBackPic_Relicrabby),
	SPECIES_SPRITE(EGEXCSUTER, gMonBackPic_EGEXCSUTER),
	SPECIES_SPRITE(GYARADOS_LANCE, gMonBackPic_GyaradosLance),
	SPECIES_SPRITE(ALAKAZAMTCG, gMonBackPic_AlakazamTCG),
	SPECIES_SPRITE(REGIEYES, gMonBackPic_REGIEYES),
	SPECIES_SPRITE(REGIFILSAMIE, gMonBackPic_REGIFILSAMIE),
	SPECIES_SPRITE(SOLACEON, gMonBackPic_SOLACEON),
	SPECIES_SPRITE(PORYGON64, gMonBackPic_PORYGON64),
	SPECIES_SPRITE(PORYGON32, gMonBackPic_PORYGON32),
	SPECIES_SPRITE(STARMIEMEGA, gMonBackPic_STARMIEMEGA),
	SPECIES_SPRITE(GIRAFARIGBOTTOM, gMonBackPic_GIRAFARIGBOTTOM),
	SPECIES_SPRITE(GIRAFARIGBUTT, gMonBackPic_GIRAFARIGBUTT),
	SPECIES_SPRITE(MEWTWOW, gMonBackPic_MEWTWOW),
	SPECIES_SPRITE(CHARIZARDQ, gMonBackPic_CHARIZARDQ),
	SPECIES_SPRITE(HOOT, gMonBackPic_HOOT),
	SPECIES_SPRITE(ZAPMOLCUNO, gMonBackPic_ZAPMOLCUNO),
	SPECIES_SPRITE(UNITEDKINGDOM, gMonBackPic_UNITEDKINGDOM),
	SPECIES_SPRITE(FIRETYPES, gMonBackPic_FIRETYPES),
	SPECIES_SPRITE(RATICATEGHOST, gMonBackPic_RATICATEGHOST),
	SPECIES_SPRITE(FINALLUGIA, gMonBackPic_FINALLUGIA),
	SPECIES_SPRITE(FINALARTICUNO, gMonBackPic_FINALARTICUNO),
	SPECIES_SPRITE(FINALHOOH, gMonBackPic_FINALHOOH),
	SPECIES_SPRITE(FINALZAPDOS, gMonBackPic_FINALZAPDOS),
	SPECIES_SPRITE(FINALMOLTRES, gMonBackPic_FINALMOLTRES),
	SPECIES_SPRITE(FINALWARTORTLE, gMonBackPic_FINALWARTORTLE),
	SPECIES_SPRITE(DODODUO, gMonBackPic_DODODUO),
	SPECIES_SPRITE(CELEBI2, gMonBackPic_CELEBI2),
	SPECIES_SPRITE(PIKACHUSURF, gMonBackPic_PIKACHUSURF),
	SPECIES_SPRITE(SHINYABRA, gMonBackPic_SHINYABRA),
	SPECIES_SPRITE(EARRAT, gMonBackPic_EARRAT),
	SPECIES_SPRITE(FINALCHARMANDER, gMonBackPic_Charmander),
	SPECIES_SPRITE(CELIASSTUPIDROMHACK, gMonBackPic_CELIASSTUPIDROMHACK),
    SPECIES_SPRITE(KECLEON_WIZ1989, gMonBackPic_Kecleon),
	SPECIES_SPRITE(GREGORY, gMonBackPic_GREGORY),
	SPECIES_SPRITE(ARCEUSLAST, gMonBackPic_ARCEUSLAST),
	SPECIES_SPRITE(NOTHING, gMonBackPic_NOTHING),
	SPECIES_SPRITE(DITTOBLIZ, gMonBackPic_DITTOBLIZ),
	SPECIES_SPRITE(IRONMASK, gMonBackPic_IRONMASK),
	SPECIES_SPRITE(ZOMBON, gMonBackPic_ZOMBON),
	SPECIES_SPRITE(TINKANETTE, gMonBackPic_TINKANETTE),
	SPECIES_SPRITE(RICKETOT, gMonBackPic_RICKETOT),
	SPECIES_SPRITE(IMAKUNIDODUO, gMonBackPic_IMAKUNIDODUO),
	SPECIES_SPRITE(ABSOLYNE, gMonBackPic_ABSOLYNE),
	SPECIES_SPRITE(LICHENMASQUERAIN, gMonBackPic_LICHENMASQUERAIN),
	SPECIES_SPRITE(LICHENMAWILE, gMonBackPic_LICHENMAWILE),
	SPECIES_SPRITE(DMCACUTOUT, gMonBackPic_DMCACUTOUT),
