const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_YVELTAL] = _("Y{UNDERSCORE}ELTAL"),
    ...
    [SPECIES_THIEVUL] = _("THIE{UNDERSCORE}UL"),
    ...
    [SPECIES_OBSTAGOON] = _("NOBSTAGOON"),
    ...
    [SPECIES_DUDUNSPARCE] = _("DUDUNSPRSE"),
    ...
    [SPECIES_RATTATA_SHINY] = _("RATTATA"),
        [SPECIES_PIKACHU_BIRTHDAY] = _("PIKACHU"),
    [SPECIES_MEW_ANCIENT] = _("MEW"),
    [SPECIES_PIKACHU_OLD] = _("PIKACHU"),
    [SPECIES_GENESECT_SHINY] = _("GENESECT"),
    [SPECIES_IRON_CLEFT] = _("IRON CLEFT"),
    [SPECIES_VULPIX_ALOLA] = _("VULPIX"),
    [SPECIES_WEEZING_ALOLA] = _("WEEZING"),
    [SPECIES_THIS_GUY] = _("THIS GUY"),
    [SPECIES_STEAMBOAT_WILLIE] = _("WILLIE"),
    [SPECIES_PIDGEOT_OLD] = _("aaabaaajss"),
    [SPECIES_STRYKE] = _("STRYKE"),
    [SPECIES_BUTTERFREE_FEMALE] = _("BUTTERFREE"),
    [SPECIES_PIKACHU_FAT_GAY] = _("PIKACHU"),
    [SPECIES_TRAPINCH_PIKACHU] = _("TRAPINCH"),
    [SPECIES_KECLEON_SANS] = _("KECLEON"),
    //[SPECIES_RATTATA_SHINY] = _("RATTATA"),
    [SPECIES_PORYGON_16] = _("PORYGON16"),
    [SPECIES_PORYGON_8] = _("PORYGON8"),
    [SPECIES_PORYGON_4] = _("PORYGON2"),
    [SPECIES_PORIST_GAMES] = _("PORISTGAME"),
    [SPECIES_MISCARRIAGE_KANGA] = _("KANGASKHAN"),
    [SPECIES_GHOST] = _("GHOST"),
    [SPECIES_VENOMOTH_ATV] = _("VENOMOTH"),
    [SPECIES_RATICATE_ALOLA] = _("RATICATE"),
    [SPECIES_MULTIPAL] = _("MULTIPAL"),
    [SPECIES_DIVIDUM] = _("DIVIDUM"),
    [SPECIES_EXPONELLE] = _("EXPONELLE"),
    [SPECIES_PIKACHU_SNAP_SURF] = _("PIKACHU"),
    [SPECIES_PIKACHU_SNAP_BALL] = _("PIKACHU"),
    [SPECIES_PIKACHU_SNAP_FLYING] = _("PIKACHU"),
    [SPECIES_PIKACHU_SNAP_CLOSE] = _("PIKACHU"),
    [SPECIES_RATICATE_DEAD] = _("RATICATE"),
    [SPECIES_SHEDINJA_ELECTRIC] = _("SHEDINJA"),
    [SPECIES_VENUSAUR_MEGA] = _("VENUSAUR"),
    [SPECIES_UNOWN_NUDES] = _("UNOWN"),
    [SPECIES_PORYGON22] = _("PORYGON22"),
    [SPECIES_HO_OWO] = _("HO-OWO"),
    [SPECIES_RATATATTA] = _("RATATATTA"),
    [SPECIES_BULBASAUR_POKERAP] = _("BULBASAUR"),
    [SPECIES_IVYSAUR_POKERAP] = _("IVYSAUR"),
    [SPECIES_VENUSAUR_POKERAP] = _("VENUSAUR"),
    [SPECIES_CHARMANDER_POKERAP] = _("CHARMANDER"),
    [SPECIES_CHARMELEON_POKERAP] = _("CHARMELEON"),
    [SPECIES_CHARIZARD_POKERAP] = _("CHARIZARD"),
    [SPECIES_SQUIRTLE_POKERAP] = _("SQUIRTLE"),
    [SPECIES_WARTORTLE_POKERAP] = _("WARTORTLE"),
    [SPECIES_BLASTOISE_POKERAP] = _("BLASTOISE"),
    [SPECIES_CATERPIE_POKERAP] = _("CATERPIE"),
    [SPECIES_METAPOD_POKERAP] = _("METAPOD"),
    [SPECIES_BUTTERFREE_POKERAP] = _("BUTTERFREE"),
    [SPECIES_WEEDLE_POKERAP] = _("WEEDLE"),
    [SPECIES_KAKUNA_POKERAP] = _("KAKUNA"),
    [SPECIES_BEEDRILL_POKERAP] = _("BEEDRILL"),
    [SPECIES_PIDGEY_POKERAP] = _("PIDGEY"),
    [SPECIES_PIDGEOTTO_POKERAP] = _("PIDGEOTTO"),
    [SPECIES_PIDGEOT_POKERAP] = _("PIDGEOT"),
    [SPECIES_RATTATA_POKERAP] = _("RATTATA"),
    [SPECIES_RATICATE_POKERAP] = _("RATICATE"),
    [SPECIES_SPEAROW_POKERAP] = _("SPEAROW"),
    [SPECIES_FEAROW_POKERAP] = _("FEAROW"),
    [SPECIES_EKANS_POKERAP] = _("EKANS"),
    [SPECIES_ARBOK_POKERAP] = _("ARBOK"),
    [SPECIES_PIKACHU_POKERAP] = _("PIKACHU"),
    [SPECIES_RAICHU_POKERAP] = _("RAICHU"),
    [SPECIES_SANDSHREW_POKERAP] = _("SANDSHREW"),
    [SPECIES_SANDSLASH_POKERAP] = _("SANDSLASH"),
    [SPECIES_NIDORINA_POKERAP] = _("NIDORINA"),
    [SPECIES_NIDOQUEEN_POKERAP] = _("NIDOQUEEN"),
    [SPECIES_NIDORINO_POKERAP] = _("NIDORINO"),
    [SPECIES_NIDOKING_POKERAP] = _("NIDOKING"),
    [SPECIES_CLEFAIRY_POKERAP] = _("CLEFAIRY"),
    [SPECIES_CLEFABLE_POKERAP] = _("CLEFABLE"),
    [SPECIES_VULPIX_POKERAP] = _("VULPIX"),
    [SPECIES_NINETALES_POKERAP] = _("NINETALES"),
    [SPECIES_JIGGLYPUFF_POKERAP] = _("JIGGLYPUFF"),
    [SPECIES_WIGGLYTUFF_POKERAP] = _("WIGGLYTUFF"),
    [SPECIES_ZUBAT_POKERAP] = _("ZUBAT"),
    [SPECIES_GOLBAT_POKERAP] = _("GOLBAT"),
    [SPECIES_ODDISH_POKERAP] = _("ODDISH"),
    [SPECIES_GLOOM_POKERAP] = _("GLOOM"),
    [SPECIES_VILEPLUME_POKERAP] = _("VILEPLUME"),
    [SPECIES_PARAS_POKERAP] = _("PARAS"),
    [SPECIES_PARASECT_POKERAP] = _("PARASECT"),
    [SPECIES_VENONAT_POKERAP] = _("VENONAT"),
    [SPECIES_VENOMOTH_POKERAP] = _("VENOMOTH"),
    [SPECIES_DIGLETT_POKERAP] = _("DIGLETT"),
    [SPECIES_DUGTRIO_POKERAP] = _("DUGTRIO"),
    [SPECIES_MEOWTH_POKERAP] = _("MEOWTH"),
    [SPECIES_PERSIAN_POKERAP] = _("PERSIAN"),
    [SPECIES_PSYDUCK_POKERAP] = _("PSYDUCK"),
    [SPECIES_GOLDUCK_POKERAP] = _("GOLDUCK"),
    [SPECIES_MANKEY_POKERAP] = _("MANKEY"),
    [SPECIES_PRIMEAPE_POKERAP] = _("PRIMEAPE"),
    [SPECIES_GROWLITHE_POKERAP] = _("GROWLITHE"),
    [SPECIES_ARCANINE_POKERAP] = _("ARCANINE"),
    [SPECIES_POLIWAG_POKERAP] = _("POLIWAG"),
    [SPECIES_POLIWHIRL_POKERAP] = _("POLIWHIRL"),
    [SPECIES_POLIWRATH_POKERAP] = _("POLIWRATH"),
    [SPECIES_ABRA_POKERAP] = _("ABRA"),
    [SPECIES_KADABRA_POKERAP] = _("KADABRA"),
    [SPECIES_ALAKAZAM_POKERAP] = _("ALAKAZAM"),
    [SPECIES_MACHOP_POKERAP] = _("MACHOP"),
    [SPECIES_MACHOKE_POKERAP] = _("MACHOKE"),
    [SPECIES_MACHAMP_POKERAP] = _("MACHAMP"),
    [SPECIES_BELLSPROUT_POKERAP] = _("BELLSPROUT"),
    [SPECIES_WEEPINBELL_POKERAP] = _("WEEPINBELL"),
    [SPECIES_VICTREEBEL_POKERAP] = _("VICTREEBEL"),
    [SPECIES_TENTACOOL_POKERAP] = _("TENTACOOL"),
    [SPECIES_TENTACRUEL_POKERAP] = _("TENTACRUEL"),
    [SPECIES_GEODUDE_POKERAP] = _("GEODUDE"),
    [SPECIES_GRAVELER_POKERAP] = _("GRAVELER"),
    [SPECIES_GOLEM_POKERAP] = _("GOLEM"),
    [SPECIES_PONYTA_POKERAP] = _("PONYTA"),
    [SPECIES_RAPIDASH_POKERAP] = _("RAPIDASH"),
    [SPECIES_SLOWPOKE_POKERAP] = _("SLOWPOKE"),
    [SPECIES_SLOWBRO_POKERAP] = _("SLOWBRO"),
    [SPECIES_MAGNEMITE_POKERAP] = _("MAGNEMITE"),
    [SPECIES_MAGNETON_POKERAP] = _("MAGNETON"),
    [SPECIES_FARFETCHD_POKERAP] = _("FARFETCH'D"),
    [SPECIES_DODUO_POKERAP] = _("DODUO"),
    [SPECIES_DODRIO_POKERAP] = _("DODRIO"),
    [SPECIES_SEEL_POKERAP] = _("SEEL"),
    [SPECIES_DEWGONG_POKERAP] = _("DEWGONG"),
    [SPECIES_GRIMER_POKERAP] = _("GRIMER"),
    [SPECIES_MUK_POKERAP] = _("MUK"),
    [SPECIES_SHELLDER_POKERAP] = _("SHELLDER"),
    [SPECIES_CLOYSTER_POKERAP] = _("CLOYSTER"),
    [SPECIES_GASTLY_POKERAP] = _("GASTLY"),
    [SPECIES_HAUNTER_POKERAP] = _("HAUNTER"),
    [SPECIES_GENGAR_POKERAP] = _("GENGAR"),
    [SPECIES_ONIX_POKERAP] = _("ONIX"),
    [SPECIES_DROWZEE_POKERAP] = _("DROWZEE"),
    [SPECIES_HYPNO_POKERAP] = _("HYPNO"),
    [SPECIES_KRABBY_POKERAP] = _("KRABBY"),
    [SPECIES_KINGLER_POKERAP] = _("KINGLER"),
    [SPECIES_VOLTORB_POKERAP] = _("VOLTORB"),
    [SPECIES_ELECTRODE_POKERAP] = _("ELECTRODE"),
    [SPECIES_EXEGGCUTE_POKERAP] = _("EXEGGCUTE"),
    [SPECIES_EXEGGUTOR_POKERAP] = _("EXEGGUTOR"),
    [SPECIES_CUBONE_POKERAP] = _("CUBONE"),
    [SPECIES_MAROWAK_POKERAP] = _("MAROWAK"),
    [SPECIES_HITMONLEE_POKERAP] = _("HITMONLEE"),
    [SPECIES_HITMONCHAN_POKERAP] = _("HITMONCHAN"),
    [SPECIES_LICKITUNG_POKERAP] = _("LIKITUNG"),
    [SPECIES_KOFFING_POKERAP] = _("KOFFING"),
    [SPECIES_WEEZING_POKERAP] = _("WEEZING"),
    [SPECIES_RHYHORN_POKERAP] = _("RHYHORN"),
    [SPECIES_RHYDON_POKERAP] = _("RHYDON"),
    [SPECIES_CHANSEY_POKERAP] = _("CHANSEY"),
    [SPECIES_TANGELA_POKERAP] = _("TANGELA"),
    [SPECIES_KANGASKHAN_POKERAP] = _("KANGASKHAN"),
    [SPECIES_HORSEA_POKERAP] = _("HORSEA"),
    [SPECIES_SEADRA_POKERAP] = _("SEADRA"),
    [SPECIES_GOLDEEN_POKERAP] = _("GOLDEEN"),
    [SPECIES_SEAKING_POKERAP] = _("SEAKING"),
    [SPECIES_STARYU_POKERAP] = _("STARYU"),
    [SPECIES_STARMIE_POKERAP] = _("STARMIE"),
    [SPECIES_MRMIME_POKERAP] = _("MR. MIME"),
    [SPECIES_SCYTHER_POKERAP] = _("SCYTHER"),
    [SPECIES_JYNX_POKERAP] = _("JYNX"),
    [SPECIES_ELECTABUZZ_POKERAP] = _("ELECTABUZZ"),
    [SPECIES_MAGMAR_POKERAP] = _("MAGMAR"),
    [SPECIES_PINSIR_POKERAP] = _("PINSIR"),
    [SPECIES_TAUROS_POKERAP] = _("TAUROS"),
    [SPECIES_MAGIKARP_POKERAP] = _("MAGIKARP"),
    [SPECIES_GYARADOS_POKERAP] = _("GYARADOS"),
    [SPECIES_LAPRAS_POKERAP] = _("LAPRAS"),
    [SPECIES_DITTO_POKERAP] = _("DITTO"),
    [SPECIES_EEVEE_POKERAP] = _("EEVEE"),
    [SPECIES_VAPOREON_POKERAP] = _("VAPOREON"),
    [SPECIES_JOLTEON_POKERAP] = _("JOLTEON"),
    [SPECIES_FLAREON_POKERAP] = _("FLAREON"),
    [SPECIES_PORYGON_POKERAP] = _("PORYGON"),
    [SPECIES_OMANYTE_POKERAP] = _("OMANYTE"),
    [SPECIES_OMASTAR_POKERAP] = _("OMASTAR"),
    [SPECIES_KABUTO_POKERAP] = _("KABUTO"),
    [SPECIES_KABUTOPS_POKERAP] = _("KABUTOPS"),
    [SPECIES_AERODACTYL_POKERAP] = _("AERODACTYL"),
    [SPECIES_SNORLAX_POKERAP] = _("SNORLAX"),
    [SPECIES_ARTICUNO_POKERAP] = _("ARTICUNO"),
    [SPECIES_ZAPDOS_POKERAP] = _("ZAPDOS"),
    [SPECIES_MOLTRES_POKERAP] = _("MOLTRES"),
    [SPECIES_DRATINI_POKERAP] = _("DRATINI"),
    [SPECIES_DRAGONAIR_POKERAP] = _("DRAGONAIR"),
    [SPECIES_DRAGONITE_POKERAP] = _("DRAGONITE"),
    [SPECIES_MEWTWO_POKERAP] = _("MEWTWO"),

    [SPECIES_REVENANT] = _("DOOMSDAY"),
    [SPECIES_UNOWNS] = _("UNOWN"),
    [SPECIES_UNOWNE] = _("UNOWN"),
    [SPECIES_UNOWNN] = _("UNOWN"),
    [SPECIES_UNOWND] = _("UNOWN"),
    [SPECIES_RELICANTHPAST] = _("ABYSS JAW"),
    [SPECIES_RELICANTHFUTURE] = _("IRON FIN"),
    [SPECIES_POKEMONRAP] = _("POKEMON"),
    [SPECIES_NIDORANMPOKERAP] = _("NIDORAN"),
    [SPECIES_NIDORANFPOKERAP] = _("NIDORAN"),
    [SPECIES_THATSALL] = _("THAT'S ALL"),
    [SPECIES_KANGASKHANTEACHER] = _("KANGASKHAN"),
    [SPECIES_TANGELACREEPY] = _("TANGELA"),
    [SPECIES_CHANSEYBLANK] = _("CHANSEY"),
    [SPECIES_IRONCLEFTGREEN] = _("IRON CLEFT"),
    [SPECIES_LATIASBLAZIKEN] = _("LATIAS"),
    [SPECIES_MONICA] = _("IRON FEET"),
    [SPECIES_IRONBUTT] = _("IRON BUTT"),
    [SPECIES_RELICRABBY] = _("KRABBY"),
    [SPECIES_EGEXCSUTER] = _("EGCEXSUTER"),
    [SPECIES_GYARADOS_LANCE] = _("GYARADOS"),
    [SPECIES_ALAKAZAMTCG] = _("ALAKAZAM"),
    [SPECIES_REGIEYES] = _("REGIEYES"),
    [SPECIES_REGIFILSAMIE] = _("REGIFISAMI"),
    [SPECIES_SOLACEON] = _("SOLACEON"),
    [SPECIES_PORYGON64] = _("PORYGON64"),
    [SPECIES_PORYGON32] = _("PORYGON32"),
    [SPECIES_STARMIEMEGA] = _("STARMIE"),
    [SPECIES_GIRAFARIGBOTTOM] = _("GIRAFARIG"),
    [SPECIES_GIRAFARIGBUTT] = _("GIRAFARIG"),
    ...
    [SPECIES_RATICATEGHOST] = _("RATICATE"),
    [SPECIES_FINALLUGIA] = _("LUGIA"),
    [SPECIES_FINALARTICUNO] = _("ARTICUNO"),
    [SPECIES_FINALHOOH] = _("HO-OH"),
    [SPECIES_FINALZAPDOS] = _("ZAPDOS"),
    [SPECIES_FINALMOLTRES] = _("MOLTRES"),
    [SPECIES_FINALWARTORTLE] = _("WARTORTLE"),
    [SPECIES_DODODUO] = _("DODODUO"),
    [SPECIES_CELEBI2] = _("CELEBI"),
    [SPECIES_PIKACHUSURF] = _("PIKACHU"),
    [SPECIES_SHINYABRA] = _("ABRA"),
    [SPECIES_EARRAT] = _("RATTATA"),
    [SPECIES_FINALCHARMANDER] = _("CHARMANDER"),
    [SPECIES_CELIASSTUPIDROMHACK] = _("STUPIDHACK"),
    [SPECIES_KECLEON_WIZ1989] = _("KECLEON"),
    [SPECIES_GREGORY] = _("GREGORY"),
    [SPECIES_ARCEUSLAST] = _("ARCEUS"),
    [SPECIES_NOTHING] = _("NOTHING"),
    [SPECIES_DITTOBLIZ] = _("D.I.T.O"),
    [SPECIES_IRONMASK] = _("IRON MASK"),
    [SPECIES_ZOMBON] = _("ZOMBON"),
    [SPECIES_TINKANETTE] = _("TINKANETTE"),
    [SPECIES_RICKETOT] = _("RICKETOT"),
    [SPECIES_IMAKUNIDODUO] = _("DODUO"),
    [SPECIES_ABSOLYNE] = _("ABSOLYNE"),
    [SPECIES_LICHENMASQUERAIN] = _("MASQUERAIN"),
    [SPECIES_LICHENMAWILE] = _("MAWILE"),
    [SPECIES_DMCACUTOUT] = _("DMCAGRUNT?"),
};
