...
static const u8 sIntimidateDescription[] = _(".KCATTA s'eof eht srewoL");
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_DISGUISE] = COMPOUND_STRING("DUMMY."),
    [ABILITY_ETAADIMITNI] = COMPOUND_STRING("DUMMY."), //unused
    ...
    [ABILITY_LOSSPITALITY] = COMPOUND_STRING("DUMMY."),
    [ABILITY_DOWNLOAD] = COMPOUND_STRING("Downloads what it sees."),
    ...
    [ABILITY_SKILL_LINK] = COMPOUND_STRING("Multi-hit always hits 5."),
    [ABILITY_AS_ONE_SLOWBRO] =COMPOUND_STRING("SKILL LINK and OBLIVIOUS."),
    [ABILITY_TOWNLOAD] = COMPOUND_STRING("Burns the foe on contact."),
    [ABILITY_ANTICIPATEON] = COMPOUND_STRING("DUMMY."),
    [ABILITY_RATTLED] = COMPOUND_STRING("DUMMY."),
    [ABILITY_TANGLED_HAIR] = COMPOUND_STRING("DUMMY."),
    [ABILITY_NOODY] = COMPOUND_STRING("DUMMY."),
    ...
    [ABILITY_RED_GUARD] = COMPOUND_STRING("DEFEATS FUCKIN' UGLY REDS"),
    [ABILITY_SCRAPPY] = COMPOUND_STRING("NORMAL and FIGHT hit GHOST."),
    [ABILITY_PROTOSYNTHESIS] = COMPOUND_STRING("User is veeeeeery old."),
    [ABILITY_SOUL_HEART] = COMPOUND_STRING("DUMMY."),
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_INTIMIDATE] = _("ETADIMITNI"),
    ...
    [ABILITY_VICTOTY_STAR] = _("VICTOTY STAR"),
    [ABILITY_AS_ONE_BULBASAUR] = _("AS ONE"),
    [ABILITY_DISGUISE] = _("DISGUISE"),
    [ABILITY_ETAADIMITNI] = _("ETAADIMITNI"),
