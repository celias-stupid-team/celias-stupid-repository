...
static const u8 sRelaxedNatureName[] = _("SNORLAX (again)");
static const u8 sImpishNatureName[] = _("DWARVEN");
static const u8 sLaxNatureName[] = _("SNORLAX");
static const u8 sTimidNatureName[] = _("SILLY"); //Switched Timmy and Silly so Dad could be silly without having to calculate a new personality value
...
static const u8 sModestNatureName[] = _("TIMMY");
static const u8 sMildNatureName[] = _("SPICY");
