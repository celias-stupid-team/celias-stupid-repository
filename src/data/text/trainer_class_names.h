const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_FRONTIER_BRAIN]        = _("FRONT. BRIAN"),
    ...
    [TRAINER_CLASS_ANGRY_NERD]          = _("ANGRY NERD"),
    ...
    [TRAINER_CLASS_PSYCHIC]             = _("SMARTTRAINER"),
    ...
    [TRAINER_CLASS_DMCA]         = _("DMCA"),
    [TRAINER_CLASS_DMCA_ADMIN]          = _("DMCA"),
    ...
    [TRAINER_CLASS_BUTTERFINGERS]             = _("BUTTERFINGRS"),
    ...
    [TRAINER_CLASS_MASTER]             = _("CLUB MASTER"),
    [TRAINER_CLASS_RAPPER]             = _("RAPPER"),
    [TRAINER_CLASS_COP]             = _("COP"),
    [TRAINER_CLASS_SKIRT]             = _("SKIRT"),
    ...
    [TRAINER_CLASS_STARLIGHT]             = _("STARLIGHT"),
};
