...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_RS_FISHERMAN]           = TRAINER_CLASS_FRONTIER_BRAIN,
    ...
    [FACILITY_CLASS_MAGMA_GRUNT_M]          = TRAINER_CLASS_TEAM_SKY,
    [FACILITY_CLASS_MAGMA_GRUNT_F]          = TRAINER_CLASS_TEAM_SKY,
    ...
    [FACILITY_CLASS_YOUNGSTER]              = TRAINER_CLASS_SHORTS,
    ...
    [FACILITY_CLASS_SUPER_NERD]             = TRAINER_CLASS_ANGRY_NERD,
    ...
    [FACILITY_CLASS_ROCKET_GRUNT_M]         = TRAINER_CLASS_DMCA,
    ...
    [FACILITY_CLASS_ROCKET_GRUNT_F]         = TRAINER_CLASS_DMCA,
