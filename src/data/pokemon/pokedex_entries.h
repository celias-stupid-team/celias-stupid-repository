const struct PokedexEntry gPokedexEntries[] =
{
    ...
    [NATIONAL_DEX_JIGGLYPUFF_ABOVE] =
    {
        .categoryName = _("ROUND"),
        .height = 5,
        .weight = 5.5,
        .description = gJigglypuffAbovePokedexText,
        .unusedDescription = gDummyPokedexTextUnused,
        .pokemonScale = 363,   
        .pokemonOffset = 0,
        .trainerScale = 256,
    ...
    [NATIONAL_DEX_TENTAQUIL] =
    {
        .categoryName = _("TENTAQUIL"),
        .height = 7,
        .weight = 51.9,
        .description = gTentaquilPokedexText,
        .unusedDescription = gDummyPokedexTextUnused,
        .pokemonScale = 271,  
        .pokemonOffset = 0,
        .trainerScale = 317,
    ...
    [NATIONAL_DEX_HITMONCHAN_SHIT] =
    {
        .categoryName = _("SILHOUETTE"),
        .height = 1,
        .weight = 1,
        .description = gHitmonchanShitPokedexText,
        .unusedDescription = gDummyPokedexTextUnused,
        .pokemonScale = 271,  
        .pokemonOffset = 0,
        .trainerScale = 317,
    ...
    [NATIONAL_DEX_HITMONCHIN] =
    {
        .categoryName = _("HAPPYSOFT"),
        .height = 172,
        .weight = 64,
        .description = gHitmonchinPokedexText,
        .unusedDescription = gDummyPokedexTextUnused,
        .pokemonScale = 271,  
        .pokemonOffset = 0,
        .trainerScale = 317,
    ...
    [NATIONAL_DEX_UNOWN_LOSS] =
    {
        .categoryName = _("MEMETIC"),
        .height = 1,
        .weight = 1,
        .description = gUnownLossPokedexText,
        .unusedDescription = gDummyPokedexTextUnused,
        .pokemonScale = 363,   
        .pokemonOffset = 0,
        .trainerScale = 256,
    ...
    [NATIONAL_DEX_YOSHI] =
    {
        .categoryName = _("SAFARI"),
        .height = 17,
        .weight = 81,
        .description = gYoshiPokedexText,
        .unusedDescription = gDummyPokedexTextUnused,
        .pokemonScale = 271,  
        .pokemonOffset = 0,
        .trainerScale = 317,
    ...
    [NATIONAL_DEX_MAGNALONE] =
    {
        .categoryName = _("FORLORN"),
        .height = 3,
        .weight = 6,
        .description = gMagnetonPokedexText,
        .unusedDescription = gDummyPokedexTextUnused,
    ...
    [NATIONAL_DEX_SOLACEON] =
    {
        ...
        .height = 12,
        .weight = 24,
        .description = gSolaceonPokedexText,
        .unusedDescription = gDummyPokedexTextUnused,
        .pokemonScale = 363,   
        .pokemonOffset = 0,
        .trainerScale = 256,
    ...
    [NATIONAL_DEX_TYRANASTAR] =
    {
        .categoryName = _("PLACEHOLDER"),
        .height = 25,
        .weight = 270,
        .description = gTyranastarPokedexText,
        .unusedDescription = gDummyPokedexTextUnused,
        .pokemonScale = 271,  
        .pokemonOffset = 0,
        .trainerScale = 317,
    ...
    [NATIONAL_DEX_DITTO_MEW] =
    {
        ...
        .height = 4,
        .weight = 4,
        .description = gDittoMewPokedexText,
        .unusedDescription = gDummyPokedexTextUnused,
        .pokemonScale = 541,
        .pokemonOffset = 0,
        .trainerScale = 256,
