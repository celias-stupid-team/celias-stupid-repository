const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_FINALCHARMANDER]    = {{EVO_LEVEL, 5, SPECIES_WARTORTLE}}, //
    [SPECIES_WARTORTLE]    = {{EVO_LEVEL, 55, SPECIES_KRABBY}}, //
    ...
    [SPECIES_DRAGONITE]  = {{EVO_ITEM, ITEM_SUPER_SCOPE, SPECIES_YOSHI},
                            {EVO_ITEM, ITEM_SCOPE_CREEP, SPECIES_YOSHI},},
    ...
    [SPECIES_ARTICUNO]    = {{EVO_HOLD_ITEM, ITEM_SOOTHE_BELL, SPECIES_ESPEON}},
    ...
    [SPECIES_AMPHAROS]     = {{EVO_ITEM, ITEM_PRETTY_HAIR, SPECIES_AMPHAROS_MEGA}},
    ...
    [SPECIES_CHANSEY]     = {{EVO_LEVEL, 35, SPECIES_SPEAROW}},
    ...
    [SPECIES_ALOMOMOLA]     = {{EVO_HAIRCUT, 1, SPECIES_LUVDISC}},
    ...
    [SPECIES_MELTAN]     = {{EVO_LEVEL, 1, SPECIES_MELMETAL}},
    //[SPECIES_POKEMON_GUN]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_VENUSAUR]     = {{EVO_LEVEL, 1, SPECIES_MEOWTH}},
};
