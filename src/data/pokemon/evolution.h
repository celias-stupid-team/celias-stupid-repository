const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_FINALCHARMANDER]    = {{EVO_LEVEL, 1, SPECIES_WARTORTLE}}, //Starter loop
    [SPECIES_WARTORTLE]    = {{EVO_LEVEL, 55, SPECIES_KRABBY}}, //Starter loop
    ...
    [SPECIES_CHANSEY]     = {{EVO_LEVEL, 1, SPECIES_SPEAROW}},
