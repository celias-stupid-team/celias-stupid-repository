const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_COMBEE]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},                 
    ...
    [SPECIES_NIDORAN_M]  = {{EVO_LEVEL, 16, SPECIES_NIDORINA}},
    ...
    [SPECIES_MANKEY]     = {{EVO_LEVEL, 19, SPECIES_PRIMEAPE}},
    ...
    [SPECIES_NIDOKING]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_CLEFABLE]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_GENGAR]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_NINETALES]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_DUGTRIO]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_TOEDSCOOL]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_PARASECT]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_AMOONGUSS]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    ...
    [SPECIES_PSYDUCK]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    ...
    [SPECIES_HITMONCHAN_SHIT]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_PORYGON_Z]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_CLOYSTER]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_ONIX]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_PLUG_OINK]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_LICKITUNG]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_CHERUBI]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_ODDISH]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_GOLBAT]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_YOSHI]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_REMORAID]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_MAGNALONE]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_ALCREMIE]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_DACHSBUN]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_SLOWPOKE]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_SLOWBRO]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_SEEL]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_LUMINEON]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_SYLVEON]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_LATIAS]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_EXEGGUTOR]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_SPEAROW]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_FARFETCHD]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_GOLURK]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    //[SPECIES_BIDOOF]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_MUK]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_AMPHAROS]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_SMEARGLE]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_GOLEM]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_TRUBBISH]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_HITMONCHIN]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_RHYDON]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_PERSIAN]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_CHANSEY]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_MR_MIME]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_JYNX]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_PINSIR]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_TAUROS]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_OMANYTE]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_TYRANASTAR]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_YANMEGA]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_ALOMOMOLA]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_DITTO]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_ORTHWORM]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    ...
    [SPECIES_ETERNATUS]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_ZYGARDE]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_MELMETAL]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_POKEMON_GUN]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_MEWTWO]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
    [SPECIES_VENUSAUR]     = {{EVO_LEVEL, 55, SPECIES_KRABBY}},
};
