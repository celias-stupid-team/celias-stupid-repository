...
LEVEL_UP_MOVE(1, MOVE_PSY_BEAM),
    ...
    LEVEL_UP_MOVE(16, MOVE_MIE_FIRST),
    LEVEL_UP_MOVE(19, MOVE_MIETEOR_MASH),
    LEVEL_UP_MOVE(20, MOVE_MIETEOR_BEAM),
    LEVEL_UP_MOVE(24, MOVE_DRACO_MIETEOR),
    LEVEL_UP_MOVE(27, MOVE_MIELING_WISH),
