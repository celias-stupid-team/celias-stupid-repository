...
static const struct LevelUpMove sVictiniLevelUpLearnset[] = {
    ...
    //LEVEL_UP_MOVE(1, MOVE_FOCUS_ENERGY),
    LEVEL_UP_MOVE(26, MOVE_L_CREATE),
    //LEVEL_UP_MOVE(30, MOVE_HEADBUTT),
...
static const struct LevelUpMove sDachsbunLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(26, MOVE_CHEESE_DRY),
    LEVEL_UP_MOVE(27, MOVE_LEAF_TOMATO),
    LEVEL_UP_MOVE(28, MOVE_LETTUCE_SNUGGLE),
    LEVEL_UP_MOVE(29, MOVE_MEATEOR_BEAM),
