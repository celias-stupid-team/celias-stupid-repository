...
static const struct LevelUpMove sChanseyLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(25, MOVE_AQUA_YEP),
    LEVEL_UP_MOVE(26, MOVE_PSYCH_YUP),
    LEVEL_UP_MOVE(27, MOVE_SURE_UP),
    LEVEL_UP_MOVE(28, MOVE_MIRACLE_AYE),
    LEVEL_UP_MOVE(29, MOVE_FILLET_OKAY),
