...
//Bulbasaur
    ...
    //LEVEL_UP_MOVE(40, MOVE_FRENZY_PLANT),
    LEVEL_UP_END
};

static const struct LevelUpMove sIvysaurLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_GROWL_CHARMANDER),
    ...
    LEVEL_UP_MOVE(40, MOVE_TRIPLE_FINISH),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sVenusaurLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(1, MOVE_ONEMERANG),
    LEVEL_UP_MOVE(1, MOVE_BANEFUL_1NKER),
    LEVEL_UP_MOVE(19, MOVE_ONEISHMENT),
    //LEVEL_UP_MOVE(21, MOVE_RAZOR_LEAF),
    //LEVEL_UP_MOVE(25, MOVE_GROWTH),
    //LEVEL_UP_MOVE(28, MOVE_GIGA_DRAIN),
    //LEVEL_UP_MOVE(31, MOVE_SYNTHESIS),
...
static const struct LevelUpMove sCharizardLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(25, MOVE_FLYING_CLAW),
    LEVEL_UP_MOVE(27, MOVE_FLYING_CLAW),
    LEVEL_UP_MOVE(32, MOVE_FLYING_DANCE),
    LEVEL_UP_MOVE(33, MOVE_FLYING_DANCE),
    LEVEL_UP_MOVE(37, MOVE_FLY_O_METEOR),
    LEVEL_UP_MOVE(39, MOVE_FLY_O_METEOR),
    LEVEL_UP_MOVE(40, MOVE_TRIPLE_FINISH),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sCaterpieLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(99, MOVE_CELEBRATE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sWeedleLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(11, MOVE_WEEDLE_ARM),
    LEVEL_UP_END
};

static const struct LevelUpMove sKakunaLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_WEEDLE_ARM),
    LEVEL_UP_MOVE(1, MOVE_WEEDLE_ARM),
    LEVEL_UP_MOVE(1, MOVE_HARDEN),
    LEVEL_UP_MOVE(11, MOVE_CLOSE_COMBAT),
    LEVEL_UP_MOVE(12, MOVE_SHOOT),
    LEVEL_UP_MOVE(15, MOVE_PSYCHIC_PUNCH),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sPidgeyLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(70, MOVE_WUMBOIZE),
    LEVEL_UP_MOVE(70, MOVE_THRASH),
    LEVEL_UP_MOVE(70, MOVE_MAX_AIRSTREAM),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sArbokLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(1, MOVE_WRAP),
    LEVEL_UP_MOVE(1, MOVE_POISON_FANG),
    LEVEL_UP_MOVE(16, MOVE_MEAN_LOOK_LOOK),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSandshrewLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(38, MOVE_COLLISION_COURSE),
...
static const struct LevelUpMove sSandslashLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(40, MOVE_SUPERSONIC),
    LEVEL_UP_MOVE(55, MOVE_GAY_BALL_PROBLEMS),
    //LEVEL_UP_MOVE(40, MOVE_SUPERSONIC),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sNidoqueenLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_FAIRY_FANG),
    LEVEL_UP_MOVE(1, MOVE_NUZZLE),
    LEVEL_UP_MOVE(1, MOVE_PECK),
    LEVEL_UP_MOVE(1, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE(4, MOVE_HORN_ATTACK),
    ...
    LEVEL_UP_MOVE(25, MOVE_SECRET_SWORD),
    LEVEL_UP_MOVE(28, MOVE_CRUNCH),
    LEVEL_UP_MOVE(30, MOVE_FAIRY_TAIL),
    LEVEL_UP_MOVE(34, MOVE_SLUDGE_BOMB),
    LEVEL_UP_MOVE(37, MOVE_MEGAHORN),
    LEVEL_UP_MOVE(40, MOVE_DOUBLE_JUMP),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sClefableLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(21, MOVE_LIGHT_SNEAK),
    LEVEL_UP_MOVE(24, MOVE_LIGHT_PUNCH),
    LEVEL_UP_MOVE(27, MOVE_COSMIC_POWER),
    LEVEL_UP_MOVE(30, MOVE_LIGHT_BALL),
...
static const struct LevelUpMove sJigglypuffLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(1, MOVE_POP_OFF),
    LEVEL_UP_MOVE(14, MOVE_ROLLOUT),
    LEVEL_UP_MOVE(14, MOVE_SEISMIC_TOSS),
    LEVEL_UP_MOVE(19, MOVE_UP_THROW),
    LEVEL_UP_MOVE(20, MOVE_UP_DOG),
    LEVEL_UP_MOVE(21, MOVE_SING),
    LEVEL_UP_MOVE(24, MOVE_CRAB_THROW),
    LEVEL_UP_MOVE(27, MOVE_CURSE),
    LEVEL_UP_MOVE(30, MOVE_WALL_OF_PAIN),
    LEVEL_UP_MOVE(35, MOVE_WEATHER_BALLOON),
    LEVEL_UP_MOVE(40, MOVE_PUFF_UP),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sZubatLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(32, MOVE_AZUBATICS),
    LEVEL_UP_MOVE(32, MOVE_AGOLBATICS),
    LEVEL_UP_MOVE(32, MOVE_ACROBATICS),
    LEVEL_UP_MOVE(35, MOVE_BRAVE_BIRD),
    LEVEL_UP_MOVE(40, MOVE_ABSORB_ZUBAT),
...
static const struct LevelUpMove sOddishLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(40, MOVE_CLANGOROUS_SOULBLAZE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sParasLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(27, MOVE_BREADLONG_RUSH),
...
static const struct LevelUpMove sParasectLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(33, MOVE_ICE_O_CUT),
...
static const struct LevelUpMove sVenomothLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(36, MOVE_PSY_WIND),
    LEVEL_UP_MOVE(42, MOVE_SLEEP_POWDER),
    LEVEL_UP_MOVE(52, MOVE_PSY_BEAM),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sDugtrioLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(26, MOVE_POPULATION_BOMB),
    LEVEL_UP_MOVE(30, MOVE_STOMPING_TANTRUM),
    LEVEL_UP_MOVE(33, MOVE_SENTENNIEL_KICK),
    LEVEL_UP_MOVE(36, MOVE_TRIPLE_PSYCLE),
    LEVEL_UP_MOVE(38, MOVE_THUNDURUS_KICK),
    LEVEL_UP_MOVE(39, MOVE_TORNADUS_KICK),
    LEVEL_UP_MOVE(40, MOVE_ZEKROM_KICK),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sMeowthLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(1, MOVE_FURRY_SWIPES),
    LEVEL_UP_MOVE(1, MOVE_CURSE),
    LEVEL_UP_MOVE(17, MOVE_CHATTER),
    LEVEL_UP_MOVE(20, MOVE_FURY_SWIPE_1),
    LEVEL_UP_MOVE(20, MOVE_FURY_SWIPE_2),
    LEVEL_UP_MOVE(20, MOVE_FURY_SWIPE_3),
    LEVEL_UP_MOVE(20, MOVE_FURY_SWIPE_4),
    LEVEL_UP_MOVE(20, MOVE_FURY_SWIPE_5),
    ...
    LEVEL_UP_MOVE(36, MOVE_ROAR_OF_DIME),
    LEVEL_UP_MOVE(37, MOVE_ASSIST),
    LEVEL_UP_MOVE(40, MOVE_BLAST_OFF),
    LEVEL_UP_END
};

static const struct LevelUpMove sPersianLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_DIVE),
    LEVEL_UP_MOVE(1, MOVE_IRAN_TAIL),
    LEVEL_UP_MOVE(1, MOVE_MIRAQLE_EYE),
    LEVEL_UP_MOVE(31, MOVE_FURY_SWIPE_1),
    LEVEL_UP_MOVE(31, MOVE_FURY_SWIPE_6),
    LEVEL_UP_MOVE(32, MOVE_ARABOLIC_CHARGE),
    LEVEL_UP_MOVE(35, MOVE_TRIPLE_DIVE),
    LEVEL_UP_MOVE(35, MOVE_TRIPLE_DIVE_2),
    LEVEL_UP_MOVE(35, MOVE_TRIPLE_DIVE_3),
    LEVEL_UP_MOVE(37, MOVE_MIRAQLE_WHIP),
    LEVEL_UP_MOVE(38, MOVE_TEHRANDERBOLT),
    LEVEL_UP_MOVE(40, MOVE_RAGING_FURRY),
    LEVEL_UP_END
};

static const struct LevelUpMove sGolduckLevelUpLearnset[] = { // The Blue One
    LEVEL_UP_MOVE(1, MOVE_EXTRASENSORY),
    LEVEL_UP_MOVE(1, MOVE_SOMESENSORY),
    LEVEL_UP_MOVE(1, MOVE_NOSENSORY),
    LEVEL_UP_MOVE(20, MOVE_AMNESIA),
    LEVEL_UP_END
};

static const struct LevelUpMove sPsyduckLevelUpLearnset[] = { // The Yellow One
    LEVEL_UP_MOVE(0, MOVE_MIND_BLOWN),
    LEVEL_UP_MOVE(1, MOVE_EXTRASENSORY),
    LEVEL_UP_MOVE(1, MOVE_SOMESENSORY),
    LEVEL_UP_MOVE(1, MOVE_NOSENSORY),
...
static const struct LevelUpMove sPrimeapeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(31, MOVE_IRON_TAIL),
    LEVEL_UP_MOVE(37, MOVE_CLOSE_COMBAT),
    LEVEL_UP_MOVE(41, MOVE_PRIME_RIBS),
    LEVEL_UP_MOVE(43, MOVE_ROAR_OF_PRIME),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sArcanineLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(70, MOVE_VACUUM_FEAR),
    LEVEL_UP_MOVE(72, MOVE_ROLLOVER),
    LEVEL_UP_MOVE(73, MOVE_WOOF_HAMMER),
    LEVEL_UP_MOVE(74, MOVE_NINE_WHIP),
    LEVEL_UP_MOVE(75, MOVE_ROAR_OF_NINE),
    LEVEL_UP_MOVE(100, MOVE_SHOOT),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sPoliwagLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(19, MOVE_FALCON_PUNCH),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sAbraLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(100, MOVE_NOTHING),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sKadabraLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(21, MOVE_PSY_WIND),
...
static const struct LevelUpMove sAlakazamLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(1, MOVE_TELEPORT),
    LEVEL_UP_MOVE(1, MOVE_DOUBLE_DIP),
    LEVEL_UP_MOVE(20, MOVE_KINICES),
    LEVEL_UP_MOVE(23, MOVE_AL_LURING_VOICE),
    LEVEL_UP_MOVE(26, MOVE_HYPNOSICE),
    LEVEL_UP_MOVE(28, MOVE_CREAM_EATER),
    LEVEL_UP_MOVE(30, MOVE_CEREAL_PULSE),
    LEVEL_UP_MOVE(33, MOVE_SPOONGEIST_BEAM),
    LEVEL_UP_MOVE(33, MOVE_SPOON_STEEL_STRIKE),
    LEVEL_UP_MOVE(35, MOVE_SOUPERPOWER),
    LEVEL_UP_MOVE(37, MOVE_PSYCHO_SCOOP),
    LEVEL_UP_MOVE(40, MOVE_AL_OUT_PUMMELING),
    LEVEL_UP_MOVE(55, MOVE_SNOWGRAVY),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sGravelerLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_ROCK_PUNCH),
    LEVEL_UP_MOVE(0, MOVE_SHOOT),
    LEVEL_UP_MOVE(1, MOVE_ROCK_PUNCH),
    LEVEL_UP_MOVE(1, MOVE_DIVE),
    LEVEL_UP_MOVE(1, MOVE_ROCK_SLIDE),
    LEVEL_UP_MOVE(1, MOVE_EARTHQUAKE),
    LEVEL_UP_MOVE(1, MOVE_WISH),
    LEVEL_UP_MOVE(25, MOVE_SHOOT),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sGolemLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(27, MOVE_DISARMED_VOICE),
    LEVEL_UP_MOVE(28, MOVE_BLEEDLE_ARM),
    LEVEL_UP_MOVE(31, MOVE_PAIN_DANCE),
    LEVEL_UP_MOVE(34, MOVE_PHANTOM_PUNCH),
    LEVEL_UP_MOVE(37, MOVE_ENDURE),
    LEVEL_UP_MOVE(40, MOVE_ACCEPTANCE),
    LEVEL_UP_MOVE(40, MOVE_ROCK_KICK),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSlowpokeLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_AQUA),
    LEVEL_UP_MOVE(1, MOVE_WHIP),
    LEVEL_UP_MOVE(1, MOVE_SLAP),
    LEVEL_UP_MOVE(1, MOVE_PAY_DAY),
    LEVEL_UP_MOVE(26, MOVE_POISON),
    LEVEL_UP_MOVE(28, MOVE_IRON),
    LEVEL_UP_MOVE(31, MOVE_WIND),
    LEVEL_UP_MOVE(34, MOVE_GLOW),
    LEVEL_UP_MOVE(36, MOVE_DRAGON),
    LEVEL_UP_MOVE(38, MOVE_SHED),
    LEVEL_UP_MOVE(40, MOVE_TAX_FRAUD),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSlowbroLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(1, MOVE_CALMP),
    LEVEL_UP_MOVE(1, MOVE_SHELL_SMASH),
    LEVEL_UP_MOVE(1, MOVE_WITHDRAW),
    LEVEL_UP_MOVE(1, MOVE_CLAM_MIND),
    LEVEL_UP_MOVE(22, MOVE_SLOW_KICK),
    //LEVEL_UP_MOVE(25, MOVE_CALMP),
    LEVEL_UP_MOVE(27, MOVE_FLAMETHROWER),
    LEVEL_UP_MOVE(30, MOVE_EXTREME_SLOW),
    LEVEL_UP_MOVE(32, MOVE_SHELL_SIDE_ASS),
    LEVEL_UP_MOVE(35, MOVE_SLOWTH),
    LEVEL_UP_MOVE(36, MOVE_BROWTH),
...
static const struct LevelUpMove sFarfetchdLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_BOTTOM_SURGERY),
...
static const struct LevelUpMove sDoduoLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(20, MOVE_DUO_ATTACK),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSeelLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(31, MOVE_BARK),
    LEVEL_UP_MOVE(31, MOVE_ROLL_OVER),
    LEVEL_UP_MOVE(31, MOVE_CLAP),
    LEVEL_UP_MOVE(31, MOVE_GALUMPH),
    LEVEL_UP_MOVE(40, MOVE_HYPER_BREAM),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sGrimerLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(25, MOVE_LUNAR_BLESSING),
    ...
    LEVEL_UP_MOVE(38, MOVE_BLOOD_MOON),
    LEVEL_UP_MOVE(40, MOVE_ROAR_OF_GRIME),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sCloysterLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_SHE_LL_SMASH),
    LEVEL_UP_MOVE(1, MOVE_SHE_HER_COLD),
    LEVEL_UP_MOVE(1, MOVE_MISTY_EXPLOSION),
    LEVEL_UP_MOVE(30, MOVE_BRAVE_BIRTH),
    LEVEL_UP_MOVE(31, MOVE_SAND_WOMB),
    LEVEL_UP_MOVE(33, MOVE_STRAP_ON),
    LEVEL_UP_MOVE(36, MOVE_FLARE_CLITZ),
    LEVEL_UP_MOVE(37, MOVE_PANTY_SHOT),
    LEVEL_UP_MOVE(40, MOVE_OVULATION_BOMB),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sHaunterLevelUpLearnset[] = {
    ...
    //LEVEL_UP_MOVE(1, MOVE_DIG_CANCEL),
    LEVEL_UP_MOVE(1, MOVE_DIVE_CANCEL),
    LEVEL_UP_MOVE(1, MOVE_PAY_DAY),
    LEVEL_UP_END
};

static const struct LevelUpMove sGengarLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_EVIL_METRONOME),
    LEVEL_UP_MOVE(1, MOVE_PLAY_NICE),
    LEVEL_UP_MOVE(1, MOVE_DOUBLE_TEAM),
    LEVEL_UP_MOVE(21, MOVE_EVIL_METRONOME),
    ...
    LEVEL_UP_MOVE(37, MOVE_SHADOW_SCREEN),
    LEVEL_UP_MOVE(40, MOVE_SHADOW_OF_RUIN),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sOnixLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_EARTHQUAKE),
    LEVEL_UP_MOVE(1, MOVE_SCREECH),
    LEVEL_UP_MOVE(30, MOVE_BROCK_THROW),
    LEVEL_UP_MOVE(30, MOVE_BROCK_WRECKER),
    LEVEL_UP_MOVE(31, MOVE_ACCELEBROCK),
...
static const struct LevelUpMove sDrowzeeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(31, MOVE_PSY_BEAM),
...
static const struct LevelUpMove sHypnoLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(35, MOVE_PSY_BEAM),
...
static const struct LevelUpMove sKrabbyLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(65, MOVE_CUTTLE),
    LEVEL_UP_MOVE(70, MOVE_MEGA_PINCH),
    LEVEL_UP_MOVE(75, MOVE_LOBSTRUCT),
    LEVEL_UP_MOVE(80, MOVE_SHELLY_DRUM),
    LEVEL_UP_MOVE(90, MOVE_KRABBIN_ASCENT),
    LEVEL_UP_MOVE(100, MOVE_CRABSORB),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sExeggcuteLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(20, MOVE_FRYING_PAN),
...
static const struct LevelUpMove sExeggutorLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(1, MOVE_GIGA_DRAIN),
    //LEVEL_UP_MOVE(1, MOVE_SOFT_BOILED),
    LEVEL_UP_MOVE(17, MOVE_BARRAGE_2),
    LEVEL_UP_MOVE(19, MOVE_BARRAGE_2),
    LEVEL_UP_MOVE(20, MOVE_BARRAGE_3),
    LEVEL_UP_MOVE(22, MOVE_BARRAGE),
    LEVEL_UP_MOVE(22, MOVE_BARRAGE_2),
    LEVEL_UP_MOVE(23, MOVE_BARRAGE_3),
    LEVEL_UP_MOVE(23, MOVE_BARRAGE),
    LEVEL_UP_MOVE(23, MOVE_BARRAGE_2),
    LEVEL_UP_MOVE(24, MOVE_BARRAGE_3),
    LEVEL_UP_MOVE(25, MOVE_BARRAGE),
    LEVEL_UP_MOVE(25, MOVE_BARRAGE_2),
    LEVEL_UP_MOVE(26, MOVE_BARRAGE_3),
    LEVEL_UP_MOVE(26, MOVE_BARRAGE),
    LEVEL_UP_MOVE(26, MOVE_ASTRAL_BARRAGE),
    LEVEL_UP_MOVE(26, MOVE_BARRAGE_3),
    LEVEL_UP_MOVE(27, MOVE_BARRAGE_2),
    LEVEL_UP_MOVE(27, MOVE_BARRAGE_2),
    LEVEL_UP_MOVE(27, MOVE_BARRAGE_3),
    LEVEL_UP_MOVE(28, MOVE_BARRAGE),
    LEVEL_UP_MOVE(29, MOVE_BARRAGE_4),
...
static const struct LevelUpMove sMarowakLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(1, MOVE_SKULL_ISSUE),
    LEVEL_UP_MOVE(1, MOVE_REAL_TEARS),
    LEVEL_UP_MOVE(1, MOVE_LEER),
    LEVEL_UP_MOVE(1, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE(1, MOVE_GROWL),
    ...
    LEVEL_UP_MOVE(20, MOVE_SKULL_ISSUE),
    LEVEL_UP_MOVE(20, MOVE_REAL_TEARS),
...
static const struct LevelUpMove sLickitungLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_PICKLE_BEAM),
    LEVEL_UP_MOVE(1, MOVE_LICKLE_BEAM),
    LEVEL_UP_MOVE(1, MOVE_LICK_DOUBLE_SLAP),
    LEVEL_UP_MOVE(7, MOVE_LICK_TICKLE),
    LEVEL_UP_MOVE(12, MOVE_LICK_STRING_SHOT),
    LEVEL_UP_MOVE(18, MOVE_LICK_WATER_GUN),
    LEVEL_UP_MOVE(27, MOVE_LICK_WRAP),
    LEVEL_UP_MOVE(30, MOVE_LICK_DISARMING_VOICE),
    //LEVEL_UP_MOVE(32, MOVE_LICK_HYPNOSIS),
    LEVEL_UP_MOVE(35, MOVE_LICK_THRASH),
    LEVEL_UP_MOVE(37, MOVE_LICK_HYDRO_PUMP),
    LEVEL_UP_MOVE(40, MOVE_LICK_RELIC_SONG),
    LEVEL_UP_MOVE(100, MOVE_LICK),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sRhydonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(38, MOVE_HI_HORSEPOWER),
    LEVEL_UP_MOVE(40, MOVE_FIRE_PLAST),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sChanseyLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(1, MOVE_YESPER_WING),
    LEVEL_UP_MOVE(26, MOVE_AQUA_YEP),
    LEVEL_UP_MOVE(27, MOVE_PSYCH_YUP),
    LEVEL_UP_MOVE(28, MOVE_SURE_UP),
    LEVEL_UP_MOVE(29, MOVE_MIRACLE_AYE),
    LEVEL_UP_MOVE(30, MOVE_FILLET_OKAY),
    LEVEL_UP_MOVE(35, MOVE_YESIPICE_BLADES),
    LEVEL_UP_MOVE(39, MOVE_OBLIVION_OUING),
    LEVEL_UP_MOVE(40, MOVE_BARRAGE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sTangelaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(1, MOVE_RECYCLE),
    LEVEL_UP_MOVE(1, MOVE_HAIR_BLITZ),
    LEVEL_UP_MOVE(1, MOVE_DIVE),
    ...
    LEVEL_UP_MOVE(30, MOVE_EXPLOSION),
    LEVEL_UP_MOVE(35, MOVE_GRASS_KNOTS),
    LEVEL_UP_MOVE(40, MOVE_BLUE_HAIR),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sKangaskhanLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(27, MOVE_CLOSE_MOMBAT),
    LEVEL_UP_MOVE(30, MOVE_TEACH_LIFE),
    LEVEL_UP_MOVE(31, MOVE_HEADBUS),
    LEVEL_UP_MOVE(32, MOVE_LANDS_MATH),
    LEVEL_UP_MOVE(33, MOVE_SPELLING_SALTS),
    LEVEL_UP_MOVE(34, MOVE_ART_STRIKE),
    LEVEL_UP_MOVE(35, MOVE_DYNAMICLUNCH),
    LEVEL_UP_MOVE(35, MOVE_CHILLY_RECESSION),
    LEVEL_UP_MOVE(36, MOVE_POWER_GYM),
    LEVEL_UP_MOVE(37, MOVE_X_SCIENCER),
    LEVEL_UP_MOVE(38, MOVE_HISTORY_EXPLOSION),
    LEVEL_UP_MOVE(39, MOVE_BUS_BUZZ),
    LEVEL_UP_MOVE(40, MOVE_BLAST_LEARN),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sHorseaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(20, MOVE_HI_HORSEPOWER),
...
static const struct LevelUpMove sSeakingLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(0, MOVE_FURY_ATTACK1),
    LEVEL_UP_MOVE(0, MOVE_FURY_ATTACK2),
    LEVEL_UP_MOVE(0, MOVE_FURY_ATTACK3),
    LEVEL_UP_MOVE(0, MOVE_FURY_SWIPE_4),
    LEVEL_UP_MOVE(0, MOVE_FURY_ATTACK5),
    LEVEL_UP_MOVE(0, MOVE_WATERFALL),
    LEVEL_UP_MOVE(0, MOVE_BARRAGE_2),
    LEVEL_UP_MOVE(0, MOVE_MEGAHORN),
    LEVEL_UP_MOVE(0, MOVE_ITS_NOT_OAK),
    LEVEL_UP_MOVE(0, MOVE_FURY_ATTACK),
    LEVEL_UP_MOVE(0, MOVE_FURRY_ATTACK2),
    LEVEL_UP_MOVE(0, MOVE_WATERFALL),
    //LEVEL_UP_MOVE(0, MOVE_FISHIOUS_REND),
    LEVEL_UP_MOVE(0, MOVE_JUDGEMENT),
    LEVEL_UP_MOVE(0, MOVE_PECK),
...
static const struct LevelUpMove sStarmieLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_FOLLOW_MIE),
    LEVEL_UP_MOVE(1, MOVE_MIE_FIRST),
    LEVEL_UP_MOVE(1, MOVE_PSY_MIEM),
    LEVEL_UP_MOVE(1, MOVE_BUBBLE_MIEM),
    LEVEL_UP_MOVE(22, MOVE_MIETEOR_MASH),
    LEVEL_UP_MOVE(25, MOVE_MIETEOR_BEAM),
    LEVEL_UP_MOVE(26, MOVE_DRACO_MIETEOR),
    LEVEL_UP_MOVE(28, MOVE_MIELING_WISH),
    LEVEL_UP_MOVE(30, MOVE_MIEF),
    LEVEL_UP_MOVE(31, MOVE_AFTER_YU),
    LEVEL_UP_MOVE(33, MOVE_FISH_US_REND),
    LEVEL_UP_MOVE(33, MOVE_HAPPY_OUR),
    LEVEL_UP_MOVE(34, MOVE_DIRE_IT),
    LEVEL_UP_MOVE(36, MOVE_SHE_LL_SMASH),
    LEVEL_UP_MOVE(38, MOVE_FOUL_THEY),
    LEVEL_UP_MOVE(40, MOVE_BLUE_HAIR),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sMrMimeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(2, MOVE_PAY_DAD),
    LEVEL_UP_MOVE(2, MOVE_SUNNY_DAD),
    LEVEL_UP_MOVE(2, MOVE_BARRIER),
    LEVEL_UP_MOVE(2, MOVE_DOUBLE_DAD),
    LEVEL_UP_MOVE(20, MOVE_MISTER),
    //LEVEL_UP_MOVE(25, MOVE_SUBSTITUTE),
    LEVEL_UP_MOVE(28, MOVE_DADDLING_GLEAM),
    LEVEL_UP_MOVE(30, MOVE_CHILLY_RECEPTION),
    LEVEL_UP_MOVE(31, MOVE_DOUBLE_DAD),
    LEVEL_UP_MOVE(32, MOVE_LIQUIDADTION),
    LEVEL_UP_MOVE(34, MOVE_MISTER_TERRAIN),
    LEVEL_UP_MOVE(34, MOVE_MISTER_EXPLOSION),
    LEVEL_UP_MOVE(35, MOVE_DOUBLE_DAD),
    LEVEL_UP_MOVE(37, MOVE_DADDY_DAD),
    LEVEL_UP_MOVE(39, MOVE_ROAR_OF_MIME),
    LEVEL_UP_MOVE(40, MOVE_POPULATION_BOMB),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sScytherLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(20, MOVE_FURY_CUTTER_TCG),
    LEVEL_UP_MOVE(21, MOVE_ANCIENT_POWER_TCG),
    LEVEL_UP_MOVE(24, MOVE_DO_THE_WAVE),
    LEVEL_UP_MOVE(24, MOVE_SWORDSDANCE_TCG),
    LEVEL_UP_MOVE(24, MOVE_SLASH_TCG),
    LEVEL_UP_MOVE(24, MOVE_RETREAT),
    LEVEL_UP_MOVE(27, MOVE_ITCHY_POLLEN),
    LEVEL_UP_MOVE(30, MOVE_MIND_GAMES),
    LEVEL_UP_MOVE(33, MOVE_GARBOTOXIN),
    LEVEL_UP_MOVE(36, MOVE_EEEEEEEK),
    LEVEL_UP_MOVE(36, MOVE_EEEEEEEEK),
    LEVEL_UP_MOVE(36, MOVE_EEEEEEEEEK),
    LEVEL_UP_MOVE(37, MOVE_EK),
    LEVEL_UP_MOVE(38, MOVE_CALL_FOR_GOONS),
    LEVEL_UP_MOVE(40, MOVE_EVERYBODY_EXPLODE_NOW),
    LEVEL_UP_END
};

static const struct LevelUpMove sJynxLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_FREEZE),
    LEVEL_UP_MOVE(1, MOVE_PSY_WIND),
    ...
    LEVEL_UP_MOVE(15, MOVE_PSYCHIC_PUNCH),
    LEVEL_UP_MOVE(15, MOVE_LUNAR_DANCE),
    LEVEL_UP_MOVE(18, MOVE_ICEBEAM),
    LEVEL_UP_MOVE(20, MOVE_LUNAR_DANCE),
    LEVEL_UP_MOVE(21, MOVE_PSY_BEAM),
    LEVEL_UP_MOVE(21, MOVE_LUNAR_DANCE),
    LEVEL_UP_MOVE(24, MOVE_ICE),
    LEVEL_UP_MOVE(24, MOVE_LUNAR_DANCE),
    LEVEL_UP_MOVE(29, MOVE_PSYCHIC_SPINNER),
    LEVEL_UP_MOVE(29, MOVE_LUNAR_DANCE),
    LEVEL_UP_MOVE(30, MOVE_LUNAR_DANCE),
    LEVEL_UP_MOVE(31, MOVE_SNOW_FORECAST),
    LEVEL_UP_MOVE(31, MOVE_LUNAR_DANCE),
    LEVEL_UP_MOVE(34, MOVE_ICE_TERRAIN),
    LEVEL_UP_MOVE(34, MOVE_EXPANDING_FROST),
    LEVEL_UP_MOVE(35, MOVE_LUNAR_DANCE),
    LEVEL_UP_MOVE(37, MOVE_PSYSTORM),
    LEVEL_UP_MOVE(40, MOVE_ICESTRIKE),
    LEVEL_UP_MOVE(40, MOVE_LUNAR_DANCE),
    LEVEL_UP_MOVE(45, MOVE_LUNAR_DANCE),
...
static const struct LevelUpMove sPinsirLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(26, MOVE_F_STINGER),
    LEVEL_UP_MOVE(27, MOVE_SAVAGE_SPIN_OUT),
    LEVEL_UP_MOVE(28, MOVE_F_BOMB),
    LEVEL_UP_MOVE(30, MOVE_O_POWER),
    LEVEL_UP_MOVE(35, MOVE_G_M_B_FUDDLE),
    LEVEL_UP_MOVE(39, MOVE_C_STINGER),
    LEVEL_UP_MOVE(39, MOVE_H_ORDER),
    LEVEL_UP_MOVE(39, MOVE_A_ORDER),
    LEVEL_UP_MOVE(39, MOVE_P_MISSILE),
    LEVEL_UP_MOVE(39, MOVE_T_POSE),
    LEVEL_UP_MOVE(39, MOVE_E_EXIT),
    LEVEL_UP_MOVE(39, MOVE_R_POWDER),
    LEVEL_UP_MOVE(40, MOVE_3_KICK),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sEeveeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(1, MOVE_HELPING_HAND),
    LEVEL_UP_MOVE(1, MOVE_GROWL),
    LEVEL_UP_MOVE(26, MOVE_G_MAX_CUDDLE),
    LEVEL_UP_MOVE(27, MOVE_EXTREME_EVOBOOST),
    LEVEL_UP_MOVE(28, MOVE_VEEVEE_VOLLEY),
    LEVEL_UP_MOVE(30, MOVE_NORMALLY_NORMAL),
    LEVEL_UP_END
};

static const struct LevelUpMove sVaporeonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_PSY_WIND),
    LEVEL_UP_MOVE(0, MOVE_PSY_BEAM),
...
static const struct LevelUpMove sFlareonLevelUpLearnset[] = {
    ...
    //LEVEL_UP_MOVE(1, MOVE_TRIPLE_WINGBEAT),
    LEVEL_UP_MOVE(1, MOVE_LEER),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sArticunoLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(51, MOVE_CONFUSING_GLARE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sMewtwoLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(66, MOVE_PSY_BEAM),
    LEVEL_UP_MOVE(69, MOVE_DOSWINGBEAT),
    LEVEL_UP_MOVE(70, MOVE_PSYSTRIKE),
    LEVEL_UP_MOVE(70, MOVE_TOXIC),
    LEVEL_UP_MOVE(70, MOVE_FLAMETHROWER_MEWTWO),
...
static const struct LevelUpMove sMewLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(40, MOVE_PSY_BEAM),
...
static const struct LevelUpMove sSpinarakLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(53, MOVE_PSY_BEAM),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sAriadosLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(63, MOVE_PSY_BEAM),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sNatuLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(50, MOVE_PSY_BEAM),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sXatuLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(65, MOVE_PSY_BEAM),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sAmpharosLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_COTTON_GONE),
    LEVEL_UP_MOVE(0, MOVE_REAL_TEARS),
    LEVEL_UP_MOVE(1, MOVE_TAIL_GLOW),
    LEVEL_UP_MOVE(1, MOVE_HAIR_CUTTER),
    LEVEL_UP_MOVE(1, MOVE_COTTON_GONE),
    LEVEL_UP_MOVE(32, MOVE_ELECTRO_BALD),
    LEVEL_UP_MOVE(32, MOVE_HAIR_CUTTER),
    LEVEL_UP_MOVE(34, MOVE_MAGNINUDE),
    LEVEL_UP_MOVE(36, MOVE_NAKE_IT_RAIN),
    LEVEL_UP_MOVE(38, MOVE_BOLT_STREAK),
    LEVEL_UP_MOVE(40, MOVE_FLASH_AMPHAROS),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSudowoodoLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_FAKE_TREERS),
    LEVEL_UP_MOVE(1, MOVE_REAL_TREERS),
    LEVEL_UP_MOVE(1, MOVE_VEIN_WHIP),
    LEVEL_UP_MOVE(1, MOVE_BRANCH_POKE),
    LEVEL_UP_MOVE(31, MOVE_ANCIENT_POWER),
    LEVEL_UP_MOVE(32, MOVE_BARK_SLIDE),
    LEVEL_UP_MOVE(35, MOVE_GRAVEL_APPLE),
    //LEVEL_UP_MOVE(36, MOVE_WOOD_HAMMER),
    LEVEL_UP_MOVE(38, MOVE_SHOWER_GEM),
    LEVEL_UP_MOVE(40, MOVE_REAL_AXE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sEspeonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_PSY_BEAM),
    LEVEL_UP_MOVE(0, MOVE_PSYSTORM),
    LEVEL_UP_MOVE(0, MOVE_PLAY_NPSYCHIC),
    LEVEL_UP_MOVE(1, MOVE_IRON_TAILS),
    LEVEL_UP_MOVE(1, MOVE_ICE),
...
static const struct LevelUpMove sMurkrowLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_DAY_NIGHTSY),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSlowkingLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(1, MOVE_STRING_SHORT),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sMisdreavusLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(30, MOVE_PSY_WIND),
...
static const struct LevelUpMove sGirafarigLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(43, MOVE_PSY_WIND),
...
static const struct LevelUpMove sHoundourLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_NIGHT_DAISY),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sPorygon2LevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(12, MOVE_PSY_WIND),
...
static const struct LevelUpMove sSmeargleLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(40, MOVE_DARK_VOID_SMEARGLE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSpindaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(16, MOVE_PSY_WIND),
    LEVEL_UP_MOVE(23, MOVE_HYPNOSIS),
...
static const struct LevelUpMove sKecleonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(12, MOVE_FURY_SWIPES),
    LEVEL_UP_MOVE(17, MOVE_PSY_WIND),
...
static const struct LevelUpMove sBaltoyLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(11, MOVE_PSY_WIND),
...
static const struct LevelUpMove sLuvdiscLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(38, MOVE_P_CREATE),
    LEVEL_UP_MOVE(40, MOVE_HEART_ATTACK),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSeviperLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(29, MOVE_RIGHT_SCREEN),
    LEVEL_UP_MOVE(31, MOVE_SLUDGE_BOMB),
    LEVEL_UP_MOVE(34, MOVE_THUNDER_ARMOR),
    LEVEL_UP_MOVE(37, MOVE_EARTHQUAKE),
    LEVEL_UP_MOVE(40, MOVE_DODGE_IT),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sCastformLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(1, MOVE_WEATHER_BALLOON),
...
static const struct LevelUpMove sRaltsLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(26, MOVE_PSY_BEAM),
...
static const struct LevelUpMove sMetangLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(38, MOVE_PSY_BEAM),
...
static const struct LevelUpMove sLatiasLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_MIST_BALL),
    LEVEL_UP_MOVE(1, MOVE_WATER_SPORT),
    LEVEL_UP_MOVE(1, MOVE_MIST_BALL),
    LEVEL_UP_MOVE(1, MOVE_PSY_BEAM),
    LEVEL_UP_MOVE(1, MOVE_DRAGON_CLAW),
    LEVEL_UP_MOVE(26, MOVE_CONFUSEON),
    LEVEL_UP_MOVE(27, MOVE_FRUSTRATEON),
    LEVEL_UP_MOVE(28, MOVE_LIQUIDATEON),
    LEVEL_UP_MOVE(30, MOVE_EON_DELUGE),
    LEVEL_UP_MOVE(33, MOVE_RUINATEON),
    LEVEL_UP_MOVE(36, MOVE_ERUPTEON),
    LEVEL_UP_MOVE(38, MOVE_EXPLOSEON),
...
static const struct LevelUpMove sJirachiLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(1, MOVE_THUNDER_WAVE),
    LEVEL_UP_MOVE(1, MOVE_COUNTER),
    LEVEL_UP_MOVE(26, MOVE_PSYSICLE_CRASH),
    LEVEL_UP_MOVE(27, MOVE_BITE),
...
static const struct LevelUpMove sChimechoLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(46, MOVE_PSY_BEAM),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sCombeeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(20, MOVE_THE_BEE_MOVE),
    LEVEL_UP_MOVE(25, MOVE_SIGNAL_BEAM),
    LEVEL_UP_MOVE(28, MOVE_HYPER_BEE),
...
static const struct LevelUpMove sCherubiLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(27, MOVE_GIGA_DRAIN),
    LEVEL_UP_MOVE(31, MOVE_CHERRY_BOMB),
    LEVEL_UP_MOVE(34, MOVE_TWIN_BEAM),
    LEVEL_UP_MOVE(37, MOVE_NICE_HAMMER),
    LEVEL_UP_MOVE(40, MOVE_NICE_SPINNER),
...
static const struct LevelUpMove sMime_Jr_LevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sPorygon_ZLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(27, MOVE_SYSTEM32),
    LEVEL_UP_MOVE(27, MOVE_TRI_ATTACK),
    LEVEL_UP_MOVE(28, MOVE_ROUNDEN),
    LEVEL_UP_MOVE(25, MOVE_SIGNAL_BEAM),
    LEVEL_UP_MOVE(29, MOVE_FLASH_CANNON),
    LEVEL_UP_MOVE(30, MOVE_BOLTBEAM),
    LEVEL_UP_MOVE(32, MOVE_CLICK_HERE),
    LEVEL_UP_MOVE(33, MOVE_MOVIES_FREE),
    LEVEL_UP_MOVE(34, MOVE_GAMING_TOOLBARS),
    LEVEL_UP_MOVE(35, MOVE_ZIPBOMB),
    LEVEL_UP_MOVE(36, MOVE_FIREREDCHEATS),
    LEVEL_UP_MOVE(37, MOVE_ANTI_VIRUS),
    LEVEL_UP_MOVE(40, MOVE_LITTHBRNTHEYES),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sPhioneLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(7, MOVE_FAIL_GLOW),
    LEVEL_UP_MOVE(7, MOVE_TAIL_BLOW),
    LEVEL_UP_MOVE(12, MOVE_P_CREATE),
    LEVEL_UP_MOVE(15, MOVE_SCARED_FIRE),
    LEVEL_UP_MOVE(15, MOVE_AEROBLASS),
    LEVEL_UP_MOVE(18, MOVE_SHYSTRIKE),
    LEVEL_UP_MOVE(22, MOVE_SPACIAL_FRIEND),
    LEVEL_UP_MOVE(22, MOVE_ROAR_OF_THYME),
    LEVEL_UP_MOVE(25, MOVE_DARK_LLOYD),
    LEVEL_UP_MOVE(27, MOVE_BORE_ENFORCER),
    LEVEL_UP_MOVE(27, MOVE_LANDS_BATH),
    LEVEL_UP_MOVE(30, MOVE_PSYCHO_BOOTS),
    LEVEL_UP_MOVE(32, MOVE_CHORE_OF_TIME),
    LEVEL_UP_MOVE(34, MOVE_FUDGEMENT),
    LEVEL_UP_MOVE(37, MOVE_PHIOMANCY),
    LEVEL_UP_MOVE(37, MOVE_SKYRIM_WING),
...
static const struct LevelUpMove sVictiniLevelUpLearnset[] = {
    ...
    //LEVEL_UP_MOVE(1, MOVE_BOLT_STRIKE),
    LEVEL_UP_MOVE(1, MOVE_RAPID_WIN),
    //LEVEL_UP_MOVE(1, MOVE_FOCUS_ENERGY),
    LEVEL_UP_MOVE(31, MOVE_L_CREATE),
    //LEVEL_UP_MOVE(30, MOVE_HEADBUTT),
    LEVEL_UP_MOVE(33, MOVE_BLUE_FLARE),
    LEVEL_UP_MOVE(35, MOVE_O_CREATE),
    LEVEL_UP_MOVE(37, MOVE_PSY_BEAM),
    LEVEL_UP_MOVE(40, MOVE_WALUIGI),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sWoobatLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_W_TURN),
    LEVEL_UP_MOVE(1, MOVE_LEECH_LIFE),
    LEVEL_UP_MOVE(1, MOVE_AZUBATICS),
    LEVEL_UP_MOVE(1, MOVE_AGOLBATICS),
    LEVEL_UP_MOVE(1, MOVE_ACROBATICS),
    LEVEL_UP_MOVE(1, MOVE_ABSORB_ZUBAT),
    LEVEL_UP_MOVE(32, MOVE_WUMBOIZE),
    LEVEL_UP_MOVE(34, MOVE_WOMP),
    LEVEL_UP_MOVE(36, MOVE_WOOST),
    LEVEL_UP_MOVE(38, MOVE_WAGON_TRAIL),
    LEVEL_UP_MOVE(39, MOVE_WAGON_ASCENT),
    LEVEL_UP_MOVE(40, MOVE_AWOOBATICS),
    LEVEL_UP_MOVE(50, MOVE_MING_ATTACK),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sAmoongussLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(1, MOVE_QUICK_BALL),
    LEVEL_UP_MOVE(30, MOVE_DUSK_BALL),
    LEVEL_UP_MOVE(31, MOVE_DIVE_BALL),
    LEVEL_UP_MOVE(32, MOVE_REPEAT_BALL),
    LEVEL_UP_MOVE(32, MOVE_REPEAT_BALL),
    LEVEL_UP_MOVE(33, MOVE_ENERGY_BALL),
    LEVEL_UP_MOVE(34, MOVE_LURE_BALL),
    LEVEL_UP_MOVE(35, MOVE_HEAL_BALL),
    LEVEL_UP_MOVE(36, MOVE_LOVE_BALL),
    LEVEL_UP_MOVE(37, MOVE_DREAM_BALL),
    LEVEL_UP_MOVE(38, MOVE_LIGHT_BALL),
    LEVEL_UP_MOVE(39, MOVE_HEAVY_BALL),
    LEVEL_UP_MOVE(40, MOVE_ALLY_SWITCH),
    LEVEL_UP_MOVE(55, MOVE_TIMER_BALL),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sAlomomolaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(25, MOVE_HEART_BEAT),
    LEVEL_UP_MOVE(27, MOVE_BITTER_SPADE),
    LEVEL_UP_MOVE(31, MOVE_CLUBBLE_BEAM),
    LEVEL_UP_MOVE(33, MOVE_DIAMOND_STORM),
    LEVEL_UP_MOVE(35, MOVE_BRANCH_POKER),
    LEVEL_UP_MOVE(40, MOVE_HEARTING_SHOT),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sGolurkLevelUpLearnset[] = {
    ...
    //LEVEL_UP_MOVE(1, MOVE_WING_ATTACK),
    LEVEL_UP_MOVE(1, MOVE_DRILL_PECK),
    LEVEL_UP_MOVE(1, MOVE_JET_PUNCH_2),
    ...
    LEVEL_UP_MOVE(40, MOVE_ROCKET_PUNCH),
...
static const struct LevelUpMove sPanchamLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_FRYING_PAN),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sSylveonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(35, MOVE_NORMALLY_NORMAL),
    LEVEL_UP_MOVE(36, MOVE_GLITZY_GLOSSED),
    ...
    //LEVEL_UP_MOVE(34, MOVE_FREEZY_FLOW),
    //LEVEL_UP_MOVE(35, MOVE_SAPPY_SEED),
...
static const struct LevelUpMove sType_NullLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sMimikyuLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_NEUTRAL_METRONOME),
    LEVEL_UP_MOVE(1, MOVE_COPYCAT),
    LEVEL_UP_MOVE(1, MOVE_KNOCK_OFF),
    LEVEL_UP_MOVE(1, MOVE_PLAY_DAY),
    LEVEL_UP_MOVE(1, MOVE_PAY_ROUGH),
    LEVEL_UP_MOVE(26, MOVE_VINE_SLAP),
    LEVEL_UP_MOVE(28, MOVE_PUNCTURE),
    LEVEL_UP_MOVE(30, MOVE_BLUNDERBOLT),
    LEVEL_UP_MOVE(32, MOVE_FAULTERGEIST),
    LEVEL_UP_MOVE(34, MOVE_PHISHIOUS_REND),
    LEVEL_UP_MOVE(36, MOVE_ANGRY_SLICE),
    LEVEL_UP_MOVE(36, MOVE_ANGRY_SLICE_2),
    LEVEL_UP_MOVE(36, MOVE_ANGRY_SLICE_3),
    LEVEL_UP_MOVE(38, MOVE_BOMBARDMENT),
    LEVEL_UP_MOVE(40, MOVE_LETS_STRUGGLE_FOREVER),
    LEVEL_UP_MOVE(55, MOVE_CRUSECEAN_WRENCH),
    	LEVEL_UP_END
};
...
static const struct LevelUpMove sJangmo_oLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sHakamo_oLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sKommo_oLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sTapu_KokoLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_THUNDERBOLT),
	LEVEL_UP_END
};

static const struct LevelUpMove sTapu_LeleLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sTapu_BuluLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sTapu_FiniLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sMeltanLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_POISON_GAS),
	LEVEL_UP_MOVE(1, MOVE_FART_STRIKE),
	LEVEL_UP_MOVE(1, MOVE_TAILWIND),
	LEVEL_UP_END
};

static const struct LevelUpMove sMelmetalLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_DOUBLE_FURY_SWIPE),
    LEVEL_UP_MOVE(0, MOVE_DOUBLE_FURY_SWIPE_2),
    LEVEL_UP_MOVE(1, MOVE_POISON_GAS),
    LEVEL_UP_MOVE(1, MOVE_SLASH),
    LEVEL_UP_MOVE(1, MOVE_RAGING_FURRY),
    LEVEL_UP_MOVE(1, MOVE_HONE_CLAWS),
    LEVEL_UP_MOVE(1, MOVE_CLOSE_COMBAT),
    LEVEL_UP_MOVE(1, MOVE_ROCKET_PUNCH),
    LEVEL_UP_MOVE(1, MOVE_ROAR_OF_DIME),
    LEVEL_UP_MOVE(1, MOVE_BLAST_OFF),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sMr_RimeLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sAlcremieLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TASTY_PLOT),
    LEVEL_UP_MOVE(1, MOVE_DARKEST_LARIAT),
    LEVEL_UP_MOVE(1, MOVE_CHOC_WAVE),
    LEVEL_UP_MOVE(1, MOVE_DAZZLING_CREAM),
    LEVEL_UP_MOVE(27, MOVE_EXTREMESPEENUT),
    LEVEL_UP_MOVE(29, MOVE_TACHYONIONCTTR),
    LEVEL_UP_MOVE(31, MOVE_SKETCHUP),
    LEVEL_UP_MOVE(33, MOVE_CHOCOLATE_RAIN),
    LEVEL_UP_MOVE(35, MOVE_SYRUP_BOMB),
    LEVEL_UP_MOVE(38, MOVE_DOUBLE_CHOCK),
    LEVEL_UP_MOVE(40, MOVE_HYPER_CREAM),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sEternatusLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(55, MOVE_MAX_TURNPIKE),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sDachsbunLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_SESAMESEEDBOMB),
    LEVEL_UP_MOVE(1, MOVE_BREADBUTT),
    LEVEL_UP_MOVE(25, MOVE_BUTTER_BLADE),
    LEVEL_UP_MOVE(25, MOVE_PICKLE_BEAM),
    LEVEL_UP_MOVE(25, MOVE_CHEESE_DRY),
    LEVEL_UP_MOVE(26, MOVE_LEAF_TOMATO),
    LEVEL_UP_MOVE(27, MOVE_LETTUCE_SNUGGLE),
    LEVEL_UP_MOVE(28, MOVE_MEATEOR_BEAM),
    LEVEL_UP_MOVE(32, MOVE_MEAT_WAVE),
    LEVEL_UP_MOVE(35, MOVE_CEASELESS_BREADGE),
    LEVEL_UP_MOVE(37, MOVE_BREAD_CHARGE),
    LEVEL_UP_MOVE(40, MOVE_DYNAMICLUNCH),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sToedscoolLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(1, MOVE_WRAP),
    LEVEL_UP_MOVE(1, MOVE_CONSTRICT),
    LEVEL_UP_MOVE(18, MOVE_TOXIC_TREAD),
    LEVEL_UP_MOVE(20, MOVE_GRASS_KNOT),
    LEVEL_UP_MOVE(23, MOVE_SHADOW_SNEAK),
    LEVEL_UP_MOVE(25, MOVE_TOEDSZOOKA),
    LEVEL_UP_MOVE(27, MOVE_AGILITY),
    LEVEL_UP_MOVE(28, MOVE_AERIAL_LACE),
    LEVEL_UP_MOVE(31, MOVE_CONVERSION),
    LEVEL_UP_MOVE(34, MOVE_NIKE_CANNON),
    LEVEL_UP_MOVE(37, MOVE_CLANGOROUS_SOLE),
...
static const struct LevelUpMove sCyclizarLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_BICYCLE_CRASH),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sOrthwormLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(52, MOVE_WORM_UP),
    LEVEL_UP_MOVE(53, MOVE_SHED_TAIL),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sGholdengoLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(22, MOVE_MUSTARD_SLAP),
    LEVEL_UP_MOVE(0, MOVE_SURF),
    LEVEL_UP_MOVE(25, MOVE_BONEMERANCH),
    LEVEL_UP_MOVE(25, MOVE_SURF),
    LEVEL_UP_MOVE(28, MOVE_ALIOLI_ACE),
    LEVEL_UP_MOVE(28, MOVE_SURF),
    LEVEL_UP_MOVE(30, MOVE_TARTARBOLT),
    LEVEL_UP_MOVE(30, MOVE_SURF),
    LEVEL_UP_MOVE(33, MOVE_BARBEQUAKE),
    LEVEL_UP_MOVE(33, MOVE_SURF),
    LEVEL_UP_MOVE(35, MOVE_CHILI_RECEPTION),
    LEVEL_UP_MOVE(35, MOVE_SURF),
    LEVEL_UP_MOVE(37, MOVE_SRIRACHA_GOTCHA),
...
static const struct LevelUpMove sTentaquilLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_PUKE_BLOOD),
    LEVEL_UP_MOVE(1, MOVE_COMET_PUNCH),
    LEVEL_UP_MOVE(6, MOVE_MEGA_PUNCH),
    LEVEL_UP_MOVE(10, MOVE_DYNAMIC_PUNCH),
    LEVEL_UP_MOVE(13, MOVE_FOCUS_PUNCH),
    LEVEL_UP_MOVE(16, MOVE_PSYCHIC_PUNCH),
    LEVEL_UP_MOVE(19, MOVE_FIRE_PUNCH),
    LEVEL_UP_MOVE(23, MOVE_PSY_WIND),
    LEVEL_UP_MOVE(27, MOVE_MUDDY_WATER),
    LEVEL_UP_MOVE(30, MOVE_SLACK_OFF),
    LEVEL_UP_MOVE(33, MOVE_PSY_BEAM),
    LEVEL_UP_MOVE(37, MOVE_ERUPTION),
    LEVEL_UP_MOVE(40, MOVE_SLURF),
	LEVEL_UP_END
};

static const struct LevelUpMove sMissingnoLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_WATER_GUN),
    LEVEL_UP_MOVE(1, MOVE_WATER_GUN_MISSINGNO),
    LEVEL_UP_MOVE(1, MOVE_SKY_ATTACK),
    LEVEL_UP_MOVE(32, MOVE_TM07),
    LEVEL_UP_MOVE(34, MOVE_BADGEBOOST),
    LEVEL_UP_MOVE(36, MOVE_RHYDON),
    LEVEL_UP_MOVE(38, MOVE_CANCEL),
    LEVEL_UP_MOVE(39, MOVE_COOLTRAINER_M),
    LEVEL_UP_MOVE(40, MOVE_TMTRAINER),
	LEVEL_UP_END
};

static const struct LevelUpMove sKenyaLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_LEER),
    LEVEL_UP_MOVE(1, MOVE_PECK),
    ...
    LEVEL_UP_MOVE(36, MOVE_MAIL_SLAP),
    LEVEL_UP_MOVE(38, MOVE_EARTHQUAKE),
    LEVEL_UP_MOVE(40, MOVE_POPULATION_BOMB),
	LEVEL_UP_END
};

static const struct LevelUpMove sHitmonchan_ShitLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_JAB),
    LEVEL_UP_MOVE(0, MOVE_SPECIALPUNCH),
    LEVEL_UP_MOVE(1, MOVE_DOUBLE_TEAM),
    LEVEL_UP_MOVE(1, MOVE_DOUBLE_KICK),
    LEVEL_UP_MOVE(1, MOVE_TWINEEDLE),
    LEVEL_UP_MOVE(1, MOVE_DUAL_WINGBEAT),
...
static const struct LevelUpMove sTrubbish_HaircutLevelUpLearnset[] = {
...
static const struct LevelUpMove sYoshiLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(30, MOVE_NOGGIN_FLOGGIN),
    LEVEL_UP_MOVE(32, MOVE_STAMPETE),
    LEVEL_UP_MOVE(35, MOVE_TOUCH_FUZZY),
    LEVEL_UP_MOVE(37, MOVE_SWALLOW),
    LEVEL_UP_MOVE(40, MOVE_TAX_FRAUD),
	LEVEL_UP_END
};

static const struct LevelUpMove sDitto_MewLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TRANSFORM),
    LEVEL_UP_MOVE(1, MOVE_FAKE_OUT),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sUnown_LossLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_SEISMIC_LOSS),
    LEVEL_UP_MOVE(1, MOVE_LOSS_CHOP),
    LEVEL_UP_MOVE(1, MOVE_LOSS_POISON),
    LEVEL_UP_MOVE(1, MOVE_CLOSS_COMBAT),
    LEVEL_UP_MOVE(1, MOVE_SLAM),
    LEVEL_UP_MOVE(1, MOVE_CHATTER),
    LEVEL_UP_MOVE(1, MOVE_CONFIDE),
    LEVEL_UP_MOVE(1, MOVE_REAL_TEARS),
...
static const struct LevelUpMove sMagnaloneLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_REAL_TEARS),
    LEVEL_UP_MOVE(0, MOVE_CRY_ATTACK),
    LEVEL_UP_MOVE(1, MOVE_BOLT_STRIKE),
    ...
    LEVEL_UP_MOVE(32, MOVE_DENIAL),
    LEVEL_UP_MOVE(34, MOVE_ANGER),
    LEVEL_UP_MOVE(36, MOVE_BARGAINING),
    LEVEL_UP_MOVE(38, MOVE_DEPRESSION),
    LEVEL_UP_MOVE(40, MOVE_ACCEPTANCE),
	LEVEL_UP_END
};

static const struct LevelUpMove sTyranastarLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_ROCK_GUN),
    LEVEL_UP_MOVE(1, MOVE_BREAKING_BIND),
    LEVEL_UP_MOVE(1, MOVE_ANCIENT_BITE),
    LEVEL_UP_MOVE(1, MOVE_CONSTRACKLE),
    LEVEL_UP_MOVE(31, MOVE_GIGA_BRINE),
    LEVEL_UP_MOVE(33, MOVE_EARTHPUMP),
    LEVEL_UP_MOVE(35, MOVE_DRAGON_CANNON),
    LEVEL_UP_MOVE(36, MOVE_CHARM_SMASH),
    LEVEL_UP_MOVE(37, MOVE_FUSION_FLARE),
    LEVEL_UP_MOVE(38, MOVE_BITE_POWER),
    LEVEL_UP_MOVE(39, MOVE_EARF),
    LEVEL_UP_MOVE(40, MOVE_CAMBRIAN_EXPLOSION),
    LEVEL_UP_MOVE(55, MOVE_CRAB_GRIP),
    LEVEL_UP_MOVE(55, MOVE_VICEHAMMER),
	LEVEL_UP_END
};

static const struct LevelUpMove sPokemon_GunLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_SHOOT),
    LEVEL_UP_MOVE(0, MOVE_BEHEMOTH_BLAST),
    LEVEL_UP_MOVE(1, MOVE_NONUPLE_WINGBEAT),
    LEVEL_UP_MOVE(1, MOVE_POWER_UP_PUP),
    LEVEL_UP_MOVE(1, MOVE_BARK_BARRAGE),
    LEVEL_UP_MOVE(1, MOVE_ROLLOVER),
    LEVEL_UP_MOVE(1, MOVE_VACUUM_FEAR),
    LEVEL_UP_MOVE(1, MOVE_SACRED_FIRE),
    LEVEL_UP_MOVE(1, MOVE_WOOF_HAMMER),
    LEVEL_UP_MOVE(1, MOVE_NINE_WHIP),
    LEVEL_UP_MOVE(1, MOVE_SHOOT),
    LEVEL_UP_MOVE(1, MOVE_THIEF),
	LEVEL_UP_END
};

static const struct LevelUpMove sPlug_OinkLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};
static const struct LevelUpMove sPikabluLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_BUBBLE_BEAM),
    LEVEL_UP_MOVE(1, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE(1, MOVE_NUZZLE),
    LEVEL_UP_MOVE(1, MOVE_ROLLOUT),
    LEVEL_UP_MOVE(27, MOVE_FAIRY_TAIL),
    LEVEL_UP_MOVE(29, MOVE_WATERBOLT),
    LEVEL_UP_MOVE(31, MOVE_BULK_UP),
    LEVEL_UP_MOVE(33, MOVE_DOUBLE_JUMP),
    LEVEL_UP_MOVE(35, MOVE_RAIN_DANCE),
    LEVEL_UP_MOVE(37, MOVE_BOUNCE),
    LEVEL_UP_MOVE(40, MOVE_VAULT_TACKLE),
    LEVEL_UP_MOVE(40, MOVE_BLU_FLARE),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sPikachu_BirthdayLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sMew_AncientLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sPikachu_OldLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sGenesect_ShinyLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sIron_CleftLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sVulpix_AlolaLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TAIL_WHIP),
	LEVEL_UP_MOVE(1, MOVE_GROWL),
	LEVEL_UP_END
};

static const struct LevelUpMove sWeezing_AlolaLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sThis_GuyLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sSteamboat_WillieLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_DOUBLE_SLAP),
	LEVEL_UP_END
};

static const struct LevelUpMove sPidgeot_OldLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_WING_ATTACK),
	LEVEL_UP_END
};

static const struct LevelUpMove sStrykeLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_CUT),
	LEVEL_UP_END
};

static const struct LevelUpMove sButterfree_FemaleLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_GUST),
	LEVEL_UP_MOVE(1, MOVE_CONFUSION),
	LEVEL_UP_END
};

static const struct LevelUpMove sPikachu_Fat_GayLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sTrapinch_PikachuLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sKecleon_SansLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sPorygon_16LevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sPorygon_8LevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sPorygon_4LevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sPorist_GamesLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sRaticate_AlolaLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TAKE_DOWN),
	LEVEL_UP_END
};

static const struct LevelUpMove sMultipalLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_THUNDER_SHOCK),
	LEVEL_UP_MOVE(1, MOVE_QUICK_ATTACK),
	LEVEL_UP_MOVE(1, MOVE_HELPING_HAND),
	LEVEL_UP_END
...
static const struct LevelUpMove sDividumLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_THUNDER_SHOCK),
	LEVEL_UP_MOVE(1, MOVE_QUICK_ATTACK),
	LEVEL_UP_MOVE(1, MOVE_HELPING_HAND),
	LEVEL_UP_END
...
static const struct LevelUpMove sExponelleLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_THUNDER_SHOCK),
	LEVEL_UP_MOVE(1, MOVE_QUICK_ATTACK),
	LEVEL_UP_MOVE(1, MOVE_HELPING_HAND),
	LEVEL_UP_END
...
static const struct LevelUpMove sPikachu_Snap_SurfLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sPikachu_Snap_BallLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sPikachu_Snap_FlyingLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sPikachu_Snap_CloseLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sRaticate_DeadLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sShedinja_ElectricLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sDigimonLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sPorygon22LevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sHo_OwOLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sRatatattaLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sBulbasaur_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sIvysaur_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sVenusaur_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sCharmander_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sCharmeleon_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sCharizard_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sSquirtle_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sWartortle_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sBlastoise_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sCaterpie_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sMetapod_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sButterfree_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sWeedle_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sKakuna_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sBeedrill_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sPidgey_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sPidgeotto_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sPidgeot_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sRattata_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sRaticate_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sSpearow_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sFearow_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sEkans_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sArbok_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sPikachu_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sRaichu_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sSandshrew_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sSandslash_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sNidorina_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sNidoqueen_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sNidorino_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sNidoking_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sClefairy_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sClefable_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sVulpix_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sNinetales_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sJigglypuff_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sWigglytuff_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sZubat_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sGolbat_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sGloom_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sVileplume_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sParas_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sParasect_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sVenonat_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sVenomoth_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sDiglett_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sDugtrio_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sMeowth_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sPersian_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sPsyduck_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sGolduck_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sMankey_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sPrimeape_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sGrowlithe_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sArcanine_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sPoliwag_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sPoliwhirl_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sPoliwrath_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sAbra_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sKadabra_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sAlakazam_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sMachop_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sMachoke_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sMachamp_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sBellsprout_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sWeepinbell_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sVictreebel_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sTentacool_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sTentacruel_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sGeodude_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sGraveler_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sGolem_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sPonyta_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sRapidash_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sSlowpoke_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sSlowbro_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sMagnemite_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sMagneton_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sFarfetchd_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sDoduo_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sDodrio_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sSeel_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sDewgong_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sGrimer_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sMuk_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sShellder_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sCloyster_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sGastly_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sHaunter_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sGengar_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sOnix_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sDrowzee_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sHypno_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sKrabby_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sKingler_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sVoltorb_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sElectrode_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sExeggcute_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sExeggutor_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sCubone_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sMarowak_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sHitmonlee_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sHitmonchan_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sLickitung_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sKoffing_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sWeezing_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sRhyhorn_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sRhydon_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sChansey_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sTangela_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sHorsea_POKERAPLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE(5, MOVE_GROWL),
    LEVEL_UP_MOVE(9, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE(10, MOVE_EMBER),
...
static const struct LevelUpMove sSeadra_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sGoldeen_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sSeaking_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sStaryu_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sStarmie_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sMrMime_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sScyther_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sJynx_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sElectabuzz_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sMagmar_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sPinsir_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sTauros_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sMagikarp_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sGyarados_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sLapras_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sDitto_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sEevee_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sVaporeon_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sJolteon_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sFlareon_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sPorygon_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sOmanyte_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sOmastar_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sKabuto_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sKabutops_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sAerodactyl_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sSnorlax_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sArticuno_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sZapdos_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sMoltres_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sDratini_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sDragonair_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sDragonite_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};
...
// using Mewtwo as my placeholder
// remove the comments on the block inside and make sure that all the moves exist before inserting
static const struct LevelUpMove sMewtwo_POKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sPOKEMONRAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sNIDORANMPOKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sNIDORANFPOKERAPLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sCHANSEYBLANKLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sIRONCLEFTGREENLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sSOLACEONLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_SUNNY_DAYCARE),
    LEVEL_UP_MOVE(1, MOVE_SUNNY_DAYCARE),
    LEVEL_UP_MOVE(26, MOVE_SWEET_CENTER),
    LEVEL_UP_MOVE(28, MOVE_MART_STRIKE),
    LEVEL_UP_MOVE(30, MOVE_CAFEINT_ATTACK),
    LEVEL_UP_MOVE(32, MOVE_GRASSY_TERRAIN),
    LEVEL_UP_MOVE(34, MOVE_POWER_GYM),
    LEVEL_UP_MOVE(35, MOVE_HIDDEN_TOWER),
    LEVEL_UP_MOVE(35, MOVE_ANCIENT_TOWER),
    LEVEL_UP_MOVE(36, MOVE_SHED_TAIL),
    LEVEL_UP_MOVE(37, MOVE_ASSURANCH),
    LEVEL_UP_MOVE(39, MOVE_STORE_OF_TIME),
    LEVEL_UP_MOVE(40, MOVE_LIGHT_OF_RUINS),
	LEVEL_UP_END
};

static const struct LevelUpMove sPORYGON64LevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sPORYGON32LevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sFINALARTICUNOLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_QUINTUPLE_WINGBEAT),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sFINALMOLTRESLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_MOLTRES_KICK),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sDODODUOLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sCELEBI2LevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sSHINYABRALevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};
...
static const struct LevelUpMove sNOTHINGLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sDITTOBLIZLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sIRONMASKLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sZOMBONLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sTINKANETTELevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sRICKETOTLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sIMAKUNIDODUOLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sABSOLYNELevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sLICHENMASQUERAINLevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};

static const struct LevelUpMove sLICHENMAWILELevelUpLearnset[] = {
	LEVEL_UP_MOVE(1, MOVE_TACKLE),
	LEVEL_UP_END
};
