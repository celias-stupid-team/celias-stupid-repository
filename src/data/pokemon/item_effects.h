...
static const u8 sItemEffect_RatStone[6] = {
    [4] = ITEM4_EVO_STONE,
};
...
static const u8 sItemEffect_WEmblem[6] = {
    [4] = ITEM4_EVO_STONE,
};
...
const u8 *const gItemEffectTable[] =
{
    ...
    [ITEM_PREMIER_CANDY - ITEM_POTION]    = sItemEffect_RareCandy,
    ...
    // [ITEM_TOXIC_BERRY - ITEM_POTION]   = sItemEffect_ToxicBerry, // probably not required due to no outside of battle effect
