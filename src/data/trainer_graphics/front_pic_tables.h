const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    {.size = 8, .y_offset = 1}, // Imposter Oak
    ...
    {.size = 8, .y_offset = 1}, // Ninjas,
    {.size = 8, .y_offset = 1}, // Darachcait,
    {.size = 8, .y_offset = 1}, // Karen,
    ...
    {.size = 8, .y_offset = 1}, // Malva,
    {.size = 8, .y_offset = 1}, // Skiier,
    ...
    {.size = 8, .y_offset = 1}, // Kimono,
    {.size = 8, .y_offset = 1}, // Starlightsprite,
    {.size = 8, .y_offset = 1}, // Hakari_Bliz,
    {.size = 8, .y_offset = 1}, // Kotone
};
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(RED_NORMAL, gTrainerFrontPic_RedNormal, 0x800),
    ...
    TRAINER_SPRITE(NINJAS, gTrainerFrontPic_Ninjas, 0x800),
    TRAINER_SPRITE(DARACHCAIT, gTrainerFrontPic_Darachcait, 0x800),
    TRAINER_SPRITE(KAREN, gTrainerFrontPic_Karen, 0x800),
    TRAINER_SPRITE(TEAM_SKY, gTrainerFrontPic_TeamSky, 0x800),
    TRAINER_SPRITE(FALKNER, gTrainerFrontPic_Falkner, 0x800),
    TRAINER_SPRITE(TERRITORIALOAK, gTrainerFrontPic_Territorialoak, 0x800),
    ...
    TRAINER_SPRITE(STARMAN, gTrainerFrontPic_Starman, 0x800),
    TRAINER_SPRITE(RADICAL_RED, gTrainerFrontPic_RadicalRed, 0x800),
    ...
    TRAINER_SPRITE(MALVA, gTrainerFrontPic_Malva, 0x800),
    TRAINER_SPRITE(SKIIER, gTrainerFrontPic_Skiier, 0x800),
    TRAINER_SPRITE(DMCA_RUNT, gTrainerFrontPic_DmcaRunt, 0x800),
    ...
    TRAINER_SPRITE(KIMONO, gTrainerFrontPic_Kimono, 0x800),
    TRAINER_SPRITE(STARLIGHTSPRITE, gTrainerFrontPic_Starlightsprite, 0x800),
    TRAINER_SPRITE(HAKARI_BLIZ, gTrainerFrontPic_Hakari_Bliz, 0x800),
    TRAINER_SPRITE(KOTONE, gTrainerFrontPic_Kotone, 0x800),
};
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(NINJAS, gTrainerPalette_Ninjas),
    TRAINER_PAL(DARACHCAIT, gTrainerPalette_Darachcait),
    ...
    TRAINER_PAL(STARMAN, gTrainerPalette_Starman),
    TRAINER_PAL(RADICAL_RED, gTrainerPalette_RadicalRed),
    ...
    TRAINER_PAL(MALVA, gTrainerPalette_Malva),
    TRAINER_PAL(SKIIER, gTrainerPalette_Skiier),
    TRAINER_PAL(DMCA_RUNT, gTrainerPalette_DmcaRunt),
    ...
    TRAINER_PAL(STARLIGHTSPRITE, gTrainerPalette_Starlightsprite),
    TRAINER_PAL(HAKARI_BLIZ, gTrainerPalette_Hakari_Bliz),
    TRAINER_PAL(KOTONE, gTrainerPalette_Kotone),
};
