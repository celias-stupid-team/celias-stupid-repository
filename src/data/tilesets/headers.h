...
const struct Tileset gTileset_BobOmbBattlefield =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_BobOmbBattlefield,
    .palettes = gTilesetPalettes_BobOmbBattlefield,
    .metatiles = gMetatiles_BobOmbBattlefield,
...
const struct Tileset gTileset_Route18_SkyPillar =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Route18_SkyPillar,
    .palettes = gTilesetPalettes_Route18_SkyPillar,
    .metatiles = gMetatiles_Route18_SkyPillar,
...
const struct Tileset gTileset_EmeraldBuilding =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_EmeraldBuilding,
    .palettes = gTilesetPalettes_EmeraldBuilding,
    .metatiles = gMetatiles_EmeraldBuilding,
    .metatileAttributes = gMetatileAttributes_EmeraldBuilding,
    .callback = NULL,
};

const struct Tileset gTileset_SodaShop =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_SodaShop,
    .palettes = gTilesetPalettes_SodaShop,
    .metatiles = gMetatiles_SodaShop,
...
const struct Tileset gTileset_SurfHouse =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_SurfHouse,
    .palettes = gTilesetPalettes_SurfHouse,
    .metatiles = gMetatiles_SurfHouse,
...
const struct Tileset gTileset_Minnesota =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Minnesota,
    .palettes = gTilesetPalettes_Minnesota,
    .metatiles = gMetatiles_Minnesota,
    .metatileAttributes = gMetatileAttributes_Minnesota,
    .callback = NULL,
};

const struct Tileset gTileset_MinnesotaGym =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_MinnesotaGym,
    .palettes = gTilesetPalettes_MinnesotaGym,
    .metatiles = gMetatiles_MinnesotaGym,
...
const struct Tileset gTileset_Chapter7Chaper2 =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_Chapter7Chaper2,
    .palettes = gTilesetPalettes_Chapter7Chaper2,
    .metatiles = gMetatiles_Chapter7Chaper2,
...
const struct Tileset gTileset_SilphCo3 =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_SilphCo3,
    .palettes = gTilesetPalettes_SilphCo3,
    .metatiles = gMetatiles_SilphCo3,
...
const struct Tileset gTileset_Starlight_Interior3 =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Starlight_Interior3,
    .palettes = gTilesetPalettes_Starlight_Interior3,
    .metatiles = gMetatiles_Starlight_Interior3,
