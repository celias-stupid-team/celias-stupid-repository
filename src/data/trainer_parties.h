...
static const struct TrainerMonItemCustomMoves sParty_YoungsterJosh[] = {
    {
        ...
        .species = SPECIES_SCRAGGY,
        .heldItem = ITEM_NONE,
        .moves = {MOVE_COMEUPPANTS, MOVE_NONE, MOVE_NONE, MOVE_NONE},
    },
    {
        .iv = 0,
        .lvl = 8,
        ...
        .heldItem = ITEM_NONE,
        .moves = {MOVE_STRING_SHORT, MOVE_NONE, MOVE_NONE, MOVE_NONE},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_YoungsterTimmy[] = {
    {
        ...
        .moves = {MOVE_THUNDERBOLT, MOVE_BRAVE_BIRD, MOVE_NONE, MOVE_NONE}
    },
    {
        .iv = 0,
        .lvl = 14,
        .species = SPECIES_SALAMENCE,
        .moves = {MOVE_HYPER_VOICE, MOVE_DRAGON_CLAW, MOVE_NONE, MOVE_NONE}
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_AngryNerdLavos[] = {
    {
        .iv = 0,
        .lvl = 11,
        .species = SPECIES_JIRACHI,
        .moves = {MOVE_CONFUSION, MOVE_SWIFT, MOVE_IRON_HEAD, MOVE_NONE}
    },
    {
        .iv = 0,
        .lvl = 11,
...
static const struct TrainerMonNoItemCustomMoves sParty_CeruleanClubImakuni[] = {
    ...
    },
    {
        .iv = 0,
        .lvl = 14,
        .species = SPECIES_IMAKUNIDODUO,
        .moves = {MOVE_FRENZIED_ESCAPE, MOVE_NONE, MOVE_NONE, MOVE_NONE},
    },
...
static const struct TrainerMonNoItemCustomMoves sParty_BugCatcherRobby[] = {
    ...
    },
    {
        ...
        .moves = {MOVE_SHROOMBURST, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
    {
        .iv = 0,
        .lvl = 10,
        .species = SPECIES_TENTACOOL,
        .moves = {MOVE_SHROOM_DESIRE, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_BugCatcherCale[] = {
    {
        ...
        .moves = {MOVE_DRAGON_CLAW, MOVE_MUD_SHOT, MOVE_NONE, MOVE_NONE}
    },
    {
        .iv = 0,
        .lvl = 15,
        .species = SPECIES_PACHIRISU,
        .moves = {MOVE_NUZZLE, MOVE_FOLLOW_ME, MOVE_SUPER_FANG, MOVE_NONE} 
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_LassAli[] = {
    ...
    },
    {
        ...
        .moves = {MOVE_NONE, MOVE_EARTHQUAKE, MOVE_PSY_BEAM, MOVE_NONE},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_OfficerVerlisify[] = {
    ...
    },
    {
        ...
        .moves = {MOVE_STOCKPILE, MOVE_SLAM, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMonNoItemCustomMoves sParty_CamperEthan[] = {
    ...
    },
    {
        ...
        .moves = {MOVE_PARTING_SHOT, MOVE_KNOCK_OFF, MOVE_FAKE_OUT, MOVE_NONE},
    },
    {
        .iv = 0,
        .lvl = 13,
        .species = SPECIES_RAICHU,
        .moves = {MOVE_FAKE_OUT, MOVE_THUNDERBOLT, MOVE_ENDEAVOR, MOVE_THUNDER_WAVE},
    },
    {
        .iv = 0,
        .lvl = 12,
        .species = SPECIES_RAYQUAZA,
        .moves = {MOVE_NONE, MOVE_AERIAL_ACE, MOVE_SWORDS_DANCE, MOVE_EXTREME_SPEED},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_CamperJeff[] = {
    {
        ...
        .moves = {MOVE_SCRATCH, MOVE_GROWL, MOVE_EMBER, MOVE_WING_ATTACK}
    },
    {
        .iv = 0,
        .lvl = 16,
        .species = SPECIES_PIKACHU_OLD,
...
static const struct TrainerMonNoItemCustomMoves sParty_PicnickerCaitlin[] = {
    {
        ...
        .moves = {MOVE_PROTECT, MOVE_BIDE, MOVE_NONE, MOVE_NONE}
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_SuperNerdJovan[] = {
    {
        ...
        .lvl = 11,
        .species = SPECIES_MAGNEMITE,
        .moves = {MOVE_GYRO_MITE, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
    {
        .iv = 0,
        .lvl = 11,
...
static const struct TrainerMonNoItemCustomMoves sParty_HikerAlan[] = {
    {
        ...
        .moves = {MOVE_THUNDER_SHOCK, MOVE_DRILL_PECK, MOVE_NONE, MOVE_NONE},
    },
    {
        .iv = 0,
        .lvl = 21,
        .species = SPECIES_PIDGEOT_OLD,
...
static const struct TrainerMonNoItemDefaultMoves sParty_GamerDirk[] = {
    {
        .iv = 0,
        .lvl = 18,
        .species = SPECIES_MISCARRIAGE_KANGA,
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_GamerDarian[] = {
    {
        ...
        .moves = {MOVE_CONFIDE, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_JugglerGregory[] = {
    {
        ...
        .lvl = 48,
        .species = SPECIES_MR_MIME,
        .moves = {MOVE_PSY_BEAM, MOVE_ROLE_PLAY, MOVE_DOUBLE_SLAP, MOVE_ENCORE},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_JugglerEdward[] = {
    ...
    },
    {
        ...
        .lvl = 48,
        .species = SPECIES_MR_MIME,
        .moves = {MOVE_PSY_BEAM, MOVE_ROLE_PLAY, MOVE_REFLECT, MOVE_ENCORE},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_LeaderGiovanni[] = {
    {
        ...
        .lvl = 45,
        .species = SPECIES_RHYHORN,
        .moves = {MOVE_TAKE_DOWN, MOVE_BOFFA, MOVE_SCARY_FACE, MOVE_EARTHQUAKE},
    },
    {
        .iv = 0,
        .lvl = 42,
...
static const struct TrainerMonNoItemCustomMoves sParty_DMCAGrunt[] = {
    {
        .iv = 0,
        .lvl = 13,
        .species = SPECIES_RATTATA,
...
static const struct TrainerMonNoItemCustomMoves sParty_DMCAGrunt2[] = {
    {
        .iv = 0,
        .lvl = 11,
        .species = SPECIES_SANDSHREW,
...
static const struct TrainerMonNoItemDefaultMoves sParty_DMCAGrunt7[] = {
    {
        .iv = 0,
        .lvl = 20,
        .species = SPECIES_RATICATE_ALOLA,
...
static const struct TrainerMonNoItemDefaultMoves sParty_DMCAGrunt8[] = {
    {
        .iv = 0,
        .lvl = 21,
        .species = SPECIES_DROWZEE,
...
static const struct TrainerMonNoItemCustomMoves sParty_DMCAGrunt9[] = { //TEAM ROCKET
    {
        .iv = 0,
        .lvl = 21,
        .species = SPECIES_EKANS,
    ...
    },
    {
        ...
        .lvl = 25,
        .species = SPECIES_MEOWTH,
        .moves = {MOVE_BLAST_OFF, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
    {
        .iv = 0,
        .lvl = 18,
...
static const struct TrainerMonNoItemCustomMoves sParty_DMCAGrunt10[] = {
    {
        .iv = 0,
        .lvl = 20,
...
static const struct TrainerMonNoItemCustomMoves sParty_DMCAGrunt12[] = {
    {
        ...
        .lvl = 18,
        .species = SPECIES_ZUBAT,
        .moves = {MOVE_BLOCK, MOVE_TAKE_DOWN, MOVE_NONE, MOVE_NONE},
    },
};

static const struct TrainerMonNoItemCustomMoves sParty_DMCAGrunt13[] = {
    {
        .iv = 0,
        .lvl = 17,
        .species = SPECIES_RATICATE_ALOLA,
...
static const struct TrainerMonNoItemDefaultMoves sParty_DMCAGrunt14[] = {
    {
        .iv = 0,
        .lvl = 20,
        .species = SPECIES_RATTATA,
...
static const struct TrainerMonNoItemDefaultMoves sParty_DMCAGrunt15[] = {
    {
        .iv = 0,
        .lvl = 21,
        .species = SPECIES_MACHOP,
...
static const struct TrainerMonNoItemCustomMoves sParty_DMCAGrunt16[] = { // Petrel
    {
        .iv = 0,
        .lvl = 23,
        .species = SPECIES_KOFFING,
...
static const struct TrainerMonNoItemDefaultMoves sParty_DMCAGrunt17[] = {
    {
        .iv = 0,
        .lvl = 23,
        .species = SPECIES_EKANS,
...
static const struct TrainerMonNoItemCustomMoves sParty_DMCAGrunt18[] = {
    {
        .iv = 0,
        .lvl = 14,
        .species = SPECIES_GRIMER,
...
static const struct TrainerMonNoItemDefaultMoves sParty_DMCAGrunt19[] = {
    {
        .iv = 0,
        .lvl = 25,
...
static const struct TrainerMonNoItemDefaultMoves sParty_DMCAGrunt22[] = {
    ...
    },
    {
        .iv = 0,
        .lvl = 26,
        .species = SPECIES_RELICANTHPAST,
    },
    {
        .iv = 0,
        .lvl = 29,
        .species = SPECIES_RELICANTHFUTURE,
    },
    {
        .iv = 0,
        .lvl = 26,
...
static const struct TrainerMonNoItemDefaultMoves sParty_DMCAGrunt23[] = {
    {
        .iv = 0,
        .lvl = 29,
        .species = SPECIES_ZUBAT,
...
static const struct TrainerMonNoItemDefaultMoves sParty_DMCAGrunt24[] = {
    {
        .iv = 0,
        .lvl = 25,
        .species = SPECIES_RATICATE_ALOLA,
...
static const struct TrainerMonNoItemDefaultMoves sParty_DMCAGrunt25[] = {
    {
        .iv = 0,
        .lvl = 28,
        .species = SPECIES_RATICATE_ALOLA,
...
static const struct TrainerMonNoItemDefaultMoves sParty_DMCAGrunt26[] = {
    {
        .iv = 0,
        .lvl = 29,
        .species = SPECIES_MACHOP,
...
static const struct TrainerMonNoItemDefaultMoves sParty_DMCAGrunt27[] = {
    {
        .iv = 0,
        .lvl = 28,
        .species = SPECIES_EKANS,
...
static const struct TrainerMonNoItemDefaultMoves sParty_DMCAGrunt28[] = {
    {
        .iv = 0,
        .lvl = 33,
        .species = SPECIES_ARBOK,
...
static const struct TrainerMonNoItemDefaultMoves sParty_DMCAGrunt29[] = {
    {
        .iv = 0,
        .lvl = 33,
        .species = SPECIES_HYPNO,
...
static const struct TrainerMonNoItemDefaultMoves sParty_DMCAGrunt30[] = {
    {
        .iv = 0,
        .lvl = 29,
        .species = SPECIES_MACHOP,
...
static const struct TrainerMonNoItemDefaultMoves sParty_DMCAGrunt31[] = {
    {
        .iv = 0,
        .lvl = 28,
        .species = SPECIES_ZUBAT,
...
static const struct TrainerMonNoItemCustomMoves sParty_DMCAGrunt32[] = {
    {
        .iv = 0,
        .lvl = 26,
        .species = SPECIES_RATICATE_ALOLA,
...
static const struct TrainerMonNoItemDefaultMoves sParty_DMCAGrunt33[] = {
    {
        .iv = 0,
        .lvl = 29,
        .species = SPECIES_CUBONE,
...
static const struct TrainerMonNoItemDefaultMoves sParty_DMCAGrunt34[] = {
    {
        .iv = 0,
        .lvl = 29,
        .species = SPECIES_SANDSHREW,
...
static const struct TrainerMonNoItemDefaultMoves sParty_DMCAGrunt36[] = {
    {
        .iv = 0,
        .lvl = 28,
        .species = SPECIES_WEEZING,
...
static const struct TrainerMonNoItemDefaultMoves sParty_DMCAGrunt37[] = {
    {
        .iv = 0,
        .lvl = 28,
        .species = SPECIES_DROWZEE,
...
static const struct TrainerMonNoItemDefaultMoves sParty_DMCAGrunt38[] = {
    {
        .iv = 0,
        .lvl = 28,
        .species = SPECIES_GOLBAT,
...
static const struct TrainerMonNoItemDefaultMoves sParty_DMCAGrunt39[] = {
    {
        .iv = 0,
        .lvl = 33,
        .species = SPECIES_MACHOKE,
...
static const struct TrainerMonNoItemDefaultMoves sParty_DMCAGrunt40[] = {
    {
        .iv = 0,
        .lvl = 25,
        .species = SPECIES_RATTATA,
...
static const struct TrainerMonNoItemDefaultMoves sParty_DMCAGrunt41[] = {
    {
        .iv = 0,
        .lvl = 32,
        .species = SPECIES_CUBONE,
...
static const struct TrainerMonNoItemCustomMoves sParty_CooltrainerOwen[] = {
    ...
    },
    {
        ...
        .lvl = 42,
        .species = SPECIES_RHYHORN,
        .moves = {MOVE_BOFFA, MOVE_SCARY_FACE, MOVE_STOMP, MOVE_TAIL_WHIP},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_CooltrainerBerke[] = {
    ...
    },
    {
        ...
        .lvl = 42,
        .species = SPECIES_GRAVELER,
        .moves = {MOVE_BOFFA, MOVE_MAGNITUDE, MOVE_ROCK_THROW, MOVE_MUD_SPORT},
    },
    {
        .iv = 100,
        .lvl = 42,
...
static const struct TrainerMonNoItemCustomMoves sParty_CooltrainerYuji[] = {
    ...
    },
    {
        ...
        .lvl = 38,
        .species = SPECIES_GRAVELER,
        .moves = {MOVE_BOFFA, MOVE_MAGNITUDE, MOVE_MUD_SPORT, MOVE_DEFENSE_CURL},
    },
    {
        .iv = 100,
        .lvl = 38,
    ...
    },
    {
        ...
        .lvl = 38,
        .species = SPECIES_GRAVELER,
        .moves = {MOVE_BOFFA, MOVE_MAGNITUDE, MOVE_ROLLOUT, MOVE_DEFENSE_CURL},
    },
    {
        .iv = 100,
        .lvl = 38,
...
static const struct TrainerMonNoItemCustomMoves sParty_CooltrainerWarren[] = {
    ...
    },
    {
        ...
        .lvl = 38,
        .species = SPECIES_RHYHORN,
        .moves = {MOVE_TAKE_DOWN, MOVE_BOFFA, MOVE_FURY_ATTACK, MOVE_SCARY_FACE},
    },
    {
        .iv = 100,
        .lvl = 39,
...
static const struct TrainerMonNoItemCustomMoves sParty_CooltrainerShannon[] = {
    ...
    },
    {
        ...
        .lvl = 42,
        .species = SPECIES_BUTTERFREE,
        .moves = {MOVE_SAFEGUARD, MOVE_PSY_WIND, MOVE_GUST, MOVE_SUPERSONIC},
    },
    {
        .iv = 100,
        .lvl = 42,
    ...
    },
    {
        ...
        .moves = {MOVE_PSY_WIND, MOVE_STUN_SPORE, MOVE_LEECH_LIFE, MOVE_DISABLE},
    },
    {
        .iv = 100,
        .lvl = 42,
        .species = SPECIES_VENOMOTH,
        .moves = {MOVE_PSY_WIND, MOVE_GUST, MOVE_SUPERSONIC, MOVE_LEECH_LIFE},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_CooltrainerAustina[] = {
    {
        ...
        .lvl = 42,
        .species = SPECIES_RHYHORN,
        .moves = {MOVE_HORN_DRILL, MOVE_BOFFA, MOVE_SCARY_FACE, MOVE_STOMP},
    },
    {
        .iv = 100,
        .lvl = 42,
...
static const struct TrainerMonItemCustomMoves sParty_EliteFourLorelei[] = {
    ...
    },
    {
        ...
        .moves = {MOVE_CONFUSE_RAY, MOVE_ICEBEAM, MOVE_SURF, MOVE_BODY_SLAM},
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_EliteFourAgatha[] = {
    ...
    },
    {
        ...
        .heldItem = ITEM_NONE,
        .moves = {MOVE_AURA_SPHERE_2, MOVE_NONE, MOVE_NONE, MOVE_NONE},
    },
    {
        .iv = 250,
        .lvl = 63,
...
static const struct TrainerMonNoItemCustomMoves sParty_RivalRoute22LateSquirtle[] = {
    {
        .iv = 150,
        .lvl = 100,
        .species = SPECIES_ZAPMOLCUNO,
        .moves = {MOVE_TRIPLE_WINGBEAT, MOVE_NONE, MOVE_NONE, MOVE_NONE},
    },
    {
        .iv = 250,
        .lvl = 6,
...
static const struct TrainerMonNoItemDefaultMoves sParty_ChannelerCarly[] = {
    {
        .iv = 0,
        .lvl = 24,
        .species = SPECIES_UNOWNS,
    },
    {
        .iv = 0,
        .lvl = 28,
        .species = SPECIES_UNOWNE,
    },
    {
        .iv = 0,
        .lvl = 27,
        .species = SPECIES_UNOWNN,
    },
    {
        .iv = 0,
        .lvl = 26,
        .species = SPECIES_UNOWND,
    },
    {
        .iv = 0,
        .lvl = 24,
...
static const struct TrainerMonNoItemDefaultMoves sParty_ChannelerHope[] = {
    ...
    },
    {
        .iv = 0,
        .lvl = 23,
        .species = SPECIES_REVENANT,
    },
    {
        .iv = 0,
        .lvl = 23,
        .species = SPECIES_TANGELACREEPY,
    },
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_DMCAGrunt42[] = {
    {
        .iv = 0,
        .lvl = 49,
        .species = SPECIES_HOUNDOUR,
...
static const struct TrainerMonNoItemCustomMoves sParty_PsychicJaclyn[] = {
    ...
    },
    {
        ...
        .lvl = 48,
        .species = SPECIES_SLOWBRO,
        .moves = {MOVE_PSY_BEAM, MOVE_HEADBUTT, MOVE_AMNESIA, MOVE_YAWN},
    },
    {
        .iv = 100,
        .lvl = 49,
...
static const struct TrainerMonNoItemCustomMoves sParty_BikerRicardo[] = {
    {
        .iv = 0,
        .lvl = 24,
        .species = SPECIES_STRYKE,
        .moves = {MOVE_CUT, MOVE_NONE, MOVE_NONE, MOVE_NONE},
    },
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_DMCAGrunt43[] = {
    {
        .iv = 0,
        .lvl = 37,
        .species = SPECIES_CUBONE,
...
static const struct TrainerMonNoItemDefaultMoves sParty_DMCAGrunt44[] = {
    {
        .iv = 0,
        .lvl = 35,
        .species = SPECIES_RATTATA,
...
static const struct TrainerMonNoItemDefaultMoves sParty_DMCAGrunt45[] = {
    {
        .iv = 0,
        .lvl = 38,
        .species = SPECIES_ZUBAT,
...
static const struct TrainerMonNoItemDefaultMoves sParty_DMCAGrunt46[] = {
    {
        .iv = 0,
        .lvl = 48,
        .species = SPECIES_MUK,
...
static const struct TrainerMonNoItemCustomMoves sParty_ScientistGideon[] = {
    ...
    },
    {
        ...
        .lvl = 46,
        .species = SPECIES_PORYGON,
        .moves = {MOVE_TRI_ATTACK, MOVE_CONVERSION, MOVE_RECOVER, MOVE_PSY_WIND},
    },
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_DMCAGrunt49[] = {
    {
        .iv = 0,
        .lvl = 48,
        .species = SPECIES_RATTATA,
...
static const struct TrainerMonNoItemCustomMoves sParty_DMCAGrunt50[] = {
    {
        .iv = 0,
        .lvl = 49,
        .species = SPECIES_GRIMER,
...
static const struct TrainerMonNoItemDefaultMoves sParty_DMCAGrunt51[] = {
    {
        .iv = 50,
        .lvl = 48,
        .species = SPECIES_EKANS,
...
static const struct TrainerMonNoItemCustomMoves sParty_PsychicDario[] = {
    {
        ...
        .moves = {MOVE_CRUNCH, MOVE_PSY_WIND, MOVE_ODOR_SLEUTH, MOVE_AGILITY},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_PsychicRodette[] = {
    ...
    },
    {
        ...
        .lvl = 48,
        .species = SPECIES_DROWZEE,
        .moves = {MOVE_PSY_BEAM, MOVE_DISABLE, MOVE_PSYCH_UP, MOVE_FUTURE_SIGHT},
    },
    {
        .iv = 100,
        .lvl = 50,
        .species = SPECIES_HYPNO,
        .moves = {MOVE_PSY_BEAM, MOVE_HYPNOSIS, MOVE_PSYCH_UP, MOVE_FUTURE_SIGHT},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_CooltrainerLeroy[] = {
    {
        ...
        .lvl = 47,
        .species = SPECIES_RHYDON,
        .moves = {MOVE_TAKE_DOWN, MOVE_HORN_DRILL, MOVE_BOFFA, MOVE_SCARY_FACE},
    },
    {
        .iv = 100,
        .lvl = 48,
        .species = SPECIES_SLOWBRO,
        .moves = {MOVE_PSY_BEAM, MOVE_HEADBUTT, MOVE_AMNESIA, MOVE_DISABLE},
    },
    {
        .iv = 100,
        .lvl = 47,
...
static const struct TrainerMonNoItemCustomMoves sParty_CooltrainerMichelle[] = {
    ...
    },
    {
        ...
        .lvl = 47,
        .species = SPECIES_DEWGONG,
        .moves = {MOVE_ICEBEAM, MOVE_TAKE_DOWN, MOVE_ICY_WIND, MOVE_GROWL},
    },
    {
        .iv = 100,
        .lvl = 48,
    ...
    },
    {
        ...
        .lvl = 50,
        .species = SPECIES_GIRAFARIG,
        .moves = {MOVE_CRUNCH, MOVE_PSY_WIND, MOVE_STOMP, MOVE_ODOR_SLEUTH},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_RuinManiacBenjamin[] = {
    {
        ...
        .lvl = 48,
        .species = SPECIES_GEODUDE,
        .moves = {MOVE_EARTHQUAKE, MOVE_BOFFA, MOVE_ROLLOUT, MOVE_SELF_DESTRUCT},
    },
    {
        .iv = 0,
        .lvl = 48,
        .species = SPECIES_GRAVELER,
        .moves = {MOVE_EARTHQUAKE, MOVE_BOFFA, MOVE_ROCK_THROW, MOVE_SELF_DESTRUCT},
    },
    {
        .iv = 0,
        .lvl = 48,
...
static const struct TrainerMonItemCustomMoves sParty_EliteFourLorelei2[] = {
    {
        ...
        .species = SPECIES_DEWGONG,
        .heldItem = ITEM_NONE,
        .moves = {MOVE_ICEBEAM, MOVE_SURF, MOVE_SIGNAL_BEAM, MOVE_DOUBLE_TEAM},
    },
    {
        .iv = 255,
        .lvl = 63,
        .species = SPECIES_CLOYSTER,
        .heldItem = ITEM_NONE,
        .moves = {MOVE_ICEBEAM, MOVE_SURF, MOVE_SUPERSONIC, MOVE_RAIN_DANCE},
    },
    {
        .iv = 255,
        .lvl = 63,
        ...
        .heldItem = ITEM_NONE,
        .moves = {MOVE_ICE, MOVE_EARTHQUAKE, MOVE_DOUBLE_EDGE, MOVE_ROCK_SLIDE},
    },
    {
        .iv = 255,
        .lvl = 66,
        .species = SPECIES_JYNX,
        .heldItem = ITEM_NONE,
        .moves = {MOVE_ICEBEAM, MOVE_PSY_BEAM, MOVE_LOVELY_KISS, MOVE_ATTRACT},
    },
    {
        .iv = 255,
        .lvl = 66,
        ...
        .moves = {MOVE_ICEBEAM, MOVE_SURF, MOVE_PSY_BEAM, MOVE_THUNDER},
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_EliteFourAgatha2[] = {
    {
        ...
        .species = SPECIES_GENGAR,
        .heldItem = ITEM_NONE,
        .moves = {MOVE_SHADOW_BALL, MOVE_PSY_BEAM, MOVE_CONFUSE_RAY, MOVE_HYPNOSIS},
    },
    {
        .iv = 255,
        .lvl = 66,
    ...
    },
    {
        ...
        .heldItem = ITEM_NONE,
        .moves = {MOVE_SHADOW_BALL, MOVE_PSY_BEAM, MOVE_THUNDERBOLT, MOVE_ATTRACT},
    },
    {
        .iv = 255,
        .lvl = 68,
    ...
    },
    {
        ...
        .moves = {MOVE_SHADOW_BALL, MOVE_PSY_BEAM, MOVE_THUNDERBOLT, MOVE_SLUDGE_BOMB},
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_EliteFourLance2[] = {
    ...
    },
    {
        ...
        .heldItem = ITEM_NONE,
        .moves = {MOVE_HYPER_BEAM, MOVE_DRAGON_DANCE, MOVE_SURF, MOVE_ICEBEAM},
    },
    {
        .iv = 255,
        .lvl = 70,
    ...
    },
    {
        ...
        .species = SPECIES_DRAGONITE,
        .heldItem = ITEM_PERSIM_BERRY,
        .moves = {MOVE_HYPER_BEAM, MOVE_OUTRAGE, MOVE_THUNDERBOLT, MOVE_ICEBEAM},
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_ChampionRematchSquirtle[] = {
    ...
    },
    {
        ...
        .species = SPECIES_ALAKAZAM,
        .heldItem = ITEM_NONE,
        .moves = {MOVE_PSY_BEAM, MOVE_SHADOW_BALL, MOVE_CALM_MIND, MOVE_REFLECT},
    },
    {
        .iv = 255,
        .lvl = 72,
    ...
    },
    {
        ...
        .species = SPECIES_EXEGGUTOR,
        .heldItem = ITEM_NONE,
        .moves = {MOVE_GIGA_DRAIN, MOVE_PSY_BEAM, MOVE_SLEEP_POWDER, MOVE_LIGHT_SCREEN},
    },
    {
        .iv = 255,
        .lvl = 75,
        .species = SPECIES_BLASTOISE,
        .heldItem = ITEM_SITRUS_BERRY,
        .moves = {MOVE_HYDRO_PUMP, MOVE_ICEBEAM, MOVE_EARTHQUAKE, MOVE_RAIN_DANCE},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_PokerapTrainer1[] = {
    ...
    },
    {
        .iv = 0,
        .lvl = 15,
        .species = SPECIES_NIDORANMPOKERAP,
        .moves = {MOVE_TACKLE, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
    {
        .iv = 0,
...
static const struct TrainerMonNoItemCustomMoves sParty_PokerapTrainer23[] = {
    ...
    },
    {
        .iv = 0,
        .lvl = 15,
        .species = SPECIES_NIDORANFPOKERAP,
        .moves = {MOVE_TACKLE, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
...
static const struct TrainerMonNoItemCustomMoves sParty_DMCAArcher[] = {
    ...
    },
    {
        .iv = 0,
        .lvl = 30,
        .species = SPECIES_IRONCLEFTGREEN,
        .moves = {MOVE_SPIKY_SHIELD, MOVE_FOLLOW_HIM, MOVE_NONE, MOVE_NONE}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_FrontierBrainGreta[] = {
    {
        .iv = 0,
        .lvl = 1,
...
static const struct TrainerMonItemCustomMoves sParty_FrontierBrainTucker[] = {
    {
        .iv = 0,
        .lvl = 30,
...
static const struct TrainerMonNoItemCustomMoves sParty_FrontierBrainNoland[] = {
    {
        ...
        .moves = {MOVE_LION_LADDER, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
...
static const struct TrainerMonItemCustomMoves sParty_DMCASabrina[] = {
    {
        ...
        .heldItem = ITEM_NONE,
        .species = SPECIES_KADABRA,
        .moves = {MOVE_KINESIS, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    }
...
static const struct TrainerMonItemCustomMoves sParty_ShortsGang1[] = {
    {
        .iv = 0,
        .lvl = 30,
        .heldItem = ITEM_NONE,
...
static const struct TrainerMonItemCustomMoves sParty_ShortsGang2[] = {
    {
        .iv = 0,
        .lvl = 30,
        .heldItem = ITEM_NONE,
...
static const struct TrainerMonItemCustomMoves sParty_ShortsGang3[] = {
    {
        .iv = 0,
        .lvl = 30,
        .heldItem = ITEM_NONE,
...
static const struct TrainerMonItemCustomMoves sParty_BerserkJeans[] = {
    {
        .iv = 0,
        .lvl = 30,
        .heldItem = ITEM_NONE,
...
static const struct TrainerMonItemCustomMoves sParty_Blaine5[] = {
    {
        ...
        .moves = {MOVE_MULTISHINE, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
};

static const struct TrainerMonItemCustomMoves sParty_Blaine6[] = {
    {
        .iv = 0,
        .lvl = 20,
        .heldItem = ITEM_NONE,
        .species = SPECIES_DEOXYS,
        .moves = {MOVE_REVELATION_DANCE_2, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
};

static const struct TrainerMonItemCustomMoves sParty_Blaine7[] = {
    {
        .iv = 0,
        .lvl = 70,
        .heldItem = ITEM_NONE,
...
static const struct TrainerMonItemCustomMoves sParty_OceanMazeLass[] = {
    {
        .iv = 0,
        .lvl = 30,
        .heldItem = ITEM_NONE,
...
static const struct TrainerMonItemCustomMoves sParty_BackpackSwimmer[] = {
    {
        .iv = 0,
        .lvl = 30,
        .heldItem = ITEM_NONE,
...
static const struct TrainerMonItemCustomMoves sParty_DMCAQW[] = {
    {
        .iv = 0,
        .lvl = 30,
...
static const struct TrainerMonItemCustomMoves sParty_BerriedAlive[] = {
    {
        .iv = 0,
        .lvl = 30,
        .heldItem = ITEM_NONE,
        .species = SPECIES_HAUNTER,
        .moves = {MOVE_TOMBSTONER, MOVE_BULK_UP, MOVE_NONE, MOVE_NONE}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_FuckSailor[] = {
    {
        .iv = 0,
        .lvl = 20,
        .heldItem = ITEM_NONE,
...
static const struct TrainerMonItemCustomMoves sParty_AVGN1[] = {
    {
        .iv = 0,
        .lvl = 20,
        .heldItem = ITEM_NONE,
...
static const struct TrainerMonItemCustomMoves sParty_AVGN2[] = {
    {
        .iv = 0,
        .lvl = 20,
        .heldItem = ITEM_NONE,
        .species = SPECIES_PORYGON64,
        .moves = {MOVE_TACKLE, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
    {
        .iv = 0,
    ...
    },
    {
        ...
        .lvl = 20,
        .heldItem = ITEM_NONE,
        .species = SPECIES_PORIST_GAMES,
        .moves = {MOVE_WRISTY_EXPLOSION, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
};
static const struct TrainerMonItemCustomMoves sParty_AVGN3[] = {
    {
        .iv = 0,
        .lvl = 20,
        .heldItem = ITEM_NONE,
...
static const struct TrainerMonItemCustomMoves sParty_AVGN4[] = {
    {
        ...
        .moves = {MOVE_SOFT_LOCK, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
};
