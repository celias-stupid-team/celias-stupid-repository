...
{
    [SPAWN_PALLET_TOWN - 1] = {MAP_GROUP(PALLET_TOWN), MAP_NUM(PALLET_TOWN), 15, 8},
    ...
    [SPAWN_FUSHCIA_CITY - 1] = {MAP_GROUP(FUSHCIA_CITY), MAP_NUM(FUSHCIA_CITY), 25, 32},
    ...
    [SPAWN_ROUTE10 - 1] = {MAP_GROUP(ROUTE10), MAP_NUM(ROUTE10), 19, 43},
