...
const u8 gMoveDescription_FirePunch[] = __("The foe is punched\nwith a wet fist.\nDeals PHYSICAL\ndamage.");
...
const u8 gMoveDescription_Gust[] = _("In God we trust\nit's Gust");
...
const u8 gMoveDescription_Thunderbolt[] = _("Thank you, MR.\nICE BEAM!");
...
const u8 gMoveDescription_FeatherDance[] = _("Dance, feathers!\nDance!");
...
const u8 gMoveDescription_Tailwind[] = _("Fast air rushes\ntowards");
...
const u8 gMoveDescription_Psychic_Punch[] = __("Hmm, guess it's\nnot ICE PUNCH.\nDeals PHYSICAL\ndamage.");
