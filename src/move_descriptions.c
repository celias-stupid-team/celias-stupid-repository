...
const u8 gMoveDescription_Gust[] = _("Graciously not\nreverted to\nNORMAL-TYPE like\nin Gen 1.");
...
const u8 gMoveDescription_Headbutt[] = _("We're adults; we\ncan call it\nHEAD ASS.");
...
const u8 gMoveDescription_Tackle[] = _("Trust me, it's\nvery important\nthat TACKLE is\nworse than POUND.");
...
const u8 gMoveDescription_Twineedle[] = _("Uhh yeah, it's\nthat one.\nClose enough.");
