...
static const u8 sTextColorTable[] =
{
 // [LOW_NYBBLE / 2]                            = 0xXY, // HIGH_NYBBLE
    ...
    [OBJ_EVENT_GFX_CELIA / 2]                = COLORS(NPC_TEXT_COLOR_FEMALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_ROCKET_M
    ...
    [OBJ_EVENT_GFX_DAD / 2]                     = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_BUGSY_FAKE
    ...
    [OBJ_EVENT_GFX_POKEDEX / 2]                 = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_TREE), // OBJ_EVENT_GFX_CUT_TREE
    [OBJ_EVENT_GFX_ROCK_SMASH_ROCK / 2]         = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_PUSHABLE_BOULDER
    [OBJ_EVENT_GFX_FOSSIL / 2]                  = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_GS_BALL
    ...
    [OBJ_EVENT_GFX_ALOLAN_GROWLITHE / 2]               = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_MON), // OBJ_EVENT_GFX_SNORLAX
    ...
    [OBJ_EVENT_GFX_PSYDUCK_SHADES / 2]                  = COLORS(NPC_TEXT_COLOR_FEMALE, NPC_TEXT_COLOR_MON), // OBJ_EVENT_GFX_CHANSEY
    [OBJ_EVENT_GFX_OMANYTE / 2]                 = COLORS(NPC_TEXT_COLOR_MON, NPC_TEXT_COLOR_MON), // OBJ_EVENT_GFX_KANGASKHAN
    [OBJ_EVENT_GFX_PIKACHU / 2]                 = COLORS(NPC_TEXT_COLOR_MON, NPC_TEXT_COLOR_FEMALE), // OBJ_EVENT_GFX_PSYDUCK
    ...
    [OBJ_EVENT_GFX_TRUCK / 2]                = COLORS(NPC_TEXT_COLOR_MON, NPC_TEXT_COLOR_MON), // OBJ_EVENT_GFX_DEOXYS_A
    [OBJ_EVENT_GFX_DEOXYS_N / 2]                = COLORS(NPC_TEXT_COLOR_MON, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_SS_ANNEc

    //New ones
    [OBJ_EVENT_GFX_LITWICK / 2] = COLORS(NPC_TEXT_COLOR_MON, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_ODD_CANDY
    [OBJ_EVENT_GFX_NES / 2] = COLORS(NPC_TEXT_COLOR_MON, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_BENCH
    [OBJ_EVENT_GFX_SHITPICKLE / 2] = COLORS(NPC_TEXT_COLOR_TREE, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_ROTOMDEX
    [OBJ_EVENT_GFX_MARIOSTAR / 2] = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_MON), // OBJ_EVENT_GFX_CHAINCHOMP
    [OBJ_EVENT_GFX_BOBOMBBUDDY / 2] = COLORS(NPC_TEXT_COLOR_FEMALE, NPC_TEXT_COLOR_MON), // OBJ_EVENT_GFX_MOLTRESEGG
    [OBJ_EVENT_GFX_ARTICUNOEGG / 2] = COLORS(NPC_TEXT_COLOR_MON, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_TRASHDAD
    [OBJ_EVENT_GFX_SNAKE / 2] = COLORS(NPC_TEXT_COLOR_MON, NPC_TEXT_COLOR_MON), // OBJ_EVENT_GFX_NEBBY
    [OBJ_EVENT_GFX_ALOLAOAK / 2] = COLORS(NPC_TEXT_COLOR_TREE, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_BRICKWALL
    [OBJ_EVENT_GFX_IMPOSTER_OAK_BIG / 2] = COLORS(NPC_TEXT_COLOR_TREE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_IMAKUNI
    [OBJ_EVENT_GFX_LOOKER / 2] = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_FEMALE), // OBJ_EVENT_GFX_CYNTHIA
    [OBJ_EVENT_GFX_DAZZLE / 2] = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_DIETDANCE
    [OBJ_EVENT_GFX_UMBRELLADAD / 2] = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_FEMALE), // OBJ_EVENT_GFX_KIMONORED
    [OBJ_EVENT_GFX_KIMONOGREEN / 2] = COLORS(NPC_TEXT_COLOR_FEMALE, NPC_TEXT_COLOR_FEMALE), // OBJ_EVENT_GFX_KIMONOBLUE
    [OBJ_EVENT_GFX_KIMONOYELLOW / 2] = COLORS(NPC_TEXT_COLOR_FEMALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_YELLOWGUY
    [OBJ_EVENT_GFX_SINNOHLASS / 2] = COLORS(NPC_TEXT_COLOR_FEMALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_FALKNER
    [OBJ_EVENT_GFX_SKYGRUNT / 2] = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_DISCODAD
    [OBJ_EVENT_GFX_SANS / 2] = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_FLINT
    [OBJ_EVENT_GFX_SKIIER / 2] = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_ASH
    [OBJ_EVENT_GFX_KURT / 2] = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_LARRY
    [OBJ_EVENT_GFX_BARRY / 2] = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_MAGMAGRUNT
    [OBJ_EVENT_GFX_JASONVORHEES / 2] = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_TREE), // OBJ_EVENT_GFX_HUMANOAK
    [OBJ_EVENT_GFX_BALLOONDAD / 2] = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_TREE), // OBJ_EVENT_GFX_PROFESSORIVY
    [OBJ_EVENT_GFX_SCOTT / 2] = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_GOLD
    [OBJ_EVENT_GFX_PLAYFIRE / 2] = COLORS(NPC_TEXT_COLOR_FEMALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_PLAYGREEN
    [OBJ_EVENT_GFX_PROTON / 2] = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_PETREL
    [OBJ_EVENT_GFX_ARIANA / 2] = COLORS(NPC_TEXT_COLOR_FEMALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_SILVER
    [OBJ_EVENT_GFX_VIKING / 2] = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_SWIMDAD
    [OBJ_EVENT_GFX_SKULLGRUNT / 2] = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_GUZMA
    [OBJ_EVENT_GFX_SWIMLASS / 2] = COLORS(NPC_TEXT_COLOR_FEMALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_SWIMNERD
    [OBJ_EVENT_GFX_SWIMBIKER / 2] = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MON), // OBJ_EVENT_GFX_HIPPOPOTAS
    [OBJ_EVENT_GFX_FURRET / 2] = COLORS(NPC_TEXT_COLOR_MON, NPC_TEXT_COLOR_MON), // OBJ_EVENT_GFX_GROWLITHESIGN
    [OBJ_EVENT_GFX_DRIFLOON / 2] = COLORS(NPC_TEXT_COLOR_MON, NPC_TEXT_COLOR_MON), // OBJ_EVENT_GFX_WAILORD
    [OBJ_EVENT_GFX_CARDAD / 2] = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MON), // OBJ_EVENT_GFX_SKITTY
    [OBJ_EVENT_GFX_SUDOWOODO / 2] = COLORS(NPC_TEXT_COLOR_MON, NPC_TEXT_COLOR_MON), // OBJ_EVENT_GFX_AMPHAROS
    [OBJ_EVENT_GFX_ORTHWORM / 2] = COLORS(NPC_TEXT_COLOR_MON, NPC_TEXT_COLOR_MON), // OBJ_EVENT_GFX_ETERNATUS
    [OBJ_EVENT_GFX_PRIMEAPE / 2] = COLORS(NPC_TEXT_COLOR_MON, NPC_TEXT_COLOR_MON), // OBJ_EVENT_GFX_DEWGONG
    [OBJ_EVENT_GFX_CASTFORM / 2] = COLORS(NPC_TEXT_COLOR_MON, NPC_TEXT_COLOR_MON), // OBJ_EVENT_GFX_ZYGARDE
    [OBJ_EVENT_GFX_ZUBAT / 2] = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_PARTYDAD
    [OBJ_EVENT_GFX_KOFFING / 2] = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_SKUNTANK
    [OBJ_EVENT_GFX_MILTANK / 2] = COLORS(NPC_TEXT_COLOR_MON, NPC_TEXT_COLOR_MON), // OBJ_EVENT_GFX_VICTINI
    [OBJ_EVENT_GFX_ABSOL / 2] = COLORS(NPC_TEXT_COLOR_MON, NPC_TEXT_COLOR_MON), // OBJ_EVENT_GFX_KANGABABY
    [OBJ_EVENT_GFX_GYARADOS / 2] = COLORS(NPC_TEXT_COLOR_MON, NPC_TEXT_COLOR_MON), // OBJ_EVENT_GFX_TRUBBISH
    [OBJ_EVENT_GFX_AZ / 2] = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_RILEY
    [OBJ_EVENT_GFX_DMCADAD / 2] = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_N
