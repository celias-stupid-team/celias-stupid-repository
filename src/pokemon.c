...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_NATIONAL(CHARIZARD), // 4
    SPECIES_TO_NATIONAL(SQUIRTLE), // 5
    SPECIES_TO_NATIONAL(IVYSAUR), // 6
    SPECIES_TO_NATIONAL(CATERPIE), // 7
    SPECIES_TO_NATIONAL(METAPOD), // 8
    SPECIES_TO_NATIONAL(BUTTERFREE), // 9
    SPECIES_TO_NATIONAL(WEEDLE), // 10
    SPECIES_TO_NATIONAL(KAKUNA), // 11
    SPECIES_TO_NATIONAL(COMBEE), // 12
    SPECIES_TO_NATIONAL(PIDGEY), // 13
    SPECIES_TO_NATIONAL(PIDGEOTTO), // 14
    SPECIES_TO_NATIONAL(PIDGEOT), // 15
    SPECIES_TO_NATIONAL(RATTATA), // 16
    SPECIES_TO_NATIONAL(RATICATE), // 17
    SPECIES_TO_NATIONAL(MANKEY), //18 
    SPECIES_TO_NATIONAL(PRIMEAPE), // 19
    SPECIES_TO_NATIONAL(SANDSHREW), // 20
    SPECIES_TO_NATIONAL(SANDSLASH), // 21
    SPECIES_TO_NATIONAL(EKANS), // 22
    SPECIES_TO_NATIONAL(ARBOK), // 23
    SPECIES_TO_NATIONAL(SEVIPER), // 24
    SPECIES_TO_NATIONAL(PIKABLU), // 25 NOT IN YET - PIKABLU
    SPECIES_TO_NATIONAL(VOLTORB), // 26
    SPECIES_TO_NATIONAL(JIGGLYPUFF_ABOVE), // 27 NOT IN YET
    SPECIES_TO_NATIONAL(JIGGLYPUFF), // 28
    SPECIES_TO_NATIONAL(NIDORAN_M), // 29
    SPECIES_TO_NATIONAL(NIDORINA), // 30
    SPECIES_TO_NATIONAL(NIDOQUEEN), //31
    SPECIES_TO_NATIONAL(NIDORAN_F), // 32
    SPECIES_TO_NATIONAL(NIDORINO), // 33
    SPECIES_TO_NATIONAL(NIDOKING), //34
    SPECIES_TO_NATIONAL(CLEFAIRY), // 35
    SPECIES_TO_NATIONAL(CLEFABLE), // 36
    SPECIES_TO_NATIONAL(GENGAR), // 37
    SPECIES_TO_NATIONAL(VULPIX), // 38
    SPECIES_TO_NATIONAL(NINETALES), // 39 
    SPECIES_TO_NATIONAL(DIGLETT), // 40
    SPECIES_TO_NATIONAL(DUGTRIO), //Digletts 41
    SPECIES_TO_NATIONAL(KRABBY), // 42
    SPECIES_TO_NATIONAL(TENTACOOL), // 43
    SPECIES_TO_NATIONAL(TOEDSCOOL), // 44
    SPECIES_TO_NATIONAL(PARAS), // 45
    SPECIES_TO_NATIONAL(PARASECT), // 46
    SPECIES_TO_NATIONAL(AMOONGUSS), // 47
    SPECIES_TO_NATIONAL(GYARADOS), // 48
    SPECIES_TO_NATIONAL(MAGIKARP), // 49
    SPECIES_TO_NATIONAL(CUBONE), // 50 
    SPECIES_TO_NATIONAL(MAROWAK), // 51
    SPECIES_TO_NATIONAL(POLIWAG), // 52 
    SPECIES_TO_NATIONAL(TENTAQUIL), // 53
    SPECIES_TO_NATIONAL(GOLDUCK), //The blue one 54
    SPECIES_TO_NATIONAL(PSYDUCK), //The yellow one 55
    SPECIES_TO_NATIONAL(ABRA), // 56
    SPECIES_TO_NATIONAL(MISSINGNO), // 57 NOT IN YET
    SPECIES_TO_NATIONAL(ALAKAZAM), // 58
    SPECIES_TO_NATIONAL(KANGASKHAN), // 59 
    SPECIES_TO_NATIONAL(KENYA), // 60  NOT IN YET
    SPECIES_TO_NATIONAL(UNOWN_LOSS), // 61 NOT IN YET
    SPECIES_TO_NATIONAL(DODUO), // 62
    SPECIES_TO_NATIONAL(HITMONCHAN_SHIT), // 63 NOT IN YET
    SPECIES_TO_NATIONAL(PORYGON), // 64
    SPECIES_TO_NATIONAL(PORYGON_Z), // 65 
    SPECIES_TO_NATIONAL(CLOYSTER), // 66
    SPECIES_TO_NATIONAL(ONIX), // 67
    SPECIES_TO_NATIONAL(LICKITUNG), // 68
    SPECIES_TO_NATIONAL(BELLSPROUT), // 69
    SPECIES_TO_NATIONAL(CHERUBI), // 70
    SPECIES_TO_NATIONAL(ODDISH), // 71
    SPECIES_TO_NATIONAL(ZUBAT), // 72
    SPECIES_TO_NATIONAL(WOOBAT), // 73
    SPECIES_TO_NATIONAL(HORSEA), // 74
    SPECIES_TO_NATIONAL(DRAGONITE), // 75
    SPECIES_TO_NATIONAL(YOSHI), // 76
    SPECIES_TO_NATIONAL(REMORAID), // 77
    SPECIES_TO_NATIONAL(HAUNTER), // 78 
    SPECIES_TO_NATIONAL(MAGNEMITE),  // 79
    SPECIES_TO_NATIONAL(MAGNALONE), // 80
    SPECIES_TO_NATIONAL(ALCREMIE), // 81
    ...
    SPECIES_TO_NATIONAL(SPEAROW), // 92
    SPECIES_TO_NATIONAL(EXEGGUTOR), // 93
    SPECIES_TO_NATIONAL(FARFETCHD), // 94
    SPECIES_TO_NATIONAL(GOLURK), // 95
    SPECIES_TO_NATIONAL(BIDOOF), // 96
    SPECIES_TO_NATIONAL(GRIMER), // 97
    SPECIES_TO_NATIONAL(MUK), // 98
    SPECIES_TO_NATIONAL(GIMMIGHOUL), // 99
    SPECIES_TO_NATIONAL(GHOLDENGO), // 100
    SPECIES_TO_NATIONAL(AMPHAROS_MEGA), // 101 NOT IN YET
    SPECIES_TO_NATIONAL(AMPHAROS), // 102
    SPECIES_TO_NATIONAL(SMEARGLE), // 103
    SPECIES_TO_NATIONAL(GOLDEEN), // 104
    SPECIES_TO_NATIONAL(SEAKING), // 105
    SPECIES_TO_NATIONAL(MACHOKE), // 106
    SPECIES_TO_NATIONAL(MACHAMP), // 107
    SPECIES_TO_NATIONAL(GEODUDE), // 108
    SPECIES_TO_NATIONAL(GRAVELER), // 109
    SPECIES_TO_NATIONAL(GOLEM), // 110
    SPECIES_TO_NATIONAL(STARMIE), // 111
    SPECIES_TO_NATIONAL(RAICHU), // 112
    SPECIES_TO_NATIONAL(MEOWTH), // 113
    SPECIES_TO_NATIONAL(TANGELA), // 114
    SPECIES_TO_NATIONAL(TRUBBISH_HAIRCUT), // 115
    SPECIES_TO_NATIONAL(VENONAT), // 116
    SPECIES_TO_NATIONAL(HITMONCHIN), // 117 NOT IN YET
    SPECIES_TO_NATIONAL(RHYDON), // 118
    SPECIES_TO_NATIONAL(PERSIAN), // 119
    SPECIES_TO_NATIONAL(LUVDISC), // 120
    SPECIES_TO_NATIONAL(ALOMOMOLA), // 121
    SPECIES_TO_NATIONAL(MR_MIME), // 122
    SPECIES_TO_NATIONAL(SCYTHER), // 123
    SPECIES_TO_NATIONAL(JYNX), // 124
    SPECIES_TO_NATIONAL(PINSIR), // 125
    SPECIES_TO_NATIONAL(TAUROS), // 126
    SPECIES_TO_NATIONAL(CHANSEY), // 127
    SPECIES_TO_NATIONAL(DACHSBUN), // 128
    SPECIES_TO_NATIONAL(ORTHWORM), // 129
    SPECIES_TO_NATIONAL(OMANYTE), // 130
    SPECIES_TO_NATIONAL(TYRANASTAR), // 131 NOT IN YET
    SPECIES_TO_NATIONAL(SUDOWOODO), // 132
    ...
    SPECIES_TO_NATIONAL(FLAREON), // 141
    SPECIES_TO_NATIONAL(PHIONE), // 142
    SPECIES_TO_NATIONAL(ETERNATUS), // 143
    SPECIES_TO_NATIONAL(ZYGARDE), // 144
    SPECIES_TO_NATIONAL(MELTAN), // 145
...
void CreateMaleMon(struct Pokemon *mon, u16 species, u8 level)
{
    ...
    CreateMon(mon, species, level, USE_RANDOM_IVS, TRUE, personality, OT_ID_PLAYER_ID, otId);
}
...
u16 MonTryLearningNewMoveEvolution(struct Pokemon *mon, bool8 firstMove)
{
    ...
    {
        while (gLevelUpLearnsets[species][sLearningMoveTableID].level == 0 
...
s32 CalculateBaseDamage(struct BattlePokemon *attacker, struct BattlePokemon *defender, u32 move, u16 sideStatus, u16 powerOverride, u8 typeOverride, u8 battlerIdAtk, u8 battlerIdDef)
{
    ...
    if (attacker->ability == ABILITY_HUSTLE)
        attack = (150 * attack) / 100;
    if (attacker->ability == ABILITY_OUTIE && ABILITY_ON_FIELD2(ABILITY_INNIE))
        spAttack = (150 * spAttack) / 100;
    if (attacker->ability == ABILITY_INNIE && ABILITY_ON_FIELD2(ABILITY_OUTIE))
        spAttack = (150 * spAttack) / 100;
...
u16 GetBattleBGM(void)
{
    ...
    if (gBattleTypeFlags & BATTLE_TYPE_TRAINER)
    {
        ...
        case TRAINER_CLASS_HAKARI_BLIZ:
...
{
    const struct LevelUpMove *learnset = gLevelUpLearnsets[species];
    if (learnset == NULL)
