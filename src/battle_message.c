...
static const u8 sText_PkmnHurtsWithSpikyShield[] = _("{B_ATK_NAME_WITH_PREFIX} was hurt by\n{B_DEF_NAME_WITH_PREFIX}'s SPIKY SHIELD!");
...
static const u8 sText_UsingItemTheStatOfPkmnRose[] = _("Your {B_SCR_ACTIVE_NAME_WITH_PREFIX} ate its {B_LAST_ITEM}!{PAUSE 20}");
...
static const u8 sText_LuvdiscAppeared[] = _("A wild LUVDISC appeared!\p");
static const u8 sText_SilphScopeUnveil[] = _("{B_PLAYER_NAME} unveiled the GHOST's\nidentity!{PAUSE 60}");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT - BATTLESTRINGS_TABLE_START] = {
    ...
    [STRINGID_BALL_DIDNT_WORK - BATTLESTRINGS_TABLE_START]               = sText_BallDidntWork,
    [STRINGID_NO_SNAG_MACHINE - BATTLESTRINGS_TABLE_START]               = sText_NoSnagMachine,
    ...
    [STRINGID_TOXICBERRYFAINT - BATTLESTRINGS_TABLE_START]               = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} ate the TOXIC BERRY…\pOh no!"),
...
const u16 gWeatherStartsStringIds[] =
{
    ...
    [WEATHER_SNOW]               = STRINGID_HAIL_STARTS,
