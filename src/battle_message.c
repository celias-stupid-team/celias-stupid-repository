...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT - BATTLESTRINGS_TABLE_START] = {
    ...
    [STRINGID_SLOWSTARTEARLY - BATTLESTRINGS_TABLE_START]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} tries to get going."),
...
const u16 gWeatherStartsStringIds[] =
{
    ...
    [WEATHER_TRICK_ROOM]         = STRINGID_DIMENSIONSARETWISTED,
