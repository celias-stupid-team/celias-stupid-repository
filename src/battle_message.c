...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT - BATTLESTRINGS_TABLE_START] = {
    ...
    [STRINGID_BADDREAMSDMG - BATTLESTRINGS_TABLE_START]                  = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} is tormented by {B_ATK_NAME_WITH_PREFIX}'s\nVERY BAD DREAMS ability!"),
...
const u16 gWeatherStartsStringIds[] =
{
    ...
    [WEATHER_TRICK_ROOM]       = STRINGID_ITISRAINING, //Add the Trick Room string here
