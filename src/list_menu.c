...
{   // { width, height, offset }
    ...
    [TYPE_BROCK + 1]    = { 32, 12, 0x108 },
    [TYPE_WEIRD + 1]    = { 32, 12, 0x10C },
    [TYPE_LARGE + 1]    = { 32, 12, 0x04 },
    [TYPE_BIRD + 1]     = { 32, 12, 0x08 },
    [TYPE_SMALL + 1]     = { 32, 12, 0x124 },
    ...
    [MENU_INFO_ICON_OBTAINABLE] = { 12, 12, 0x148 },
    [MENU_INFO_ICON_BONUS] = { 12, 12, 0x14C },
    [MENU_INFO_ICON_PREMIER] = { 16, 13, 0x160 }, 
    [MENU_INFO_ICON_THREE_STAR] = { 15, 12, 0x164 }, 
};
