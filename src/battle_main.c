...
const u8 gTypeEffectiveness[516] = //You need to update battle_main.h as well!!!! I fucking hate this
{
    ...
    TYPE_DARK, TYPE_WEIRD, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_FIGHTING, TYPE_DAD, TYPE_MUL_SUPER_EFFECTIVE,

    TYPE_POISON, TYPE_BROCK, TYPE_MUL_NO_EFFECT,
    TYPE_NORMAL, TYPE_BROCK, TYPE_MUL_NO_EFFECT,
    TYPE_FIGHTING, TYPE_BROCK, TYPE_MUL_NO_EFFECT,
    TYPE_FLYING, TYPE_BROCK, TYPE_MUL_NO_EFFECT,
    TYPE_STEEL, TYPE_BROCK, TYPE_MUL_NO_EFFECT,
    TYPE_ROCK, TYPE_BROCK, TYPE_MUL_NO_EFFECT,
    TYPE_BUG, TYPE_BROCK, TYPE_MUL_NO_EFFECT,
    TYPE_GHOST, TYPE_BROCK, TYPE_MUL_NO_EFFECT,
    ...
    TYPE_FAIRY_TRANS, TYPE_DARK, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_FAIRY_TRANS, TYPE_FIGHTING, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_FAIRY_TRANS, TYPE_DRAGON, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_FAIRY_TRANS, TYPE_POISON, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_FAIRY_TRANS, TYPE_STEEL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_FAIRY_TRANS, TYPE_FIRE, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_POISON, TYPE_FAIRY_TRANS, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_STEEL, TYPE_FAIRY_TRANS, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_FIGHTING, TYPE_FAIRY_TRANS, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_BUG, TYPE_FAIRY_TRANS, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_DARK, TYPE_FAIRY_TRANS, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_DRAGON, TYPE_FAIRY_TRANS, TYPE_MUL_NO_EFFECT,

    TYPE_WATER_PHYSICAL, TYPE_FIRE, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WATER_PHYSICAL, TYPE_WATER, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WATER_PHYSICAL, TYPE_GRASS, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WATER_PHYSICAL, TYPE_GROUND, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WATER_PHYSICAL, TYPE_ROCK, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WATER_PHYSICAL, TYPE_DRAGON, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ELECTRIC_PHYSICAL, TYPE_WATER, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ELECTRIC_PHYSICAL, TYPE_ELECTRIC, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ELECTRIC_PHYSICAL, TYPE_GRASS, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ELECTRIC_PHYSICAL, TYPE_GROUND, TYPE_MUL_NO_EFFECT,
    TYPE_ELECTRIC_PHYSICAL, TYPE_FLYING, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ELECTRIC_PHYSICAL, TYPE_DRAGON, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_PSYCHIC_PHYSICAL, TYPE_FIGHTING, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_PSYCHIC_PHYSICAL,TYPE_POISON, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_PSYCHIC_PHYSICAL, TYPE_PSYCHIC, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_PSYCHIC_PHYSICAL, TYPE_DARK, TYPE_MUL_NO_EFFECT,
    TYPE_PSYCHIC_PHYSICAL, TYPE_STEEL, TYPE_MUL_NOT_EFFECTIVE,

    TYPE_WATER, TYPE_GRASS_TCG, TYPE_TCG_NOT_EFFECTIVE,
    TYPE_ICE, TYPE_GRASS_TCG, TYPE_TCG_NOT_EFFECTIVE,
    TYPE_FIRE, TYPE_GRASS_TCG, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_NORMAL, TYPE_GRASS_TCG, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ELECTRIC, TYPE_GRASS_TCG, TYPE_TCG_NOT_EFFECTIVE,
    TYPE_DARK, TYPE_GRASS_TCG, TYPE_TCG_NOT_EFFECTIVE,
    TYPE_PSYCHIC, TYPE_GRASS_TCG, TYPE_TCG_NOT_EFFECTIVE,
    TYPE_FIGHTING, TYPE_GRASS_TCG, TYPE_TCG_NOT_EFFECTIVE,
...
const struct TrainerMoney gTrainerMoneyTable[] =
{
    ...
    {TRAINER_CLASS_OFFICER, 25},
    {TRAINER_CLASS_DOCTOR, 25},
    {TRAINER_CLASS_BUTTERFINGERS, 25},
    {TRAINER_CLASS_ODD_LIFEFORM, 25},
     ...
     && !(gBattleTypeFlags & (BATTLE_TYPE_BATTLE_TOWER | BATTLE_TYPE_EREADER_TRAINER | BATTLE_TYPE_TRAINER_TOWER)))
    {
        ...
        for (i = 0; i < gTrainers[trainerNum].partySize; i++)
        {
            ...
            switch (gTrainers[trainerNum].partyFlags)
            {
                ...
                {
                    const struct TrainerMonItemAbilityCustomMoves *partyData = gTrainers[trainerNum].party.ItemAbilityCustomMoves;
