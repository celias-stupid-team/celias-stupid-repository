...
const u8 gText_IngredientBread[] = _("BREAD");
const u8 gText_IngredientSesameSeed[] = _("SESAME SEED");
const u8 gText_IngredientMeat[] = _("MEAT");
const u8 gText_IngredientCheese[] = _("CHEESE");
const u8 gText_IngredientLettuce[] = _("LETTUCE");
const u8 gText_IngredientPickles[] = _("PICKLES");
const u8 gText_IngredientBreadObtained[] = _("BREAD obtained");
const u8 gText_IngredientSesameSeedObtained[] = _("SESAME SEED obtained");
const u8 gText_IngredientMeatObtained[] = _("MEAT obtained");
const u8 gText_IngredientCheeseObtained[] = _("CHEESE obtained");
const u8 gText_IngredientLettuceObtained[] = _("LETTUCE obtained");
const u8 gText_IngredientPicklesObtained[] = _("PICKLES obtained");
