...
const u8 gText_CantUseRetreat[] = _("There is no bench around.");
...
const u8 gText_OakThisIsListOfPokemon[] = _("Okay, they are turning on!\pThe rest will be on in a second.\p");
...
const u8 gText_ReturnToABench[] = _("Retreat to a bench.");
...
const u8 gText_ReturnToBench[] = _("Would you like to retreat to the\nnearest bench around?");
