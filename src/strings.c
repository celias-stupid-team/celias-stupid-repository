...
const u8 gText_MysteryGift[] = _("YOUR TRUE SELF");
const u8 gText_WirelessNotConnected[] = _("You really like surveys.");
...
const u8 gText_DexCategory_FirstBadgePkmn[] = _("First Badge POKéMON");
const u8 gText_DexCategory_SecondBadgePkmn[] = _("Second Badge POKéMON");
const u8 gText_DexCategory_ThirdBadgePkmn[] = _("Third Badge POKéMON");
const u8 gText_DexCategory_FourthBadgePkmn[] = _("Fourth Badge POKéMON");
const u8 gText_DexCategory_FifthBadgePkmn[] = _("Fifth Badge POKéMON");
const u8 gText_DexCategory_SixthBadgePkmn[] = _("Sixth Badge POKéMON");
const u8 gText_DexCategory_SeventhBadgePkmn[] = _("Seventh Badge POKéMON");
const u8 gText_DexCategory_FinalBadgePkmn[] = _("Final Badge POKéMON");
const u8 gText_DexCategory_RarePkmn[] = _("???");
...
const u8 gSaveStatName_VersionNumber[] = _("0.9999");
...
const u8 gOtherText_On[] = _("WALK");
const u8 gOtherText_Off[] = _("OFF");
...
const u8 gText_DontDrinkAndDrive[] = _("{PLAYER} used {STR_VAR_1}.\l...But it failed!\pNo drinking and driving, silly!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PayDayTM[] = _("{PLAYER} booted up the TM!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PlayedPokeFluteCatchy[] = _("Played the BLUE FLUTE.\pNow, that's a catchy tune!{PAUSE_UNTIL_PRESS}");
const u8 gText_PlayedPokeFlute[] = _("Played the BLUE FLUTE.");
...
const u8 gText_SandwichCase[] = _("SANDWICH CASE");
const u8 gText_TheSandwichCaseWillBePutAway[] = _("The SANDWICH CASE will be\nput away.");
const u8 gText_IngredientBread[] = _("A good sandwich requires a good\nfoundation. Where might sell some?");
const u8 gText_IngredientSesameSeed[] = _("Known to mate for life, SESAME\nSEEDS are native to FUSHCIA CITY.");
const u8 gText_IngredientMeat[] = _("Not just any MEAT will do. We need\nthe rarest and tastiest available.");
const u8 gText_IngredientCheese[] = _("Despite your insistence, the fridge\nstill has no cheese. Alas!");
const u8 gText_IngredientLettuce[] = _("The best LETTUCE needs to be CUT\nfresh before eating.");
const u8 gText_IngredientPickles[] = _("While we're making a sandwich, it's\nstill wise to fill the POKéDEX.");
const u8 gText_IngredientBreadObtained[] = _("Don't question why each slice is\nindividually wrapped.");
const u8 gText_IngredientSesameSeedObtained[] = _("If it makes you feel better, he'd\nprolly get eaten by a bird anyway.");
const u8 gText_IngredientMeatObtained[] = _("The black market MEAT is usually\nthe tastiest anyway.");
const u8 gText_IngredientCheeseObtained[] = _("This is also what happens when you\nsolve a puzzle incorrectly.");
const u8 gText_IngredientLettuceObtained[] = _("It's okay; you only gave him a\nhaircut.");
const u8 gText_IngredientPicklesObtained[] = _("And there's my car keys!");
...
const u8 gText_PlayerObtainedClefairy[] = _("{PLAYER} obtained the CLEFAIRY!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PCSwitchError[] = _("Exit the PC and try again!");
...
const u8 gText_PkmnLearnedMove2[] = _("{STR_VAR_1} can't learn a move!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ReturnToABench[] = _("Go to the bench.");

const u8 gText_OdorSleuthFieldMove[] = _("Sleuth for interesting odors.");
...
const u8 gText_ReturnToBench[] = _("Would you like to retreat to \nthe bench?");
...
const u8 gText_FreshWater_200[] = _("CHEESE{CLEAR_TO 0x57}{FONT_SMALL}¥50");
...
const u8 gText_Cascadebadge[] = _("WATER MEDAL");
const u8 gText_Thunderbadge[] = _("PHOTOSENSITIVBADGE");
const u8 gText_Rainbowbadge[] = _("RAINBOWBADGE");
const u8 gText_Soulbadge[] = _("DAD BADGE");
...
const u8 gText_BillSPc[] = _("SOMEONE'S PC");
...
const u8 gText_Bicycle_Price[] = _("BICYCLE{CLEAR_TO 0x49}{FONT_SMALL}Too Much"); //Eventually make it so this is player's money + 1; couldn't figure it out
...
const u8 gText_DomeFossil[] = _("JAW FOSSIL");
...
const u8 gText_BoulderBadge[] = _("BOULDERBADGE");
const u8 gText_CascadeBadge[] = _("WATER MEDAL");
const u8 gText_ThunderBadge[] = _("PHOTOSENSITIVEBADGE");
const u8 gText_RainbowBadge[] = _("RAINBOWBADGE");
const u8 gText_SoulBadge[] = _("DAD BADGE");
const u8 gText_MarshBadge[] = _("MARSHBADGE");
const u8 gText_VolcanoBadge[] = _("VOLCANOBADGE");
...
const u8 gText_OopsTryAgain[] = _("Oops! Something broke!");
...
const u8 gPCText_Etcetera[] = _("NEW! SPECIAL!");
const u8 gPCText_Forest[] = _("FOREST");
const u8 gPCText_City[] = _("BRICK PIECES");
const u8 gPCText_Bookshelf[] = _("BOOKSHELF");
const u8 gPCText_Rickroll[] = _("TRY IT!");
const u8 gPCText_PokemonBox[] = _("¥1,200");
const u8 gPCText_Volcano[] = _("MR. DREAM");
const u8 gPCText_Snow[] = _("IMAGINATION");
const u8 gPCText_Cave[] = _("1997");
const u8 gPCText_Dad[] = _("DAD");
const u8 gPCText_Seafloor[] = _("CAPITALISM");
const u8 gPCText_River[] = _("ANIMATED");
const u8 gPCText_Sky[] = _("LANDSCAPE");
const u8 gPCText_PopupScam[] = _("CONGRATULATIONS!");
...
const u8 gText_PokeSum_MetInATrade_FreeShiny[] = _("Free Shiny!\nMet in a trade.\nCongrats on your friend finding me!");
...
const u8 gText_PokeSum_FatefulEncounterMet_FreeShiny[] = _("Free Shiny!\nMet in a fateful encounter at {LV_2} {DYNAMIC 0x01}.\nCongrats on finding me!");
...
const u8 gText_PokeSum_Met_FreeShiny[] = _("Free Shiny!\nMet in {DYNAMIC 0x02} at {LV_2} {DYNAMIC 0x01}.\nCongrats on finding me!");
...
const u8 gText_PokeSum_ApparentlyMet_FreeShiny[] = _("Free Shiny!\nApparently met in {DYNAMIC 0x02} at {LV_2} {DYNAMIC 0x01}.\nCongrats on your friend finding me!");
...
const u8 gText_PokeSum_Hatched_FreeShiny[] = _("Free Shiny!\nHatched: {DYNAMIC 0x02} at {LV_2} {DYNAMIC 0x01}.\nCongrats on finding me!");
...
const u8 gText_PokeSum_FatefulEncounterHatched_FreeShiny[] = _("Free Shiny! Met in a fateful\nencounter (hatched: {DYNAMIC 0x02}\nat {LV_2} {DYNAMIC 0x01}). Congrats on finding me!");
...
const u8 gText_PokeSum_ApparentlyFatefulEncounterHatched_FreeShiny[] = _("Free Shiny! Apparently met in a\nfateful encounter (hatched: {DYNAMIC 0x02}\nat {LV_2} {DYNAMIC 0x01}). Congrats on finding me!");
...
const u8 gText_BattleScene[] = _("SKIP CUTSCENE");
...
const u8 gText_TextSpeedMid[] = _("SLOWER");
const u8 gText_TextSpeedFast[] = _("SLOWEST");
const u8 gText_BattleSceneOn[] = _("OFF");
const u8 gText_BattleSceneOff[] = _("OFF");
const u8 gText_BattleStyleShift[] = _("SHIFT");
const u8 gText_BattleStyleSet[] = _("CAPS LOCK");
const u8 gText_SoundMono[] = _("BAD");
const u8 gText_SoundStereo[] = _("GOOD");
const u8 gTextJP_Type[] = _("タイプ");
const u8 gText_ButtonTypeHelp[] = _("HELP");
const u8 gText_ButtonTypeLEqualsA[] = _("IN A MENU!");
const u8 gText_ButtonTypeLR[] = _("I'M TRAPPED");
...
const u8 gText_ALIVE[] = _("ALIVE");
const u8 gText_AliveLower[] = _("Alive");
...
const u8 gText_Huh[] = _("Huh?\pThat evolution isn't available yet!"); //Evolution stone locked by Pokedex
...
const u8 gText_PlayerScurriedToSafety[] = _(" \n");
...
const u8 gText_TeachWhichMove[] = _("Teach which move?");
...
const u8 gText_GiveUpTryingToTeachNewMove_NoMon[] = _("Give up trying to teach a new\nmove?");
...
const u8 gFameCheckerKantoShorelineName[] = _("SHORELINE");
const u8 gFameCheckerSaffronName[] = _("WEST SEA");
const u8 gFameCheckerGreatSeaName[] = _("GREAT SEA");
const u8 gFameCheckerGreatSeaNorthName[] = _("EAST SEA");
...
const u8 gText_UnzippedTheItem[] = _("{PLAYER} unzipped the {STR_VAR_1}!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_GimmieghoulCameOut[] = _("Wow!\nA GIMMIEGHOUL came out of the TM!{PAUSE_UNTIL_PRESS}");
