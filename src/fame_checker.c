...
static const u8 sFameCheckerTrainerPicIdxs[] = {
    ...
    [FAMECHECKER_VIRIDIAN]    = TRAINER_PIC_BEAUTY,
    [FAMECHECKER_PEWTER]    = TRAINER_PIC_LEADER_BROCK,
    [FAMECHECKER_MT_MOON]    = TRAINER_PIC_PROTON,
    [FAMECHECKER_CERULEAN]  = TRAINER_PIC_LEADER_MISTY,
    [FAMECHECKER_VERMILION]    = TRAINER_PIC_LEADER_LT_SURGE,
    [FAMECHECKER_ROCK_TUNNEL]     = TRAINER_PIC_SCIENTIST,
    [FAMECHECKER_LAVENDER]  = TRAINER_PIC_ELITE_FOUR_AGATHA,
...
{
    gFameCheckerPersonName_Pallet,
    gFameCheckerPersonName_Viridian,
    gFameCheckerPersonName_Pewter,
    gFameCheckerPersonName_MtMoon,
    gFameCheckerPersonName_Cerulean,
    gFameCheckerPersonName_Vermilion,
    gFameCheckerPersonName_RockTunnel,
    gFameCheckerPersonName_Lavender,
    gFameCheckerPersonName_Celadon,
...
static const u8 *const sFlavorTextOriginObjectNameTexts[] = {
    gFameCheckerFlavorTextOriginObjectName_Pallet0, gFameCheckerFlavorTextOriginObjectName_Pallet1, gFameCheckerFlavorTextOriginObjectName_Pallet2, gFameCheckerFlavorTextOriginObjectName_Pallet3, gFameCheckerFlavorTextOriginObjectName_Pallet4, gFameCheckerFlavorTextOriginObjectName_Pallet5,
    gFameCheckerFlavorTextOriginObjectName_Viridian0, gFameCheckerFlavorTextOriginObjectName_Viridian1, gFameCheckerFlavorTextOriginObjectName_Viridian2, gFameCheckerFlavorTextOriginObjectName_Viridian3, gFameCheckerFlavorTextOriginObjectName_Viridian4, gFameCheckerFlavorTextOriginObjectName_Viridian5,
    gFameCheckerFlavorTextOriginObjectName_Pewter0, gFameCheckerFlavorTextOriginObjectName_Pewter1, gFameCheckerFlavorTextOriginObjectName_Pewter2, gFameCheckerFlavorTextOriginObjectName_Pewter3, gFameCheckerFlavorTextOriginObjectName_Pewter4, gFameCheckerFlavorTextOriginObjectName_Pewter5,
    gFameCheckerFlavorTextOriginObjectName_MtMoon0, gFameCheckerFlavorTextOriginObjectName_MtMoon1, gFameCheckerFlavorTextOriginObjectName_MtMoon2, gFameCheckerFlavorTextOriginObjectName_MtMoon3, gFameCheckerFlavorTextOriginObjectName_MtMoon4, gFameCheckerFlavorTextOriginObjectName_MtMoon5,
    gFameCheckerFlavorTextOriginObjectName_Cerulean0, gFameCheckerFlavorTextOriginObjectName_Cerulean1, gFameCheckerFlavorTextOriginObjectName_Cerulean2, gFameCheckerFlavorTextOriginObjectName_Cerulean3, gFameCheckerFlavorTextOriginObjectName_Cerulean4, gFameCheckerFlavorTextOriginObjectName_Cerulean5,
    gFameCheckerFlavorTextOriginObjectName_Vermilion0, gFameCheckerFlavorTextOriginObjectName_Vermilion1, gFameCheckerFlavorTextOriginObjectName_Vermilion2, gFameCheckerFlavorTextOriginObjectName_Vermilion3, gFameCheckerFlavorTextOriginObjectName_Vermilion4, gFameCheckerFlavorTextOriginObjectName_Vermilion5,
    gFameCheckerFlavorTextOriginObjectName_RockTunnel0, gFameCheckerFlavorTextOriginObjectName_RockTunnel1, gFameCheckerFlavorTextOriginObjectName_RockTunnel2, gFameCheckerFlavorTextOriginObjectName_RockTunnel3, gFameCheckerFlavorTextOriginObjectName_RockTunnel4, gFameCheckerFlavorTextOriginObjectName_RockTunnel5,
    gFameCheckerFlavorTextOriginObjectName_Lavender0, gFameCheckerFlavorTextOriginObjectName_Lavender1, gFameCheckerFlavorTextOriginObjectName_Lavender2, gFameCheckerFlavorTextOriginObjectName_Lavender3, gFameCheckerFlavorTextOriginObjectName_Lavender4, gFameCheckerFlavorTextOriginObjectName_Lavender5,
    gFameCheckerFlavorTextOriginObjectName_Celadon0, gFameCheckerFlavorTextOriginObjectName_Celadon1, gFameCheckerFlavorTextOriginObjectName_Celadon2, gFameCheckerFlavorTextOriginObjectName_Celadon3, gFameCheckerFlavorTextOriginObjectName_Celadon4, gFameCheckerFlavorTextOriginObjectName_Celadon5,
